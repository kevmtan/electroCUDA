function [errors,n,x] = ec_preproc_iEEG(sbj,task,o,n,x,arg)
...
arguments
    % Main inputs
    sbj % Subject name
    task {mustBeText} = 'MMR' % Project name
...
%% Prep
[errors,o,n,chNfo,trialNfo,psy] = ec_initialize(sbj,task,o,n,dirs=dirs,save=arg.save,...
...
%% Detect HFO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [n,ch_bad,errors] = hfo_lfn(n,x,ch_bad,dirs,task,o,errors)
sbj = n.sbj;
fs = n.fs;
nBlocks = n.nRuns;
blocks = n.blocks;
