...
static __global__ void mldivide_kernel30(const int32_T b, const int32_T na,
                                         emxArray_real_T A, int32_T A_dim0);

static __global__ void mldivide_kernel31(const emxArray_real_T B,
...
static __global__ __launch_bounds__(1024, 1) void mldivide_kernel31(
              ...
              emxArray_real_T *gpu_Y, boolean_T *Y_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_A, 2, &lf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_jpvt, 2, &lf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_tau, 1, &lf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_cpu_A, 2, &lf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_ptrdiff_t#" MW_AT_LINE);
  emxInit_ptrdiff_t(&jpvt_t, 1, &hf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_IPIV, 1, &mf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_B, 1, &jf_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b_cpu_A, u0, &df_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(cpu_IPIV, u0, &ff_emlrtRTEI);
    ...
    if (cpu_maxmn < 0) {
      *Y_outdatedOnGpu = false;
      ...
      cpu_Y->size[0] = B->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(cpu_Y, u0, &if_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_A, u0, &cf_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(cpu_jpvt, u0, &ef_emlrtRTEI);
    u0 = cpu_A->size[0];
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_tau, u0, &gf_emlrtRTEI);
    u0 = jpvt_t->size[0];
    jpvt_t->size[0] = cpu_A->size[1];
    nvtxMarkA("#emxEnsureCapacity_ptrdiff_t#" MW_AT_LINE);
    emxEnsureCapacity_ptrdiff_t(jpvt_t, u0, &hf_emlrtRTEI);
    ...
    if ((int32_T)info_t != 0) {
      ...
      if (validLaunchParams) {
        ...
        mldivide_kernel30<<<grid, block>>>(cpu_maxmn - 1, na, b_gpu_A,
                                           cpu_A->size[0U]);
      }
      A_outdatedOnGpu = false;
    ...
    *Y_outdatedOnGpu = false;
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#mldivide_kernel31#" MW_AT_LINE);
      mldivide_kernel31<<<grid, block>>>(gpu_B, gpu_jpvt, na, *gpu_Y);
    }
    *Y_outdatedOnGpu = false;
    *Y_outdatedOnCpu = true;
