...
//
// ec_wtc_fp_terminate.cu
//
// Code generation for function 'ec_wtc_fp_terminate'
//
...
void ec_wtc_fp_atexit()
{
  nvtxRangePushA("#termFcn#ec_wtc_fp_atexit#" MW_AT_LOCATION);
...
void ec_wtc_fp_terminate()
{
  cudaError_t errCode;
  nvtxRangePushA("#fcn#ec_wtc_fp_terminate#" MW_AT_LOCATION);
...
// End of code generation (ec_wtc_fp_terminate.cu)
