                               ...
                               const emxArray_real_T *in5)
{
  ...
  profileLoopStart("binary_expand_op_6_loop_0", __LINE__, (b - 1) + 1, "");
  for (i = 0; i < b; i++) {
    b_in1->data[i] =
  ...
  profileLoopStart("binary_expand_op_6_loop_1", __LINE__,
                   (b_in1->size[0] - 1) + 1, "");
                               ...
                               const emxArray_real_T *in5)
{
  ...
  int32_T stride_1_0;
  int32_T stride_2_0;
  nvtxRangePushA("#fcn#binary_expand_op_7#" MW_AT_LOCATION);
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  ...
  profileLoopStart("binary_expand_op_7_loop_0", __LINE__, (b - 1) + 1, "");
  for (i = 0; i < b; i++) {
    b_in1->data[i] =
        in1->data[i * stride_0_0] +
  ...
  profileLoopStart("binary_expand_op_7_loop_1", __LINE__,
                   (b_in1->size[0] - 1) + 1, "");
  for (i = 0; i < b_in1->size[0]; i++) {
    in1->data[i] = b_in1->data[i];
  }
...
void firls(real_T varargin_1, const real_T varargin_2[4], emxArray_real_T *h)
{
  ...
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&m, 2, &ae_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&k, 1, &be_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&G, 2, &qe_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc1A, 2, &re_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc2A, 2, &se_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc3A, 2, &te_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc4A, 2, &ue_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b, 1, &he_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_a, 1, &ve_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_dv, 1, &we_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&x, 1, &xe_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_dv1, 1, &we_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&y, 1, &ye_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_y, 1, &af_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b0, 1, &je_emlrtRTEI, true);
  if ((!(max_freq > 1.0)) && (!(min_freq < 0.0))) {
    ...
    if (a_outdatedOnGpu) {
      ...
      G->size[1] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(G, b_i, &ce_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      k->size[0] = nx - i;
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(k, b_i, &ie_emlrtRTEI);
    } else {
      i1Start = 0;
    }
    b_i = b->size[0];
    b->size[0] = k->size[0];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b, b_i, &he_emlrtRTEI);
    ...
    for (int32_T s{0}; s < 2; s++) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_dv, b_i, &le_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_dv1, b_i, &le_emlrtRTEI);
      ...
      y->size[0] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(y, b_i, &le_emlrtRTEI);
      ...
      b_y->size[0] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_y, b_i, &le_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b0, b_i, &je_emlrtRTEI);
      b0->data[0] = b_b0;
      loop_ub = b->size[0];
      ...
      b->size[0] = b0->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b, b_i, &ne_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(cpu_a, b_i, &ke_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(x, b_i, &me_emlrtRTEI);
