...
static __global__ void ec_wtc_fp_kernel10(const emxArray_uint32_T y,
                                          const real_T nZeroBegin,
                                          const int32_T b_y,
                                          emxArray_int32_T iv1);

static __global__ void ec_wtc_fp_kernel11(const emxArray_real32_T opts_filter,
                                          const emxArray_int32_T iv1,
                                          const int32_T b_iv1,
                                          emxArray_real32_T h);

static __global__ void ec_wtc_fp_kernel12(const emxArray_real32_T opts_x,
                                          const int32_T b_opts_x,
                                          emxArray_real32_T b_y1);

static __global__ void ec_wtc_fp_kernel13(const emxArray_real32_T b_y1,
                                          const int32_T b,
                                          emxArray_real32_T fv);

static __global__ void ec_wtc_fp_kernel14(const emxArray_creal32_T yp,
                                          const int32_T b, emxArray_real32_T y);

static __global__ void ec_wtc_fp_kernel15(const emxArray_real32_T opts_x,
                                          const int32_T b_opts_x,
                                          emxArray_real32_T fv);

static __global__ void ec_wtc_fp_kernel16(const emxArray_real32_T w,
                                          const int32_T vlen, const int32_T b,
                                          emxArray_real32_T y);

static __global__ void ec_wtc_fp_kernel17(emxArray_real_T y);

static __global__ void
ec_wtc_fp_kernel18(const emxArray_real32_T y, const emxArray_real_T b_y,
                   const real_T opts_filterDelay, const int32_T ii,
                   const int32_T b, emxArray_real32_T b_y1, int32_T y1_dim0);

static __global__ void ec_wtc_fp_kernel19(const int32_T b, emxArray_real_T y);

static __global__ void ec_wtc_fp_kernel2(const emxArray_real32_T xp,
                                         const int32_T b_xp, const int32_T c_xp,
                                         emxArray_real32_T fv, int32_T fv_dim0,
                                         int32_T xp_dim0);

static __global__ void ec_wtc_fp_kernel20(const emxArray_real32_T b_y1,
                                          const int32_T b,
                                          emxArray_real32_T fv);

static __global__ void ec_wtc_fp_kernel21(const emxArray_real32_T b_y1,
                                          const int32_T c_y1,
                                          const int32_T d_y1,
                                          emxArray_real32_T fv, int32_T fv_dim0,
                                          int32_T y1_dim0);

static __global__ void ec_wtc_fp_kernel22(const emxArray_real32_T opts_x,
                                          const int32_T b_opts_x,
                                          emxArray_real32_T b_y1);

static __global__ void ec_wtc_fp_kernel23(const int32_T b, emxArray_uint32_T y);

static __global__ void ec_wtc_fp_kernel24(const emxArray_real32_T fv,
                                          const int32_T b_fv,
                                          emxArray_real32_T opts_x);

static __global__ void ec_wtc_fp_kernel25(const emxArray_real32_T fv,
                                          const int32_T b_fv,
                                          const int32_T c_fv,
                                          emxArray_real32_T opts_x,
                                          int32_T opts_x_dim0, int32_T fv_dim0);

static __global__ void ec_wtc_fp_kernel3(const emxArray_creal32_T yp,
                                         const int32_T b_yp, const int32_T c_yp,
                                         emxArray_creal32_T d_yp,
                                         int32_T yp_dim0, int32_T b_yp_dim0);

static __global__ void ec_wtc_fp_kernel4(const emxArray_real32_T fv,
                                         const int32_T b,
                                         emxArray_real32_T opts_x);
...
static __global__ void ec_wtc_fp_kernel6(const emxArray_real_T b_dv2,
...
static __global__ void ec_wtc_fp_kernel8(const emxArray_real_T h1,
                                         const int32_T b_h1,
                                         emxArray_real32_T opts_filter);

static __global__ void ec_wtc_fp_kernel9(const int32_T nZeroBegin,
                                         emxArray_real32_T h);
...
static __global__ __launch_bounds__(1024, 1) void ec_wtc_fp_kernel16(
...
static __global__
    __launch_bounds__(32, 1) void ec_wtc_fp_kernel17(emxArray_real_T y)
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtc_fp_kernel18(
...
static __global__
    __launch_bounds__(1024, 1) void ec_wtc_fp_kernel19(const int32_T b,
                                                       emxArray_real_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtc_fp_kernel22(
    const emxArray_real32_T opts_x, const int32_T b_opts_x,
    emxArray_real32_T b_y1)
{
  uint64_T gStride;
...
static __global__
    __launch_bounds__(1024, 1) void ec_wtc_fp_kernel23(const int32_T b,
                                                       emxArray_uint32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtc_fp_kernel25(
...
static __global__ __launch_bounds__(1024, 1) void ec_wtc_fp_kernel8(
...
static __global__
    __launch_bounds__(1024, 1) void ec_wtc_fp_kernel9(const int32_T nZeroBegin,
                                                      emxArray_real32_T h)
{
  uint64_T gStride;
  uint64_T gThreadId;
               ...
               emxArray_cell_wrap_0 *xx, emxArray_cell_wrap_0 *yy)
{
  ...
  for (int32_T p{0}; p < b_i1; p++) {
    ...
    if (validLaunchParams) {
      ...
      ec_wtc_fp_kernel2<<<grid, block>>>(gpu_xp, i1, i, gpu_fv,
                                         cpu_fv->size[0U], cpu_xp->size[0U]);
    }
    ...
    if (ds[1] != 0.0) {
      ...
      if (opts_dim == 1) {
        if ((cpu_fv->size[0] == 1) || (cpu_fv->size[1] == 1)) {
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel4<<<grid, block>>>(gpu_fv, b_c - 1, gpu_opts_x);
          }
          ...
          nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
          emxEnsureCapacity_real32_T(cpu_opts_x, i, &g_emlrtRTEI);
          i1 = cpu_fv->size[0] * cpu_fv->size[1] - 1;
          nvtxMarkA("#computeNumIters#" MW_AT_LINE);
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel24<<<grid, block>>>(gpu_fv, i1, gpu_opts_x);
          }
          opts_x_outdatedOnCpu = true;
        }
      } else {
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#ec_wtc_fp_kernel25#" MW_AT_LINE);
          ec_wtc_fp_kernel25<<<grid, block>>>(gpu_fv, i, i1, gpu_opts_x,
                                              cpu_opts_x->size[0U],
                                              cpu_fv->size[0U]);
        }
        opts_x_outdatedOnCpu = true;
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel5<<<grid, block>>>(gpu_r, i, gpu_dv1);
      }
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel6<<<grid, block>>>(gpu_dv2, gpu_dv1, i, gpu_h1);
      }
      vlen = cpu_h1->size[0];
      if (cpu_h1->size[0] == 0) {
        pqmax = 0.0;
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel7<<<grid, block>>>(pqmax, opts_p, i, gpu_h1);
      }
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel8<<<grid, block>>>(gpu_h1, i, gpu_opts_filter);
      }
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel9<<<grid, block>>>(i, gpu_h);
      }
      if (cpu_opts_filter->size[0] < 1) {
        ...
        if (validLaunchParams) {
          ...
          ec_wtc_fp_kernel23<<<grid, block>>>(static_cast<int32_T>(u) - 1,
                                              gpu_y);
        }
      }
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel10<<<grid, block>>>(gpu_y, nZeroBegin, i, gpu_iv1);
      }
      i = cpu_iv1->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      ...
      if (validLaunchParams) {
        ...
        ec_wtc_fp_kernel11<<<grid, block>>>(gpu_opts_filter, gpu_iv1, i, gpu_h);
      }
      ...
      if (opts_dim == 1) {
        if (opts_isRowVectorInput) {
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel12<<<grid, block>>>(gpu_opts_x, i, gpu_y1);
          }
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel13<<<grid, block>>>(gpu_y1, b_c - 1, gpu_fv);
          }
        } else {
          i = cpu_fv->size[0] * cpu_fv->size[1];
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel15<<<grid, block>>>(gpu_opts_x, i, gpu_fv);
          }
          yp_needsGpuEnsureCapacity = false;
          nvtxMarkA("#uniformResampleAlongFirstDim#" MW_AT_LINE);
          coder::b_signal::internal::resample::uniformResampleAlongFirstDim(
        ...
        if (cpu_opts_x->size[0] == 1) {
          ...
          for (int32_T ii{0}; ii < opts_dim; ii++) {
            ...
            if (validLaunchParams) {
              ...
              ec_wtc_fp_kernel16<<<grid, block>>>(gpu_w, vlen, i1, c_gpu_y);
            }
            nvtxMarkA("#div_s32#" MW_AT_LINE);
            ...
            if (std::isnan(pqmax)) {
              ...
              ec_wtc_fp_kernel17<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
                  d_gpu_y);
            } else if (pqmax < 1.0) {
              d_cpu_y->size[0] = 1;
              d_cpu_y->size[1] = 0;
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel22<<<grid, block>>>(gpu_opts_x, i, gpu_y1);
          }
          opts_isRowVectorInput = false;
          yp_needsGpuEnsureCapacity = true;
          nvtxMarkA("#uniformResampleAlongFirstDim#" MW_AT_LINE);
        ...
        if ((cpu_opts_x->size[0] == 1) || (cpu_opts_x->size[1] == 1)) {
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel20<<<grid, block>>>(gpu_y1, i1, gpu_fv);
          }
        } else {
          i = cpu_fv->size[0] * cpu_fv->size[1];
          ...
          if (validLaunchParams) {
            ...
            ec_wtc_fp_kernel21<<<grid, block>>>(
                gpu_y1, i1, i, gpu_fv, cpu_fv->size[0U], cpu_y1->size[0U]);
          }
        }
      }
    ...
    for (i1 = 0; i1 < 2; i1++) {
      b_dv[i1] = static_cast<uint32_T>(b_cpu_yp->size[i1]);
    }
    profileLoopEnd();
    ...
    if (validLaunchParams) {
      ...
      ec_wtc_fp_kernel14<<<grid, block>>>(b_gpu_yp, vlen - 1, b_gpu_y);
    }
    yp_needsGpuEnsureCapacity = true;
    ...
    profileLoopStart("ec_wtc_fp_loop_4", __LINE__,
                     (cpu_fv->size[0] * cpu_fv->size[1] - 1) + 1, "");
