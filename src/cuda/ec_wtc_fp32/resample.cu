...
static __global__ void resample_kernel72(const emxArray_creal32_T varargin_1,
                                         const int32_T b,
                                         emxArray_creal32_T varargout_1);

static __global__ void resample_kernel73(const emxArray_real_T r,
                                         const int32_T b_r,
                                         emxArray_real_T b_dv);

static __global__ void resample_kernel74(const emxArray_real_T b_dv1,
                                         const emxArray_real_T b_dv,
                                         const int32_T c_dv,
                                         emxArray_real_T h1);

static __global__ void resample_kernel75(const real_T pqmax,
                                         const real_T opts_p, const int32_T h1,
                                         emxArray_real_T b_h1);

static __global__ void resample_kernel76(const emxArray_real_T h1,
                                         const int32_T b_h1,
                                         emxArray_real32_T opts_filter);

static __global__ void resample_kernel77(const int32_T nZeroBegin,
                                         emxArray_real32_T h);

static __global__ void resample_kernel78(const emxArray_uint32_T y,
                                         const real_T nZeroBegin,
                                         const int32_T b_y,
                                         emxArray_int32_T iv);

static __global__ void resample_kernel79(const emxArray_real32_T opts_filter,
                                         const emxArray_int32_T iv,
                                         const int32_T b_iv,
                                         emxArray_real32_T h);

static __global__ void resample_kernel80(const emxArray_creal32_T varargout_1,
                                         const int32_T b_varargout_1,
                                         emxArray_creal32_T b_y1);

static __global__ void resample_kernel81(const emxArray_creal32_T b_y1,
                                         const int32_T b,
                                         emxArray_creal32_T varargout_1);

static __global__ void resample_kernel82(const emxArray_creal32_T w,
                                         const int32_T vlen, const int32_T b,
                                         emxArray_creal32_T y);

static __global__ void resample_kernel83(emxArray_real_T y);

static __global__ void
resample_kernel84(const emxArray_creal32_T y, const emxArray_real_T b_y,
                  const real_T opts_filterDelay, const int32_T ii,
                  const int32_T b, emxArray_creal32_T b_y1, int32_T y1_dim0);

static __global__ void resample_kernel85(const int32_T b, emxArray_real_T y);

static __global__ void resample_kernel86(const emxArray_creal32_T b_y1,
                                         const int32_T varargin_1,
                                         emxArray_creal32_T varargout_1);

static __global__ void resample_kernel87(const emxArray_creal32_T b_y1,
                                         const int32_T c_y1, const int32_T d_y1,
                                         emxArray_creal32_T varargout_1,
                                         int32_T varargout_1_dim0,
                                         int32_T y1_dim0);

static __global__ void resample_kernel88(const emxArray_creal32_T varargout_1,
                                         const int32_T b_varargout_1,
                                         emxArray_creal32_T b_y1);

static __global__ void resample_kernel89(const int32_T b, emxArray_uint32_T y);

static __global__ void resample_kernel90(const emxArray_creal32_T varargin_1,
                                         const int32_T b_varargin_1,
                                         emxArray_creal32_T varargout_1);

static __global__ void resample_kernel91(const emxArray_creal32_T varargin_1,
                                         const int32_T b_varargin_1,
                                         const int32_T c_varargin_1,
                                         emxArray_creal32_T varargout_1,
                                         int32_T varargout_1_dim0,
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel72(
    const emxArray_creal32_T varargin_1, const int32_T b,
    emxArray_creal32_T varargout_1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel75(
...
static __global__
    __launch_bounds__(1024, 1) void resample_kernel77(const int32_T nZeroBegin,
                                                      emxArray_real32_T h)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel79(
    const emxArray_real32_T opts_filter, const emxArray_int32_T iv,
    const int32_T b_iv, emxArray_real32_T h)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel80(
    const emxArray_creal32_T varargout_1, const int32_T b_varargout_1,
    emxArray_creal32_T b_y1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel81(
    const emxArray_creal32_T b_y1, const int32_T b,
    emxArray_creal32_T varargout_1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel82(
    const emxArray_creal32_T w, const int32_T vlen, const int32_T b,
    emxArray_creal32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(32,
                                    1) void resample_kernel83(emxArray_real_T y)
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel84(
    const emxArray_creal32_T y, const emxArray_real_T b_y,
...
static __global__ __launch_bounds__(1024,
                                    1) void resample_kernel85(const int32_T b,
                                                              emxArray_real_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel86(
    const emxArray_creal32_T b_y1, const int32_T varargin_1,
    emxArray_creal32_T varargout_1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel87(
    const emxArray_creal32_T b_y1, const int32_T c_y1, const int32_T d_y1,
    emxArray_creal32_T varargout_1, int32_T varargout_1_dim0, int32_T y1_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__
    __launch_bounds__(1024, 1) void resample_kernel89(const int32_T b,
                                                      emxArray_uint32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel90(
    const emxArray_creal32_T varargin_1, const int32_T b_varargin_1,
    emxArray_creal32_T varargout_1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel91(
    const emxArray_creal32_T varargin_1, const int32_T b_varargin_1,
    const int32_T c_varargin_1, emxArray_creal32_T varargout_1,
...
//
namespace coder {
void resample(emxArray_creal32_T *cpu_varargin_1,
              emxArray_creal32_T *gpu_varargin_1,
              boolean_T *varargin_1_outdatedOnGpu, real_T varargin_2,
              real_T varargin_3, emxArray_creal32_T *cpu_varargout_1,
              boolean_T *varargout_1_outdatedOnCpu,
              emxArray_creal32_T *gpu_varargout_1,
              boolean_T *varargout_1_outdatedOnGpu)
{
  ...
  if (opts_dim == 1) {
    if ((cpu_varargin_1->size[0] == 1) || (cpu_varargin_1->size[1] == 1)) {
      ...
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &g_emlrtRTEI);
      ...
      gpuEmxEnsureCapacity_creal32_T(cpu_varargin_1, gpu_varargin_1,
                                     !*varargin_1_outdatedOnGpu);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_varargout_1, gpu_varargout_1, true);
      if (*varargin_1_outdatedOnGpu) {
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_creal32_T(gpu_varargin_1, cpu_varargin_1);
      }
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel72#" MW_AT_LINE);
        resample_kernel72<<<grid, block>>>(*gpu_varargin_1, u1 - 1,
                                           *gpu_varargout_1);
      }
      ...
      *varargout_1_outdatedOnCpu = true;
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel90#" MW_AT_LINE);
        resample_kernel90<<<grid, block>>>(*gpu_varargin_1, i,
                                           *gpu_varargout_1);
      }
      *varargout_1_outdatedOnGpu = false;
      *varargout_1_outdatedOnCpu = true;
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#resample_kernel91#" MW_AT_LINE);
      resample_kernel91<<<grid, block>>>(
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel73#" MW_AT_LINE);
    resample_kernel73<<<grid, block>>>(gpu_r, i, gpu_dv);
  }
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel74#" MW_AT_LINE);
    resample_kernel74<<<grid, block>>>(gpu_dv1, gpu_dv, varargin_1, gpu_h1);
  }
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  ...
  if (cpu_h1->size[0] == 0) {
    ...
    profileLoopStart("resample_loop_0", __LINE__, (vlen - 2) + 1, "");
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel75#" MW_AT_LINE);
    resample_kernel75<<<grid, block>>>(pqmax, opts_p, i, gpu_h1);
  }
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel76#" MW_AT_LINE);
    resample_kernel76<<<grid, block>>>(gpu_h1, i, gpu_opts_filter);
  }
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel77#" MW_AT_LINE);
    resample_kernel77<<<grid, block>>>(i, gpu_h);
  }
  ...
  if (cpu_opts_filter->size[0] < 1) {
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#resample_kernel89#" MW_AT_LINE);
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel78#" MW_AT_LINE);
    resample_kernel78<<<grid, block>>>(gpu_y, nZeroBegin, i, gpu_iv);
  }
  ...
  validLaunchParams = mwValidateLaunchParameters(grid, block);
  if (validLaunchParams) {
    nvtxMarkA("#resample_kernel79#" MW_AT_LINE);
    resample_kernel79<<<grid, block>>>(gpu_opts_filter, gpu_iv, i, gpu_h);
  }
  ...
  emxInit_creal32_T(&cpu_y1, 2, &cb_emlrtRTEI, true);
  if (opts_dim == 1) {
    if (opts_isRowVectorInput) {
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_y1, i, &r_emlrtRTEI);
      i = cpu_varargout_1->size[0] * cpu_varargout_1->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_y1, &gpu_y1, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel80#" MW_AT_LINE);
        resample_kernel80<<<grid, block>>>(*gpu_varargout_1, i, gpu_y1);
      }
      y1_outdatedOnGpu = false;
      w_outdatedOnCpu = true;
      nvtxMarkA("#b_uniformResampleAlongFirstDim#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &hg_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(u1 - 1), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_y1, &gpu_y1, !y1_outdatedOnGpu);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_varargout_1, gpu_varargout_1, true);
      if (y1_outdatedOnGpu) {
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_y1, cpu_y1);
      }
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel81#" MW_AT_LINE);
        resample_kernel81<<<grid, block>>>(gpu_y1, u1 - 1, *gpu_varargout_1);
      }
    } else {
      nvtxMarkA("#b_uniformResampleAlongFirstDim#" MW_AT_LINE);
      b_signal::internal::resample::b_uniformResampleAlongFirstDim(
    ...
    if (cpu_varargout_1->size[0] == 1) {
      ...
      cpu_y1->size[1] = cpu_varargout_1->size[1];
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_y1, i, &s_emlrtRTEI);
      ...
      nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
      emxInit_creal32_T(&cpu_w, 1, &v_emlrtRTEI, true);
      nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
      emxInit_creal32_T(&b_cpu_y, 1, &v_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&c_cpu_y, 2, &eb_emlrtRTEI, true);
      profileLoopStart("resample_loop_1", __LINE__, (opts_dim - 1) + 1, "");
      for (int32_T ii{0}; ii < opts_dim; ii++) {
        ...
        for (varargin_1 = 0; varargin_1 < static_cast<int32_T>(opts_p);
             varargin_1++) {
          yCol->data[varargin_1].re = 0.0F;
          yCol->data[varargin_1].im = 0.0F;
        }
        profileLoopEnd();
        nvtxMarkA("#div_s32#" MW_AT_LINE);
        vlen = div_s32(i2 - 1, i1) + 1;
        profileLoopStart("resample_loop_3", __LINE__, (vlen - 1) + 1, "");
        for (varargin_1 = 0; varargin_1 < vlen; varargin_1++) {
          if (*varargout_1_outdatedOnCpu) {
            ...
            gpuEmxMemcpyGpuToCpu_creal32_T(cpu_varargout_1, gpu_varargout_1);
          }
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(b_cpu_y, i, &v_emlrtRTEI);
        varargin_1 = u1 / vlen;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(varargin_1), &grid, &block,
                                2147483647U);
        ...
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(b_cpu_y, &b_gpu_y, true);
        y_needsGpuEnsureCapacity = false;
        if (w_outdatedOnGpu) {
          nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#resample_kernel82#" MW_AT_LINE);
          resample_kernel82<<<grid, block>>>(gpu_w, vlen, varargin_1, b_gpu_y);
        }
        nvtxMarkA("#div_s32#" MW_AT_LINE);
        if (!(div_s32(u1, vlen) + 1 < Ly)) {
          ...
          nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
          emxEnsureCapacity_creal32_T(b_cpu_y, i, &w_emlrtRTEI);
          y_needsGpuEnsureCapacity = true;
        }
        if (std::isnan(pqmax)) {
          ...
          nvtxMarkA("#resample_kernel83#" MW_AT_LINE);
          resample_kernel83<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(c_gpu_y);
        } else if (pqmax < 1.0) {
          c_cpu_y->size[0] = 1;
          c_cpu_y->size[1] = 0;
        } else {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            nvtxMarkA("#resample_kernel85#" MW_AT_LINE);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#resample_kernel84#" MW_AT_LINE);
          resample_kernel84<<<grid, block>>>(b_gpu_y, c_gpu_y, opts_filterDelay,
                                             ii, vlen - 1, gpu_y1,
                                             cpu_y1->size[0U]);
        }
      }
      ...
      cpu_y1->size[1] = cpu_varargout_1->size[1];
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_y1, i, &p_emlrtRTEI);
      i = cpu_varargout_1->size[0] * cpu_varargout_1->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel88#" MW_AT_LINE);
        resample_kernel88<<<grid, block>>>(*gpu_varargout_1, i, gpu_y1);
      }
      y1_outdatedOnGpu = false;
      w_outdatedOnCpu = true;
      nvtxMarkA("#b_uniformResampleAlongFirstDim#" MW_AT_LINE);
    ...
    if ((cpu_varargout_1->size[0] == 1) || (cpu_varargout_1->size[1] == 1)) {
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel86#" MW_AT_LINE);
        resample_kernel86<<<grid, block>>>(gpu_y1, i, *gpu_varargout_1);
      }
      *varargout_1_outdatedOnCpu = true;
    } else {
      i = cpu_varargout_1->size[0] * cpu_varargout_1->size[1];
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel87#" MW_AT_LINE);
