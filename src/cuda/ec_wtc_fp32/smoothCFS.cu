...
static void binary_expand_op_8(emxArray_creal32_T *in1,
                               const emxArray_real_T *in2,
                               const emxArray_creal32_T *in3);

static __global__ void smoothCFS_kernel144(const real_T d,
                                           const emxArray_int32_T omega_tmp1,
                                           const int32_T b_omega_tmp1,
                                           emxArray_real_T omega_tmp2);

static __global__ void smoothCFS_kernel145(emxArray_real_T omega);

static __global__ void smoothCFS_kernel146(const emxArray_real_T omega_tmp2,
                                           const int32_T b,
                                           emxArray_real_T omega);

static __global__ void
smoothCFS_kernel147(const int32_T offsetH, const int32_T midpoint,
                    const emxArray_real_T omega_tmp2, const int32_T N,
                    emxArray_real_T omega, int32_T omega_tmp2_dim1);

static __global__ void smoothCFS_kernel148(const int32_T cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void
smoothCFS_kernel149(const emxArray_real_T scales, const emxArray_real_T omega,
                    const int32_T b_scales, const int32_T b,
                    emxArray_real_T Fmat, int32_T Fmat_dim0);

static __global__ void smoothCFS_kernel150(const emxArray_creal32_T cfsDFT,
                                           const emxArray_real_T Fmat,
                                           const int32_T b_Fmat,
                                           emxArray_creal32_T c_Fmat);

static __global__ void smoothCFS_kernel151(const emxArray_creal32_T r,
                                           const int32_T b_r,
                                           emxArray_real32_T smooth);

static __global__ void smoothCFS_kernel152(const emxArray_real32_T smooth,
                                           const int32_T b, emxArray_real32_T a,
                                           int32_T smooth_dim0);

static __global__ void smoothCFS_kernel153(const int32_T a,
                                           emxArray_real32_T c);

static __global__ void smoothCFS_kernel154(const emxArray_real32_T c,
                                           const int32_T b_c,
                                           emxArray_real32_T cfs,
                                           int32_T cfs_dim0);

static __global__ void smoothCFS_kernel155(const real_T npad,
                                           const emxArray_real32_T a,
                                           emxArray_real32_T c);

static __global__ void smoothCFS_kernel156(const int32_T a,
                                           emxArray_real32_T expanded);

static __global__ void smoothCFS_kernel157(const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv1);

static __global__ void smoothCFS_kernel158(const emxArray_real32_T a,
                                           const emxArray_int32_T iv1,
                                           const int32_T b,
                                           emxArray_real32_T expanded);

static __global__ void smoothCFS_kernel159(const real_T npad,
                                           const emxArray_real32_T expanded,
                                           const int32_T b,
                                           emxArray_real32_T c);

static __global__ void smoothCFS_kernel160(const int32_T smooth,
                                           const int32_T b_smooth,
                                           emxArray_real32_T cfs,
                                           int32_T cfs_dim0);

static __global__ void smoothCFS_kernel161(const real_T npad,
                                           const emxArray_real32_T smooth,
                                           emxArray_real32_T b_smooth);

static __global__ void smoothCFS_kernel162(const emxArray_real32_T smooth,
                                           emxArray_real32_T cfs);

static __global__ void smoothCFS_kernel163(const int32_T smooth,
                                           emxArray_real32_T expanded);

static __global__ void smoothCFS_kernel164(const int32_T offsetH,
                                           const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv);

static __global__ void smoothCFS_kernel165(const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv2);

static __global__ void
smoothCFS_kernel166(const emxArray_real32_T smooth, const int32_T b_smooth,
                    const int32_T b, emxArray_real32_T c_smooth,
                    int32_T smooth_dim0, int32_T b_smooth_dim0);

static __global__ void
smoothCFS_kernel167(const emxArray_real32_T smooth, const int32_T smooth_dim0,
...
static __global__ void
smoothCFS_kernel168(const real_T npad, const emxArray_real32_T expanded,
                    const emxArray_int32_T rows, const real_T ns,
                    const int32_T b, const int32_T c, emxArray_real32_T cfs,
                    int32_T expanded_dim0, int32_T cfs_dim0);

static __global__ void smoothCFS_kernel169(const int32_T cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void smoothCFS_kernel170(const emxArray_real32_T cfs,
                                           const int32_T b, const int32_T c,
                                           emxArray_creal32_T cfsDFT,
                                           int32_T cfsDFT_dim0,
                                           int32_T cfs_dim0);

static __global__ void smoothCFS_kernel171(const emxArray_real32_T cfs,
                                           const int32_T b_cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void smoothCFS_kernel172(const int32_T N,
                                           const int32_T midpoint,
                                           emxArray_creal32_T cfsDFT);

static __global__ void smoothCFS_kernel173(const int32_T N,
                                           const int32_T cfsDFT,
                                           const int32_T midpoint,
                                           emxArray_creal32_T b_cfsDFT,
                                           int32_T cfsDFT_dim0);

static __global__ void smoothCFS_kernel174(const int32_T b,
                                           emxArray_int32_T omega_tmp1);

static __global__ void smoothCFS_kernel175(const real_T d,
                                           const emxArray_int32_T omega_tmp1,
                                           const int32_T b_omega_tmp1,
                                           emxArray_real_T omega_tmp2);

static __global__ void smoothCFS_kernel176(emxArray_real_T omega);

static __global__ void smoothCFS_kernel177(const emxArray_real_T omega_tmp2,
                                           const int32_T b,
                                           emxArray_real_T omega);

static __global__ void
smoothCFS_kernel178(const int32_T offsetH, const int32_T x,
                    const emxArray_real_T omega_tmp2, const int32_T ySize_idx_1,
                    emxArray_real_T omega, int32_T omega_tmp2_dim1);

static __global__ void smoothCFS_kernel179(const int32_T cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void
smoothCFS_kernel180(const emxArray_real_T scales, const emxArray_real_T omega,
                    const int32_T b_scales, const int32_T b,
                    emxArray_real_T Fmat, int32_T Fmat_dim0);

static __global__ void smoothCFS_kernel181(const emxArray_creal32_T cfsDFT,
                                           const emxArray_real_T Fmat,
                                           const int32_T b_Fmat,
                                           emxArray_creal32_T c_Fmat);

static __global__ void smoothCFS_kernel182(const emxArray_creal32_T smooth,
                                           const int32_T b,
                                           emxArray_creal32_T a,
                                           int32_T smooth_dim0);

static __global__ void smoothCFS_kernel183(const int32_T a,
                                           emxArray_creal32_T c);

static __global__ void smoothCFS_kernel184(const emxArray_creal32_T c,
                                           const int32_T b_c,
                                           emxArray_creal32_T cfs,
                                           int32_T cfs_dim0);

static __global__ void smoothCFS_kernel185(const emxArray_creal32_T a,
                                           const real_T npad, real32_T *cv_im,
                                           real32_T *cv_re);

static __global__ void smoothCFS_kernel186(const real32_T *cv_re,
                                           const real32_T *cv_im,
                                           emxArray_creal32_T c);

static __global__ void smoothCFS_kernel187(const int32_T a,
                                           emxArray_creal32_T expanded);

static __global__ void smoothCFS_kernel188(const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv1);

static __global__ void smoothCFS_kernel189(const emxArray_creal32_T a,
                                           const emxArray_int32_T iv1,
                                           const int32_T b,
                                           emxArray_creal32_T expanded);

static __global__ void smoothCFS_kernel190(const emxArray_creal32_T expanded,
                                           const real_T npad, const int32_T b,
                                           emxArray_creal32_T c);
...
static __global__ void smoothCFS_kernel192(const real_T npad, const int32_T b,
                                           creal32_T a_data[1]);

static __global__ void smoothCFS_kernel193(const int32_T smooth,
                                           emxArray_creal32_T expanded);

static __global__ void smoothCFS_kernel194(const int32_T offsetH,
                                           const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv);

static __global__ void smoothCFS_kernel195(const emxArray_int32_T y,
                                           const int32_T b_y,
                                           emxArray_int32_T iv2);

static __global__ void
smoothCFS_kernel196(const emxArray_creal32_T smooth, const int32_T b_smooth,
                    const int32_T b, emxArray_creal32_T c_smooth,
                    int32_T smooth_dim0, int32_T b_smooth_dim0);

static __global__ void
smoothCFS_kernel197(const emxArray_creal32_T smooth, const int32_T smooth_dim0,
                    const emxArray_int32_T iv2, const emxArray_int32_T iv,
                    const int32_T b_smooth, const int32_T c_smooth,
                    emxArray_creal32_T expanded, int32_T expanded_dim0);

static __global__ void
smoothCFS_kernel198(const int32_T offsetH, const emxArray_creal32_T expanded,
                    const int32_T k, const emxArray_int32_T rows,
                    const int32_T b_rows, emxArray_creal32_T newIm,
                    int32_T expanded_dim0);

static __global__ void
smoothCFS_kernel199(const real32_T cv_re, const int32_T offsetH,
                    const int32_T k, emxArray_creal32_T cfs, int32_T cfs_dim0);

static __global__ void
smoothCFS_kernel200(const real32_T cv_im, const int32_T offsetH,
                    const int32_T k, emxArray_creal32_T cfs, int32_T cfs_dim0);

static __global__ void smoothCFS_kernel201(const int32_T cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void smoothCFS_kernel202(const emxArray_creal32_T cfs,
                                           const int32_T b, const int32_T c,
                                           emxArray_creal32_T cfsDFT,
                                           int32_T cfsDFT_dim0,
                                           int32_T cfs_dim0);

static __global__ void smoothCFS_kernel203(const emxArray_creal32_T cfs,
                                           const int32_T b_cfs,
                                           emxArray_creal32_T cfsDFT);

static __global__ void smoothCFS_kernel204(const int32_T b,
                                           emxArray_int32_T omega_tmp1);
                               ...
                               const emxArray_creal32_T *in3)
{
  ...
  emxInit_creal32_T(&b_in2, 2, &qg_emlrtRTEI, true);
  ...
  emxEnsureCapacity_creal32_T(b_in2, i, &qg_emlrtRTEI);
...
static __global__
    __launch_bounds__(32, 1) void smoothCFS_kernel145(emxArray_real_T omega)
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel146(
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel148(
    const int32_T cfs, emxArray_creal32_T cfsDFT)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T j;
    j = static_cast<int32_T>(idx);
    cfsDFT.data[j].re = 0.0F;
    cfsDFT.data[j].im = 0.0F;
  }
}
    ...
    int32_T Fmat_dim0)
{
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    j = static_cast<int32_T>((idx - static_cast<uint64_T>(i)) /
                             (static_cast<uint64_T>(b_scales) + 1UL));
    a = omega.data[j] * scales.data[i];
    Fmat.data[i + Fmat_dim0 * j] = exp(-0.5 * (a * a));
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel150(
    const emxArray_creal32_T cfsDFT, const emxArray_real_T Fmat,
    const int32_T b_Fmat, emxArray_creal32_T c_Fmat)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T j;
    j = static_cast<int32_T>(idx);
    c_Fmat.data[j].re = static_cast<real32_T>(Fmat.data[j]) * cfsDFT.data[j].re;
    c_Fmat.data[j].im = static_cast<real32_T>(Fmat.data[j]) * cfsDFT.data[j].im;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel151(
    const emxArray_creal32_T r, const int32_T b_r, emxArray_real32_T smooth)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel152(
    const emxArray_real32_T smooth, const int32_T b, emxArray_real32_T a,
    int32_T smooth_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(1024, 1) void smoothCFS_kernel153(const int32_T a,
                                                        emxArray_real32_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel154(
    const emxArray_real32_T c, const int32_T b_c, emxArray_real32_T cfs,
    int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel155(
    const real_T npad, const emxArray_real32_T a, emxArray_real32_T c)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    c.data[0] = a.data[0] * static_cast<real32_T>(npad);
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel156(
    const int32_T a, emxArray_real32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel158(
    const emxArray_real32_T a, const emxArray_int32_T iv1, const int32_T b,
    emxArray_real32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel159(
    const real_T npad, const emxArray_real32_T expanded, const int32_T b,
    emxArray_real32_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    c.data[orow] = expanded.data[orow] * static_cast<real32_T>(npad);
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel160(
    const int32_T smooth, const int32_T b_smooth, emxArray_real32_T cfs,
    int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    j = static_cast<int32_T>((idx - static_cast<uint64_T>(i)) /
                             (static_cast<uint64_T>(smooth) + 1UL));
    cfs.data[i + cfs_dim0 * j] = 0.0F;
  }
}

static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel161(
    const real_T npad, const emxArray_real32_T smooth,
    emxArray_real32_T b_smooth)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    b_smooth.data[0] = smooth.data[0] * static_cast<real32_T>(npad);
  }
}

static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel162(
    const emxArray_real32_T smooth, emxArray_real32_T cfs)
{
  int32_T k;
  k = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (k < 1) {
    cfs.data[0] = smooth.data[0];
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel163(
    const int32_T smooth, emxArray_real32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel166(
    const emxArray_real32_T smooth, const int32_T b_smooth, const int32_T b,
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel167(
    const emxArray_real32_T smooth, const int32_T smooth_dim0,
    const emxArray_int32_T iv2, const emxArray_int32_T iv,
    const int32_T b_smooth, const int32_T c_smooth, emxArray_real32_T expanded,
    int32_T expanded_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel168(
    const real_T npad, const emxArray_real32_T expanded,
    const emxArray_int32_T rows, const real_T ns, const int32_T b,
    const int32_T c, emxArray_real32_T cfs, int32_T expanded_dim0,
    int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    for (int32_T m{0}; m < j; m++) {
      ...
      b_cv += expanded.data[(q1 + expanded_dim0 * i) - 1] *
              static_cast<real32_T>(npad);
    }
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel170(
    const emxArray_real32_T cfs, const int32_T b, const int32_T c,
    emxArray_creal32_T cfsDFT, int32_T cfsDFT_dim0, int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    cfsDFT.data[j + cfsDFT_dim0 * i].im = 0.0F;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel171(
    const emxArray_real32_T cfs, const int32_T b_cfs, emxArray_creal32_T cfsDFT)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel172(
    const int32_T N, const int32_T midpoint, emxArray_creal32_T cfsDFT)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel173(
    ...
    emxArray_creal32_T b_cfsDFT, int32_T cfsDFT_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel174(
    ...
    const int32_T b_omega_tmp1, emxArray_real_T omega_tmp2)
{
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    omega_tmp2.data[b] = static_cast<real_T>(omega_tmp1.data[b]) * d;
  }
}

static __global__
    __launch_bounds__(32, 1) void smoothCFS_kernel176(emxArray_real_T omega)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel177(
    const emxArray_real_T omega_tmp2, const int32_T b, emxArray_real_T omega)
{
  uint64_T gStride;
  uint64_T gThreadId;
    ...
    const int32_T cfs, emxArray_creal32_T cfsDFT)
{
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T b;
    b = static_cast<int32_T>(idx);
    cfsDFT.data[b].re = 0.0F;
    cfsDFT.data[b].im = 0.0F;
  }
}
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel181(
    const emxArray_creal32_T cfsDFT, const emxArray_real_T Fmat,
    const int32_T b_Fmat, emxArray_creal32_T c_Fmat)
{
  uint64_T gStride;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T b;
    b = static_cast<int32_T>(idx);
    c_Fmat.data[b].re = static_cast<real32_T>(Fmat.data[b]) * cfsDFT.data[b].re;
    c_Fmat.data[b].im = static_cast<real32_T>(Fmat.data[b]) * cfsDFT.data[b].im;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel182(
    const emxArray_creal32_T smooth, const int32_T b, emxArray_creal32_T a,
    int32_T smooth_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(1024, 1) void smoothCFS_kernel183(const int32_T a,
                                                        emxArray_creal32_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel184(
    const emxArray_creal32_T c, const int32_T b_c, emxArray_creal32_T cfs,
    int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel185(
    const emxArray_creal32_T a, const real_T npad, real32_T *cv_im,
    real32_T *cv_re)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    *cv_re = static_cast<real32_T>(npad) * a.data[0].re;
    *cv_im = static_cast<real32_T>(npad) * a.data[0].im;
  }
}

static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel186(
    const real32_T *cv_re, const real32_T *cv_im, emxArray_creal32_T c)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel187(
    const int32_T a, emxArray_creal32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T b;
    b = static_cast<int32_T>(idx);
    expanded.data[b].re = 0.0F;
    expanded.data[b].im = 0.0F;
  }
}
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel189(
    const emxArray_creal32_T a, const emxArray_int32_T iv1, const int32_T b,
    emxArray_creal32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel190(
    const emxArray_creal32_T expanded, const real_T npad, const int32_T b,
    emxArray_creal32_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T a;
    a = static_cast<int32_T>(idx);
    c.data[a].re = static_cast<real32_T>(npad) * expanded.data[a].re;
    c.data[a].im = static_cast<real32_T>(npad) * expanded.data[a].im;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel191(
    const int32_T smooth, const int32_T b_smooth, emxArray_creal32_T cfs,
    int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    b = static_cast<int32_T>((idx - static_cast<uint64_T>(a)) /
                             (static_cast<uint64_T>(smooth) + 1UL));
    cfs.data[a + cfs_dim0 * b].re = 0.0F;
    cfs.data[a + cfs_dim0 * b].im = 0.0F;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel192(
    const real_T npad, const int32_T b, creal32_T a_data[1])
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T b_b;
    b_b = static_cast<int32_T>(idx);
    a_data[b_b].re = static_cast<real32_T>(npad);
    a_data[b_b].im = 0.0F;
  }
}

static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel193(
    const int32_T smooth, emxArray_creal32_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel196(
    const emxArray_creal32_T smooth, const int32_T b_smooth, const int32_T b,
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel197(
    const emxArray_creal32_T smooth, const int32_T smooth_dim0,
    const emxArray_int32_T iv2, const emxArray_int32_T iv,
    const int32_T b_smooth, const int32_T c_smooth, emxArray_creal32_T expanded,
    int32_T expanded_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel198(
...
static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel199(
    ...
    emxArray_creal32_T cfs, int32_T cfs_dim0)
{
  ...
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    cfs.data[k + cfs_dim0 * offsetH].re = cv_re;
  }
}

static __global__ __launch_bounds__(32, 1) void smoothCFS_kernel200(
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel202(
    const emxArray_creal32_T cfs, const int32_T b, const int32_T c,
    emxArray_creal32_T cfsDFT, int32_T cfsDFT_dim0, int32_T cfs_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel203(
    const emxArray_creal32_T cfs, const int32_T b_cfs,
    emxArray_creal32_T cfsDFT)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void smoothCFS_kernel204(
    const int32_T b, emxArray_int32_T omega_tmp1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
namespace internal {
namespace cwt {
void b_smoothCFS(emxArray_creal32_T *cpu_cfs, boolean_T *cfs_outdatedOnCpu,
                 emxArray_creal32_T *gpu_cfs, boolean_T *cfs_outdatedOnGpu,
                 emxArray_real_T *cpu_scales, emxArray_real_T *gpu_scales,
                 boolean_T *scales_outdatedOnGpu, real_T ns)
{
  dim3 block;
  dim3 grid;
  emxArray_creal32_T b_gpu_Fmat;
  emxArray_creal32_T b_gpu_expanded;
  emxArray_creal32_T b_gpu_smooth;
  emxArray_creal32_T gpu_a;
  emxArray_creal32_T gpu_c;
  emxArray_creal32_T gpu_cfsDFT;
  emxArray_creal32_T gpu_expanded;
  emxArray_creal32_T gpu_newIm;
  emxArray_creal32_T gpu_smooth;
  emxArray_creal32_T *b_cpu_Fmat;
  emxArray_creal32_T *b_cpu_expanded;
  emxArray_creal32_T *b_cpu_smooth;
  emxArray_creal32_T *cpu_a;
  emxArray_creal32_T *cpu_c;
  emxArray_creal32_T *cpu_cfsDFT;
  emxArray_creal32_T *cpu_expanded;
  emxArray_creal32_T *cpu_newIm;
  emxArray_creal32_T *cpu_smooth;
  ...
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&gpu_c);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&gpu_a);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&b_gpu_Fmat);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&gpu_smooth);
  ...
  if (ySize_idx_1 < 1) {
    ...
    if (validLaunchParams) {
      nvtxMarkA("#smoothCFS_kernel204#" MW_AT_LINE);
      smoothCFS_kernel204<<<grid, block>>>(ySize_idx_1 - 1, gpu_omega_tmp1);
    }
  }
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel175<<<grid, block>>>(6.2831853071795862 / npad,
  ...
  smoothCFS_kernel176<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(gpu_omega);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel177<<<grid, block>>>(gpu_omega_tmp2, ySize_idx_1 - 1,
                                         gpu_omega);
  }
  nvtxMarkA("#div_s32#" MW_AT_LINE);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel178<<<grid, block>>>(offsetH, x, gpu_omega_tmp2,
  ...
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfsDFT, 2, &og_emlrtRTEI, true);
  if ((cpu_cfs->size[0] == 0) || (cpu_cfs->size[1] == 0) ||
    ...
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(cpu_cfsDFT, i, &og_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel179<<<grid, block>>>(i, gpu_cfsDFT);
    }
    ...
    if (cpu_cfs->size[1] < static_cast<int32_T>(npad)) {
      ...
      if (validLaunchParams) {
        ...
        smoothCFS_kernel201<<<grid, block>>>(i, gpu_cfsDFT);
      }
    } else {
      i = cpu_cfsDFT->size[0] * cpu_cfsDFT->size[1];
      cpu_cfsDFT->size[0] = cpu_cfs->size[0];
      cpu_cfsDFT->size[1] = static_cast<int32_T>(npad);
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_cfsDFT, i, &vd_emlrtRTEI);
      c_omega_tmp1_needsGpuEnsureCapa = true;
    }
    ...
    mwGetLaunchParameters1D(computeNumIters(x - 1, ySize_idx_1 - 1), &grid,
                            &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal32_T(cpu_cfs, gpu_cfs, !*cfs_outdatedOnGpu);
    if (c_omega_tmp1_needsGpuEnsureCapa) {
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_cfsDFT, &gpu_cfsDFT, true);
    }
    ...
    *cfs_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel202<<<grid, block>>>(*gpu_cfs, ySize_idx_1 - 1, x - 1,
    ...
    cufftExecC2C(b_fftPlanHandle, (cufftComplex *)&gpu_cfsDFT.data[0],
    ...
    cufftExecC2C(fftPlanHandle, (cufftComplex *)&gpu_cfs->data[0],
                 (cufftComplex *)&gpu_cfs->data[0], CUFFT_FORWARD);
    i = cpu_cfsDFT->size[0] * cpu_cfsDFT->size[1];
    cpu_cfsDFT->size[0] = cpu_cfs->size[0];
    ...
    *cfs_outdatedOnGpu = false;
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#smoothCFS_kernel203#" MW_AT_LINE);
      smoothCFS_kernel203<<<grid, block>>>(*gpu_cfs, i, gpu_cfsDFT);
    }
  }
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel180<<<grid, block>>>(*gpu_scales, gpu_omega, i,
  ...
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_smooth, 2, &vg_emlrtRTEI, true);
  if ((cpu_Fmat->size[0] == cpu_cfsDFT->size[0]) &&
      (cpu_Fmat->size[1] == cpu_cfsDFT->size[1])) {
    nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
    emxInit_creal32_T(&b_cpu_Fmat, 2, &xg_emlrtRTEI, true);
    i = b_cpu_Fmat->size[0] * b_cpu_Fmat->size[1];
    b_cpu_Fmat->size[0] = cpu_Fmat->size[0];
    b_cpu_Fmat->size[1] = cpu_Fmat->size[1];
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(b_cpu_Fmat, i, &xg_emlrtRTEI);
    i = cpu_Fmat->size[0] * cpu_Fmat->size[1] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal32_T(b_cpu_Fmat, &b_gpu_Fmat, true);
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#smoothCFS_kernel181#" MW_AT_LINE);
      smoothCFS_kernel181<<<grid, block>>>(gpu_cfsDFT, gpu_Fmat, i, b_gpu_Fmat);
    }
    nvtxMarkA("#gpuEmxMemcpyGpuToCpu_creal32_T#" MW_AT_LINE);
    gpuEmxMemcpyGpuToCpu_creal32_T(b_cpu_Fmat, &b_gpu_Fmat);
    nvtxMarkA("#ifft#" MW_AT_LINE);
    ifft(b_cpu_Fmat, cpu_smooth);
    nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
    emxFree_creal32_T(&b_cpu_Fmat);
  } else {
  ...
  npad = 1.0 / ns;
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_a, 1, &vf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_c, 1, &dg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_expanded, 2, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_expanded, 1, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  ...
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&c_cpu_y, 2, &eg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv2, 1, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_rows, 2, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_newIm, 1, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&smooth, 1, &ig_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_smooth, 2, &tg_emlrtRTEI, true);
  if ((cpu_smooth->size[0] == 1) && (static_cast<int32_T>(ns) == 1)) {
    i = cpu_a->size[0];
    cpu_a->size[0] = i2;
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(cpu_a, i, &vf_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i2 - 1), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal32_T(cpu_smooth, &gpu_smooth, false);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal32_T(cpu_a, &gpu_a, true);
    nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
    gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_smooth, cpu_smooth);
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#smoothCFS_kernel182#" MW_AT_LINE);
      smoothCFS_kernel182<<<grid, block>>>(gpu_smooth, i2 - 1, gpu_a,
                                           cpu_smooth->size[0U]);
    }
    i = cpu_c->size[0];
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel183<<<grid, block>>>(i, gpu_c);
    }
    if (cpu_a->size[0] != 0) {
      if (cpu_a->size[0] == 1) {
        i = cpu_c->size[0];
        ...
        smoothCFS_kernel185<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            gpu_a, npad, gpu_cv_im, gpu_cv_re);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(cpu_c, &gpu_c, true);
        nvtxMarkA("#smoothCFS_kernel186#" MW_AT_LINE);
        smoothCFS_kernel186<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            gpu_cv_re, gpu_cv_im, gpu_c);
      } else {
        int32_T OH;
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(b_cpu_expanded, i, &bg_emlrtRTEI);
        i = cpu_a->size[0] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(b_cpu_expanded, &gpu_expanded, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#smoothCFS_kernel187#" MW_AT_LINE);
          smoothCFS_kernel187<<<grid, block>>>(i, gpu_expanded);
        }
        x = cpu_a->size[0];
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel188<<<grid, block>>>(gpu_y, i, gpu_iv1);
        }
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel189<<<grid, block>>>(gpu_a, gpu_iv1, ySize_idx_1 - 1,
                                               gpu_expanded);
        }
        i = cpu_c->size[0];
        cpu_c->size[0] = cpu_a->size[0];
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel190<<<grid, block>>>(gpu_expanded, npad, OH - 1,
                                               gpu_c);
        }
      }
    }
    ...
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(cpu_cfs, i, &sg_emlrtRTEI);
    i = cpu_c->size[0] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel184<<<grid, block>>>(gpu_c, i, *gpu_cfs,
                                           cpu_cfs->size[0U]);
    }
    *cfs_outdatedOnGpu = false;
    *cfs_outdatedOnCpu = true;
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel191<<<grid, block>>>(b_smooth[0] - 1, i2 - 1, *gpu_cfs,
                                           cpu_cfs->size[0U]);
    }
    *cfs_outdatedOnGpu = false;
    *cfs_outdatedOnCpu = true;
    if ((cpu_smooth->size[0] != 0) && (i2 != 0) &&
      ...
      if ((cpu_smooth->size[0] == 1) && (i2 == 1) &&
        ...
        smooth->size[0] = 1;
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(smooth, i, &ig_emlrtRTEI);
        nvtxMarkA("#checkCudaError#" MW_AT_LINE);
        ...
        *cfs_outdatedOnGpu = true;
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel193<<<grid, block>>>(i, b_gpu_expanded);
        }
        x = cpu_smooth->size[0];
        ...
        c_cpu_y->size[1] = i2;
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(c_cpu_y, i, &cg_emlrtRTEI);
        c_cpu_y->data[0] = 1;
        ySize_idx_1 = 1;
        ...
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(cpu_iv2, i, &bg_emlrtRTEI);
        i = c_cpu_y->size[1] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel195<<<grid, block>>>(c_gpu_y, i, gpu_iv2);
        }
        i = b_cpu_smooth->size[0] * b_cpu_smooth->size[1];
        b_cpu_smooth->size[0] = cpu_smooth->size[0];
        b_cpu_smooth->size[1] = i2;
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(b_cpu_smooth, i, &tg_emlrtRTEI);
        ...
        gpuEmxEnsureCapacity_creal32_T(cpu_smooth, &gpu_smooth, false);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(b_cpu_smooth, &b_gpu_smooth, true);
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_smooth, cpu_smooth);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#smoothCFS_kernel196#" MW_AT_LINE);
          smoothCFS_kernel196<<<grid, block>>>(
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel197<<<grid, block>>>(
        ...
        cpu_cfs->size[1] = i2;
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(cpu_cfs, i, &bg_emlrtRTEI);
        ...
        for (offsetH = 0; offsetH < i2; offsetH++) {
          ...
          for (int32_T k{0}; k < OH; k++) {
            ...
            if (validLaunchParams) {
              ...
              smoothCFS_kernel198<<<grid, block>>>(offsetH, b_gpu_expanded, k,
            ...
            for (x = 0; x < ySize_idx_1; x++) {
              ...
              cpu_cv_re += cpu_newIm->data[x].re * static_cast<real32_T>(npad);
              newIm_outdatedOnCpu = false;
              cpu_cv_im += cpu_newIm->data[x].im * static_cast<real32_T>(npad);
            }
            profileLoopEnd();
            ...
            smoothCFS_kernel199<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
                cpu_cv_re, offsetH, k, *gpu_cfs, cpu_cfs->size[0U]);
            cfs_needsGpuEnsureCapacity = false;
            nvtxMarkA("#smoothCFS_kernel200#" MW_AT_LINE);
            smoothCFS_kernel200<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
                cpu_cv_im, offsetH, k, *gpu_cfs, cpu_cfs->size[0U]);
          }
          profileLoopEnd();
        }
        profileLoopEnd();
  ...
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  emxFree_creal32_T(&b_cpu_smooth);
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  ...
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  emxFree_creal32_T(&cpu_c);
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  emxFree_creal32_T(&cpu_a);
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  emxFree_creal32_T(&cpu_smooth);
  emlrtHeapReferenceStackLeaveFcnR2012b(emlrtRootTLSGlobal);
  ...
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_smooth);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&b_gpu_Fmat);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_a);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_c);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  ...
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&b_gpu_smooth);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaFree#" MW_AT_LINE);
  checkCudaError(mwCudaFree(*gpu_a_data), __FILE__, __LINE__);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaFree#" MW_AT_LINE);
  checkCudaError(mwCudaFree(gpu_cv_im), __FILE__, __LINE__);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaFree#" MW_AT_LINE);
...
//
//
void smoothCFS(emxArray_real32_T *cpu_cfs, boolean_T *cfs_outdatedOnCpu,
               emxArray_real32_T *gpu_cfs, boolean_T *cfs_outdatedOnGpu,
               emxArray_real_T *cpu_scales, emxArray_real_T *gpu_scales,
               boolean_T *scales_outdatedOnGpu, real_T ns)
{
  dim3 block;
  ...
  emxArray_real32_T c_gpu_smooth;
  ...
  gpuEmxReset_real32_T(&c_gpu_smooth);
  nvtxMarkA("#gpuEmxReset_real32_T#" MW_AT_LINE);
  ...
  if (N < 1) {
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel174<<<grid, block>>>(N - 1, gpu_omega_tmp1);
    }
  }
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_omega_tmp2, 2, &mg_emlrtRTEI, true);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel144<<<grid, block>>>(6.2831853071795862 / npad,
  ...
  smoothCFS_kernel145<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(gpu_omega);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel146<<<grid, block>>>(gpu_omega_tmp2, N - 1, gpu_omega);
  }
  nvtxMarkA("#div_s32#" MW_AT_LINE);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel147<<<grid, block>>>(offsetH, midpoint, gpu_omega_tmp2, N,
  ...
  if ((cpu_cfs->size[0] == 0) || (cpu_cfs->size[1] == 0) ||
    ...
    cpu_cfsDFT->size[1] = static_cast<int32_T>(npad);
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(cpu_cfsDFT, k, &og_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel148<<<grid, block>>>(k, gpu_cfsDFT);
    }
  } else if (cpu_cfs->size[1] != static_cast<int32_T>(npad)) {
    ...
    if (cpu_cfs->size[1] < static_cast<int32_T>(npad)) {
      ...
      if (validLaunchParams) {
        ...
        smoothCFS_kernel169<<<grid, block>>>(k, gpu_cfsDFT);
      }
    } else {
      k = cpu_cfsDFT->size[0] * cpu_cfsDFT->size[1];
      cpu_cfsDFT->size[0] = cpu_cfs->size[0];
      cpu_cfsDFT->size[1] = static_cast<int32_T>(npad);
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_cfsDFT, k, &vd_emlrtRTEI);
      c_omega_tmp1_needsGpuEnsureCapa = true;
    }
    N = cpu_cfs->size[0];
    if (cpu_cfs->size[1] > static_cast<int32_T>(npad)) {
    ...
    gpuEmxEnsureCapacity_real32_T(cpu_cfs, gpu_cfs, !*cfs_outdatedOnGpu);
    if (c_omega_tmp1_needsGpuEnsureCapa) {
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_cfsDFT, &gpu_cfsDFT, true);
    }
    if (*cfs_outdatedOnGpu) {
      ...
      gpuEmxMemcpyCpuToGpu_real32_T(gpu_cfs, cpu_cfs);
    }
    *cfs_outdatedOnGpu = false;
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#smoothCFS_kernel170#" MW_AT_LINE);
      smoothCFS_kernel170<<<grid, block>>>(*gpu_cfs, N - 1, midpoint - 1,
                                           gpu_cfsDFT, cpu_cfsDFT->size[0U],
                                           cpu_cfs->size[0U]);
    }
    N = cpu_cfsDFT->size[1];
    ...
    if (midpoint -
      ...
      *cfs_outdatedOnGpu = false;
      ...
      if (validLaunchParams) {
        ...
        smoothCFS_kernel171<<<grid, block>>>(*gpu_cfs, k, gpu_cfsDFT);
      }
      N = cpu_cfsDFT->size[1];
      fftPlanHandle = acquireCUFFTPlan(1, &N, &N, cpu_cfsDFT->size[0], 1,
                                       CUFFT_C2C, cpu_cfsDFT->size[0]);
      cufftExecC2C(fftPlanHandle, (cufftComplex *)&gpu_cfsDFT.data[0],
                   (cufftComplex *)&gpu_cfsDFT.data[0], CUFFT_FORWARD);
    } else {
      cufftHandle b_fftPlanHandle;
      uint32_T xSize[2];
      ...
      *cfs_outdatedOnGpu = false;
      cufftExecR2C(b_fftPlanHandle, (cufftReal *)&gpu_cfs->data[0],
      ...
      if ((cpu_cfsDFT->size[0] == 1) || (cpu_cfsDFT->size[1] == 1)) {
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel172<<<grid, block>>>(static_cast<int32_T>(xSize[1]),
                                               midpoint, gpu_cfsDFT);
        }
      } else {
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel173<<<grid, block>>>(static_cast<int32_T>(xSize[1]),
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel149<<<grid, block>>>(*gpu_scales, gpu_omega, k, N - 1,
                                         gpu_Fmat, cpu_Fmat->size[0U]);
  }
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  emxFree_real_T(&cpu_omega);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r, 2, &wg_emlrtRTEI, true);
  if ((cpu_Fmat->size[0] == cpu_cfsDFT->size[0]) &&
      (cpu_Fmat->size[1] == cpu_cfsDFT->size[1])) {
    nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
    emxInit_creal32_T(&b_cpu_Fmat, 2, &qg_emlrtRTEI, true);
    k = b_cpu_Fmat->size[0] * b_cpu_Fmat->size[1];
    b_cpu_Fmat->size[0] = cpu_Fmat->size[0];
    b_cpu_Fmat->size[1] = cpu_Fmat->size[1];
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(b_cpu_Fmat, k, &qg_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel150<<<grid, block>>>(gpu_cfsDFT, gpu_Fmat, k, b_gpu_Fmat);
    }
    nvtxMarkA("#gpuEmxMemcpyGpuToCpu_creal32_T#" MW_AT_LINE);
    gpuEmxMemcpyGpuToCpu_creal32_T(b_cpu_Fmat, &b_gpu_Fmat);
    nvtxMarkA("#ifft#" MW_AT_LINE);
  ...
  emxInit_real32_T(&cpu_smooth, 2, &vg_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real32_T(cpu_smooth, k, &rg_emlrtRTEI);
  k = cpu_r->size[0] * cpu_r->size[1] - 1;
  nvtxMarkA("#computeNumIters#" MW_AT_LINE);
  mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
  nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
  gpuEmxEnsureCapacity_creal32_T(cpu_r, &gpu_r, false);
  nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
  ...
  if (validLaunchParams) {
    ...
    smoothCFS_kernel151<<<grid, block>>>(gpu_r, k, gpu_smooth);
  }
  nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
  ...
  npad = 1.0 / ns;
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_a, 1, &vf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_c, 1, &dg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  ...
  emxInit_int32_T(&cpu_rows, 2, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_smooth, 1, &ig_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&c_cpu_smooth, 2, &tg_emlrtRTEI, true);
  if ((cpu_smooth->size[0] == 1) && (static_cast<int32_T>(ns) == 1)) {
    k = cpu_a->size[0];
    cpu_a->size[0] = i2;
    nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
    emxEnsureCapacity_real32_T(cpu_a, k, &vf_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i2 - 1), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel152<<<grid, block>>>(gpu_smooth, i2 - 1, gpu_a,
                                           cpu_smooth->size[0U]);
    }
    k = cpu_c->size[0];
    cpu_c->size[0] = cpu_a->size[0];
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel153<<<grid, block>>>(k, gpu_c);
    }
    if (cpu_a->size[0] != 0) {
      if (cpu_a->size[0] == 1) {
        k = cpu_c->size[0];
        ...
        smoothCFS_kernel155<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            npad, gpu_a, gpu_c);
      } else {
        int32_T OH;
        int8_T threadDims[3];
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel156<<<grid, block>>>(k, gpu_expanded);
        }
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel157<<<grid, block>>>(gpu_y, k, gpu_iv1);
        }
        N = cpu_iv1->size[0];
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel158<<<grid, block>>>(gpu_a, gpu_iv1, N - 1,
                                               gpu_expanded);
        }
        k = cpu_c->size[0];
        cpu_c->size[0] = cpu_a->size[0];
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel159<<<grid, block>>>(npad, gpu_expanded, OH - 1,
                                               gpu_c);
        }
      }
    }
    ...
    cpu_cfs->size[1] = cpu_c->size[0];
    nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
    emxEnsureCapacity_real32_T(cpu_cfs, k, &sg_emlrtRTEI);
    k = cpu_c->size[0] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel154<<<grid, block>>>(gpu_c, k, *gpu_cfs,
                                           cpu_cfs->size[0U]);
    }
  } else {
    int32_T smooth[2];
    ...
    if (validLaunchParams) {
      ...
      smoothCFS_kernel160<<<grid, block>>>(smooth[0] - 1, i2 - 1, *gpu_cfs,
                                           cpu_cfs->size[0U]);
    }
    if ((cpu_smooth->size[0] != 0) && (i2 != 0) &&
        (static_cast<int32_T>(ns) != 0)) {
      if ((cpu_smooth->size[0] == 1) && (i2 == 1) &&
          (static_cast<int32_T>(ns) == 1)) {
        k = b_cpu_smooth->size[0];
        b_cpu_smooth->size[0] = 1;
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(b_cpu_smooth, k, &ig_emlrtRTEI);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(b_cpu_smooth, &b_gpu_smooth, true);
        nvtxMarkA("#smoothCFS_kernel161#" MW_AT_LINE);
        smoothCFS_kernel161<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            npad, gpu_smooth, b_gpu_smooth);
        k = cpu_cfs->size[0] * cpu_cfs->size[1];
        cpu_cfs->size[0] = 1;
        cpu_cfs->size[1] = 1;
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_cfs, k, &sg_emlrtRTEI);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(cpu_cfs, gpu_cfs, true);
        nvtxMarkA("#smoothCFS_kernel162#" MW_AT_LINE);
        smoothCFS_kernel162<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            b_gpu_smooth, *gpu_cfs);
      } else {
        int32_T OH;
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel163<<<grid, block>>>(k, b_gpu_expanded);
        }
        ...
        c_cpu_y->size[1] = i2;
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(c_cpu_y, k, &cg_emlrtRTEI);
        c_cpu_y->data[0] = 1;
        N = 1;
        ...
        cpu_iv2->size[0] = c_cpu_y->size[1];
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(cpu_iv2, k, &bg_emlrtRTEI);
        k = c_cpu_y->size[1] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel167<<<grid, block>>>(
        ...
        cpu_cfs->size[1] = i2;
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_cfs, k, &bg_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          smoothCFS_kernel168<<<grid, block>>>(
  ...
  nvtxMarkA("#gpuEmxFree_real32_T#" MW_AT_LINE);
  gpuEmxFree_real32_T(&c_gpu_smooth);
  *cfs_outdatedOnCpu = true;
  *cfs_outdatedOnGpu = false;
  *scales_outdatedOnGpu = false;
  nvtxRangePop();
