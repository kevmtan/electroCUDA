    ...
    *sigmaT = std::sqrt(
    ...
    if (std::isinf(*sigmaT) || std::isnan(*sigmaT)) {
      ...
      if (!(b_be > 0.0)) {
        ...
        nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
        emxInit_real_T(&y, 2, &ic_emlrtRTEI, true);
        nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
        emxInit_real_T(&fx, 2, &jc_emlrtRTEI, true);
        nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
        emxInit_real_T(&b_dv1, 2, &kc_emlrtRTEI, true);
        nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
        emxInit_real_T(&b_y, 2, &kc_emlrtRTEI, true);
        ...
        do {
          ...
          if (guard1) {
            ...
            nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
            emxEnsureCapacity_real_T(b_dv1, ix, &dc_emlrtRTEI);
