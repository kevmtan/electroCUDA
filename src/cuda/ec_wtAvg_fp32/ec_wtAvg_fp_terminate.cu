...
//
// ec_wtAvg_fp_terminate.cu
//
// Code generation for function 'ec_wtAvg_fp_terminate'
//
...
void ec_wtAvg_fp_atexit()
{
  nvtxRangePushA("#termFcn#ec_wtAvg_fp_atexit#" MW_AT_LOCATION);
...
void ec_wtAvg_fp_terminate()
{
  cudaError_t errCode;
  nvtxRangePushA("#fcn#ec_wtAvg_fp_terminate#" MW_AT_LOCATION);
...
// End of code generation (ec_wtAvg_fp_terminate.cu)
