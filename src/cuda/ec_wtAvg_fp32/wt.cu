...
static __global__ void cwtfilterbank_wt_kernel15(const int32_T i,
                                                 const int32_T b,
                                                 emxArray_real32_T x);
...
//
namespace coder {
void cwtfilterbank_wt(cwtfilterbank *self, const emxArray_real32_T *x,
                      emxArray_creal32_T *varargout_1)
{
  ...
  nd2 = x->size[0];
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_x, 1, &tc_emlrtRTEI, true);
  bcoef = b_x->size[0];
  b_x->size[0] = x->size[0];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(b_x, bcoef, &tc_emlrtRTEI);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_xv, 2, &uc_emlrtRTEI, true);
  xv_outdatedOnGpu = false;
  bcoef = cpu_xv->size[0] * cpu_xv->size[1];
  cpu_xv->size[0] = 1;
  cpu_xv->size[1] = x->size[0];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(cpu_xv, bcoef, &uc_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
    emxInit_real32_T(&cpu_x, 2, &xc_emlrtRTEI, true);
    xv_outdatedOnGpu = false;
    bcoef = cpu_x->size[0] * cpu_x->size[1];
    cpu_x->size[0] = 1;
    cpu_x->size[1] = i;
    nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
    emxEnsureCapacity_real32_T(cpu_x, bcoef, &xc_emlrtRTEI);
  ...
  emxInit_creal32_T(&cpu_xposdft, 2, &vc_emlrtRTEI, true);
  if (cpu_xv->size[1] == 0) {
    xv_outdatedOnGpu = false;
    ...
    cpu_xposdft->size[1] = cpu_xv->size[1];
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(cpu_xposdft, bcoef, &wc_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfsposdft, 2, &cd_emlrtRTEI, true);
  x_outdatedOnCpu = false;
  ...
  nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
  emxEnsureCapacity_creal32_T(cpu_cfsposdft, bcoef, &i_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(varargout_1, bcoef, &bd_emlrtRTEI);
  }
