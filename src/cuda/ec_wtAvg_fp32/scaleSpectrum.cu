                                 ...
                                 boolean_T *savgp_outdatedOnGpu)
{
  ...
  emxInit_creal32_T(&cfs, 2, &o_emlrtRTEI, true);
  ...
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&y, 2, &jd_emlrtRTEI, true);
  vstride = y->size[0] * y->size[1];
  y->size[0] = cfs->size[0];
  y->size[1] = cfs->size[1];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(y, vstride, &f_emlrtRTEI);
  ...
  profileLoopEnd();
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&a, 2, &kd_emlrtRTEI, true);
  vstride = a->size[0] * a->size[1];
  a->size[0] = y->size[0];
  a->size[1] = y->size[1];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(a, vstride, &h_emlrtRTEI);
  ...
  emxFree_real32_T(&y);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&abscfssq, 2, &ld_emlrtRTEI, true);
  ...
  emxInit_uint32_T(&b_y, 2, &md_emlrtRTEI, true);
  if (abscfssq->size[1] < 1) {
    ...
    emxEnsureCapacity_uint32_T(b_y, vstride, &w_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_z, 1, &nd_emlrtRTEI, true);
  z_outdatedOnGpu = false;
  vstride = cpu_z->size[0];
  cpu_z->size[0] = abscfssq->size[0];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(cpu_z, vstride, &dd_emlrtRTEI);
  ...
  if (abscfssq->size[1] > 1) {
    ...
    emxInit_real_T(&c, 1, &fd_emlrtRTEI, true);
    if (b_y->size[1] == 1) {
      nx = abscfssq->size[1];
      vstride = c->size[0];
      ...
      c->size[0] = abscfssq->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(c, vstride, &ed_emlrtRTEI);
      c->data[0] =
  ...
  if (cpu_z->size[0] <= 1) {
    ...
    if (Scales->size[1] == 1) {
      ...
      cpu_c->size[0] = cpu_z->size[0];
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(cpu_c, vstride, &ed_emlrtRTEI);
  ...
  nx = cfs->size[0] * cfs->size[1];
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&c_y, 2, &od_emlrtRTEI, true);
  vstride = c_y->size[0] * c_y->size[1];
  c_y->size[0] = cfs->size[0];
  c_y->size[1] = cfs->size[1];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(c_y, vstride, &f_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_y, 2, &od_emlrtRTEI, true);
  vstride = d_y->size[0] * d_y->size[1];
  d_y->size[0] = c_y->size[0];
  d_y->size[1] = c_y->size[1];
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(d_y, vstride, &h_emlrtRTEI);
  ...
  if ((static_cast<int32_T>(defaultSL_idx_1) == 0) && (abswt2S->size[1] == 0)) {
    ...
    cpu_savgp->size[1] = 1;
    nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
    emxEnsureCapacity_real32_T(cpu_savgp, vstride, &id_emlrtRTEI);
    ...
    *savgp_outdatedOnGpu = false;
    ...
    if (static_cast<int32_T>(defaultSL_idx_1) <= 1) {
      ...
      if (static_cast<int32_T>(defaultSL_idx_1) == 1) {
        ...
        b_cpu_c->size[0] = static_cast<int32_T>(defaultSL_idx_1);
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(b_cpu_c, vstride, &ed_emlrtRTEI);
