...
static __global__ void ec_wt_fp_kernel1(const int32_T ch,
                                        ...
                                        const int32_T b_x, emxArray_real32_T xc,
                                        int32_T x_dim0);

static __global__ void ec_wt_fp_kernel10(const emxArray_real32_T fv,
                                         const real_T ds, const int32_T b,
                                         emxArray_real32_T b_fv);

static __global__ void ec_wt_fp_kernel11(const emxArray_real32_T fv,
                                         const int32_T b_fv,
                                         emxArray_real32_T c_fv);

static __global__ void ec_wt_fp_kernel12(const emxArray_real32_T fv,
                                         const int32_T ch,
...
static __global__ void ec_wt_fp_kernel13(const int32_T vlen,
                                         const emxArray_real32_T x,
                                         const int32_T b, emxArray_real32_T b_b,
                                         int32_T x_dim0);

static __global__ void ec_wt_fp_kernel14(const emxArray_real32_T r,
                                         const int32_T b_r,
...
static __global__ void ec_wt_fp_kernel16(const emxArray_creal32_T r2,
                                         const int32_T b_r2, const int32_T c_r2,
                                         emxArray_creal32_T x, int32_T x_dim0,
                                         int32_T r2_dim0);

static __global__ void ec_wt_fp_kernel17(const emxArray_creal32_T x,
                                         const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel18(const emxArray_real32_T y,
                                         const int32_T b,
...
static __global__ void ec_wt_fp_kernel2(const emxArray_creal32_T cfs,
                                        const int32_T b, emxArray_real32_T y);
...
ec_wt_fp_kernel21(const emxArray_real32_T fv1, const int32_T lshift_dim0,
                  const int32_T vlen, const int32_T b, const int32_T c,
                  emxArray_real32_T b_fv1, int32_T fv1_dim0);

static __global__ void ec_wt_fp_kernel22(const emxArray_real32_T fv1,
                                         const int32_T lshift,
                                         emxArray_real32_T b_fv1);

static __global__ void ec_wt_fp_kernel23(const emxArray_real32_T fv1,
                                         const int32_T y_dim0, const int32_T ch,
                                         const int32_T y, const int32_T b_y,
                                         emxArray_real32_T c_y,
                                         int32_T b_y_dim0, int32_T y_dim1);

static __global__ void ec_wt_fp_kernel24(const emxArray_creal32_T r1,
                                         const int32_T b_r1, const int32_T c_r1,
                                         emxArray_creal32_T x, int32_T x_dim0,
                                         int32_T r1_dim0);

static __global__ void ec_wt_fp_kernel25(const emxArray_creal32_T x,
                                         const int32_T b,
                                         emxArray_real32_T fv1);

static __global__ void ec_wt_fp_kernel3(const emxArray_real32_T y,
                                        const int32_T b, emxArray_real32_T x);

static __global__ void ec_wt_fp_kernel4(const real32_T b,
                                        const emxArray_creal32_T cfs,
                                        const int32_T nx, const int32_T cfsnorm,
                                        const int32_T vlen,
                                        emxArray_creal32_T b_cfsnorm,
                                        int32_T cfs_dim0, int32_T cfsnorm_dim0);

static __global__ void ec_wt_fp_kernel5(const emxArray_creal32_T cfsnorm,
                                        const int32_T b,
                                        const int32_T b_cfsnorm,
                                        emxArray_creal32_T x, int32_T x_dim0,
                                        int32_T cfsnorm_dim0);

static __global__ void ec_wt_fp_kernel6(const emxArray_creal32_T x,
                                        const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel7(const emxArray_real32_T y,
                                        const int32_T b, emxArray_real32_T x);

static __global__ void ec_wt_fp_kernel8(const int32_T sz, emxArray_real32_T b);

static __global__ void ec_wt_fp_kernel9(const emxArray_real32_T b,
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel12(
    const emxArray_real32_T fv, const int32_T ch, const int32_T lshift_dim0,
    const int32_T b, emxArray_real32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T xpageoffset;
    xpageoffset = static_cast<int32_T>(idx);
    y.data[xpageoffset + lshift_dim0 * ch] = fv.data[xpageoffset];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel16(
    const emxArray_creal32_T r2, const int32_T b_r2, const int32_T c_r2,
    emxArray_creal32_T x, int32_T x_dim0, int32_T r2_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel18(
    const emxArray_real32_T y, const int32_T b, emxArray_real32_T fv1)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel21(
    const emxArray_real32_T fv1, const int32_T lshift_dim0, const int32_T vlen,
    const int32_T b, const int32_T c, emxArray_real32_T b_fv1, int32_T fv1_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    b_fv1.data[bcoef + fv1_dim0 * xpageoffset] =
        fv1.data[vlen * bcoef + lshift_dim0 * xpageoffset];
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel22(
    const emxArray_real32_T fv1, const int32_T lshift, emxArray_real32_T b_fv1)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T xpageoffset;
    xpageoffset = static_cast<int32_T>(idx);
    b_fv1.data[xpageoffset] = fv1.data[xpageoffset];
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel23(
    const emxArray_real32_T fv1, const int32_T y_dim0, const int32_T ch,
    const int32_T y, const int32_T b_y, emxArray_real32_T c_y, int32_T b_y_dim0,
    int32_T y_dim1)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    c_y.data[(bcoef + b_y_dim0 * ch) + b_y_dim0 * y_dim1 * xpageoffset] =
        fv1.data[bcoef + y_dim0 * xpageoffset];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel25(
    const emxArray_creal32_T x, const int32_T b, emxArray_real32_T fv1)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    fv1.data[k] = hypotf(x.data[k].re, x.data[k].im);
  }
}
...
static __global__
    __launch_bounds__(1024, 1) void ec_wt_fp_kernel8(const int32_T sz,
                                                     emxArray_real32_T b)
{
  uint64_T gStride;
  uint64_T gThreadId;
              ...
              emxArray_real32_T *cpu_y, emxArray_real_T *freqs)
{
  ...
  emxArray_creal32_T *cpu_r2;
  emxArray_creal32_T *e_cpu_x;
  emxArray_real32_T b_gpu_fv;
  emxArray_real32_T b_gpu_fv1;
  emxArray_real32_T b_gpu_x;
  emxArray_real32_T b_gpu_xc;
  ...
  emxArray_real32_T *b_cpu_fv1;
  emxArray_real32_T *b_cpu_xc;
  ...
  if (doAvg) {
    ...
    emxEnsureCapacity_real32_T(cpu_y, dim, &b_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
    emxEnsureCapacity_real32_T(cpu_y, dim, &c_emlrtRTEI);
    y_needsGpuEnsureCapacity = true;
  }
  ...
  emxInit_real32_T(&cpu_xc, 1, &d_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_xc, 1, &e_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfs, 2, &s_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_y, 2, &t_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_fv, 1, &u_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_x, 2, &g_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&c_cpu_x, 2, &h_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&c_cpu_y, 2, &v_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_fv1, 2, &w_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_cpu_x, 2, &v_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfsnorm, 2, &x_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&e_cpu_x, 2, &m_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_cpu_y, 2, &y_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&f_cpu_x, 2, &y_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_b, 2, &q_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_r, 2, &ab_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r1, 2, &g_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r2, 2, &h_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_fv, 1, &k_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_fv1, 2, &n_emlrtRTEI, true);
  ...
  for (int32_T ch{0}; ch < i; ch++) {
    ...
    if (doAvg) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(cpu_xc, dim, &d_emlrtRTEI);
      ...
      if (doPwr) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(c_cpu_y, dim, &i_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(c_cpu_y, &gpu_y, true);
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(d_cpu_x, dim, &j_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        if (d_cpu_x->size[0] * d_cpu_x->size[1] == 0) {
          ...
          nvtxMarkA("#gpuEmxMemcpyGpuToCpu_real32_T#" MW_AT_LINE);
          gpuEmxMemcpyGpuToCpu_real32_T(d_cpu_x, &b_gpu_x);
          b = d_cpu_x->data[0];
        ...
        b = std::sqrt(fb.sigvar /
                      (static_cast<real32_T>(
                           1.0 / static_cast<real_T>(fb.Scales->size[1])) *
                       b));
        ...
        emxEnsureCapacity_creal32_T(cpu_cfsnorm, dim, &l_emlrtRTEI);
        ...
        if ((cpu_cfs->size[0] != 0) && (cpu_cfs->size[1] != 0)) {
          ...
          if (validLaunchParams) {
            ...
            ec_wt_fp_kernel4<<<grid, block>>>(b, gpu_cfs, nx, xpageoffset, vlen,
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(e_cpu_x, dim, &m_emlrtRTEI);
        ...
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(e_cpu_x, &c_gpu_x, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(d_cpu_y, dim, &i_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(d_cpu_y, &b_gpu_y, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(f_cpu_x, dim, &j_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(
            computeNumIters(
                static_cast<int32_T>(sz[0]) * static_cast<int32_T>(sz[1]) - 1),
            &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(f_cpu_x, &d_gpu_x, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
        ...
        if ((f_cpu_x->size[0] == 0) || (f_cpu_x->size[1] == 0)) {
          ...
          nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
          emxEnsureCapacity_real32_T(cpu_b, dim, &q_emlrtRTEI);
          nvtxMarkA("#computeNumIters#" MW_AT_LINE);
          mwGetLaunchParameters1D(
          ...
          nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
          emxEnsureCapacity_real32_T(cpu_b, dim, &o_emlrtRTEI);
          nvtxMarkA("#computeNumIters#" MW_AT_LINE);
          mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                  2147483647U);
          nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_fv, dim, &f_emlrtRTEI);
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel14<<<grid, block>>>(gpu_r, xpageoffset, gpu_fv);
        }
        //  Magnitude
      }
      //  Downsample
      ...
      if (ds != 0.0) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(b_cpu_fv, dim, &k_emlrtRTEI);
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel10<<<grid, block>>>(gpu_fv, ds, xpageoffset, b_gpu_fv);
        }
        dim = cpu_fv->size[0];
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel11<<<grid, block>>>(b_gpu_fv, xpageoffset, gpu_fv);
        }
      }
      nx = cpu_y->size[0];
      ...
      if (validLaunchParams) {
        ...
        ec_wt_fp_kernel12<<<grid, block>>>(gpu_fv, ch, lshift[0], nx - 1,
                                           c_gpu_y);
      }
      r_outdatedOnCpu = true;
    } else {
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(b_cpu_xc, dim, &e_emlrtRTEI);
      xpageoffset = cpu_x->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(xpageoffset), &grid, &block,
                              2147483647U);
      ...
      x_needsGpuEnsureCapacity = false;
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_real32_T(b_cpu_xc, &b_gpu_xc, true);
      if (x_outdatedOnGpu) {
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_real32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_real32_T(&gpu_x, cpu_x);
      }
      ...
      if (doPwr) {
        ...
        nvtxMarkA("#gpuEmxMemcpyGpuToCpu_real32_T#" MW_AT_LINE);
        gpuEmxMemcpyGpuToCpu_real32_T(b_cpu_xc, &b_gpu_xc);
        nvtxMarkA("#cwtfilterbank_wt#" MW_AT_LINE);
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(c_cpu_x, dim, &h_emlrtRTEI);
        ...
        mwGetLaunchParameters1D(computeNumIters(xpageoffset, vlen), &grid,
                                &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(cpu_r2, &gpu_r2, false);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(c_cpu_x, &e_gpu_x, true);
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_r2, cpu_r2);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(b_cpu_y, dim, &i_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(b_cpu_y, &d_gpu_y, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
        ...
        profileLoopEnd();
        dim = cpu_fv1->size[0] * cpu_fv1->size[1];
        cpu_fv1->size[0] = static_cast<int32_T>(sz[0]);
        cpu_fv1->size[1] = static_cast<int32_T>(sz[1]);
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_fv1, dim, &j_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(
            computeNumIters(
                static_cast<int32_T>(sz[0]) * static_cast<int32_T>(sz[1]) - 1),
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(b_cpu_x, dim, &g_emlrtRTEI);
        ...
        mwGetLaunchParameters1D(computeNumIters(xpageoffset, vlen), &grid,
                                &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(cpu_r1, &gpu_r1, false);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(b_cpu_x, &f_gpu_x, true);
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        ...
        cpu_fv1->size[1] = static_cast<int32_T>(sz[1]);
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_fv1, dim, &i_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel25<<<grid, block>>>(f_gpu_x, nx - 1, gpu_fv1);
        }
        //  Magnitude
      }
      //  Downsample
      ...
      if (ds != 0.0) {
        ...
        for (xpageoffset = 0; xpageoffset < 2; xpageoffset++) {
          cpu_sizeX[xpageoffset] = cpu_fv1->size[xpageoffset];
          r_outdatedOnGpu = true;
          cpu_lshift[xpageoffset] = cpu_fv1->size[xpageoffset];
          r_outdatedOnCpu = true;
        }
        profileLoopEnd();
        if (1 - dim >= 0) {
        ...
        dim = b_cpu_fv1->size[0] * b_cpu_fv1->size[1];
        nvtxMarkA("#div_s32#" MW_AT_LINE);
        b_cpu_fv1->size[0] = div_s32(xpageoffset, vlen) + 1;
        b_cpu_fv1->size[1] = nx;
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(b_cpu_fv1, dim, &n_emlrtRTEI);
        xpageoffset /= vlen;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(nx - 1, xpageoffset), &grid,
                                &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real32_T(b_cpu_fv1, &b_gpu_fv1, true);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#ec_wt_fp_kernel21#" MW_AT_LINE);
          ec_wt_fp_kernel21<<<grid, block>>>(gpu_fv1, cpu_lshift[0], vlen,
                                             xpageoffset, nx - 1, b_gpu_fv1,
                                             b_cpu_fv1->size[0U]);
        }
        nvtxMarkA("#checkCudaError#" MW_AT_LINE);
        nvtxMarkA("#cudaMemcpy#" MW_AT_LINE);
        checkCudaError(
            ...
            __FILE__, __LINE__);
        dim = cpu_fv1->size[0] * cpu_fv1->size[1];
        cpu_fv1->size[0] = cpu_sizeX[0];
        cpu_fv1->size[1] = cpu_sizeX[1];
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_fv1, dim, &p_emlrtRTEI);
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel22<<<grid, block>>>(b_gpu_fv1, xpageoffset, gpu_fv1);
        }
      }
      c_y[0] = cpu_y->size[0];
      c_y[2] = cpu_y->size[2];
      ...
      if (validLaunchParams) {
        ...
        ec_wt_fp_kernel23<<<grid, block>>>(gpu_fv1, c_y[0], ch, c_y[0] - 1,
  ...
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_r2);
  nvtxMarkA("#gpuEmxFree_real32_T#" MW_AT_LINE);
  gpuEmxFree_real32_T(&b_gpu_fv);
  nvtxMarkA("#gpuEmxFree_real32_T#" MW_AT_LINE);
  gpuEmxFree_real32_T(&b_gpu_fv1);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
