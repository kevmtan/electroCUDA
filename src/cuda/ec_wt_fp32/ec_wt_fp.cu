...
static __global__ void ec_wt_fp_kernel10(const int32_T sz, emxArray_real32_T b);

static __global__ void ec_wt_fp_kernel11(const emxArray_real32_T b,
                                         const real_T a, const int32_T b_b,
                                         emxArray_real32_T fv1);

static __global__ void ec_wt_fp_kernel12(const emxArray_real32_T fv1,
                                         const int32_T b_fv1,
                                         emxArray_creal32_T yc);
...
static __global__ void ec_wt_fp_kernel14(const emxArray_creal32_T r2,
                                         const int32_T b_r2, const int32_T c_r2,
                                         emxArray_creal32_T x, int32_T x_dim0,
                                         int32_T r2_dim0);

static __global__ void ec_wt_fp_kernel15(const emxArray_creal32_T x,
                                         const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel16(const emxArray_real32_T y,
                                         const int32_T b,
                                         emxArray_real32_T b_y);

static __global__ void ec_wt_fp_kernel17(const emxArray_real32_T y,
                                         const int32_T b_y,
                                         emxArray_creal32_T yc);

static __global__ void ec_wt_fp_kernel18(const emxArray_creal32_T r3,
                                         const int32_T b_r3, const int32_T c_r3,
                                         emxArray_creal32_T x, int32_T x_dim0,
                                         int32_T r3_dim0);

static __global__ void ec_wt_fp_kernel19(const emxArray_creal32_T x,
                                         const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel2(const emxArray_real32_T r,
                                        const int32_T b_r,
                                        emxArray_real32_T fv);

static __global__ void ec_wt_fp_kernel20(const emxArray_real32_T y,
                                         const int32_T b_y,
                                         emxArray_creal32_T yc);

static __global__ void ec_wt_fp_kernel21(const emxArray_creal32_T r1,
                                         const int32_T b_r1, const int32_T c_r1,
                                         emxArray_creal32_T yc, int32_T yc_dim0,
                                         int32_T r1_dim0);

static __global__ void ec_wt_fp_kernel3(const emxArray_real32_T fv,
                                        const int32_T b_fv,
                                        emxArray_creal32_T yc);

static __global__ void ec_wt_fp_kernel4(const emxArray_creal32_T cfs,
                                        const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel5(const emxArray_real32_T y,
                                        const int32_T b, emxArray_real32_T x);

static __global__ void ec_wt_fp_kernel6(const real32_T b,
...
static __global__ void ec_wt_fp_kernel7(const emxArray_creal32_T cfsnorm,
                                        const int32_T b,
                                        const int32_T b_cfsnorm,
                                        emxArray_creal32_T x, int32_T x_dim0,
                                        int32_T cfsnorm_dim0);

static __global__ void ec_wt_fp_kernel8(const emxArray_creal32_T x,
                                        const int32_T b, emxArray_real32_T y);

static __global__ void ec_wt_fp_kernel9(const emxArray_real32_T y,
                                        const int32_T b, emxArray_real32_T x);
...
static __global__
    __launch_bounds__(1024, 1) void ec_wt_fp_kernel10(const int32_T sz,
                                                      emxArray_real32_T b)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel11(
    const emxArray_real32_T b, const real_T a, const int32_T b_b,
    emxArray_real32_T fv1)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T xpageoffset;
    xpageoffset = static_cast<int32_T>(idx);
    fv1.data[xpageoffset] = static_cast<real32_T>(a) * b.data[xpageoffset];
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel12(
    const emxArray_real32_T fv1, const int32_T b_fv1, emxArray_creal32_T yc)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T xpageoffset;
    xpageoffset = static_cast<int32_T>(idx);
    yc.data[xpageoffset].re = fv1.data[xpageoffset];
    yc.data[xpageoffset].im = 0.0F;
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel17(
    const emxArray_real32_T y, const int32_T b_y, emxArray_creal32_T yc)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel18(
    const emxArray_creal32_T r3, const int32_T b_r3, const int32_T c_r3,
    emxArray_creal32_T x, int32_T x_dim0, int32_T r3_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel21(
    ...
    emxArray_creal32_T yc, int32_T yc_dim0, int32_T r1_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt_fp_kernel3(
    const emxArray_real32_T fv, const int32_T b_fv, emxArray_creal32_T yc)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    int32_T xpageoffset;
    xpageoffset = static_cast<int32_T>(idx);
    yc.data[xpageoffset].re = fv.data[xpageoffset];
    yc.data[xpageoffset].im = 0.0F;
  }
}
              ...
              emxArray_cell_wrap_0 *y, emxArray_real_T *freqs)
{
  ...
  emxArray_creal32_T gpu_r3;
  emxArray_creal32_T gpu_yc;
  ...
  emxArray_creal32_T *cpu_r3;
  emxArray_creal32_T *cpu_yc;
  ...
  gpuEmxReset_creal32_T(&b_gpu_yc);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&gpu_r3);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  ...
  emxInit_creal32_T(&cpu_yc, 2, &w_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_xc, 1, &c_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_fv, 1, &h_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_y, 2, &x_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&Scales, 2, &e_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&b_cpu_y, 2, &y_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_x, 2, &g_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfs, 2, &ab_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&c_cpu_x, 2, &i_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&c_cpu_y, 2, &bb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_cpu_y, 2, &x_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_cpu_x, 2, &bb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_cfsnorm, 2, &cb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&e_cpu_x, 2, &q_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&e_cpu_y, 2, &db_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&f_cpu_x, 2, &db_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_b, 2, &s_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_fv1, 1, &u_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&cpu_r, 2, &d_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r1, 2, &eb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r2, 2, &g_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r3, 2, &i_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_yc, 2, &l_emlrtRTEI, true);
  ...
  for (int32_T ch{0}; ch < i; ch++) {
    ...
    if (yType == 4) {
      ...
      if (validLaunchParams) {
        ...
        ec_wt_fp_kernel2<<<grid, block>>>(gpu_r, xpageoffset, gpu_fv);
      }
      xpageoffset = cpu_yc->size[0] * cpu_yc->size[1];
      cpu_yc->size[0] = cpu_fv->size[0];
      cpu_yc->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_yc, xpageoffset, &h_emlrtRTEI);
      xpageoffset = cpu_fv->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(xpageoffset), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_yc, &gpu_yc, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#ec_wt_fp_kernel3#" MW_AT_LINE);
        ec_wt_fp_kernel3<<<grid, block>>>(gpu_fv, xpageoffset, gpu_yc);
      }
      r_outdatedOnCpu = false;
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(c_cpu_y, xpageoffset, &j_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(d_cpu_x, xpageoffset, &m_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_cfsnorm, xpageoffset, &p_emlrtRTEI);
      ...
      if ((cpu_cfs->size[0] != 0) && (cpu_cfs->size[1] != 0)) {
        ...
        if (validLaunchParams) {
          ...
          ec_wt_fp_kernel6<<<grid, block>>>(b, gpu_cfs, nx, xpageoffset, vlen,
                                            gpu_cfsnorm, cpu_cfs->size[0U],
                                            cpu_cfsnorm->size[0U]);
        }
      }
      a = 1.0 / static_cast<real_T>(Scales->size[1]);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(e_cpu_x, xpageoffset, &q_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(e_cpu_y, xpageoffset, &j_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_real32_T(e_cpu_y, &b_gpu_y, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(f_cpu_x, xpageoffset, &m_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(
          computeNumIters(
              static_cast<int32_T>(sz[0]) * static_cast<int32_T>(sz[1]) - 1),
      ...
      if ((f_cpu_x->size[0] == 0) || (f_cpu_x->size[1] == 0)) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_b, xpageoffset, &s_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_b, xpageoffset, &r_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      ...
      xpageoffset = cpu_fv1->size[0];
      cpu_fv1->size[0] = cpu_b->size[1];
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(cpu_fv1, xpageoffset, &t_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        ec_wt_fp_kernel11<<<grid, block>>>(gpu_b, a, xpageoffset, gpu_fv1);
      }
      xpageoffset = cpu_yc->size[0] * cpu_yc->size[1];
      cpu_yc->size[0] = cpu_fv1->size[0];
      cpu_yc->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_yc, xpageoffset, &u_emlrtRTEI);
      xpageoffset = cpu_fv1->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(xpageoffset), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        ec_wt_fp_kernel12<<<grid, block>>>(gpu_fv1, xpageoffset, gpu_yc);
      }
      r_outdatedOnCpu = false;
      r_outdatedOnGpu = true;
    } else if (yType == 2) {
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(b_cpu_x, xpageoffset, &g_emlrtRTEI);
      ...
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(b_cpu_x, &e_gpu_x, true);
      nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(cpu_y, xpageoffset, &j_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(d_cpu_y, xpageoffset, &m_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(
          computeNumIters(
              static_cast<int32_T>(sz[0]) * static_cast<int32_T>(sz[1]) - 1),
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_yc, xpageoffset, &o_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(c_cpu_x, xpageoffset, &i_emlrtRTEI);
      ...
      mwGetLaunchParameters1D(computeNumIters(xpageoffset, vlen), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(cpu_r3, &gpu_r3, false);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(c_cpu_x, &f_gpu_x, true);
      nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
      gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_r3, cpu_r3);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(b_cpu_y, xpageoffset, &j_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                              2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_real32_T(b_cpu_y, &e_gpu_y, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_yc, xpageoffset, &n_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_yc, xpageoffset, &f_emlrtRTEI);
    ...
    if (ds[1] != 0.0) {
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(b_cpu_yc, xpageoffset, &l_emlrtRTEI);
      ...
      for (xpageoffset = 0; xpageoffset <= nx; xpageoffset++) {
        if (r_outdatedOnGpu) {
          ...
          gpuEmxMemcpyGpuToCpu_creal32_T(cpu_yc, &gpu_yc);
        }
        r_outdatedOnGpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
    emxEnsureCapacity_creal32_T(y->data[ch].f1, xpageoffset, &k_emlrtRTEI);
    xpageoffset = y->data[ch].f1->size[0] * y->data[ch].f1->size[1];
  ...
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_r3);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&b_gpu_yc);
  nvtxRangePop();
