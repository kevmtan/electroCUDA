...
static __global__ void resample_kernel28(const emxArray_creal32_T varargin_1,
                                         const int32_T b,
                                         emxArray_creal32_T opts_x);

static __global__ void resample_kernel29(const emxArray_creal32_T w,
...
resample_kernel31(const emxArray_creal32_T y, const emxArray_real_T b_y,
                  const real_T nlast, const int32_T exponent, const int32_T b,
                  emxArray_creal32_T varargout_1, int32_T varargout_1_dim0);

static __global__ void resample_kernel32(const int32_T b, emxArray_real_T y);

static __global__ void resample_kernel33(const emxArray_creal32_T varargout_1,
                                         const int32_T b_varargout_1,
                                         const int32_T c_varargout_1,
                                         emxArray_creal32_T d_varargout_1,
                                         int32_T varargout_1_dim0,
                                         int32_T b_varargout_1_dim0);

static __global__ void resample_kernel34(const emxArray_creal32_T varargout_1,
                                         const int32_T b_varargout_1,
                                         emxArray_creal32_T c_varargout_1);

static __global__ void resample_kernel35(const emxArray_creal32_T varargin_1,
                                         const int32_T b_varargin_1,
                                         emxArray_creal32_T opts_x);

static __global__ void resample_kernel36(const emxArray_creal32_T varargin_1,
                                         const int32_T b_varargin_1,
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel29(
    const emxArray_creal32_T w, const int32_T u0, const int32_T b,
    emxArray_creal32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel31(
    const emxArray_creal32_T y, const emxArray_real_T b_y, const real_T nlast,
    const int32_T exponent, const int32_T b, emxArray_creal32_T varargout_1,
    int32_T varargout_1_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel33(
    const emxArray_creal32_T varargout_1, const int32_T b_varargout_1,
    const int32_T c_varargout_1, emxArray_creal32_T d_varargout_1,
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel34(
    const emxArray_creal32_T varargout_1, const int32_T b_varargout_1,
    emxArray_creal32_T c_varargout_1)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(1024, 1) void resample_kernel36(
    const emxArray_creal32_T varargin_1, const int32_T b_varargin_1,
    const int32_T c_varargin_1, emxArray_creal32_T opts_x, int32_T opts_x_dim0,
    int32_T varargin_1_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
              ...
              boolean_T *varargout_1_outdatedOnGpu)
{
  ...
  gpuEmxReset_creal32_T(&gpu_y);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&gpu_w);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  gpuEmxReset_creal32_T(&b_gpu_varargout_1);
  nvtxMarkA("#gpuEmxReset_creal32_T#" MW_AT_LINE);
  ...
  emxInit_creal32_T(&cpu_opts_x, 2, &he_emlrtRTEI, true);
  if (opts_dim == 1) {
    if ((cpu_varargin_1->size[0] == 1) || (cpu_varargin_1->size[1] == 1)) {
      ...
      emxEnsureCapacity_creal32_T(cpu_opts_x, i, &he_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        resample_kernel28<<<grid, block>>>(*gpu_varargin_1, u1 - 1, gpu_opts_x);
      }
    } else {
      i = cpu_opts_x->size[0] * cpu_opts_x->size[1];
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel35#" MW_AT_LINE);
        resample_kernel35<<<grid, block>>>(*gpu_varargin_1, i, gpu_opts_x);
      }
    }
  } else {
    i = cpu_opts_x->size[0] * cpu_opts_x->size[1];
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#resample_kernel36#" MW_AT_LINE);
      resample_kernel36<<<grid, block>>>(*gpu_varargin_1, b_varargin_1, i,
  ...
  emxInitStruct_ResampleParser(&expl_temp, &he_emlrtRTEI, true);
  ...
  if (expl_temp.dim == 1) {
    if (expl_temp.isRowVectorInput) {
      ...
      *varargout_1_outdatedOnGpu = false;
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &ke_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &je_emlrtRTEI);
    } else {
      *varargout_1_outdatedOnCpu = false;
      *varargout_1_outdatedOnGpu = false;
      i = cpu_varargout_1->size[0] * cpu_varargout_1->size[1];
    ...
    if (expl_temp.x->size[0] == 1) {
      ...
      *varargout_1_outdatedOnGpu = false;
      ...
      cpu_varargout_1->size[1] = expl_temp.x->size[1];
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &le_emlrtRTEI);
      ...
      nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
      emxInit_creal32_T(&cpu_w, 1, &oe_emlrtRTEI, true);
      nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
      emxInit_creal32_T(&cpu_y, 1, &oe_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&b_cpu_y, 2, &re_emlrtRTEI, true);
      ...
      for (exponent = 0; exponent < opts_dim; exponent++) {
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(cpu_y, i, &oe_emlrtRTEI);
        i = u1 / b_varargin_1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        ...
        nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal32_T(cpu_y, &gpu_y, true);
        ...
        if (validLaunchParams) {
          ...
          resample_kernel29<<<grid, block>>>(gpu_w, b_varargin_1, i, gpu_y);
        }
        nvtxMarkA("#div_s32#" MW_AT_LINE);
        if (!(div_s32(u1, b_varargin_1) + 1 < Ly)) {
          ...
          nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
          emxEnsureCapacity_creal32_T(cpu_y, i, &pe_emlrtRTEI);
        ...
        if (c_varargout_1_needsGpuEnsureCap) {
          nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
          gpuEmxEnsureCapacity_creal32_T(cpu_varargout_1, gpu_varargout_1,
                                         true);
        }
      ...
      *varargout_1_outdatedOnGpu = false;
      ...
      cpu_varargout_1->size[1] = expl_temp.x->size[1];
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(cpu_varargout_1, i, &ie_emlrtRTEI);
    ...
    if ((expl_temp.x->size[0] == 1) || (expl_temp.x->size[1] == 1)) {
      ...
      nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
      emxInit_creal32_T(&b_cpu_varargout_1, 2, &me_emlrtRTEI, true);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(b_cpu_varargout_1, i, &me_emlrtRTEI);
      ...
      nvtxMarkA("#gpuEmxEnsureCapacity_creal32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal32_T(b_cpu_varargout_1, &b_gpu_varargout_1,
                                     true);
      if (*varargout_1_outdatedOnGpu) {
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_creal32_T(gpu_varargout_1, cpu_varargout_1);
      }
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel33#" MW_AT_LINE);
        resample_kernel33<<<grid, block>>>(
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#resample_kernel34#" MW_AT_LINE);
        resample_kernel34<<<grid, block>>>(b_gpu_varargout_1, i,
                                           *gpu_varargout_1);
      }
      *varargout_1_outdatedOnGpu = false;
      *varargout_1_outdatedOnCpu = true;
      nvtxMarkA("#emxFree_creal32_T#" MW_AT_LINE);
      emxFree_creal32_T(&b_cpu_varargout_1);
    }
  }
  ...
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&b_gpu_varargout_1);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_w);
  nvtxMarkA("#gpuEmxFree_creal32_T#" MW_AT_LINE);
  gpuEmxFree_creal32_T(&gpu_y);
