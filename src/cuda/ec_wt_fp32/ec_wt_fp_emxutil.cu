...
void emxFreeStruct_ResampleParser(
    coder::b_signal::internal::resample::ResampleParser *pStruct)
{
  nvtxRangePushA("#fcn#emxFreeStruct_ResampleParser#" MW_AT_LOCATION);
  nvtxMarkA("#emxFree_real32_T#" MW_AT_LINE);
  emxFree_real32_T(&pStruct->filter);
  nvtxMarkA("#emxFree_real32_T#" MW_AT_LINE);
  emxFree_real32_T(&pStruct->filterWithPadding);
...
void emxInitStruct_ResampleParser(
    coder::b_signal::internal::resample::ResampleParser *pStruct,
    const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  nvtxRangePushA("#fcn#emxInitStruct_ResampleParser#" MW_AT_LOCATION);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&pStruct->filter, 1, srcLocation, doPush);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&pStruct->filterWithPadding, 1, srcLocation, doPush);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&pStruct->x, 2, srcLocation, doPush);
  nvtxRangePop();
}
                               ...
                               boolean_T doPush)
{
  ...
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&pStruct->f1, 2, srcLocation, doPush);
  nvtxRangePop();
}
...
// End of code generation (ec_wt_fp_emxutil.cu)
