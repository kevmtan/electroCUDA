...
real_T numCpsi(const char_T wname[5], real_T varargin_1, real_T varargin_2)
{
  ...
  if (first_iteration) {
    ...
    if (!(anorm > 0.0)) {
      ...
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&a, 2, &xd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&fx, 2, &ce_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&d_x, 2, &yd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&b_a, 2, &xd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&e_x, 2, &ae_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&f_x, 2, &de_emlrtRTEI, true);
      ...
      do {
        ...
        if (guard1) {
          ...
          a->size[1] = c_x->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(a, ix, &xd_emlrtRTEI);
          ...
          d_x->size[1] = y->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(d_x, ix, &yd_emlrtRTEI);
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(b_a, ix, &xd_emlrtRTEI);
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(e_x, ix, &ae_emlrtRTEI);
