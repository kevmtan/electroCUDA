...
//
// _coder_ec_wt_fp_mex.cu
//
// Code generation for function '_coder_ec_wt_fp_mex'
//
                 ...
                 const mxArray *prhs[])
{
  ...
  nvtxMarkA("#ec_wt_fp_initialize#" MW_AT_LINE);
  ec_wt_fp_initialize();
  try { // Dispatch the entry-point.
    nvtxMarkA("#unsafe_ec_wt_fp_mexFunction#" MW_AT_LINE);
    unsafe_ec_wt_fp_mexFunction(nlhs, plhs, nrhs, prhs);
    // Module termination.
    nvtxMarkA("#ec_wt_fp_terminate#" MW_AT_LINE);
    ec_wt_fp_terminate();
  } catch (...) {
...
// End of code generation (_coder_ec_wt_fp_mex.cu)
