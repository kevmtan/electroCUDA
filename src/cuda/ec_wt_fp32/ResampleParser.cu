                                     ...
                                     ResampleParser *obj)
{
  ...
  emxEnsureCapacity_creal32_T(obj->x, inw, &se_emlrtRTEI);
  ...
  emxInit_real_T(&r, 2, &te_emlrtRTEI, true);
  nvtxMarkA("#firls#" MW_AT_LINE);
  firls(pqmax - 1.0, b_dv, r);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&c_dv, 1, &te_emlrtRTEI, true);
  inw = c_dv->size[0];
  c_dv->size[0] = r->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(c_dv, inw, &te_emlrtRTEI);
  ...
  if (nw <= 1) {
    ...
    b_dv1->size[0] = nw;
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b_dv1, inw, &ve_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&h1, 1, &we_emlrtRTEI, true);
  inw = h1->size[0];
  h1->size[0] = c_dv->size[0];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(h1, inw, &we_emlrtRTEI);
  ...
  emxEnsureCapacity_real32_T(obj->filter, inw, &xe_emlrtRTEI);
  ...
  nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
  emxEnsureCapacity_real32_T(obj->filterWithPadding, inw, &ye_emlrtRTEI);
  ...
  emxInit_uint32_T(&y, 2, &bf_emlrtRTEI, true);
  ...
  emxInit_int32_T(&iv, 2, &cf_emlrtRTEI, true);
  inw = iv->size[0] * iv->size[1];
  iv->size[0] = 1;
  iv->size[1] = y->size[1];
  nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
  emxEnsureCapacity_int32_T(iv, inw, &af_emlrtRTEI);
