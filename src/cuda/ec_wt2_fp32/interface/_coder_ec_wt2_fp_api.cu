...
//
// _coder_ec_wt2_fp_api.cu
//
// Code generation for function '_coder_ec_wt2_fp_api'
//
...
void ec_wt2_fp_api(const mxArray *const prhs[7], int32_T nlhs,
                   const mxArray *plhs[2])
{
  emxArray_cell_wrap_0 *y;
  emxArray_real32_T *x;
  emxArray_real_T *frqs;
  ...
  emxInit_cell_wrap_0(&y, 2, &cd_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&frqs, 1, &cd_emlrtRTEI, true);
  nvtxMarkA("#ec_wt2_fp#" MW_AT_LINE);
  ec_wt2_fp(x, fs, *lims, voices, ds, doReal, doPwr, y, frqs);
  ...
  if (nlhs > 1) {
    frqs->canFreeData = false;
    nvtxMarkA("#emlrt_marshallOut#" MW_AT_LINE);
    plhs[1] = emlrt_marshallOut(frqs);
  }
...
// End of code generation (_coder_ec_wt2_fp_api.cu)
