...
static __global__ void ec_wt2_fp_kernel10(const emxArray_creal32_T r,
                                          const int32_T b_r, const int32_T c_r,
                                          emxArray_creal32_T yc,
                                          int32_T yc_dim0, int32_T r_dim0);

static __global__ void ec_wt2_fp_kernel11(const int32_T i1, const int32_T nx,
                                          const int32_T dim, int32_T sizeX[2]);

static __global__ void
ec_wt2_fp_kernel12(const emxArray_creal32_T yc, const int32_T lshift_dim0,
                   const int32_T i1, const int32_T b, const int32_T c,
                   emxArray_creal32_T b_yc, int32_T yc_dim0);

static __global__ void ec_wt2_fp_kernel13(const emxArray_creal32_T yc,
                                          const int32_T lshift,
                                          emxArray_creal32_T b_yc);

static __global__ void ec_wt2_fp_kernel2(const emxArray_creal32_T r1,
                                         const int32_T b_r1, const int32_T c_r1,
                                         emxArray_creal32_T x, int32_T x_dim0,
                                         int32_T r1_dim0);

static __global__ void ec_wt2_fp_kernel3(const emxArray_creal32_T x,
                                         const int32_T b, emxArray_real32_T yc);

static __global__ void ec_wt2_fp_kernel4(const emxArray_real32_T yc,
                                         const int32_T b_yc,
                                         emxArray_real32_T x);

static __global__ void ec_wt2_fp_kernel5(const emxArray_real32_T x,
                                         const int32_T b, emxArray_real32_T yc);
...
static __global__ void
ec_wt2_fp_kernel7(const emxArray_real32_T yc, const int32_T lshift_dim0,
                  const int32_T i1, const int32_T b, const int32_T c,
                  emxArray_real32_T b_yc, int32_T yc_dim0);

static __global__ void ec_wt2_fp_kernel8(const emxArray_real32_T yc,
                                         const int32_T lshift,
...
static __global__ __launch_bounds__(1024, 1) void ec_wt2_fp_kernel1(
    const int32_T k, const emxArray_real32_T x, const int32_T b_x,
    emxArray_real32_T c_x, int32_T x_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt2_fp_kernel4(
    const emxArray_real32_T yc, const int32_T b_yc, emxArray_real32_T x)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void ec_wt2_fp_kernel5(
    const emxArray_real32_T x, const int32_T b, emxArray_real32_T yc)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
               ...
               emxArray_cell_wrap_0 *y, emxArray_real_T *frqs)
{
  ...
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&b_cpu_x, 2, &f_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&c_cpu_x, 2, &i_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r, 2, &r_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  emxInit_creal32_T(&cpu_r1, 2, &f_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&d_cpu_x, 1, &c_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real32_T#" MW_AT_LINE);
  emxInit_real32_T(&e_cpu_x, 1, &d_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal32_T#" MW_AT_LINE);
  ...
  for (int32_T k{0}; k < i; k++) {
    ...
    if (doReal) {
      ...
      emxEnsureCapacity_real32_T(e_cpu_x, vstride, &d_emlrtRTEI);
      dim = cpu_x->size[0] - 1;
      ...
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_real32_T(e_cpu_x, &b_gpu_x, true);
      if (x_outdatedOnGpu) {
      ...
      gpuEmxMemcpyGpuToCpu_real32_T(e_cpu_x, &b_gpu_x);
      ...
      emxEnsureCapacity_creal32_T(b_cpu_x, vstride, &f_emlrtRTEI);
      dim = cpu_r1->size[0] - 1;
      nx = cpu_r1->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(cpu_yc, vstride, &h_emlrtRTEI);
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      if (doPwr) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(c_cpu_x, vstride, &i_emlrtRTEI);
        ...
        cpu_yc->size[1] = static_cast<int32_T>(b_dv[1]);
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_yc, vstride, &l_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      if (ds != 0.0) {
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(d_cpu_yc, dim, &k_emlrtRTEI);
        dim = nx / i1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
        emxEnsureCapacity_real32_T(cpu_yc, vstride, &n_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(y->data[k].f1, vstride, &j_emlrtRTEI);
      vstride = y->data[k].f1->size[0] * y->data[k].f1->size[1];
      ...
      for (vstride = 0; vstride < cpu_yc->size[0] * cpu_yc->size[1];
        ...
        y->data[k].f1->data[vstride].im = 0.0F;
      }
      profileLoopEnd();
    } else {
      boolean_T validLaunchParams;
      ...
      nvtxMarkA("#emxEnsureCapacity_real32_T#" MW_AT_LINE);
      emxEnsureCapacity_real32_T(d_cpu_x, vstride, &c_emlrtRTEI);
      dim = cpu_x->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(dim), &grid, &block, 2147483647U);
      if (x_needsGpuEnsureCapacity) {
      ...
      x_needsGpuEnsureCapacity = false;
      nvtxMarkA("#gpuEmxEnsureCapacity_real32_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_real32_T(d_cpu_x, &e_gpu_x, true);
      if (x_outdatedOnGpu) {
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_real32_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_real32_T(&gpu_x, cpu_x);
      }
      ...
      nvtxMarkA("#gpuEmxMemcpyGpuToCpu_real32_T#" MW_AT_LINE);
      gpuEmxMemcpyGpuToCpu_real32_T(d_cpu_x, &e_gpu_x);
      nvtxMarkA("#cwtfilterbank_wt#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(b_cpu_yc, vstride, &e_emlrtRTEI);
      dim = cpu_r->size[0] - 1;
      nx = cpu_r->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(dim, nx), &grid, &block,
      ...
      if (ds != 0.0) {
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(c_cpu_yc, dim, &k_emlrtRTEI);
        dim = nx / i1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(cpu_lshift[1] - 1, dim), &grid,
                                &block, 2147483647U);
        ...
        nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
        emxEnsureCapacity_creal32_T(b_cpu_yc, vstride, &m_emlrtRTEI);
        dim = cpu_sizeX[0] * cpu_sizeX[1] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(dim), &grid, &block,
                                2147483647U);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal32_T#" MW_AT_LINE);
      emxEnsureCapacity_creal32_T(y->data[k].f1, vstride, &g_emlrtRTEI);
      vstride = y->data[k].f1->size[0] * y->data[k].f1->size[1];
