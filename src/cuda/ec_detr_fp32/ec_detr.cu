...
static __global__ void ec_detr_kernel10(const emxArray_real32_T fv1,
                                        const emxArray_real32_T regs,
                                        const int32_T b_regs,
                                        const int32_T c_regs,
                                        emxArray_real32_T d_regs,
                                        int32_T regs_dim0, int32_T b_regs_dim0);

static __global__ void
ec_detr_kernel11(const real32_T y, const emxArray_real32_T r,
                 const emxArray_real32_T regs, const int32_T b_regs,
                 const int32_T c_regs, emxArray_real32_T b_r, int32_T r_dim0,
                 int32_T regs_dim0);

static __global__ void ec_detr_kernel12(const emxArray_real32_T fv1,
                                        const emxArray_real32_T r,
                                        const int32_T b_r, const int32_T c_r,
                                        emxArray_real32_T r1, int32_T r1_dim0,
                                        int32_T r_dim0);

static __global__ void ec_detr_kernel13(const emxArray_real32_T r1,
                                        const int32_T b_r1, const int32_T c_r1,
                                        emxArray_real32_T r2, int32_T r2_dim0,
                                        int32_T r1_dim0);

static __global__ void ec_detr_kernel14(const emxArray_creal32_T V,
                                        const int32_T b_V,
...
static __global__ void ec_detr_kernel15(const emxArray_int32_T iv,
                                        ...
                                        emxArray_real32_T b_V, int32_T V_dim0,
                                        int32_T b_V_dim0);

static __global__ void ec_detr_kernel16(const emxArray_real32_T V,
                                        const int32_T b_V,
                                        emxArray_real32_T c_V);

static __global__ void ec_detr_kernel17(const emxArray_real32_T fv1,
                                        const real32_T mn,
                                        const emxArray_real32_T fv,
                                        const int32_T b_fv,
                                        emxArray_real32_T A);

static __global__ void ec_detr_kernel18(const int32_T b, emxArray_real32_T y);

static __global__ void ec_detr_kernel19(const emxArray_real32_T r1,
                                        const int32_T b_r1, const int32_T c_r1,
                                        emxArray_real32_T r3, int32_T r3_dim0,
                                        int32_T r1_dim0);

static __global__ void ec_detr_kernel2(emxArray_real_T lin);

static __global__ void ec_detr_kernel20(const emxArray_real32_T y,
                                        const int32_T b_y,
                                        emxArray_real32_T c_y);

static __global__ void ec_detr_kernel21(const real32_T mn,
                                        const emxArray_real32_T fv,
                                        const emxArray_real32_T fv2,
                                        const int32_T b_fv2,
                                        emxArray_real32_T z);

static __global__ void ec_detr_kernel22(const emxArray_real32_T fv1,
                                        const emxArray_real32_T z,
                                        const emxArray_real32_T fv,
                                        const int32_T b_fv,
                                        emxArray_real32_T d);

static __global__ void ec_detr_kernel23(const emxArray_real32_T d,
                                        const int32_T b, emxArray_real32_T y);

static __global__ void ec_detr_kernel24(const real32_T xbar,
                                        const emxArray_real32_T y,
                                        const int32_T nx,
                                        emxArray_real32_T fv1);

static __global__ void ec_detr_kernel25(const emxArray_real32_T d, real32_T *y);

static __global__ void ec_detr_kernel26(const real32_T xbar,
                                        const emxArray_real32_T d,
                                        const int32_T vlen,
                                        emxArray_real32_T absdiff);

static __global__ void ec_detr_kernel27(const emxArray_creal32_T D,
                                        const int32_T nz, emxArray_creal32_T d,
                                        int32_T D_dim0);

static __global__ void ec_detr_kernel28(const emxArray_real32_T z,
                                        const int32_T ch, const int32_T b,
                                        emxArray_real32_T x, int32_T x_dim0);

static __global__ void ec_detr_kernel29(const emxArray_real32_T fv1,
                                        const int32_T ch, const int32_T b,
...
static __global__ void
ec_detr_kernel5(const int32_T k, const emxArray_real_T lin, const int32_T vlen,
...
static __global__ void ec_detr_kernel6(const int32_T ch,
                                       ...
                                       const int32_T b_x, emxArray_real32_T fv,
                                       int32_T x_dim0);

static __global__ void ec_detr_kernel7(const int32_T ch,
                                       const emxArray_real32_T w,
                                       const int32_T b_w, emxArray_real32_T fv1,
                                       int32_T w_dim0);

static __global__ void ec_detr_kernel8(const emxArray_real32_T fv1,
                                       const emxArray_real32_T fv,
                                       const int32_T b_fv, emxArray_real32_T x);

static __global__ void ec_detr_kernel9(const emxArray_real32_T fv1,
                                       const emxArray_real32_T fv,
                                       const int32_T b_fv, emxArray_real32_T x);
                             ...
                             const emxArray_real32_T *in4)
{
  ...
  emxEnsureCapacity_real32_T(in1, i, &rc_emlrtRTEI);
                               ...
                               const emxArray_real32_T *in4)
{
  ...
  emxEnsureCapacity_real32_T(in1, i, &nc_emlrtRTEI);
                               ...
                               const emxArray_real32_T *in3)
{
  ...
  emxEnsureCapacity_real32_T(in1, i, &ec_emlrtRTEI);
  stride_0_0 = (in2->size[0] != 1);
                               ...
                               const emxArray_real32_T *in3)
{
  ...
  in3_idx_0 = in3->size[0];
  emxInit_real32_T(&b_in2, 2, &cc_emlrtRTEI, true);
  ...
  emxEnsureCapacity_real32_T(b_in2, i, &cc_emlrtRTEI);
  stride_0_0 = (in2->size[0] != 1);
  stride_1_0 = (in3_idx_0 != 1);
  for (i = 0; i < in2->size[1]; i++) {
    int32_T b;
                               ...
                               const emxArray_real32_T *in3)
{
  ...
  emxInit_real32_T(&b_in1, 1, &de_emlrtRTEI, true);
  i = b_in1->size[0];
  b_in1->size[0] = in1_idx_0;
  emxEnsureCapacity_real32_T(b_in1, i, &de_emlrtRTEI);
...
static __global__ __launch_bounds__(1024, 1) void ec_detr_kernel15(
    ...
    const int32_T b_iv, emxArray_real32_T b_V, int32_T V_dim0, int32_T b_V_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__
    __launch_bounds__(1024, 1) void ec_detr_kernel18(const int32_T b,
                                                     emxArray_real32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_detr_kernel24(
    const real32_T xbar, const emxArray_real32_T y, const int32_T nx,
    emxArray_real32_T fv1)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(32, 1) void ec_detr_kernel25(const emxArray_real32_T d,
                                                   real32_T *y)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
...
static __global__ __launch_bounds__(1024, 1) void ec_detr_kernel27(
    const emxArray_creal32_T D, const int32_T nz, emxArray_creal32_T d,
    int32_T D_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
                  ...
                  const emxArray_real32_T *in3)
{
  ...
  emxEnsureCapacity_real32_T(in1, i, &cc_emlrtRTEI);
  stride_0_0 = (in2->size[0] != 1);
  stride_1_0 = (in3->size[0] != 1);
  if (in3->size[0] == 1) {
    b = in2->size[0];
...
void ec_detr(emxArray_real32_T *cpu_x, emxArray_real32_T *cpu_w,
             ...
             const real32_T itr_data[], const int32_T[2], real_T olPct_data[],
             int32_T olPct_size[2])
{
  ...
  emxInit_real32_T(&cpu_fv, 1, &jc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_fv1, 1, &jc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_z, 1, &xc_emlrtRTEI, true);
  emxInit_boolean_T(&b_cpu_x, 1, &bc_emlrtRTEI, true);
  emxInit_real32_T(&c_cpu_x, 1, &cc_emlrtRTEI, true);
  emxInit_real32_T(&d_cpu_x, 1, &cc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_r, 2, &yc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_y, 2, &ad_emlrtRTEI, true);
  emxInit_creal32_T(&cpu_V, 2, &jc_emlrtRTEI, true);
  emxInit_creal32_T(&cpu_D, 2, &jc_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_V, 2, &bd_emlrtRTEI, true);
  emxInit_creal32_T(&cpu_d, 1, &cd_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv, 1, &dd_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_y, 2, &ed_emlrtRTEI, true);
  emxInit_real32_T(&cpu_A, 2, &nc_emlrtRTEI, true);
  emxInit_real32_T(&c_cpu_y, 2, &fd_emlrtRTEI, true);
  emxInit_real32_T(&d_cpu_y, 1, &gd_emlrtRTEI, true);
  emxInit_real32_T(&cpu_fv2, 1, &hd_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_d, 1, &rc_emlrtRTEI, true);
  emxInit_real32_T(&e_cpu_y, 1, &id_emlrtRTEI, true);
  emxInit_real32_T(&cpu_absdiff, 1, &jd_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_r, 2, &kd_emlrtRTEI, true);
  emxInit_real32_T(&cpu_r1, 2, &ld_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_regs, 2, &cc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_r2, 2, &fc_emlrtRTEI, true);
  emxInit_real32_T(&c_cpu_V, 2, &kc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_r3, 2, &fc_emlrtRTEI, true);
  emxInit_real32_T(&f_cpu_y, 1, &pc_emlrtRTEI, true);
  emxInit_real32_T(&cpu_r4, 2, &mc_emlrtRTEI, true);
  for (int32_T ii{0}; ii < b_i; ii++) {
    ...
    for (int32_T ch{0}; ch < k; ch++) {
      ...
      boolean_T fv_needsGpuEnsureCapacity;
      ...
      emxEnsureCapacity_real32_T(cpu_fv, i, &xb_emlrtRTEI);
      nx = cpu_x->size[0] - 1;
      ...
      fv_needsGpuEnsureCapacity = false;
      if (x_outdatedOnGpu) {
        gpuEmxMemcpyCpuToGpu_real32_T(&gpu_x, cpu_x);
      }
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_detr_kernel6<<<grid, block>>>(ch, gpu_x, nx, gpu_fv,
                                         cpu_x->size[0U]);
      }
      fv_outdatedOnCpu = true;
      i = cpu_fv1->size[0];
      cpu_fv1->size[0] = cpu_w->size[0];
      emxEnsureCapacity_real32_T(cpu_fv1, i, &yb_emlrtRTEI);
      nx = cpu_w->size[0] - 1;
      mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block, 2147483647U);
      if (y_outdatedOnCpu) {
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_detr_kernel7<<<grid, block>>>(ch, gpu_w, nx, gpu_fv1,
                                         cpu_w->size[0U]);
      }
      ...
      emxEnsureCapacity_real32_T(cpu_z, i, &ac_emlrtRTEI);
      x_needsGpuEnsureCapacity = true;
      ...
      for (int32_T b_ii{0}; b_ii < i5; b_ii++) {
        ...
        if (cpu_fv->size[0] == cpu_fv1->size[0]) {
          ...
          emxEnsureCapacity_real32_T(c_cpu_x, i, &cc_emlrtRTEI);
          nx = cpu_fv->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                  2147483647U);
          if (fv_needsGpuEnsureCapacity) {
            gpuEmxEnsureCapacity_real32_T(cpu_fv, &gpu_fv, true);
          }
          fv_needsGpuEnsureCapacity = false;
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel8<<<grid, block>>>(gpu_fv1, gpu_fv, nx, b_gpu_x);
          }
          ...
          fv_needsGpuEnsureCapacity = true;
        }
        vlen = c_cpu_x->size[0];
        if (c_cpu_x->size[0] == 0) {
          xbar = 0.0F;
        ...
        if (cpu_fv->size[0] == cpu_fv1->size[0]) {
          ...
          emxEnsureCapacity_real32_T(d_cpu_x, i, &cc_emlrtRTEI);
          nx = cpu_fv->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                  2147483647U);
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel9<<<grid, block>>>(gpu_fv1, gpu_fv, nx, c_gpu_x);
          }
        ...
        if (cpu_regs->size[0] == cpu_fv1->size[0]) {
          ...
          emxEnsureCapacity_real32_T(b_cpu_regs, i, &cc_emlrtRTEI);
          nx = cpu_regs->size[1] - 1;
          vlen = cpu_regs->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx, vlen), &grid, &block,
                                  2147483647U);
          if (fv1_needsGpuEnsureCapacity) {
            gpuEmxEnsureCapacity_real32_T(cpu_fv1, &gpu_fv1, true);
          }
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel10<<<grid, block>>>(gpu_fv1, gpu_regs, vlen, nx,
        ...
        emxEnsureCapacity_real32_T(cpu_r, i, &dc_emlrtRTEI);
        nx = cpu_regs->size[1] - 1;
        vlen = cpu_regs->size[0] - 1;
        mwGetLaunchParameters1D(computeNumIters(nx, vlen), &grid, &block,
                                2147483647U);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_detr_kernel11<<<grid, block>>>(g_cpu_y, gpu_r, gpu_regs, vlen, nx,
        ...
        if (cpu_r->size[0] == cpu_fv1->size[0]) {
          ...
          emxEnsureCapacity_real32_T(cpu_r1, i, &ec_emlrtRTEI);
          nx = cpu_r->size[1] - 1;
          vlen = cpu_r->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx, vlen), &grid, &block,
                                  2147483647U);
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel12<<<grid, block>>>(gpu_fv1, b_gpu_r, vlen, nx,
        ...
        emxEnsureCapacity_real32_T(cpu_r2, i, &fc_emlrtRTEI);
        nx = cpu_r1->size[0] - 1;
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_detr_kernel13<<<grid, block>>>(gpu_r1, vlen, nx, gpu_r2,
        ...
        emxEnsureCapacity_real32_T(b_cpu_V, i, &gc_emlrtRTEI);
        ...
        if ((cpu_D->size[0] == 1) && (cpu_D->size[1] == 1)) {
          i = cpu_d->size[0];
          cpu_d->size[0] = 1;
          emxEnsureCapacity_creal32_T(cpu_d, i, &ic_emlrtRTEI);
        ...
        emxEnsureCapacity_real32_T(c_cpu_V, i, &kc_emlrtRTEI);
        nx = cpu_iv->size[0] - 1;
        ...
        emxEnsureCapacity_real32_T(b_cpu_V, i, &lc_emlrtRTEI);
        ...
        emxEnsureCapacity_real32_T(cpu_r4, i, &mc_emlrtRTEI);
        ...
        coder::internal::blas::mtimes(
            ...
            &fv2_outdatedOnGpu, cpu_r1, &r1_outdatedOnCpu, &gpu_r1,
            &r1_outdatedOnGpu);
        y_outdatedOnCpu = true;
        ...
        if (cpu_fv->size[0] == cpu_fv1->size[0]) {
          ...
          emxEnsureCapacity_real32_T(cpu_A, i, &nc_emlrtRTEI);
          nx = cpu_fv->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                  2147483647U);
          if (fv1_needsGpuEnsureCapacity) {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel17<<<grid, block>>>(gpu_fv1, b_mn, gpu_fv, nx, gpu_A);
          }
          x_outdatedOnGpu = false;
        ...
        if ((cpu_A->size[1] == 0) || (cpu_r1->size[0] == 0) ||
          ...
          emxEnsureCapacity_real32_T(b_cpu_y, i, &oc_emlrtRTEI);
          nz = cpu_r1->size[1];
          ...
          g_cpu_y = 0.0F;
          if (x_needsGpuEnsureCapacity) {
            gpuEmxEnsureCapacity_real32_T(cpu_A, &gpu_A, !x_outdatedOnGpu);
          }
          gpuEmxEnsureCapacity_real32_T(cpu_r1, &gpu_r1, !r1_outdatedOnGpu);
          y_outdatedOnCpu = false;
          gpuEmxEnsureCapacity_real32_T(b_cpu_y, &b_gpu_y, true);
        ...
        emxEnsureCapacity_real32_T(cpu_r3, i, &fc_emlrtRTEI);
        nx = cpu_r1->size[0] - 1;
        vlen = cpu_r1->size[1] - 1;
        mwGetLaunchParameters1D(computeNumIters(nx, vlen), &grid, &block,
                                2147483647U);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_detr_kernel19<<<grid, block>>>(gpu_r1, vlen, nx, gpu_r3,
        ...
        emxEnsureCapacity_real32_T(f_cpu_y, i, &pc_emlrtRTEI);
        nx = b_cpu_y->size[1] - 1;
        mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                2147483647U);
        gpuEmxEnsureCapacity_real32_T(b_cpu_y, &b_gpu_y, !w_outdatedOnGpu);
        ...
        w_outdatedOnGpu = false;
        fv2_outdatedOnCpu = true;
        coder::internal::blas::b_mtimes(b_cpu_V, &b_gpu_V, &fv2_outdatedOnGpu,
        ...
        if (cpu_fv2->size[0] == cpu_fv->size[0]) {
          ...
          emxEnsureCapacity_real32_T(cpu_z, i, &qc_emlrtRTEI);
          nx = cpu_fv2->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                  2147483647U);
          if (fv_needsGpuEnsureCapacity) {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel21<<<grid, block>>>(mn, gpu_fv, gpu_fv2, nx, gpu_z);
          }
          x_outdatedOnGpu = false;
        ...
        if ((cpu_fv->size[0] == cpu_z->size[0]) && (nx == cpu_fv1->size[0])) {
          ...
          emxEnsureCapacity_real32_T(b_cpu_d, i, &rc_emlrtRTEI);
          nx = cpu_fv->size[0] - 1;
          mwGetLaunchParameters1D(computeNumIters(nx), &grid, &block,
                                  2147483647U);
          if (fv1_needsGpuEnsureCapacity) {
          ...
          fv1_needsGpuEnsureCapacity = false;
          if (x_needsGpuEnsureCapacity) {
            gpuEmxEnsureCapacity_real32_T(cpu_z, &gpu_z, !x_outdatedOnGpu);
          }
          x_needsGpuEnsureCapacity = false;
          if (fv_needsGpuEnsureCapacity) {
            gpuEmxEnsureCapacity_real32_T(cpu_fv, &gpu_fv, true);
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel22<<<grid, block>>>(gpu_fv1, gpu_z, gpu_fv, nx,
                                              gpu_d);
          }
          fv2_outdatedOnCpu = false;
        ...
        if (b_cpu_d->size[0] == 0) {
          ...
          emxEnsureCapacity_real32_T(cpu_absdiff, i, &sc_emlrtRTEI);
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_detr_kernel26<<<grid, block>>>(xbar, gpu_d, vlen, gpu_absdiff);
          }
          cublasCheck(cublasSnrm2(getCublasGlobalHandle(), b_cpu_d->size[0],
                                  (float *)&gpu_absdiff.data[0], 1,
                                  (float *)&x),
                      __FILE__, __LINE__);
        ...
        emxEnsureCapacity_real32_T(e_cpu_y, i, &tc_emlrtRTEI);
        mwGetLaunchParameters1D(computeNumIters(nx - 1), &grid, &block,
                                2147483647U);
        if (fv2_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real32_T(b_cpu_d, &gpu_d, !fv2_outdatedOnCpu);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_detr_kernel24<<<grid, block>>>(thr_data[ii] * g_cpu_y, f_gpu_y, nx,
                                            gpu_fv1);
        }
        fv1_outdatedOnCpu = true;
        //  update weights
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_detr_kernel29<<<grid, block>>>(gpu_fv1, ch, nz - 1, gpu_w,
                                          cpu_w->size[0U]);
      }
      fv2_outdatedOnCpu = true;
      //  Detrend
