...
cwtfilterbank_wt_kernel14(const int32_T i, const int32_T b, emxArray_real_T x);
                      ...
                      emxArray_creal_T *varargout_1)
{
  ...
  emxInit_real_T(&cpu_xv, 2, &sc_emlrtRTEI, true);
  xv_outdatedOnGpu = false;
  bcoef = cpu_xv->size[0] * cpu_xv->size[1];
  cpu_xv->size[0] = 1;
  cpu_xv->size[1] = x->size[0];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(cpu_xv, bcoef, &sc_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&cpu_x, 2, &vc_emlrtRTEI, true);
    xv_outdatedOnGpu = false;
    bcoef = cpu_x->size[0] * cpu_x->size[1];
    cpu_x->size[0] = 1;
    cpu_x->size[1] = i;
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_x, bcoef, &vc_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_xv, bcoef, &wc_emlrtRTEI);
    acoef = cpu_x->size[1];
  ...
  emxInit_creal_T(&cpu_xposdft, 2, &tc_emlrtRTEI, true);
  if (cpu_xv->size[1] == 0) {
    xv_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_creal_T(cpu_xposdft, bcoef, &tc_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_cfsposdft, 2, &ad_emlrtRTEI, true);
  x_outdatedOnCpu = false;
  ...
  nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
  emxEnsureCapacity_creal_T(cpu_cfsposdft, bcoef, &rc_emlrtRTEI);
  ...
  if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(varargout_1, bcoef, &xc_emlrtRTEI);
