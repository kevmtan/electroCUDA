...
real_T quadgk(real_T fun_workspace_be, real_T fun_workspace_ga)
{
  ...
  if (!(pathlen > 0.0)) {
    ...
    emxInit_real_T(&x, 2, &yb_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_x, 2, &fc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&xt, 2, &gc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&y, 2, &mc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&fx, 2, &nc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_y, 2, &oc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&a, 2, &kc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_dv1, 2, &pc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&c_y, 2, &qc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&dv4, 2, &pc_emlrtRTEI, true);
    ...
    do {
      ...
      x->size[1] = 15 * (nsubs + 1);
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(x, ix, &yb_emlrtRTEI);
      ix = -1;
      ...
      b_x->size[1] = x->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_x, ix, &ac_emlrtRTEI);
      ix = xt->size[0] * xt->size[1];
      xt->size[0] = 1;
      xt->size[1] = x->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(xt, ix, &bc_emlrtRTEI);
      ix = x->size[1];
      ...
      if (!first_iteration) {
        ...
        if (first_iteration) {
          ...
          fx->size[1] = x->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(fx, ix, &dc_emlrtRTEI);
      ...
      if (guard1) {
        ...
        y->size[1] = b_x->size[1];
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(y, ix, &l_emlrtRTEI);
        ix = b_x->size[1];
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(b_y, ix, &l_emlrtRTEI);
        ix = b_x->size[1];
        profileLoopStart("quadgk_loop_9", __LINE__, (ix - 1) + 1, "");
        for (k = 0; k < ix; k++) {
          nvtxMarkA("#rt_powd_snf#" MW_AT_LINE);
        ...
        if (y->size[1] == b_y->size[1]) {
          ...
          a->size[1] = y->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(a, ix, &kc_emlrtRTEI);
          profileLoopStart("quadgk_loop_11", __LINE__, (y->size[1] - 1) + 1,
                           "");
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(b_dv1, ix, &l_emlrtRTEI);
        ix = a->size[1];
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(c_y, ix, &l_emlrtRTEI);
        ix = b_x->size[1];
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(dv4, ix, &lc_emlrtRTEI);
        profileLoopStart("quadgk_loop_14", __LINE__, (c_y->size[1] - 1) + 1,
                         "");
        ...
        if (b_dv1->size[1] == dv4->size[1]) {
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(fx, ix, &ec_emlrtRTEI);
          profileLoopStart("quadgk_loop_16", __LINE__, (b_dv1->size[1] - 1) + 1,
                           "");
