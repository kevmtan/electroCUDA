                                                  ...
                                                  real_T varargin_10)
{
  ...
  if (!freqsep) {
    ...
    emxInit_char_T(&tmpStr, 2, &xb_emlrtRTEI, true);
    ...
    if (!freqsep) {
      ...
      emlrt_marshallIn(length(emlrtAlias(c_tmpStr), &b_emlrtMCI),
                       "<output of length>");
      nvtxMarkA("#emxInit_char_T#" MW_AT_LINE);
      emxInit_char_T(&d_tmpStr, 2, &xb_emlrtRTEI, true);
      nvtxMarkA("#emlrt_marshallIn#" MW_AT_LINE);
                                           ...
                                           real_T varargin_10)
{
  ...
  emxInit_real_T(&omega_tmp1, 2, &s_emlrtRTEI, true);
  if (std::isnan(b)) {
    i = omega_tmp1->size[0] * omega_tmp1->size[1];
    omega_tmp1->size[0] = 1;
    omega_tmp1->size[1] = 1;
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(omega_tmp1, i, &s_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&omega_tmp2, 2, &t_emlrtRTEI, true);
  i = omega_tmp2->size[0] * omega_tmp2->size[1];
  omega_tmp2->size[0] = 1;
  omega_tmp2->size[1] = omega_tmp1->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(omega_tmp2, i, &t_emlrtRTEI);
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_self->Omega, i, &u_emlrtRTEI);
  ...
  if (!y) {
    ...
    fo = cf / cutoff;
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_y, 2, &mb_emlrtRTEI, true);
    nvtxMarkA("#b_log2#" MW_AT_LINE);
    ...
    if (std::isnan(b)) {
      ...
      b_y->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_y, i, &v_emlrtRTEI);
      b_y->data[0] = rtNaN;
    } else if (b < 0.0) {
      b_y->size[0] = 1;
      b_y->size[1] = 0;
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&c_b, 2, &nb_emlrtRTEI, true);
    i = c_b->size[0] * c_b->size[1];
    c_b->size[0] = 1;
    c_b->size[1] = b_y->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(c_b, i, &l_emlrtRTEI);
    nx = b_y->size[1];
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b_self->Scales, i, &w_emlrtRTEI);
    ...
    N = rt_powd_snf(2.0, 1.0 / nv);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&c_y, 2, &pb_emlrtRTEI, true);
    nvtxMarkA("#b_log2#" MW_AT_LINE);
    ...
    if (std::isnan(b)) {
      ...
      c_y->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(c_y, i, &v_emlrtRTEI);
      c_y->data[0] = rtNaN;
    } else if (b < 0.0) {
      c_y->size[0] = 1;
      c_y->size[1] = 0;
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&d_b, 2, &sb_emlrtRTEI, true);
    i = d_b->size[0] * d_b->size[1];
    d_b->size[0] = 1;
    d_b->size[1] = c_y->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(d_b, i, &l_emlrtRTEI);
    nx = c_y->size[1];
  ...
  nvtxRangePop();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&psidft, 2, &vb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  ...
  if (y) {
    ...
    be = b_self->Beta;
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_somega, 2, &qb_emlrtRTEI, true);
    if (b_self->Scales->size[1] == 1) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_somega, i, &bb_emlrtRTEI);
    ...
    if (ga == 3.0) {
      ...
      powscales->size[1] = absomega->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(powscales, i, &l_emlrtRTEI);
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_x, 2, &eb_emlrtRTEI, true);
    if ((absomega->size[0] == powscales->size[0]) &&
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_x, i, &eb_emlrtRTEI);
    ...
    if ((b_x->size[0] == b_somega->size[0]) &&
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(psidft, i, &hb_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(f, i, &ib_emlrtRTEI);
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&somega, 2, &ob_emlrtRTEI, true);
    if (b_self->Scales->size[1] == 1) {
      nvtxMarkA("#bsxfun#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(somega, i, &y_emlrtRTEI);
      loop_ub = b_self->Omega->size[1];
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&w, 2, &ab_emlrtRTEI, true);
    i = w->size[0] * w->size[1];
    w->size[0] = somega->size[0];
    w->size[1] = somega->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(w, i, &ab_emlrtRTEI);
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&expnt, 2, &rb_emlrtRTEI, true);
    i = expnt->size[0] * expnt->size[1];
    expnt->size[0] = w->size[0];
    expnt->size[1] = w->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(expnt, i, &cb_emlrtRTEI);
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&d_y, 2, &ub_emlrtRTEI, true);
    ...
    if ((expnt->size[0] == d_y->size[0]) && (expnt->size[1] == d_y->size[1])) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(psidft, i, &fb_emlrtRTEI);
    ...
    f->size[1] = b_self->Scales->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(f, i, &gb_emlrtRTEI);
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_self->PsiDFT, i, &kb_emlrtRTEI);
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_self->WaveletCenterFrequencies, i, &lb_emlrtRTEI);
