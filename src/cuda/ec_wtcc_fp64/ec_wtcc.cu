...
static __global__ void ec_wtcc_kernel10(const emxArray_real_T opts_filter,
                                        const emxArray_int32_T iv1,
                                        const int32_T b_iv1, emxArray_real_T h);

static __global__ void ec_wtcc_kernel11(const emxArray_real_T opts_x,
                                        const int32_T b_opts_x,
                                        emxArray_real_T b_y1);

static __global__ void ec_wtcc_kernel12(const emxArray_real_T b_y1,
                                        const int32_T b, emxArray_real_T b_dv);

static __global__ void ec_wtcc_kernel13(const emxArray_creal_T yp,
                                        const int32_T b, emxArray_real_T y);

static __global__ void ec_wtcc_kernel14(const emxArray_real_T opts_x,
                                        const int32_T b_opts_x,
                                        emxArray_real_T b_dv);

static __global__ void ec_wtcc_kernel15(const emxArray_real_T w,
                                        const int32_T vlen, const int32_T b,
                                        emxArray_real_T y);

static __global__ void ec_wtcc_kernel16(emxArray_real_T y);

static __global__ void ec_wtcc_kernel17(const emxArray_real_T y,
                                        const emxArray_real_T b_y,
                                        const real_T opts_filterDelay,
                                        const int32_T ii, const int32_T b,
                                        emxArray_real_T b_y1, int32_T y1_dim0);

static __global__ void ec_wtcc_kernel18(const int32_T b, emxArray_real_T y);

static __global__ void ec_wtcc_kernel19(const emxArray_real_T b_y1,
                                        const int32_T b, emxArray_real_T b_dv);

static __global__ void ec_wtcc_kernel2(const emxArray_real_T xp,
                                       const int32_T b_xp, const int32_T c_xp,
                                       emxArray_real_T b_dv, int32_T dv_dim0,
                                       int32_T xp_dim0);

static __global__ void ec_wtcc_kernel20(const emxArray_real_T b_y1,
                                        const int32_T c_y1, const int32_T d_y1,
                                        emxArray_real_T b_dv, int32_T dv_dim0,
                                        int32_T y1_dim0);

static __global__ void ec_wtcc_kernel21(const emxArray_real_T opts_x,
                                        const int32_T b_opts_x,
                                        emxArray_real_T b_y1);

static __global__ void ec_wtcc_kernel22(const int32_T b, emxArray_uint32_T y);

static __global__ void ec_wtcc_kernel23(const emxArray_real_T b_dv,
                                        const int32_T c_dv,
                                        emxArray_real_T opts_x);

static __global__ void ec_wtcc_kernel24(const emxArray_real_T b_dv,
                                        const int32_T c_dv, const int32_T d_dv,
                                        emxArray_real_T opts_x,
                                        int32_T opts_x_dim0, int32_T dv_dim0);

static __global__ void ec_wtcc_kernel3(const emxArray_creal_T yp,
                                       const int32_T b_yp, const int32_T c_yp,
                                       emxArray_creal_T d_yp, int32_T yp_dim0,
                                       int32_T b_yp_dim0);

static __global__ void ec_wtcc_kernel4(const emxArray_real_T b_dv,
...
static __global__ void ec_wtcc_kernel6(const emxArray_real_T dv3,
                                       const emxArray_real_T b_dv2,
                                       const int32_T c_dv2, emxArray_real_T h1);

static __global__ void ec_wtcc_kernel7(const real_T pqmax,
                                       const emxArray_real_T h1,
                                       const real_T opts_p, const int32_T b_h1,
                                       emxArray_real_T opts_filter);

static __global__ void ec_wtcc_kernel8(const int32_T nZeroBegin,
                                       emxArray_real_T h);

static __global__ void ec_wtcc_kernel9(const emxArray_uint32_T y,
...
static __global__ __launch_bounds__(32,
                                    1) void ec_wtcc_kernel16(emxArray_real_T y)
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtcc_kernel17(
...
static __global__ __launch_bounds__(1024,
                                    1) void ec_wtcc_kernel18(const int32_T b,
                                                             emxArray_real_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtcc_kernel19(
    const emxArray_real_T b_y1, const int32_T b, emxArray_real_T b_dv)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(1024, 1) void ec_wtcc_kernel22(const int32_T b,
                                                     emxArray_uint32_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtcc_kernel23(
...
static __global__
    __launch_bounds__(1024, 1) void ec_wtcc_kernel8(const int32_T nZeroBegin,
                                                    emxArray_real_T h)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_wtcc_kernel9(
             ...
             emxArray_cell_wrap_0 *xx, emxArray_cell_wrap_0 *yy)
{
  ...
  for (int32_T p{0}; p < i1; p++) {
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      ec_wtcc_kernel2<<<grid, block>>>(gpu_xp, i, x, gpu_dv, cpu_dv->size[0U],
                                       cpu_xp->size[0U]);
    }
    ...
    if (ds[1] != 0.0) {
      ...
      if (opts_dim == 1) {
        if ((cpu_dv->size[0] == 1) || (cpu_dv->size[1] == 1)) {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel4<<<grid, block>>>(gpu_dv, b_c - 1, gpu_opts_x);
          }
          ...
          emxEnsureCapacity_real_T(cpu_opts_x, i, &g_emlrtRTEI);
          i = cpu_dv->size[0] * cpu_dv->size[1] - 1;
          mwGetLaunchParameters1D(computeNumIters(i), &grid, &block,
                                  2147483647U);
          gpuEmxEnsureCapacity_real_T(cpu_opts_x, &gpu_opts_x, true);
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel23<<<grid, block>>>(gpu_dv, i, gpu_opts_x);
          }
          opts_x_outdatedOnCpu = true;
        }
      } else {
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_wtcc_kernel24<<<grid, block>>>(
              gpu_dv, x, i, gpu_opts_x, cpu_opts_x->size[0U], cpu_dv->size[0U]);
        }
        opts_x_outdatedOnCpu = true;
      }
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel5<<<grid, block>>>(gpu_r, x, gpu_dv2);
      }
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel6<<<grid, block>>>(gpu_dv3, gpu_dv2, x, gpu_h1);
      }
      vlen = cpu_h1->size[0];
      if (cpu_h1->size[0] == 0) {
        pqmax = 0.0;
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel7<<<grid, block>>>(pqmax, gpu_h1, opts_p, x,
                                         gpu_opts_filter);
      }
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel8<<<grid, block>>>(x, gpu_h);
      }
      if (cpu_opts_filter->size[0] < 1) {
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          ec_wtcc_kernel22<<<grid, block>>>(static_cast<int32_T>(u) - 1, gpu_y);
        }
      }
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel9<<<grid, block>>>(gpu_y, nZeroBegin, x, gpu_iv1);
      }
      x = cpu_iv1->size[1] - 1;
      mwGetLaunchParameters1D(computeNumIters(x), &grid, &block, 2147483647U);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_wtcc_kernel10<<<grid, block>>>(gpu_opts_filter, gpu_iv1, x, gpu_h);
      }
      ...
      if (opts_dim == 1) {
        if (opts_isRowVectorInput) {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel11<<<grid, block>>>(gpu_opts_x, x, gpu_y1);
          }
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel12<<<grid, block>>>(gpu_y1, b_c - 1, gpu_dv);
          }
        } else {
          i = cpu_dv->size[0] * cpu_dv->size[1];
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel14<<<grid, block>>>(gpu_opts_x, x, gpu_dv);
          }
          yp_needsGpuEnsureCapacity = false;
          coder::b_signal::internal::resample::uniformResampleAlongFirstDim(
        ...
        if (cpu_opts_x->size[0] == 1) {
          ...
          for (x = 0; x < opts_dim; x++) {
            ...
            validLaunchParams = mwValidateLaunchParameters(grid, block);
            if (validLaunchParams) {
              ec_wtcc_kernel15<<<grid, block>>>(gpu_w, vlen, i, c_gpu_y);
            }
            ...
            if (std::isnan(pqmax)) {
              ...
              ec_wtcc_kernel16<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
                  d_gpu_y);
            } else if (pqmax < 1.0) {
              d_cpu_y->size[0] = 1;
              d_cpu_y->size[1] = 0;
            ...
            validLaunchParams = mwValidateLaunchParameters(grid, block);
            if (validLaunchParams) {
              ec_wtcc_kernel17<<<grid, block>>>(c_gpu_y, d_gpu_y,
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel21<<<grid, block>>>(gpu_opts_x, x, gpu_y1);
          }
          opts_isRowVectorInput = false;
          yp_needsGpuEnsureCapacity = true;
          coder::b_signal::internal::resample::uniformResampleAlongFirstDim(
        ...
        if ((cpu_opts_x->size[0] == 1) || (cpu_opts_x->size[1] == 1)) {
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel19<<<grid, block>>>(gpu_y1, i, gpu_dv);
          }
        } else {
          i = cpu_dv->size[0] * cpu_dv->size[1];
          ...
          validLaunchParams = mwValidateLaunchParameters(grid, block);
          if (validLaunchParams) {
            ec_wtcc_kernel20<<<grid, block>>>(
                gpu_y1, i, x, gpu_dv, cpu_dv->size[0U], cpu_y1->size[0U]);
          }
        }
      }
    ...
    for (i = 0; i < 2; i++) {
      b_dv1[i] = static_cast<uint32_T>(b_cpu_yp->size[i]);
    }
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      ec_wtcc_kernel13<<<grid, block>>>(b_gpu_yp, vlen - 1, b_gpu_y);
    }
    yp_needsGpuEnsureCapacity = true;
