                       ...
                       int32_T *y_m, int32_T *y_n)
{
  ...
  emxEnsureCapacity_int32_T(y_colidx, outridx, &pd_emlrtRTEI);
  if (this_m >= 0) {
  ...
  emxEnsureCapacity_real_T(y_d, outridx, &qd_emlrtRTEI);
  outridx = y_rowidx->size[0];
  y_rowidx->size[0] = numalloc + 1;
  nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
  emxEnsureCapacity_int32_T(y_rowidx, outridx, &qd_emlrtRTEI);
  if (numalloc >= 0) {
  ...
  emxInit_int32_T(&counts, 1, &rd_emlrtRTEI, true);
  if ((this_m != 0) && (this_n != 0)) {
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(counts, outridx, &rd_emlrtRTEI);
