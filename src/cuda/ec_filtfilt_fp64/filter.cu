...
static __global__ void filter_kernel20(const real_T a1, const int32_T b,
                                       emxArray_real_T b_b);

static __global__ void filter_kernel21(const real_T a1, const int32_T b,
                                       emxArray_real_T a);

static __global__ void filter_kernel22(emxArray_real_T a);

static __global__ void filter_kernel23(const int32_T k, const int32_T b,
                                       emxArray_real_T b_b);

static __global__ void filter_kernel24(const int32_T b,
                                       emxArray_real_T expanded);

static __global__ void filter_kernel25(const int32_T offsetH,
                                       const emxArray_int32_T y,
                                       const int32_T b_y, emxArray_int32_T iv);

static __global__ void filter_kernel26(const emxArray_real_T x,
                                       const emxArray_int32_T iv,
                                       const int32_T b,
                                       emxArray_real_T expanded);

static __global__ void filter_kernel27(const emxArray_real_T expanded,
                                       const emxArray_int32_T rows,
                                       const emxArray_real_T b, const int32_T c,
                                       emxArray_real_T convOut, int32_T b_dim0);

static __global__ void filter_kernel28(const emxArray_real_T convOut,
                                       const int32_T na, const int32_T b,
                                       emxArray_real_T zf);

static __global__ void filter_kernel29(const emxArray_real_T convOut,
                                       const emxArray_real_T a, const int32_T b,
                                       emxArray_real_T zf, int32_T a_dim0,
                                       int32_T x_dim0);

static __global__ void filter_kernel30(const emxArray_real_T convOut,
                                       const int32_T x, emxArray_real_T y);

static __global__ void filter_kernel31(const emxArray_real_T zi,
                                       const int32_T b,
                                       emxArray_real_T convOut);

static __global__ void filter_kernel32(const real_T a1, const int32_T b,
                                       emxArray_real_T b_b);

static __global__ void filter_kernel33(const real_T a1, const int32_T b,
                                       emxArray_real_T a);

static __global__ void filter_kernel34(emxArray_real_T a);

static __global__ void filter_kernel35(const int32_T k, const int32_T b,
                                       emxArray_real_T b_b);

static __global__ void filter_kernel36(const int32_T b,
                                       emxArray_real_T expanded);

static __global__ void filter_kernel37(const int32_T offsetH,
                                       const emxArray_int32_T y,
                                       const int32_T b_y, emxArray_int32_T iv);

static __global__ void filter_kernel38(const emxArray_real_T x,
                                       const emxArray_int32_T iv,
                                       const int32_T b,
                                       emxArray_real_T expanded);

static __global__ void filter_kernel39(const emxArray_real_T expanded,
                                       const emxArray_int32_T rows,
                                       const emxArray_real_T b, const int32_T c,
                                       emxArray_real_T convOut, int32_T b_dim0);

static __global__ void filter_kernel40(const emxArray_real_T convOut,
                                       const int32_T x, emxArray_real_T y);

static __global__ void filter_kernel41(const emxArray_real_T zi,
                                       const int32_T b,
                                       emxArray_real_T convOut);
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel20(const real_T a1,
                                                            const int32_T b,
                                                            emxArray_real_T b_b)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel21(const real_T a1,
                                                            const int32_T b,
                                                            emxArray_real_T a)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(32,
                                    1) void filter_kernel22(emxArray_real_T a)
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel23(const int32_T k,
                                                            const int32_T b,
                                                            emxArray_real_T b_b)
{
  uint64_T gStride;
...
static __global__
    __launch_bounds__(1024, 1) void filter_kernel24(const int32_T b,
                                                    emxArray_real_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void filter_kernel25(
...
static __global__ __launch_bounds__(1024, 1) void filter_kernel26(
    const emxArray_real_T x, const emxArray_int32_T iv, const int32_T b,
    emxArray_real_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void filter_kernel28(
    const emxArray_real_T convOut, const int32_T na, const int32_T b,
    emxArray_real_T zf)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void filter_kernel29(
    ...
    emxArray_real_T zf, int32_T a_dim0, int32_T x_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void filter_kernel30(
    const emxArray_real_T convOut, const int32_T x, emxArray_real_T y)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel32(const real_T a1,
                                                            const int32_T b,
                                                            emxArray_real_T b_b)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel33(const real_T a1,
                                                            const int32_T b,
                                                            emxArray_real_T a)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(32,
                                    1) void filter_kernel34(emxArray_real_T a)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
...
static __global__ __launch_bounds__(1024,
                                    1) void filter_kernel35(const int32_T k,
                                                            const int32_T b,
                                                            emxArray_real_T b_b)
{
  uint64_T gStride;
...
static __global__
    __launch_bounds__(1024, 1) void filter_kernel36(const int32_T b,
                                                    emxArray_real_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
  ...
  *a_outdatedOnCpu = false;
  if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
    ...
    if (validLaunchParams) {
      ...
      filter_kernel32<<<grid, block>>>(a1, nb - 1, *gpu_b);
    }
    ...
    *b_outdatedOnCpu = true;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel33<<<grid, block>>>(a1, na - 2, *gpu_a);
    }
    nvtxMarkA("#filter_kernel34#" MW_AT_LINE);
    filter_kernel34<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_a);
  ...
  if (cpu_a->size[0] > cpu_b->size[0]) {
    ...
    emxEnsureCapacity_real_T(cpu_b, na, &l_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(nb - 1), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_real_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      filter_kernel35<<<grid, block>>>(k, nb - 1, *gpu_b);
    }
    *b_outdatedOnGpu = false;
    *b_outdatedOnCpu = true;
  }
  if (cpu_x->size[0] == 0) {
    *y_outdatedOnCpu = false;
    ...
    emxInit_real_T(&cpu_expanded, 1, &m_emlrtRTEI, true);
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_expanded, k, &m_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      filter_kernel36<<<grid, block>>>(na, gpu_expanded);
    }
    nb = cpu_x->size[0];
    ...
    if (validLaunchParams) {
      ...
      filter_kernel37<<<grid, block>>>(offsetH, b_gpu_y, na, gpu_iv);
    }
    ...
    *x_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel38<<<grid, block>>>(*gpu_x, gpu_iv, nb - 1, gpu_expanded);
    }
    nvtxMarkA("#emxFree_int32_T#" MW_AT_LINE);
    ...
    profileLoopEnd();
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&cpu_convOut, 1, &l_emlrtRTEI, true);
    k = cpu_convOut->size[0];
    cpu_convOut->size[0] = static_cast<int32_T>(OH);
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_convOut, k, &m_emlrtRTEI);
    if (a1 < 4.294967296E+9) {
      if (a1 >= 0.0) {
        window_idx_0 = static_cast<uint32_T>(a1);
      } else {
        window_idx_0 = 0U;
      }
    } else if (a1 >= 4.294967296E+9) {
    ...
    *b_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel39<<<grid, block>>>(gpu_expanded, gpu_rows, *gpu_b,
      ...
      if (cpu_zi->size[0] == 1) {
        ...
        *zi_outdatedOnGpu = false;
        ...
        if (validLaunchParams) {
          ...
          filter_kernel41<<<grid, block>>>(*gpu_zi, na - 1, gpu_convOut);
        }
      }
    }
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_y, k, &o_emlrtRTEI);
    na = cpu_x->size[0] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(na), &grid, &block, 2147483647U);
    if (b_needsGpuEnsureCapacity) {
    ...
    if (validLaunchParams) {
      ...
      filter_kernel40<<<grid, block>>>(gpu_convOut, na, *gpu_y);
    }
  ...
  *a_outdatedOnCpu = false;
    ...
    if (!(cpu_a->data[0] == 0.0)) {
      if (cpu_a->data[0] != 1.0) {
        ...
        if (validLaunchParams) {
          ...
          filter_kernel20<<<grid, block>>>(a1, nb - 1, *gpu_b);
        }
        *b_outdatedOnGpu = false;
        *b_outdatedOnCpu = true;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          filter_kernel21<<<grid, block>>>(a1, na - 2, *gpu_a);
        }
        a_needsGpuEnsureCapacity = false;
        nvtxMarkA("#filter_kernel22#" MW_AT_LINE);
        filter_kernel22<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_a);
        *a_outdatedOnGpu = false;
        *a_outdatedOnCpu = true;
      } else {
  ...
  if (cpu_a->size[0] > cpu_b->size[0]) {
    ...
    if (validLaunchParams) {
      ...
      filter_kernel23<<<grid, block>>>(k, nb - 1, *gpu_b);
    }
    *b_outdatedOnGpu = false;
    *b_outdatedOnCpu = true;
  }
  ...
  if (cpu_x->size[0] == 0) {
    ...
    *zf_outdatedOnCpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_zf, k, &l_emlrtRTEI);
  } else {
    int32_T KH;
    int32_T offsetH;
    uint32_T OH;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel24<<<grid, block>>>(nb, gpu_expanded);
    }
    nb = cpu_x->size[0];
    nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
    emxInit_int32_T(&b_cpu_y, 2, &m_emlrtRTEI, true);
    ...
    if (validLaunchParams) {
      ...
      filter_kernel25<<<grid, block>>>(offsetH, b_gpu_y, nb, gpu_iv);
    }
    nvtxMarkA("#emxFree_int32_T#" MW_AT_LINE);
    emxFree_int32_T(&b_cpu_y);
    nb = cpu_iv->size[0];
    ...
    if (validLaunchParams) {
      ...
      filter_kernel26<<<grid, block>>>(*gpu_x, gpu_iv, nb - 1, gpu_expanded);
    }
    nvtxMarkA("#emxFree_int32_T#" MW_AT_LINE);
    emxFree_int32_T(&cpu_iv);
    nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
    ...
    *b_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel27<<<grid, block>>>(gpu_expanded, gpu_rows, *gpu_b,
                                       static_cast<int32_T>(OH) - 1,
                                       gpu_convOut, cpu_b->size[0U]);
    }
    convOut_outdatedOnGpu = false;
      ...
      if (cpu_zi->size[0] == 1) {
        ...
        *zi_outdatedOnGpu = false;
        ...
        if (validLaunchParams) {
          ...
          filter_kernel31<<<grid, block>>>(*gpu_zi, na - 1, gpu_convOut);
        }
      }
    }
    na = cpu_x->size[0] + cpu_a->size[0];
    ...
    if (validLaunchParams) {
      ...
      filter_kernel28<<<grid, block>>>(gpu_convOut, na, nb, *gpu_zf);
    }
    na = cpu_a->size[0];
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    *a_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel29<<<grid, block>>>(gpu_convOut, *gpu_a, na - 3, *gpu_zf,
    ...
    *zf_outdatedOnCpu = true;
    ...
    if (validLaunchParams) {
      ...
      filter_kernel30<<<grid, block>>>(gpu_convOut, nb, *gpu_y);
    }
    *y_outdatedOnCpu = true;
    nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
    emxFree_real_T(&cpu_convOut);
