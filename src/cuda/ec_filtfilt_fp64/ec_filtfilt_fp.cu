...
ec_filtfilt_fp_kernel1(const int32_T ch, const emxArray_real_T x,
                       const int32_T b_x, emxArray_real_T dv, int32_T x_dim0);

static __global__ void ec_filtfilt_fp_kernel10(const emxArray_real_T a,
                                               const int32_T b_a,
                                               emxArray_real_T c_a);

static __global__ void ec_filtfilt_fp_kernel11(const emxArray_real_T b,
                                               const int32_T b_b,
                                               emxArray_real_T c_b);

static __global__ void ec_filtfilt_fp_kernel12(const emxArray_real_T a,
                                               const int32_T b_a,
                                               emxArray_real_T c_a);

static __global__ void ec_filtfilt_fp_kernel13(const emxArray_real_T yc3,
                                               const int32_T bcoef,
                                               const int32_T i5,
                                               const int32_T b,
                                               emxArray_real_T b_yc3);

static __global__ void ec_filtfilt_fp_kernel14(const real_T a,
                                               const emxArray_real_T z,
                                               const int32_T b_z,
                                               emxArray_real_T c_z);

static __global__ void ec_filtfilt_fp_kernel15(const emxArray_real_T b,
                                               const int32_T b_b,
                                               emxArray_real_T c_b);

static __global__ void ec_filtfilt_fp_kernel16(const emxArray_real_T a,
                                               const int32_T b_a,
                                               emxArray_real_T c_a);

static __global__ void ec_filtfilt_fp_kernel17(const emxArray_real_T yc2,
                                               const int32_T bcoef,
                                               const int32_T i5,
                                               const int32_T b,
...
static __global__ void
ec_filtfilt_fp_kernel18(const emxArray_real_T yc5, const int32_T bcoef,
                        const int32_T i5, const int32_T b, emxArray_real_T dv);

static __global__ void
ec_filtfilt_fp_kernel19(const emxArray_real_T dv, const int32_T ch,
                        const int32_T b, emxArray_real_T y, int32_T y_dim0);

static __global__ void
ec_filtfilt_fp_kernel2(const emxArray_real_T dv, const int32_T bcoef,
                       const int32_T i3, const int32_T i2, const real_T a,
                       const int32_T i5, emxArray_real_T xt);

static __global__ void ec_filtfilt_fp_kernel3(const emxArray_real_T b,
                                              const int32_T b_b,
                                              emxArray_real_T c_b);

static __global__ void ec_filtfilt_fp_kernel4(const emxArray_real_T a,
                                              const int32_T b_a,
                                              emxArray_real_T c_a);

static __global__ void ec_filtfilt_fp_kernel5(const real_T a,
                                              const emxArray_real_T z,
                                              const int32_T b_z,
                                              emxArray_real_T c_z);

static __global__ void ec_filtfilt_fp_kernel6(const emxArray_real_T b,
                                              const int32_T b_b,
                                              emxArray_real_T c_b);

static __global__ void ec_filtfilt_fp_kernel7(const emxArray_real_T a,
                                              const int32_T b_a,
                                              emxArray_real_T c_a);

static __global__ void
ec_filtfilt_fp_kernel8(const emxArray_real_T dv, const int32_T bcoef,
                       const int32_T i7, const int32_T i6, const real_T a,
                       const int32_T i5, emxArray_real_T c);

static __global__ void ec_filtfilt_fp_kernel9(const emxArray_real_T b,
                                              const int32_T b_b,
                                              emxArray_real_T c_b);
...
void ec_filtfilt_fp(const emxArray_real_T *cpu_x, const emxArray_real_T *cpu_b,
                    ...
                    real_T nf, real_T L, emxArray_real_T *cpu_y)
{
  ...
  for (int32_T ch{0}; ch < b_i; ch++) {
    ...
    if (validLaunchParams) {
      ...
      ec_filtfilt_fp_kernel1<<<grid, block>>>(ch, gpu_x, i, gpu_dv,
                                              cpu_x->size[0U]);
    }
    ...
    for (int32_T ii{0}; ii < i1; ii++) {
      ...
      if (validLaunchParams) {
        ...
        ec_filtfilt_fp_kernel18<<<grid, block>>>(gpu_yc5, bcoef, i5, i, gpu_dv);
      }
      dv_outdatedOnGpu = false;
    }
    profileLoopEnd();
    ...
    if (validLaunchParams) {
      ...
      ec_filtfilt_fp_kernel19<<<grid, block>>>(gpu_dv, ch, i5 - 1, gpu_y,
                                               cpu_y->size[0U]);
    }
    yc5_outdatedOnCpu = true;
  }
