                        ...
                        const emxArray_real_T *in3, const emxArray_real_T *in4)
{
  ...
  emxEnsureCapacity_real_T(in1, i, &fc_emlrtRTEI);
...
real_T quadgk(real_T fun_workspace_be, real_T fun_workspace_ga)
{
  ...
  if (!(pathlen > 0.0)) {
    ...
    emxInit_real_T(&x, 2, &ac_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_x, 2, &gc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&xt, 2, &hc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&y, 2, &nc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&fx, 2, &oc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_dv1, 2, &pc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&b_y, 2, &qc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&c_y, 2, &rc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&d_y, 2, &pc_emlrtRTEI, true);
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&a, 2, &mc_emlrtRTEI, true);
    ...
    do {
      ...
      x->size[1] = 15 * (nsubs + 1);
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(x, ix, &ac_emlrtRTEI);
      ix = -1;
      ...
      b_x->size[1] = x->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_x, ix, &bc_emlrtRTEI);
      ix = xt->size[0] * xt->size[1];
      xt->size[0] = 1;
      xt->size[1] = x->size[1];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(xt, ix, &cc_emlrtRTEI);
      ix = x->size[1];
      ...
      if (guard1) {
        ...
        y->size[1] = b_x->size[1];
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(y, ix, &h_emlrtRTEI);
        ix = b_x->size[1];
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(b_dv1, ix, &lc_emlrtRTEI);
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(b_y, ix, &h_emlrtRTEI);
        ix = b_x->size[1];
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(c_y, ix, &h_emlrtRTEI);
        ix = b_x->size[1];
        ...
        if (b_y->size[1] == c_y->size[1]) {
          ...
          a->size[1] = b_y->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(a, ix, &mc_emlrtRTEI);
        ...
        d_y->size[1] = a->size[1];
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(d_y, ix, &h_emlrtRTEI);
        ix = a->size[1];
        ...
        if (d_y->size[1] == b_dv1->size[1]) {
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(fx, ix, &fc_emlrtRTEI);
