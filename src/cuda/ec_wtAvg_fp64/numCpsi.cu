...
real_T numCpsi(const char_T wname[5], real_T varargin_1, real_T varargin_2)
{
  ...
  if (first_iteration) {
    ...
    if (!(anorm > 0.0)) {
      ...
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&y, 2, &rd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&a, 2, &od_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&fx, 2, &sd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&d_x, 2, &pd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&b_a, 2, &od_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&e_x, 2, &qd_emlrtRTEI, true);
      nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
      emxInit_real_T(&f_x, 2, &td_emlrtRTEI, true);
      ...
      do {
        ...
        if (guard1) {
          ...
          a->size[1] = c_x->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(a, ix, &od_emlrtRTEI);
          ...
          d_x->size[1] = y->size[1];
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(d_x, ix, &pd_emlrtRTEI);
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(b_a, ix, &od_emlrtRTEI);
          ...
          nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
          emxEnsureCapacity_real_T(e_x, ix, &qd_emlrtRTEI);
