...
static const mxArray *b_emlrt_marshallOut(const emxArray_real_T *u)
{
  ...
  const mxArray *m;
  const mxArray *y;
  nvtxRangePushA("#fcn#b_emlrt_marshallOut#" MW_AT_LOCATION);
  y = nullptr;
                     ...
                     const mxArray *plhs[2])
{
  ...
  real_T fs;
  boolean_T doPwr;
  nvtxRangePushA("#fcn#ec_wtAvg_fp_api#" MW_AT_LOCATION);
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  prhs_copy_idx_2 = emlrtProtectR2012b(prhs[2], 2, false, -1);
  // Marshall function inputs
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&x, 2, &ud_emlrtRTEI, true);
  x->canFreeData = false;
  nvtxMarkA("#emlrt_marshallIn#" MW_AT_LINE);
  ...
  nvtxMarkA("#c_emlrt_marshallIn#" MW_AT_LINE);
  doPwr = c_emlrt_marshallIn(emlrtAliasP(prhs[5]), "doPwr");
  // Invoke the target function
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&y, 2, &ud_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&freqs, 1, &ud_emlrtRTEI, true);
  nvtxMarkA("#ec_wtAvg_fp#" MW_AT_LINE);
  ec_wtAvg_fp(x, fs, *fLims, fVoices, ds, doPwr, y, freqs);
  ...
  if (nlhs > 1) {
    ...
    nvtxMarkA("#b_emlrt_marshallOut#" MW_AT_LINE);
...
// End of code generation (_coder_ec_wtAvg_fp_api.cu)
