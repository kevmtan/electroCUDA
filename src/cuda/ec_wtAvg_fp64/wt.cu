...
cwtfilterbank_wt_kernel15(const int32_T i, const int32_T b, emxArray_real_T x);

static __global__ void cwtfilterbank_wt_kernel16(const uint32_T xSize_dim1,
                                                 const int32_T b,
...
static __global__ __launch_bounds__(1024, 1) void cwtfilterbank_wt_kernel16(
                      ...
                      emxArray_creal_T *varargout_1)
{
  ...
  emxInit_real_T(&b_x, 1, &sc_emlrtRTEI, true);
  bcoef = b_x->size[0];
  b_x->size[0] = x->size[0];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_x, bcoef, &sc_emlrtRTEI);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_xv, 2, &tc_emlrtRTEI, true);
  xv_outdatedOnGpu = false;
  bcoef = cpu_xv->size[0] * cpu_xv->size[1];
  cpu_xv->size[0] = 1;
  cpu_xv->size[1] = x->size[0];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(cpu_xv, bcoef, &tc_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
    emxInit_real_T(&cpu_x, 2, &wc_emlrtRTEI, true);
    xv_outdatedOnGpu = false;
    bcoef = cpu_x->size[0] * cpu_x->size[1];
    cpu_x->size[0] = 1;
    cpu_x->size[1] = i;
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_x, bcoef, &wc_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      cwtfilterbank_wt_kernel15<<<grid, block>>>(i, (i >> 1) - 1, gpu_x);
    }
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_xv, bcoef, &xc_emlrtRTEI);
    acoef = cpu_x->size[1];
  ...
  emxInit_creal_T(&cpu_xposdft, 2, &uc_emlrtRTEI, true);
  if (cpu_xv->size[1] == 0) {
    xv_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_creal_T(cpu_xposdft, bcoef, &uc_emlrtRTEI);
    ...
    cpu_xposdft->size[1] = cpu_xv->size[1];
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_xposdft, bcoef, &vc_emlrtRTEI);
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#cwtfilterbank_wt_kernel16#" MW_AT_LINE);
      cwtfilterbank_wt_kernel16<<<grid, block>>>(xSize[1], nd2 - 2,
                                                 gpu_xposdft);
    }
    xv_outdatedOnGpu = true;
  }
  ...
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_cfsposdft, 2, &bd_emlrtRTEI, true);
  x_outdatedOnCpu = false;
  ...
  nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
  emxEnsureCapacity_creal_T(cpu_cfsposdft, bcoef, &i_emlrtRTEI);
  ...
  if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(varargout_1, bcoef, &yc_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(varargout_1, bcoef, &ad_emlrtRTEI);
  }
