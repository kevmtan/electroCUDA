...
real_T numCpsi(const char_T wname[5], real_T varargin_1, real_T varargin_2)
{
  ...
  if (first_iteration) {
    ...
    if (!(pathlen > 0.0)) {
      ...
      err_ok = 0.0;
      first_iteration = true;
      emxInit_real_T(&b_x, 2, &jc_emlrtRTEI, true);
      emxInit_real_T(&c_x, 2, &pc_emlrtRTEI, true);
      emxInit_real_T(&xt, 2, &qc_emlrtRTEI, true);
      emxInit_real_T(&y, 2, &fd_emlrtRTEI, true);
      emxInit_real_T(&a, 2, &cd_emlrtRTEI, true);
      emxInit_real_T(&fx, 2, &gd_emlrtRTEI, true);
      emxInit_real_T(&d_x, 2, &dd_emlrtRTEI, true);
      emxInit_real_T(&b_a, 2, &cd_emlrtRTEI, true);
      emxInit_real_T(&e_x, 2, &ed_emlrtRTEI, true);
      emxInit_real_T(&f_x, 2, &hd_emlrtRTEI, true);
      do {
        real_T halfh;
        real_T midpt;
        boolean_T guard1;
        ...
        emxEnsureCapacity_real_T(b_x, ix, &jc_emlrtRTEI);
        ix = -1;
        for (k = 0; k <= nsubs; k++) {
          anorm = subs[k << 1];
          absxk = subs[(k << 1) + 1];
        ...
        emxEnsureCapacity_real_T(c_x, ix, &kc_emlrtRTEI);
        ...
        if (guard1) {
          ...
          a->size[0] = 1;
          a->size[1] = c_x->size[1];
          emxEnsureCapacity_real_T(a, ix, &cd_emlrtRTEI);
          ...
          d_x->size[0] = 1;
          d_x->size[1] = y->size[1];
          emxEnsureCapacity_real_T(d_x, ix, &dd_emlrtRTEI);
          ...
          emxEnsureCapacity_real_T(b_a, ix, &cd_emlrtRTEI);
          for (ix = 0; ix < c_x->size[1]; ix++) {
          ...
          emxEnsureCapacity_real_T(e_x, ix, &ed_emlrtRTEI);
          ...
          emxEnsureCapacity_real_T(f_x, ix, &n_emlrtRTEI);
          for (k = 0; k < nx; k++) {
