...
void ec_cwtAvg(ec_cwtAvgStackData *SD, const emxArray_real32_T *cpu_x,
               real_T fs, const real_T fLims[2], real_T fOctave,
               const real32_T ds[2], cell_wrap_0 y_data[], int32_T y_size[2],
