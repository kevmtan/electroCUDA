...
void firls(real_T varargin_1, const real_T varargin_2[4], emxArray_real_T *h)
{
  ...
  emxInit_real_T(&m, 2, &yd_emlrtRTEI, true);
  emxInit_real_T(&k, 1, &ae_emlrtRTEI, true);
  emxInit_real_T(&G, 2, &pe_emlrtRTEI, true);
  emxInit_real_T(&sinc1A, 2, &qe_emlrtRTEI, true);
  emxInit_real_T(&sinc2A, 2, &re_emlrtRTEI, true);
  emxInit_real_T(&sinc3A, 2, &se_emlrtRTEI, true);
  emxInit_real_T(&sinc4A, 2, &te_emlrtRTEI, true);
  emxInit_real_T(&b, 1, &ge_emlrtRTEI, true);
  emxInit_real_T(&cpu_a, 1, &ue_emlrtRTEI, true);
  emxInit_real_T(&b_dv, 1, &ve_emlrtRTEI, true);
  emxInit_real_T(&x, 1, &we_emlrtRTEI, true);
  emxInit_real_T(&b_dv1, 1, &ve_emlrtRTEI, true);
  emxInit_real_T(&y, 1, &xe_emlrtRTEI, true);
  emxInit_real_T(&b_y, 1, &ye_emlrtRTEI, true);
  emxInit_real_T(&b0, 1, &ie_emlrtRTEI, true);
  if ((!(max_freq > 1.0)) && (!(min_freq < 0.0))) {
    ...
    if (!Nodd) {
      ...
      emxEnsureCapacity_real_T(m, b_i, &yd_emlrtRTEI);
      ...
      m->size[0] = 1;
      m->size[1] = static_cast<int32_T>(L) + 1;
      emxEnsureCapacity_real_T(m, b_i, &xd_emlrtRTEI);
      for (b_i = 0; b_i <= static_cast<int32_T>(L); b_i++) {
        m->data[b_i] = b_i;
      }
    }
    ...
    if (a_outdatedOnGpu) {
      ...
      G->size[0] = k->size[0];
      G->size[1] = k->size[0];
      emxEnsureCapacity_real_T(G, b_i, &be_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      b_i = k->size[0];
      k->size[0] = nx - i;
      emxEnsureCapacity_real_T(k, b_i, &he_emlrtRTEI);
    } else {
      i1Start = 0;
    }
    b_i = b->size[0];
    ...
    for (int32_T s{0}; s < 2; s++) {
      ...
      emxEnsureCapacity_real_T(b_dv, b_i, &ke_emlrtRTEI);
      for (b_i = 0; b_i < k->size[0]; b_i++) {
      ...
      emxEnsureCapacity_real_T(b_dv1, b_i, &ke_emlrtRTEI);
      ...
      b_i = y->size[0];
      y->size[0] = k->size[0];
      emxEnsureCapacity_real_T(y, b_i, &ke_emlrtRTEI);
      for (b_i = 0; b_i < k->size[0]; b_i++) {
      ...
      b_i = b_y->size[0];
      b_y->size[0] = k->size[0];
      emxEnsureCapacity_real_T(b_y, b_i, &ke_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      emxEnsureCapacity_real_T(b0, b_i, &ie_emlrtRTEI);
      b0->data[0] = b_b0;
      loop_ub = b->size[0];
      for (b_i = 0; b_i < loop_ub; b_i++) {
      ...
      b_i = b->size[0];
      b->size[0] = b0->size[0];
      emxEnsureCapacity_real_T(b, b_i, &me_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      emxEnsureCapacity_real_T(cpu_a, b_i, &je_emlrtRTEI);
      for (b_i = 0; b_i < b->size[0]; b_i++) {
    ...
    if (Nodd) {
      ...
      emxEnsureCapacity_real_T(h, b_i, &ne_emlrtRTEI);
      ...
      emxEnsureCapacity_real_T(x, b_i, &le_emlrtRTEI);
      ...
      emxEnsureCapacity_real_T(h, b_i, &oe_emlrtRTEI);
      loop_ub = x->size[0];
      for (b_i = 0; b_i < loop_ub; b_i++) {
