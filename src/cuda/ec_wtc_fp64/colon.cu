...
static __global__ void eml_float_colon_kernel28(const real_T apnd,
                                                const int32_T n, const real_T a,
                                                const int32_T b,
                                                emxArray_real_T y);

// Function Definitions
static __global__ __launch_bounds__(1024, 1) void eml_float_colon_kernel28(
                     ...
                     boolean_T *y_outdatedOnGpu)
{
  ...
  real_T ndbl;
  int32_T nm1d2;
  nvtxRangePushA("#fcn#eml_float_colon#" MW_AT_LOCATION);
  ...
  *y_outdatedOnGpu = false;
  ...
  emxEnsureCapacity_real_T(cpu_y, nm1d2, &wd_emlrtRTEI);
    ...
    *y_outdatedOnGpu = true;
    if (static_cast<int32_T>(ndbl) > 1) {
      ...
      if (validLaunchParams) {
        nvtxMarkA("#eml_float_colon_kernel28#" MW_AT_LINE);
        eml_float_colon_kernel28<<<grid, block>>>(
