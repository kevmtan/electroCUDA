...
static __global__ void wcoherence_kernel25(const int32_T i, const int32_T b,
                                           emxArray_real_T x);
                               ...
                               const emxArray_creal_T *in3)
{
  ...
  emxEnsureCapacity_creal_T(in1, i, &mb_emlrtRTEI);
...
static __global__ __launch_bounds__(1024, 1) void wcoherence_kernel25(
                ...
                emxArray_creal_T *gpu_wcs, boolean_T *wcs_outdatedOnGpu)
{
  ...
  emxInit_creal_T(&cwtx, 2, &pb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&f, 1, &pb_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&coitmp, 1, &pb_emlrtRTEI, true);
  nvtxMarkA("#cwtfilterbank_wt#" MW_AT_LINE);
  cwtfilterbank_wt(&fb, x, cwtx, f, coitmp);
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  emxFree_real_T(&coitmp);
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  emxFree_real_T(&f);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&psihat, 2, &gb_emlrtRTEI, true);
  i = psihat->size[0] * psihat->size[1];
  psihat->size[0] = fb.PsiDFT->size[0];
  psihat->size[1] = fb.PsiDFT->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(psihat, i, &gb_emlrtRTEI);
  ...
  for (i = 0; i < fb.PsiDFT->size[0] * fb.PsiDFT->size[1]; i++) {
    psihat->data[i] = fb.PsiDFT->data[i];
  }
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  ...
  if (fb.SignalPad > 0.0) {
    ...
    gpuEmxEnsureCapacity_real_T(cpu_x, &gpu_x, !xposdft_outdatedOnCpu);
    if (xposdft_outdatedOnCpu) {
    ...
    if (validLaunchParams) {
      nvtxMarkA("#wcoherence_kernel25#" MW_AT_LINE);
      wcoherence_kernel25<<<grid, block>>>(b_i, (b_i >> 1) - 1, gpu_x);
    }
    xposdft_outdatedOnCpu = true;
    xv_outdatedOnGpu = false;
    i = cpu_xv->size[0] * cpu_xv->size[1];
  ...
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  emxFree_real_T(&psihat);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cfspos, 2, &rb_emlrtRTEI, true);
  ...
  if (fb.SignalPad > 0.0) {
    ...
    cfspos->size[1] = k - nd2;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cfspos, i, &jb_emlrtRTEI);
  }
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&g_y, 2, &sb_emlrtRTEI, true);
  i = g_y->size[0] * g_y->size[1];
  g_y->size[0] = cwtx->size[0];
  g_y->size[1] = cwtx->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(g_y, i, &h_emlrtRTEI);
  profileLoopStart("wcoherence_loop_5", __LINE__, (nd2 - 1) + 1, "");
  for (k = 0; k < nd2; k++) {
    nvtxMarkA("#rt_hypotd_snf#" MW_AT_LINE);
    g_y->data[k] = rt_hypotd_snf(cwtx->data[k].re, cwtx->data[k].im);
  }
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_y, 2, &sb_emlrtRTEI, true);
  xposdft_outdatedOnGpu = false;
  xposdft_outdatedOnCpu = false;
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(cpu_y, i, &kb_emlrtRTEI);
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&i_y, 2, &tb_emlrtRTEI, true);
  i = i_y->size[0] * i_y->size[1];
  i_y->size[0] = cfspos->size[0];
  i_y->size[1] = cfspos->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(i_y, i, &h_emlrtRTEI);
  profileLoopStart("wcoherence_loop_11", __LINE__, (nd2 - 1) + 1, "");
  for (k = 0; k < nd2; k++) {
    nvtxMarkA("#rt_hypotd_snf#" MW_AT_LINE);
    i_y->data[k] = rt_hypotd_snf(cfspos->data[k].re, cfspos->data[k].im);
  }
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_cpu_y, 2, &tb_emlrtRTEI, true);
  xv_outdatedOnGpu = false;
  xposdft_outdatedOnCpu = false;
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_cpu_y, i, &kb_emlrtRTEI);
  ...
  if ((cwtx->size[0] == cfspos->size[0]) &&
    ...
    *wcs_outdatedOnGpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_wcs, i, &mb_emlrtRTEI);
    profileLoopStart("wcoherence_loop_13", __LINE__,
                     (cwtx->size[0] * cwtx->size[1] - 1) + 1, "");
    for (i = 0; i < cwtx->size[0] * cwtx->size[1]; i++) {
      c_y = cfspos->data[i].re;
      maxperiod = -cfspos->data[i].im;
      cpu_wcs->data[i].re =
          cwtx->data[i].re * c_y - cwtx->data[i].im * maxperiod;
      cpu_wcs->data[i].im =
          cwtx->data[i].re * maxperiod + cwtx->data[i].im * c_y;
    ...
    if (*wcs_outdatedOnCpu) {
      nvtxMarkA("#gpuEmxMemcpyGpuToCpu_creal_T#" MW_AT_LINE);
      gpuEmxMemcpyGpuToCpu_creal_T(cpu_wcs, gpu_wcs);
    }
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&j_y, 2, &ub_emlrtRTEI, true);
  i = j_y->size[0] * j_y->size[1];
  j_y->size[0] = cpu_wcs->size[0];
  j_y->size[1] = cpu_wcs->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(j_y, i, &h_emlrtRTEI);
  ...
  for (k = 0; k < nd2; k++) {
    ...
    *wcs_outdatedOnCpu = false;
    nvtxMarkA("#rt_hypotd_snf#" MW_AT_LINE);
    j_y->data[k] = rt_hypotd_snf(cpu_wcs->data[k].re, cpu_wcs->data[k].im);
  }
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&k_y, 2, &ub_emlrtRTEI, true);
  i = k_y->size[0] * k_y->size[1];
  k_y->size[0] = j_y->size[0];
  k_y->size[1] = j_y->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(k_y, i, &kb_emlrtRTEI);
  ...
  if ((cpu_y->size[0] == b_cpu_y->size[0]) &&
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(wcoh, i, &nb_emlrtRTEI);
