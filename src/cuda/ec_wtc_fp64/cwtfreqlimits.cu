                     ...
                     real_T *minscale, real_T *maxfreq, real_T *minperiod)
{
  ...
  nvtxRangePushA("#fcn#cwtfreqlimits#" MW_AT_LOCATION);
  T = 1.0 / varargin_1;
  *maxscale = N / 2.8284271247461903;
  ...
  if (psihat_workspace_alpha - 2.0 > 0.0) {
    ...
    if (psihat_workspace_alpha - 2.0 == 0.0) {
      ...
      d = 0.0;
      exitg1 = false;
      nvtxRangePushA("#loop#cwtfreqlimits_whileloop_0##" MW_AT_LINE);
...
real_T getFreqFromCutoffAmor(real_T cutoff, real_T cf)
{
  ...
  real_T omegac;
  real_T psihat_workspace_alpha;
  nvtxRangePushA("#fcn#getFreqFromCutoffAmor#" MW_AT_LOCATION);
  ...
  if (psihat_workspace_alpha - 2.0 * std::exp(-(a * a) / 2.0) > 0.0) {
    ...
    if (fa == 0.0) {
      ...
      d = 0.0;
      exitg1 = false;
      nvtxRangePushA("#loop#getFreqFromCutoffAmor_whileloop_0##" MW_AT_LINE);
      while ((!exitg1) && ((fb != 0.0) && (a != omegac))) {
        real_T m;
        real_T toler;
        if ((fb > 0.0) == (fc > 0.0)) {
...
real_T getFreqFromCutoffBump(real_T cutoff, real_T cf)
{
  real_T omegac;
  int32_T exponent;
  nvtxRangePushA("#fcn#getFreqFromCutoffBump#" MW_AT_LOCATION);
  if (cutoff < 4.94065645841247E-323) {
    ...
    if (fa == 0.0) {
      ...
      d = 0.0;
      exitg1 = false;
      nvtxRangePushA("#loop#getFreqFromCutoffBump_whileloop_0##" MW_AT_LINE);
