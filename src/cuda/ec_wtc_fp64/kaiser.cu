...
void kaiser(real_T N, emxArray_real_T *w)
{
  ...
  int32_T iseven;
  int32_T nw;
  nvtxRangePushA("#fcn#kaiser#" MW_AT_LOCATION);
  if (N == std::floor(N)) {
  ...
  if (nw <= 1) {
    ...
    w->size[0] = nw;
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(w, iseven, &pf_emlrtRTEI);
    profileLoopStart("kaiser_loop_0", __LINE__, (nw - 1) + 1, "");
    ...
    profileLoopStart("kaiser_loop_1", __LINE__, b + 1L, "");
            ...
            if (r < 2.2250738585072014E-305) {
              ...
              if (hz_re > -700.92179369444591) {
                ...
                if (!(acz < 2.2204460492503131E-16)) {
                  ...
                  s = 1.0;
                  aa = 2.0;
                  nvtxRangePushA("#loop#kaiser_whileloop_0##" MW_AT_LINE);
                  real_T re;
                  real_T rs;
                  do {
                    rs = 1.0 / s;
    ...
    profileLoopEnd();
    profileLoopStart("kaiser_loop_2", __LINE__, (mid - 2) + 1, "");
