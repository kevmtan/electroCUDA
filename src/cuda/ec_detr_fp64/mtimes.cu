  ...
  if ((cpu_A->size[0] == 0) || (cpu_A->size[1] == 0) || (cpu_B->size[0] == 0)) {
    ...
    *B_outdatedOnGpu = false;
    cublasDgemm(getCublasGlobalHandle(), CUBLAS_OP_N, CUBLAS_OP_N,
                cpu_A->size[0], 1, cpu_A->size[1], (double *)&alpha1,
                (double *)&gpu_A->data[0], cpu_A->size[0],
                (double *)&gpu_B->data[0], cpu_A->size[1], (double *)&beta1,
  ...
  if ((cpu_A->size[0] == 0) || (cpu_A->size[1] == 0) || (cpu_B->size[0] == 0) ||
    ...
    *B_outdatedOnGpu = false;
    cublasDgemm(getCublasGlobalHandle(), CUBLAS_OP_N, CUBLAS_OP_N,
                ...
                (double *)&alpha1, (double *)&gpu_A->data[0], cpu_A->size[0],
                (double *)&gpu_B->data[0], cpu_A->size[1], (double *)&beta1,
                (double *)&gpu_C->data[0], cpu_A->size[0]);
    *C_outdatedOnGpu = false;
    *C_outdatedOnCpu = true;
