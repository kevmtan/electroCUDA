...
//
// ec_detr_fp_initialize.cu
//
// Code generation for function 'ec_detr_fp_initialize'
//
...
static void ec_detr_fp_once();

// Function Definitions
static void ec_detr_fp_once()
{
  mex_InitInfAndNan();
  nvtxRangePushA("#initFcn#ec_detr_fp_once#" MW_AT_LOCATION);
...
void ec_detr_fp_initialize()
{
  nvtxRangePushA("#fcn#ec_detr_fp_initialize#" MW_AT_LOCATION);
  ...
  if (emlrtFirstTimeR2012b(emlrtRootTLSGlobal)) {
    nvtxMarkA("#ec_detr_fp_once#" MW_AT_LINE);
    ec_detr_fp_once();
  }
  nvtxRangePop();
}

// End of code generation (ec_detr_fp_initialize.cu)
