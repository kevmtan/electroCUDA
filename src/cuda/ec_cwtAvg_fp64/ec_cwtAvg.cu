...
static emlrtRTEInfo mb_emlrtRTEI{ 211, // lineNo
  24,                                  // colNo
  "trapz",                             // fName
  "/usr/local/MATLAB/R2023a/toolbox/eml/lib/matlab/datafun/trapz.m"// pName
};
...
static emlrtRTEInfo sb_emlrtRTEI{ 95,  // lineNo
  1,                                   // colNo
  "sprintf",                           // fName
  "/usr/local/MATLAB/R2023a/toolbox/eml/lib/matlab/strfun/sprintf.m"// pName
};
...
static emlrtRTEInfo cc_emlrtRTEI{ 287, // lineNo
  5,                                   // colNo
  "scaleSpectrum",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/scaleSpectrum.m"// pName
};
...
static __global__ void ec_cwtAvg_kernel10(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel100(const emxArray_real_T x, int32_T
  bcoef, emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel101(const emxArray_real_T xt, const
  emxArray_real_T x, const emxArray_real_T y, int32_T b_y, emxArray_real_T fx);
static __global__ void ec_cwtAvg_kernel102(int16_T dv2_idx_1, emxArray_real_T fx);
static __global__ void ec_cwtAvg_kernel103(const emxArray_creal_T cfspos,
  int32_T bcoef, emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel104(const emxArray_real_T y, int32_T
  bcoef, emxArray_real_T abscfssq);
static __global__ void ec_cwtAvg_kernel105(const emxArray_real_T abscfssq,
  int32_T b_abscfssq, emxArray_real_T a);
static __global__ void ec_cwtAvg_kernel106(const emxArray_real_T fb_Scales,
  const emxArray_real_T a, const int32_T acoef, const int32_T abscfssq, int32_T
  nbytes, emxArray_real_T b_abscfssq, int32_T a_dim0, int32_T fb_Scales_dim1,
  int32_T abscfssq_dim0);
static __global__ void ec_cwtAvg_kernel107(uint32_T N, emxArray_uint32_T y);
static __global__ void ec_cwtAvg_kernel108(int32_T abscfssq, emxArray_real_T z);
static __global__ void ec_cwtAvg_kernel109(const emxArray_uint32_T y,
  emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel11(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel110(const emxArray_uint32_T y, int32_T
...
static __global__ void ec_cwtAvg_kernel112(const emxArray_uint32_T y, int32_T
  nbytes, emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel113(const real_T r, emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel114(const real_T r, emxArray_real_T c,
  int32_T abscfssq_dim1);
static __global__ void ec_cwtAvg_kernel115(const emxArray_real_T fb_Scales,
  emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel116(const emxArray_real_T fb_Scales,
...
static __global__ void ec_cwtAvg_kernel118(const emxArray_real_T fb_Scales,
  int32_T nbytes, emxArray_real_T c);
...
static __global__ void ec_cwtAvg_kernel120(const real_T r, emxArray_real_T c,
  int32_T z_dim0);
static __global__ void ec_cwtAvg_kernel121(const real_T a, int32_T k,
  emxArray_creal_T cfspos);
static __global__ void ec_cwtAvg_kernel122(const emxArray_creal_T cfspos,
  int32_T bcoef, emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel123(const emxArray_real_T y, int32_T
  bcoef, emxArray_real_T abswt2);
static __global__ void ec_cwtAvg_kernel124(const emxArray_real_T fb_Scales,
  ...
  int32_T nbytes, emxArray_real_T b_abswt2S, int32_T abswt2_dim0, int32_T
  fb_Scales_dim1, int32_T abswt2S_dim0);
static __global__ void ec_cwtAvg_kernel125(int32_T abswt2S, emxArray_real_T
  savgpTMP);
static __global__ void ec_cwtAvg_kernel126(const emxArray_real_T fb_Scales,
  emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel127(const emxArray_real_T fb_Scales,
  int32_T nbytes, emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel128(const emxArray_real_T fb_Scales,
  emxArray_real_T c, int32_T abswt2S_dim0);
static __global__ void ec_cwtAvg_kernel129(const emxArray_real_T fb_Scales,
  int32_T nbytes, emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel13(const emxArray_real_T a, int32_T bcoef,
  emxArray_real_T dv3);
static __global__ void ec_cwtAvg_kernel130(const real_T r, emxArray_real_T c);
static __global__ void ec_cwtAvg_kernel131(const real_T r, emxArray_real_T c,
  int32_T abswt2S_dim0);
static __global__ void ec_cwtAvg_kernel14(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
...
static __global__ void ec_cwtAvg_kernel2(const real_T fLims[2], real_T
  freqrange[2]);
static __global__ void ec_cwtAvg_kernel20(const int32_T bcoef, real_T interval
  [650]);
...
static __global__ void ec_cwtAvg_kernel23(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T dv9);
static __global__ void ec_cwtAvg_kernel24(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
...
static __global__ void ec_cwtAvg_kernel31(const uint32_T N, int32_T k,
...
static __global__ void ec_cwtAvg_kernel33(const emxArray_real_T omega, int32_T
  nsubs, emxArray_real_T r);
static __global__ void ec_cwtAvg_kernel34(const int32_T nbytes, const int32_T
  acoef, const emxArray_real_T omega, int32_T nsubs, emxArray_real_T r, int32_T
  omega_dim1);
...
static __global__ void ec_cwtAvg_kernel4(const char_T cv[128], char_T wav[5],
  char_T b_dim0, char_T b_dim1, char_T b_dim2, char_T b_dim3, char_T b_dim4);
static __global__ void ec_cwtAvg_kernel40(const int32_T bcoef, real_T interval
  [650]);
...
static __global__ void ec_cwtAvg_kernel42(const emxArray_real_T x, int32_T
  nbytes, emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ec_cwtAvg_kernel43(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel44(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel45(const emxArray_real_T y, const
  emxArray_real_T b_y, int32_T c_y, emxArray_real_T a);
static __global__ void ec_cwtAvg_kernel46(const emxArray_real_T a, int32_T bcoef,
  emxArray_real_T dv10);
static __global__ void ec_cwtAvg_kernel47(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
...
static __global__ void ec_cwtAvg_kernel53(const int32_T bcoef, real_T interval
  [650]);
...
static __global__ void ec_cwtAvg_kernel55(const emxArray_real_T x, int32_T
  nbytes, emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ec_cwtAvg_kernel56(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T dv14);
static __global__ void ec_cwtAvg_kernel57(const emxArray_real_T x, int32_T bcoef,
  emxArray_real_T y);
...
static __global__ void ec_cwtAvg_kernel62(const emxArray_real_T y, const real_T
  delta, int32_T bcoef, emxArray_real_T b_y);
...
static __global__ void ec_cwtAvg_kernel66(const emxArray_real_T y, const real_T
  r, int32_T bcoef, emxArray_real_T b_y);
...
static __global__ void ec_cwtAvg_kernel7(const int32_T bcoef, real_T interval
  [650]);
static __global__ void ec_cwtAvg_kernel70(const emxArray_real_T omega, const
  emxArray_real_T fb_Scales, const int32_T b_fb_Scales, int32_T nsubs,
...
static __global__ void ec_cwtAvg_kernel73(int32_T bcoef, emxArray_real_T
  absomega);
...
static __global__ void ec_cwtAvg_kernel75(int32_T bcoef, emxArray_real_T x);
...
static __global__ void ec_cwtAvg_kernel77(const emxArray_real_T fb_Scales,
  int32_T b_fb_Scales, emxArray_real_T f);
static __global__ void ec_cwtAvg_kernel78(const real_T fs, int32_T k,
  emxArray_real_T f);
...
static __global__ void ec_cwtAvg_kernel8(const real_T interval[650], int32_T
  nsubs, real_T subs[1298]);
static __global__ void ec_cwtAvg_kernel80(const int32_T nbytes, const
  emxArray_real_T x, int32_T b_x, emxArray_real_T xv, int32_T x_dim0);
static __global__ void ec_cwtAvg_kernel81(const int32_T nbytes, const
  emxArray_real_T x, real_T y, emxArray_real_T b_x, int32_T x_dim0);
static __global__ void ec_cwtAvg_kernel82(const emxArray_real_T x, int32_T nsubs,
  emxArray_real_T xv);
static __global__ void ec_cwtAvg_kernel83(const emxArray_real_T xv, int32_T b_xv,
  emxArray_creal_T xposdft);
static __global__ void ec_cwtAvg_kernel84(const emxArray_creal_T xposdft, const
  ...
  cfsposdft_dim0);
static __global__ void ec_cwtAvg_kernel85(const real_T cfsposdft_re, const
  emxArray_creal_T cfsposdft, int32_T b_cfsposdft, emxArray_creal_T cfspos);
static __global__ void ec_cwtAvg_kernel86(uint32_T xSize[2], int32_T
  cfsposdft_dim1);
static __global__ void ec_cwtAvg_kernel87(int32_T xSize, emxArray_creal_T cfspos);
static __global__ void ec_cwtAvg_kernel88(char_T wav[5]);
static __global__ void ec_cwtAvg_kernel89(char_T wav[5], char_T b_dim0, char_T
...
static __global__ void ec_cwtAvg_kernel90(const char_T wav[5], char_T wavname[5]);
static __global__ void ec_cwtAvg_kernel91(real_T interval[650]);
static __global__ void ec_cwtAvg_kernel92(real_T interval[650]);
static __global__ void ec_cwtAvg_kernel93(const int32_T bcoef, real_T interval
  [650]);
static __global__ void ec_cwtAvg_kernel94(const real_T interval[650], int32_T
  nsubs, real_T subs[1298]);
static __global__ void ec_cwtAvg_kernel95(const emxArray_real_T x, int32_T
  nbytes, emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ec_cwtAvg_kernel96(const emxArray_real_T x, int32_T b_x,
  emxArray_real_T a);
static __global__ void ec_cwtAvg_kernel97(const emxArray_real_T a, int32_T bcoef,
  emxArray_real_T y);
static __global__ void ec_cwtAvg_kernel98(const emxArray_real_T y, int32_T b_y,
  emxArray_real_T x);
static __global__ void ec_cwtAvg_kernel99(const emxArray_real_T x, int32_T b_x,
  emxArray_real_T c_x);
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel102(int16_T
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel104(const
  emxArray_real_T y, int32_T bcoef, emxArray_real_T abscfssq)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel106(const
  ...
  int32_T abscfssq, int32_T nbytes, emxArray_real_T b_abscfssq, int32_T a_dim0,
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel107(uint32_T N,
  emxArray_uint32_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel108(int32_T
  abscfssq, emxArray_real_T z)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_2;
    varargin_2 = static_cast<int32_T>(idx);
    z.data[varargin_2] = 0.0;
  }
}

static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel109(const
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel113(const real_T
  r, emxArray_real_T c)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel114(const real_T
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel115(const
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel116(const
  emxArray_real_T fb_Scales, int32_T nbytes, emxArray_real_T c)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel117(const
  ...
  emxArray_real_T fb_Scales, int32_T nbytes, emxArray_real_T c)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_2;
    varargin_2 = static_cast<int32_T>(idx);
    c.data[varargin_2] = fb_Scales.data[0];
  }
}
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel120(const real_T
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel121(const
  real_T a, int32_T k, emxArray_creal_T cfspos)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_2;
    varargin_2 = static_cast<int32_T>(idx);
    cfspos.data[varargin_2].re *= a;
    cfspos.data[varargin_2].im *= a;
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel123(const
  emxArray_real_T y, int32_T bcoef, emxArray_real_T abswt2)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel124(const
  ...
  const int32_T abswt2S, int32_T nbytes, emxArray_real_T b_abswt2S, int32_T
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel125(int32_T
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel130(const real_T
  r, emxArray_real_T c)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel131(const real_T
  r, emxArray_real_T c, int32_T abswt2S_dim0)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel23(const
  emxArray_real_T x, int32_T bcoef, emxArray_real_T dv9)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel33(const
  emxArray_real_T omega, int32_T nsubs, emxArray_real_T r)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel34(const
  int32_T nbytes, const int32_T acoef, const emxArray_real_T omega, int32_T
  nsubs, emxArray_real_T r, int32_T omega_dim1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_2;
    varargin_2 = static_cast<int32_T>(idx);
    r.data[(varargin_2 + omega_dim1) + 1] = -omega.data[acoef + nbytes *
      varargin_2];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel46(const
  emxArray_real_T a, int32_T bcoef, emxArray_real_T dv10)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel56(const
  emxArray_real_T x, int32_T bcoef, emxArray_real_T dv14)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel62(const
  emxArray_real_T y, const real_T delta, int32_T bcoef, emxArray_real_T b_y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel70(const
  ...
  b_fb_Scales, int32_T nsubs, emxArray_real_T somega, int32_T somega_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel80(const
  int32_T nbytes, const emxArray_real_T x, int32_T b_x, emxArray_real_T xv,
  int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel81(const
  int32_T nbytes, const emxArray_real_T x, real_T y, emxArray_real_T b_x,
  int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel82(const
  emxArray_real_T x, int32_T nsubs, emxArray_real_T xv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  emxArray_real_T xv, int32_T b_xv, emxArray_creal_T xposdft)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    xposdft.data[varargin_2].im = 0.0;
  }
}
  ...
  psidft_dim0, int32_T cfsposdft_dim0)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    b_cfsposdft.data[b_k + cfsposdft_dim0 * k].re = psidft.data[b_bcoef * b_k +
      psidft_dim0 * (acoef - 1)] * xposdft.data[k].re;
    b_cfsposdft.data[b_k + cfsposdft_dim0 * k].im = psidft.data[b_bcoef * b_k +
      psidft_dim0 * (acoef - 1)] * xposdft.data[k].im;
  }
}
  ...
  emxArray_creal_T cfspos)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    int32_T varargin_2;
    varargin_2 = static_cast<int32_T>(idx);
    tk2 = cfsposdft.data[varargin_2].re;
    tkd1mtk = cfsposdft.data[varargin_2].im;
    if (tkd1mtk == 0.0) {
      cfspos.data[varargin_2].re = tk2 / cfsposdft_re;
      cfspos.data[varargin_2].im = 0.0;
    } else if (tk2 == 0.0) {
      cfspos.data[varargin_2].re = 0.0;
      cfspos.data[varargin_2].im = tkd1mtk / cfsposdft_re;
    } else {
      cfspos.data[varargin_2].re = tk2 / cfsposdft_re;
      cfspos.data[varargin_2].im = tkd1mtk / cfsposdft_re;
    }
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel86(uint32_T
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel87(int32_T
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel88(char_T wav[5])
{
  uint64_T threadId;
  int32_T varargin_2;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel89(char_T wav[5],
  char_T b_dim0, char_T b_dim1, char_T b_dim2, char_T b_dim3, char_T b_dim4)
{
  __shared__ char_T b_shared[5];
  uint64_T threadId;
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel90(const char_T
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel91(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(512, 1) void ec_cwtAvg_kernel92(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T k;
...
static __global__ __launch_bounds__(32, 1) void ec_cwtAvg_kernel93(const int32_T
  bcoef, real_T interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwtAvg_kernel97(const
  emxArray_real_T a, int32_T bcoef, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
               ...
               real_T fOctave, emxArray_real_T *cpu_freqs)
{
  ...
  if (first_iteration) {
    if (cpu_x->size[0] <= 100000) {
      ...
      delta = std::frexp(static_cast<real_T>(cpu_x->size[0]), &nbytes);
      if (delta == 0.5) {
        y = static_cast<real_T>(nbytes) - 1.0;
      } else {
        y = std::log(delta) / 0.69314718055994529 + static_cast<real_T>(nbytes);
      }
  ...
  if (!first_iteration) {
    ...
    ec_cwtAvg_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(fs,
      *gpu_NyquistRange);
    b_dirtyOnGpu = true;
    emxInit_char_T(&str, 2, &sb_emlrtRTEI, true);
    guard1 = false;
    if (cpu_fLims[1] <= 0.0) {
      guard1 = true;
    } else {
    ...
    if (guard1) {
      ...
      nbytes = (int32_T)emlrtMexSnprintf(nullptr, 0, "%f", cpu_NyquistRange[1])
        + 1;
      k = str->size[0] * str->size[1];
      str->size[0] = 1;
      str->size[1] = nbytes;
      emxEnsureCapacity_char_T(str, k, &b_emlrtRTEI);
     ...
     case 0:
      ...
      if (std::isinf(r) || std::isnan(r)) {
        ...
        if (nsubs + 1 < 2) {
          ...
          ec_cwtAvg_kernel7<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(bcoef,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (acoef <= 0) {
          ...
          emxInit_real_T(&cpu_xt, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_y, 2, &fc_emlrtRTEI, true);
          emxInit_real_T(&cpu_fx, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_y, 2, &gc_emlrtRTEI, true);
          emxInit_real_T(&cpu_a, 2, &q_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv3, 2, &ic_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_y, 2, &jc_emlrtRTEI, true);
          ...
          do {
            ...
            emxEnsureCapacity_real_T(b_cpu_x, k, &g_emlrtRTEI);
            if (!b_x_dirtyOnCpu) {
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              for (j = 0; j < 15; j++) {
                b_cpu_x->data[(nbytes + j) + 1] = NODES[j] * cpu_halfh + c_r;
                b_x_dirtyOnCpu = true;
              }
            ...
            k = c_cpu_x->size[0] * c_cpu_x->size[1];
            c_cpu_x->size[0] = 1;
            c_cpu_x->size[1] = b_cpu_x->size[1];
            emxEnsureCapacity_real_T(c_cpu_x, k, &h_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(c_cpu_x, &o_gpu_x);
            k = cpu_xt->size[0] * cpu_xt->size[1];
            cpu_xt->size[0] = 1;
            cpu_xt->size[1] = b_cpu_x->size[1];
            emxEnsureCapacity_real_T(cpu_xt, k, &i_emlrtRTEI);
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                emxEnsureCapacity_real_T(cpu_fx, k, &m_emlrtRTEI);
                if (!fx_dirtyOnCpu) {
            ...
            if (b_guard1) {
              ...
              emxEnsureCapacity_real_T(cpu_y, k, &k_emlrtRTEI);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel10<<<grid, block>>>(o_gpu_x, bcoef, o_gpu_y);
                y_dirtyOnGpu = true;
              }
              ...
              emxEnsureCapacity_real_T(b_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(b_cpu_y, &p_gpu_y);
              bcoef = c_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel11<<<grid, block>>>(o_gpu_x, bcoef, p_gpu_y);
                b_y_dirtyOnGpu = true;
              }
              ...
              if (cpu_y->size[1] == b_cpu_y->size[1]) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ec_cwtAvg_kernel12<<<grid, block>>>(p_gpu_y, o_gpu_y, bcoef,
                    d_gpu_a);
                  a_dirtyOnGpu = true;
                  a_dirtyOnCpu = false;
                }
              ...
              k = cpu_dv3->size[0] * cpu_dv3->size[1];
              cpu_dv3->size[0] = 1;
              ...
              if (b_dirtyOnGpu) {
                ...
                a_dirtyOnCpu = false;
                ec_cwtAvg_kernel13<<<grid, block>>>(d_gpu_a, bcoef, gpu_dv3);
                dv3_dirtyOnGpu = true;
              }
              ...
              emxEnsureCapacity_real_T(c_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(c_cpu_y, &q_gpu_y);
              bcoef = c_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel14<<<grid, block>>>(o_gpu_x, bcoef, q_gpu_y);
              }

              k = cpu_dv6->size[0] * cpu_dv6->size[1];
              cpu_dv6->size[0] = 1;
              cpu_dv6->size[1] = c_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv6, k, &w_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv6, &gpu_dv6);
              bcoef = c_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
                1L), &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel15<<<grid, block>>>(q_gpu_y, bcoef, gpu_dv6);
                dv6_dirtyOnGpu = true;
              }
              ...
              if (cpu_dv3->size[1] == cpu_dv6->size[1]) {
                ...
                emxEnsureCapacity_real_T(cpu_fx, k, &ab_emlrtRTEI);
                if (!fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(cpu_fx, &e_gpu_fx);
                }

                bcoef = cpu_dv3->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef
                  + 1L), &grid, &block, 1024U, 65535U);
                if (b_dirtyOnGpu) {
                  if (fx_dirtyOnCpu) {
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                subs_dirtyOnGpu = false;
                cpu_halfh = (cpu_subs[(k << 1) + 1] - cpu_subs[k << 1]) / 2.0;
                maxScale *= cpu_halfh;
                qsub[k] = maxScale;
                c_r += maxScale;
                errsub[k] = r * cpu_halfh;
              }
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                subs_dirtyOnGpu = false;
                if (delta <= c_r * ((cpu_subs[(k << 1) + 1] - cpu_subs[k << 1]) /
                                    2.0)) {
                  err_ok += maxScale;
                  q_ok += qsub[k];
                } else {
        ...
        if (nsubs + 1 < 2) {
          ...
          ec_cwtAvg_kernel20<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(bcoef,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (acoef <= 0) {
          ...
          emxInit_real_T(&b_cpu_xt, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv9, 2, &kc_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_fx, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&f_cpu_y, 2, &lc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv11, 2, &kc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            k = d_cpu_x->size[0] * d_cpu_x->size[1];
            d_cpu_x->size[0] = 1;
            d_cpu_x->size[1] = 15 * nsubs;
            emxEnsureCapacity_real_T(d_cpu_x, k, &g_emlrtRTEI);
            if (!c_x_dirtyOnCpu) {
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              cpu_halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                d_cpu_x->data[(nbytes + j) + 1] = NODES[j] * cpu_halfh + c_r;
                c_x_dirtyOnCpu = true;
              }
            ...
            emxEnsureCapacity_real_T(e_cpu_x, k, &h_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(e_cpu_x, &m_gpu_x);
            k = b_cpu_xt->size[0] * b_cpu_xt->size[1];
            b_cpu_xt->size[0] = 1;
            b_cpu_xt->size[1] = d_cpu_x->size[1];
            emxEnsureCapacity_real_T(b_cpu_xt, k, &i_emlrtRTEI);
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                k = b_cpu_fx->size[0] * b_cpu_fx->size[1];
                b_cpu_fx->size[0] = 1;
                b_cpu_fx->size[1] = d_cpu_x->size[1];
                emxEnsureCapacity_real_T(b_cpu_fx, k, &m_emlrtRTEI);
                if (!b_fx_dirtyOnCpu) {
            ...
            if (b_guard1) {
              first_iteration = false;
              k = cpu_dv9->size[0] * cpu_dv9->size[1];
              cpu_dv9->size[0] = 1;
              cpu_dv9->size[1] = e_cpu_x->size[1];
              emxEnsureCapacity_real_T(cpu_dv9, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv9, &gpu_dv9);
              bcoef = e_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel23<<<grid, block>>>(m_gpu_x, bcoef, gpu_dv9);
                dv9_dirtyOnGpu = true;
              }
              ...
              emxEnsureCapacity_real_T(f_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(f_cpu_y, &n_gpu_y);
              bcoef = e_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel24<<<grid, block>>>(m_gpu_x, bcoef, n_gpu_y);
              }

              k = cpu_dv11->size[0] * cpu_dv11->size[1];
              cpu_dv11->size[0] = 1;
              cpu_dv11->size[1] = f_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv11, k, &x_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv11, &gpu_dv11);
              bcoef = f_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
                1L), &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel25<<<grid, block>>>(n_gpu_y, bcoef, gpu_dv11);
              ...
              if (cpu_dv9->size[1] == cpu_dv11->size[1]) {
                ...
                emxEnsureCapacity_real_T(b_cpu_fx, k, &ab_emlrtRTEI);
                if (!b_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(b_cpu_fx, &d_gpu_fx);
                }

                j = cpu_dv9->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(j +
                  1L), &grid, &block, 1024U, 65535U);
                if (b_dirtyOnGpu) {
                  if (b_fx_dirtyOnCpu) {
                    gpuEmxMemcpyCpuToGpu_real_T(&d_gpu_fx, b_cpu_fx);
    ...
    if (cpu_fLims[0] < c_r) {
      ec_cwtAvg_kernel28<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(c_r,
    ...
    {
      delta = std::frexp(cpu_freqrange[1], &eint);
      if (delta == 0.5) {
        r = static_cast<real_T>(eint) - 1.0;
      } else if ((eint == 1) && (delta < 0.75)) {
        r = std::log(2.0 * delta) / 0.69314718055994529;
      } else {
        r = std::log(delta) / 0.69314718055994529 + static_cast<real_T>(eint);
      }
    } else {
      r = cpu_freqrange[1];
    }
    ...
    if ((!std::isinf(cpu_freqrange[0])) && (!std::isnan(cpu_freqrange[0]))) {
      delta = std::frexp(cpu_freqrange[0], &b_eint);
      if (delta == 0.5) {
        c_r = static_cast<real_T>(b_eint) - 1.0;
      } else if ((b_eint == 1) && (delta < 0.75)) {
        c_r = std::log(2.0 * delta) / 0.69314718055994529;
      } else {
        c_r = std::log(delta) / 0.69314718055994529 + static_cast<real_T>(b_eint);
      }
    } else {
      c_r = cpu_freqrange[0];
    }
    ...
    if (!(r - c_r >= 1.0 / fb_VoicesPerOctave)) {
      c_r = 1.0 / fb_VoicesPerOctave;
      nbytes = (int32_T)emlrtMexSnprintf(nullptr, 0, "%2.2f", c_r) + 1;
      emxInit_char_T(&b_str, 2, &sb_emlrtRTEI, true);
      k = b_str->size[0] * b_str->size[1];
      b_str->size[0] = 1;
      b_str->size[1] = nbytes;
      emxEnsureCapacity_char_T(b_str, k, &b_emlrtRTEI);
      emlrtMexSnprintf(&b_str->data[0], (size_t)nbytes, "%2.2f", c_r);
  ...
  if (nbytes < 1) {
    ...
    emxEnsureCapacity_real_T(cpu_omega, k, &c_emlrtRTEI);
  ...
  k = cpu_omega->size[0] * cpu_omega->size[1];
  cpu_omega->size[0] = 1;
  emxEnsureCapacity_real_T(cpu_omega, k, &d_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(cpu_omega, &gpu_omega);
  k = cpu_omega->size[1] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_cwtAvg_kernel31<<<grid, block>>>(N, k, gpu_omega);
    omega_dirtyOnGpu = true;
  }
  ...
  cpu_r->size[0] = 1;
  cpu_r->size[1] = (cpu_omega->size[1] + div_s32(bcoef - acoef, nbytes)) + 2;
  emxEnsureCapacity_real_T(cpu_r, k, &e_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(cpu_r, &gpu_r);
  ec_cwtAvg_kernel32<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(gpu_r);
  nsubs = cpu_omega->size[1];
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nsubs), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_cwtAvg_kernel33<<<grid, block>>>(gpu_omega, nsubs, gpu_r);
  }

  nsubs = div_s32(bcoef - acoef, nbytes);
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nsubs + 1L), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_cwtAvg_kernel34<<<grid, block>>>(nbytes, acoef, gpu_omega, nsubs, gpu_r,
      cpu_omega->size[1U]);
  }
  ...
  emxEnsureCapacity_real_T(cpu_omega, k, &f_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(cpu_omega, &gpu_omega);
  bcoef = cpu_r->size[1] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_cwtAvg_kernel35<<<grid, block>>>(gpu_r, bcoef, gpu_omega);
    omega_dirtyOnGpu = true;
  }
  ...
  if (!first_iteration) {
    ...
    if (c_r == 0.0) {
      ...
      c_r = std::frexp(c_r, &c_eint);
      if (c_r == 0.5) {
        c_r = static_cast<real_T>(c_eint) - 1.0;
      } else if ((c_eint == 1) && (c_r < 0.75)) {
        c_r = std::log(2.0 * c_r) / 0.69314718055994529;
      } else {
        c_r = std::log(c_r) / 0.69314718055994529 + static_cast<real_T>(c_eint);
      }
    }

    emxInit_real_T(&d_cpu_y, 2, &tb_emlrtRTEI, true);
    c_r *= fb_VoicesPerOctave;
    if (std::isnan(c_r)) {
      k = d_cpu_y->size[0] * d_cpu_y->size[1];
      d_cpu_y->size[0] = 1;
      d_cpu_y->size[1] = 1;
      emxEnsureCapacity_real_T(d_cpu_y, k, &j_emlrtRTEI);
      ...
      gpuEmxEnsureCapacity_real_T(d_cpu_y, &gpu_y);
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>
        (static_cast<int64_T>(c_r) + 1L), &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel65<<<grid, block>>>(c_r, gpu_y);
      }
    }

    emxInit_real_T(&e_cpu_y, 2, &ub_emlrtRTEI, true);
    k = e_cpu_y->size[0] * e_cpu_y->size[1];
    e_cpu_y->size[0] = 1;
    e_cpu_y->size[1] = d_cpu_y->size[1];
    emxEnsureCapacity_real_T(e_cpu_y, k, &k_emlrtRTEI);
    ...
    k = cpu_fb_Scales->size[0] * cpu_fb_Scales->size[1];
    cpu_fb_Scales->size[0] = 1;
    cpu_fb_Scales->size[1] = e_cpu_y->size[1];
    emxEnsureCapacity_real_T(cpu_fb_Scales, k, &l_emlrtRTEI);
    ...
    if (b_dirtyOnGpu) {
      ...
      ec_cwtAvg_kernel67<<<grid, block>>>(b_gpu_y, gpu_halfh, bcoef,
        gpu_fb_Scales);
     ...
     case 0:
      ...
      if (std::isinf(r) || std::isnan(r)) {
        ...
        if (nsubs + 1 < 2) {
          ...
          ec_cwtAvg_kernel40<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(bcoef,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (acoef <= 0) {
          ...
          emxInit_real_T(&c_cpu_xt, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&i_cpu_y, 2, &fc_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_fx, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&j_cpu_y, 2, &gc_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_a, 2, &q_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv10, 2, &ic_emlrtRTEI, true);
          emxInit_real_T(&k_cpu_y, 2, &jc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv12, 2, &ic_emlrtRTEI, true);
          do {
            exitg1 = 0;
            k = f_cpu_x->size[0] * f_cpu_x->size[1];
            f_cpu_x->size[0] = 1;
            f_cpu_x->size[1] = 15 * nsubs;
            emxEnsureCapacity_real_T(f_cpu_x, k, &g_emlrtRTEI);
            if (!d_x_dirtyOnCpu) {
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              cpu_halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                f_cpu_x->data[(nbytes + j) + 1] = NODES[j] * cpu_halfh + c_r;
                d_x_dirtyOnCpu = true;
              }
            ...
            k = g_cpu_x->size[0] * g_cpu_x->size[1];
            g_cpu_x->size[0] = 1;
            g_cpu_x->size[1] = f_cpu_x->size[1];
            emxEnsureCapacity_real_T(g_cpu_x, k, &h_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(g_cpu_x, &k_gpu_x);
            k = c_cpu_xt->size[0] * c_cpu_xt->size[1];
            c_cpu_xt->size[0] = 1;
            c_cpu_xt->size[1] = f_cpu_x->size[1];
            emxEnsureCapacity_real_T(c_cpu_xt, k, &i_emlrtRTEI);
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                k = c_cpu_fx->size[0] * c_cpu_fx->size[1];
                c_cpu_fx->size[0] = 1;
                c_cpu_fx->size[1] = f_cpu_x->size[1];
                emxEnsureCapacity_real_T(c_cpu_fx, k, &m_emlrtRTEI);
                if (!c_fx_dirtyOnCpu) {
            ...
            if (b_guard1) {
              ...
              emxEnsureCapacity_real_T(i_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(i_cpu_y, &k_gpu_y);
              bcoef = g_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel43<<<grid, block>>>(k_gpu_x, bcoef, k_gpu_y);
                c_y_dirtyOnGpu = true;
              }

              k = j_cpu_y->size[0] * j_cpu_y->size[1];
              j_cpu_y->size[0] = 1;
              j_cpu_y->size[1] = g_cpu_x->size[1];
              emxEnsureCapacity_real_T(j_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(j_cpu_y, &l_gpu_y);
              bcoef = g_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel44<<<grid, block>>>(k_gpu_x, bcoef, l_gpu_y);
                d_y_dirtyOnGpu = true;
              }
              ...
              if (i_cpu_y->size[1] == j_cpu_y->size[1]) {
                ...
                emxEnsureCapacity_real_T(b_cpu_a, k, &q_emlrtRTEI);
                if (!b_a_dirtyOnCpu) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ec_cwtAvg_kernel45<<<grid, block>>>(l_gpu_y, k_gpu_y, bcoef,
                    c_gpu_a);
                  b_a_dirtyOnGpu = true;
                  b_a_dirtyOnCpu = false;
                }
              ...
              k = cpu_dv10->size[0] * cpu_dv10->size[1];
              cpu_dv10->size[0] = 1;
              cpu_dv10->size[1] = b_cpu_a->size[1];
              emxEnsureCapacity_real_T(cpu_dv10, k, &k_emlrtRTEI);
              ...
              if (b_dirtyOnGpu) {
                ...
                b_a_dirtyOnCpu = false;
                ec_cwtAvg_kernel46<<<grid, block>>>(c_gpu_a, bcoef, gpu_dv10);
              ...
              emxEnsureCapacity_real_T(k_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(k_cpu_y, &m_gpu_y);
              bcoef = g_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel47<<<grid, block>>>(k_gpu_x, bcoef, m_gpu_y);
              }

              k = cpu_dv12->size[0] * cpu_dv12->size[1];
              cpu_dv12->size[0] = 1;
              cpu_dv12->size[1] = k_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv12, k, &w_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv12, &gpu_dv12);
              bcoef = k_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
                1L), &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel48<<<grid, block>>>(m_gpu_y, bcoef, gpu_dv12);
              ...
              if (cpu_dv10->size[1] == cpu_dv12->size[1]) {
                ...
                emxEnsureCapacity_real_T(c_cpu_fx, k, &ab_emlrtRTEI);
                if (!c_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(c_cpu_fx, &c_gpu_fx);
                }
        ...
        if (nsubs + 1 < 2) {
          ...
          ec_cwtAvg_kernel53<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(bcoef,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (acoef <= 0) {
          ...
          emxInit_real_T(&d_cpu_xt, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv14, 2, &kc_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_fx, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&l_cpu_y, 2, &lc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv17, 2, &kc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            k = h_cpu_x->size[0] * h_cpu_x->size[1];
            h_cpu_x->size[0] = 1;
            h_cpu_x->size[1] = 15 * nsubs;
            emxEnsureCapacity_real_T(h_cpu_x, k, &g_emlrtRTEI);
            if (!e_x_dirtyOnCpu) {
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              cpu_halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                h_cpu_x->data[(nbytes + j) + 1] = NODES[j] * cpu_halfh + c_r;
                e_x_dirtyOnCpu = true;
              }
            ...
            k = i_cpu_x->size[0] * i_cpu_x->size[1];
            i_cpu_x->size[0] = 1;
            i_cpu_x->size[1] = h_cpu_x->size[1];
            emxEnsureCapacity_real_T(i_cpu_x, k, &h_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(i_cpu_x, &i_gpu_x);
            k = d_cpu_xt->size[0] * d_cpu_xt->size[1];
            d_cpu_xt->size[0] = 1;
            d_cpu_xt->size[1] = h_cpu_x->size[1];
            emxEnsureCapacity_real_T(d_cpu_xt, k, &i_emlrtRTEI);
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                k = d_cpu_fx->size[0] * d_cpu_fx->size[1];
                d_cpu_fx->size[0] = 1;
                d_cpu_fx->size[1] = h_cpu_x->size[1];
                emxEnsureCapacity_real_T(d_cpu_fx, k, &m_emlrtRTEI);
                if (!d_fx_dirtyOnCpu) {
            ...
            if (b_guard1) {
              first_iteration = false;
              k = cpu_dv14->size[0] * cpu_dv14->size[1];
              cpu_dv14->size[0] = 1;
              cpu_dv14->size[1] = i_cpu_x->size[1];
              emxEnsureCapacity_real_T(cpu_dv14, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv14, &gpu_dv14);
              bcoef = i_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel56<<<grid, block>>>(i_gpu_x, bcoef, gpu_dv14);
              ...
              emxEnsureCapacity_real_T(l_cpu_y, k, &k_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(l_cpu_y, &j_gpu_y);
              bcoef = i_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
                &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel57<<<grid, block>>>(i_gpu_x, bcoef, j_gpu_y);
              }

              k = cpu_dv17->size[0] * cpu_dv17->size[1];
              cpu_dv17->size[0] = 1;
              cpu_dv17->size[1] = l_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv17, k, &x_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv17, &gpu_dv17);
              bcoef = l_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
                1L), &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                ec_cwtAvg_kernel58<<<grid, block>>>(j_gpu_y, bcoef, gpu_dv17);
              ...
              if (cpu_dv14->size[1] == cpu_dv17->size[1]) {
                ...
                emxEnsureCapacity_real_T(d_cpu_fx, k, &ab_emlrtRTEI);
                if (!d_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(d_cpu_fx, &b_gpu_fx);
                }

                bcoef = cpu_dv14->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef
                  + 1L), &grid, &block, 1024U, 65535U);
                if (b_dirtyOnGpu) {
                  if (d_fx_dirtyOnCpu) {
    ...
    emxInit_real_T(&g_cpu_y, 2, &yb_emlrtRTEI, true);
    c_r = std::fmax(r, 1.0 / fb_VoicesPerOctave) * fb_VoicesPerOctave;
    if (std::isnan(c_r)) {
      k = g_cpu_y->size[0] * g_cpu_y->size[1];
      g_cpu_y->size[0] = 1;
      g_cpu_y->size[1] = 1;
      emxEnsureCapacity_real_T(g_cpu_y, k, &j_emlrtRTEI);
      ...
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(static_cast<
        int64_T>(c_r) + 1L), &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel61<<<grid, block>>>(c_r, h_gpu_y);
      }
    }
    ...
    emxEnsureCapacity_real_T(h_cpu_y, k, &k_emlrtRTEI);
    ...
    if (b_dirtyOnGpu) {
      ...
      ec_cwtAvg_kernel62<<<grid, block>>>(h_gpu_y, rt_powd_snf(2.0, 1.0 /
        fb_VoicesPerOctave), bcoef, i_gpu_y);
    }
    ...
    if (b_dirtyOnGpu) {
      cudaMemcpy(gpu_halfh, &cpu_halfh, 8UL, cudaMemcpyHostToDevice);
      ec_cwtAvg_kernel63<<<grid, block>>>(i_gpu_y, gpu_halfh, bcoef,
        gpu_fb_Scales);
      fb_Scales_dirtyOnGpu = true;
    }
  ...
  emxInit_real_T(&cpu_psidft, 2, &vb_emlrtRTEI, true);
  emxInit_real_T(&cpu_f, 2, &wb_emlrtRTEI, true);
  if (first_iteration) {
    emxInit_real_T(&cpu_somega, 2, &xb_emlrtRTEI, true);
    if (cpu_fb_Scales->size[1] == 1) {
      ...
      emxEnsureCapacity_real_T(cpu_somega, k, &p_emlrtRTEI);
      ...
      cpu_somega->size[1] = cpu_omega->size[1];
      emxEnsureCapacity_real_T(cpu_somega, k, &o_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_somega, &gpu_somega);
      nsubs = cpu_omega->size[1];
      bcoef = cpu_fb_Scales->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((bcoef + 1L) *
        nsubs), &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel70<<<grid, block>>>(gpu_omega, gpu_fb_Scales, bcoef,
          nsubs, gpu_somega, cpu_somega->size[0U]);
    ...
    for (j = 0; j < 2; j++) {
      cpu_xSize[j] = static_cast<uint32_T>(cpu_somega->size[j]);
    ...
    emxEnsureCapacity_real_T(cpu_absomega, k, &t_emlrtRTEI);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef), &grid,
      &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel73<<<grid, block>>>(bcoef, gpu_absomega);
      absomega_dirtyOnGpu = true;
    }
    ...
    if ((cpu_absomega->size[0] == cpu_powscales->size[0]) && (cpu_absomega->
      ...
      emxEnsureCapacity_real_T(j_cpu_x, k, &y_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(j_cpu_x, &gpu_x);
      bcoef = cpu_absomega->size[0] * cpu_absomega->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
        &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel74<<<grid, block>>>(gpu_powscales, gpu_absomega, bcoef,
          gpu_x);
        e_x_dirtyOnGpu = true;
      }
    } else {
    ...
    if (b_dirtyOnGpu) {
      ...
      ec_cwtAvg_kernel75<<<grid, block>>>(bcoef, gpu_x);
      e_x_dirtyOnGpu = true;
      f_x_dirtyOnCpu = false;
    }
    ...
    if ((j_cpu_x->size[0] == cpu_somega->size[0]) && (j_cpu_x->size[1] ==
         cpu_somega->size[1])) {
      k = cpu_psidft->size[0] * cpu_psidft->size[1];
      cpu_psidft->size[0] = j_cpu_x->size[0];
      cpu_psidft->size[1] = j_cpu_x->size[1];
      emxEnsureCapacity_real_T(cpu_psidft, k, &bb_emlrtRTEI);
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel76<<<grid, block>>>(gpu_somega, gpu_x, bcoef, gpu_psidft);
      }
    } else {
      if (e_x_dirtyOnGpu) {
    ...
    k = cpu_f->size[0] * cpu_f->size[1];
    cpu_f->size[0] = 1;
    cpu_f->size[1] = cpu_fb_Scales->size[1];
    emxEnsureCapacity_real_T(cpu_f, k, &cb_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_f, &gpu_f);
    bcoef = cpu_fb_Scales->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel77<<<grid, block>>>(gpu_fb_Scales, bcoef, gpu_f);
    }
  } else {
    k = cpu_psidft->size[0] * cpu_psidft->size[1];
    cpu_psidft->size[0] = cpu_fb_Scales->size[1];
    cpu_psidft->size[1] = cpu_omega->size[1];
    emxEnsureCapacity_real_T(cpu_psidft, k, &n_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_psidft, &gpu_psidft);
    bcoef = cpu_fb_Scales->size[1] * cpu_omega->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel68<<<grid, block>>>(bcoef, gpu_psidft);
    }

    k = cpu_f->size[0] * cpu_f->size[1];
    cpu_f->size[0] = 1;
    cpu_f->size[1] = cpu_fb_Scales->size[1];
    emxEnsureCapacity_real_T(cpu_f, k, &r_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_f, &gpu_f);
    bcoef = cpu_fb_Scales->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel69<<<grid, block>>>(gpu_fb_Scales, bcoef, gpu_f);
    }
  }
  ...
  k = cpu_f->size[0] * cpu_f->size[1];
  cpu_f->size[0] = 1;
  emxEnsureCapacity_real_T(cpu_f, k, &s_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(cpu_f, &gpu_f);
  k = cpu_f->size[1] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_cwtAvg_kernel78<<<grid, block>>>(fs, k, gpu_f);
  }

  // 'ec_cwtAvg:29' freqs = centerFrequencies(fb);
  k = cpu_freqs->size[0];
  cpu_freqs->size[0] = cpu_f->size[1];
  emxEnsureCapacity_real_T(cpu_freqs, k, &u_emlrtRTEI);
  bcoef = cpu_f->size[1] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L), &grid,
    &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    gpuEmxMemcpyCpuToGpu_real_T(&gpu_freqs, cpu_freqs);
    ec_cwtAvg_kernel79<<<grid, block>>>(gpu_f, bcoef, gpu_freqs);
  ...
  emxInit_real_T(&cpu_savgpTMP, 2, &cc_emlrtRTEI, true);
  ...
  emxInit_real_T(&cpu_xv, 2, &db_emlrtRTEI, true);
  emxInit_creal_T(&cpu_xposdft, 2, &eb_emlrtRTEI, true);
  emxInit_real_T(&k_cpu_x, 2, &gb_emlrtRTEI, true);
  emxInit_creal_T(&cpu_cfsposdft, 2, &hc_emlrtRTEI, true);
  emxInit_creal_T(&cpu_cfspos, 2, &ib_emlrtRTEI, true);
  emxInit_real_T(&m_cpu_y, 2, &mc_emlrtRTEI, true);
  emxInit_real_T(&cpu_abscfssq, 2, &nc_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_a, 2, &kb_emlrtRTEI, true);
  emxInit_real_T(&l_cpu_x, 2, &g_emlrtRTEI, true);
  emxInit_uint32_T(&n_cpu_y, 2, &oc_emlrtRTEI, true);
  emxInit_real_T(&cpu_z, 1, &pc_emlrtRTEI, true);
  emxInit_real_T(&m_cpu_x, 2, &dc_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_xt, 2, &ec_emlrtRTEI, true);
  emxInit_real_T(&cpu_c, 1, &ob_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_c, 1, &ob_emlrtRTEI, true);
  emxInit_real_T(&o_cpu_y, 2, &qc_emlrtRTEI, true);
  emxInit_real_T(&p_cpu_y, 2, &rc_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_a, 2, &nb_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_fx, 2, &vb_emlrtRTEI, true);
  emxInit_real_T(&n_cpu_x, 2, &pb_emlrtRTEI, true);
  emxInit_real_T(&cpu_abswt2, 2, &sc_emlrtRTEI, true);
  emxInit_real_T(&o_cpu_x, 2, &qb_emlrtRTEI, true);
  emxInit_real_T(&q_cpu_y, 2, &tc_emlrtRTEI, true);
  emxInit_real_T(&cpu_abswt2S, 2, &uc_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_c, 1, &ob_emlrtRTEI, true);
  ...
  for (int64_T ch{0L}; ch <= d; ch++) {
    ...
    if (cpu_x->size[0] == 1) {
      r = cpu_x->data[cpu_x->size[0] * (static_cast<int32_T>(ch + 1L) - 1)];
      if ((!std::isinf(r)) && (!std::isnan(r))) {
        toler = 0.0;
      } else {
        toler = rtNaN;
      ...
      c_r = cpu_x->data[cpu_x->size[0] * (static_cast<int32_T>(ch + 1L) - 1)];
      for (k = 0; k < nbytes; k++) {
        c_r += cpu_x->data[(k + cpu_x->size[0] * (static_cast<int32_T>(ch + 1L)
          - 1)) + 1];
      }
      ...
      r = 0.0;
      for (k = 0; k <= nbytes; k++) {
        delta = cpu_x->data[k + cpu_x->size[0] * (static_cast<int32_T>(ch + 1L)
          - 1)] - c_r;
        r += delta * delta;
      }
    ...
    k = cpu_xv->size[0] * cpu_xv->size[1];
    cpu_xv->size[0] = 1;
    cpu_xv->size[1] = cpu_x->size[0];
    emxEnsureCapacity_real_T(cpu_xv, k, &db_emlrtRTEI);
    if (!xv_dirtyOnCpu) {
    ...
    if (b_dirtyOnGpu) {
      ...
      ec_cwtAvg_kernel80<<<grid, block>>>(static_cast<int32_T>(ch + 1L), b_gpu_x,
    ...
    if (y > 0.0) {
      ...
      k = k_cpu_x->size[0] * k_cpu_x->size[1];
      k_cpu_x->size[0] = 1;
      k_cpu_x->size[1] = static_cast<int32_T>(y);
      emxEnsureCapacity_real_T(k_cpu_x, k, &gb_emlrtRTEI);
      if (!g_x_dirtyOnCpu) {
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel81<<<grid, block>>>(static_cast<int32_T>(ch + 1L),
      ...
      for (nsubs = 0; nsubs < nbytes; nsubs++) {
        bcoef = (static_cast<int32_T>(y) - nsubs) - 1;
        if (f_x_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_real_T(k_cpu_x, &c_gpu_x);
        }

        c_r = k_cpu_x->data[nsubs];
        k_cpu_x->data[nsubs] = k_cpu_x->data[bcoef];
        k_cpu_x->data[bcoef] = c_r;
        g_x_dirtyOnCpu = true;
        f_x_dirtyOnGpu = false;
      }
      ...
      cpu_xv->size[1] = ((cpu_x->size[0] + k_cpu_x->size[1]) + div_s32(acoef -
        eint, b_eint)) + 1;
      emxEnsureCapacity_real_T(cpu_xv, k, &hb_emlrtRTEI);
      if (!xv_dirtyOnCpu) {
        gpuEmxEnsureCapacity_real_T(cpu_xv, &gpu_xv);
      }

      nsubs = k_cpu_x->size[1];
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nsubs), &grid,
        &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        if (g_x_dirtyOnCpu) {
        ...
        ec_cwtAvg_kernel82<<<grid, block>>>(c_gpu_x, nsubs, gpu_xv);
        xv_dirtyOnGpu = true;
        xv_dirtyOnCpu = false;
      }
      ...
      for (k = 0; k < nsubs; k++) {
        ...
        cpu_xv->data[k + k_cpu_x->size[1]] = cpu_x->data[k + cpu_x->size[0] * (
          static_cast<int32_T>(ch + 1L) - 1)];
        xv_dirtyOnCpu = true;
        xv_dirtyOnGpu = false;
      }

      nsubs = div_s32(acoef - eint, b_eint);
      for (k = 0; k <= nsubs; k++) {
        if (xv_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_real_T(cpu_xv, &gpu_xv);
        }

        cpu_xv->data[(k + cpu_x->size[0]) + k_cpu_x->size[1]] = cpu_x->data
          [(eint + b_eint * k) + cpu_x->size[0] * (static_cast<int32_T>(ch + 1L)
          - 1)];
        xv_dirtyOnCpu = true;
        xv_dirtyOnGpu = false;
      }
    ...
    if (cpu_xv->size[1] - (static_cast<int32_T>(static_cast<uint32_T>
      ...
      cufftType b_fftType;
      int fftDirection;
      k = cpu_xposdft->size[0] * cpu_xposdft->size[1];
      cpu_xposdft->size[0] = 1;
      cpu_xposdft->size[1] = cpu_xv->size[1];
      emxEnsureCapacity_creal_T(cpu_xposdft, k, &eb_emlrtRTEI);
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel83<<<grid, block>>>(gpu_xv, bcoef, gpu_xposdft);
        xposdft_dirtyOnCpu = false;
      }
      ...
      for (j = 0; j < 2; j++) {
        cpu_xSize[j] = static_cast<uint32_T>(cpu_xv->size[j]);
        xSize_dirtyOnCpu = true;
      }
      ...
      emxEnsureCapacity_creal_T(cpu_xposdft, k, &fb_emlrtRTEI);
      if (!xposdft_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal_T(cpu_xposdft, &gpu_xposdft);
      }
      ...
      nbytes = static_cast<int32_T>(static_cast<real_T>(static_cast<int32_T>
        (cpu_xSize[1]) + 1) / 2.0);
      for (acoef = 0; acoef <= nbytes - 2; acoef++) {
        if (b_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_creal_T(cpu_xposdft, &gpu_xposdft);
        }

        cpu_xposdft->data[(static_cast<int32_T>(cpu_xSize[1]) - acoef) - 1].re =
          cpu_xposdft->data[acoef + 1].re;
        cpu_xposdft->data[(static_cast<int32_T>(cpu_xSize[1]) - acoef) - 1].im =
          -cpu_xposdft->data[acoef + 1].im;
    ...
    emxEnsureCapacity_creal_T(cpu_cfsposdft, eint, &p_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(cpu_cfsposdft, &gpu_cfsposdft);
    if ((csz_idx_0 != 0) && (k != 0)) {
      bcoef = (cpu_psidft->size[1] != 1);
      nbytes = k - 1;
      j = cpu_cfsposdft->size[0] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((j + 1L) *
      ...
      if (b_dirtyOnGpu) {
        ...
        psidft_dirtyOnCpu = false;
        ec_cwtAvg_kernel84<<<grid, block>>>(gpu_xposdft, gpu_psidft, bcoef, j, k
    ...
    if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
      for (j = 0; j < 2; j++) {
        cpu_xSize[j] = static_cast<uint32_T>(cpu_cfsposdft->size[j]);
        xSize_dirtyOnCpu = true;
      }
      ...
      ec_cwtAvg_kernel86<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_xSize,
      ...
      emxEnsureCapacity_creal_T(cpu_cfspos, k, &ib_emlrtRTEI);
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel87<<<grid, block>>>(bcoef, gpu_cfspos);
      ...
      j = cpu_cfsposdft->size[0] * cpu_cfsposdft->size[1] - 1;
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel85<<<grid, block>>>(static_cast<real_T>(bcoef),
          gpu_cfsposdft, j, gpu_cfspos);
        cfspos_dirtyOnGpu = true;
        cfspos_dirtyOnCpu = false;
      }
    }
    ...
    if (y > 0.0) {
      ...
      acoef = cpu_cfspos->size[0];
      nsubs = bcoef - nbytes;
      for (k = 0; k < nsubs; k++) {
        for (eint = 0; eint < acoef; eint++) {
          if (cfspos_dirtyOnGpu) {
            gpuEmxMemcpyGpuToCpu_creal_T(cpu_cfspos, &gpu_cfspos);
          }

          cpu_cfspos->data[eint + acoef * k] = cpu_cfspos->data[eint
            + cpu_cfspos->size[0] * (nbytes + k)];
      ...
      emxEnsureCapacity_creal_T(cpu_cfspos, k, &jb_emlrtRTEI);
      if (!cfspos_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal_T(cpu_cfspos, &gpu_cfspos);
      }
    }
    ...
    if (first_iteration) {
      ec_cwtAvg_kernel89<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_wav, b_b
        [0], b_b[1], b_b[2], b_b[3], b_b[4]);
      ec_cwtAvg_kernel90<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_wav,
        *gpu_wavname);
      wavname_dirtyOnGpu = true;
    } else {
      ec_cwtAvg_kernel88<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_wav);
    }
    ...
    if (first_iteration) {
      c_r = 0.0057083835261;
      for (acoef = 0; acoef < 6; acoef++) {
        c_r = c_r / 177.7777777777778 + c[acoef];
      }
      ...
      ec_cwtAvg_kernel91<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_interval);
      ec_cwtAvg_kernel92<<<dim3(2U, 1U, 1U), dim3(512U, 1U, 1U)>>>(*gpu_interval);
      interval_dirtyOnCpu = false;
      e = 0.0;
      bcoef = 1;
      cudaMemcpy(cpu_interval, *gpu_interval, 5200UL, cudaMemcpyDeviceToHost);
      acoef = static_cast<int32_T>(cpu_interval[1]) - static_cast<int32_T>
        (cpu_interval[0]);
      if (acoef > 0) {
        c_r = 10.0 / static_cast<real_T>(acoef);
      ...
      if (nsubs + 1 < 2) {
        ...
        ec_cwtAvg_kernel93<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(bcoef,
          *gpu_interval);
        interval_dirtyOnCpu = false;
        nsubs = 1;
      }
      ...
      if (acoef <= 0) {
        ...
        if (b_dirtyOnGpu) {
          ...
          ec_cwtAvg_kernel94<<<grid, block>>>(*gpu_interval, nsubs, *gpu_subs);
          subs_dirtyOnGpu = true;
          subs_dirtyOnCpu = false;
        }
        ...
        do {
          exitg1 = 0;
          k = l_cpu_x->size[0] * l_cpu_x->size[1];
          l_cpu_x->size[0] = 1;
          l_cpu_x->size[1] = 15 * nsubs;
          emxEnsureCapacity_real_T(l_cpu_x, k, &g_emlrtRTEI);
          if (!h_x_dirtyOnCpu) {
          ...
          for (k = 0; k < nsubs; k++) {
            ...
            cpu_halfh = (r - maxScale) / 2.0;
            for (j = 0; j < 15; j++) {
              l_cpu_x->data[(nbytes + j) + 1] = NODES[j] * cpu_halfh + c_r;
              h_x_dirtyOnCpu = true;
            }
          ...
          k = m_cpu_x->size[0] * m_cpu_x->size[1];
          m_cpu_x->size[0] = 1;
          m_cpu_x->size[1] = l_cpu_x->size[1];
          emxEnsureCapacity_real_T(m_cpu_x, k, &h_emlrtRTEI);
          gpuEmxEnsureCapacity_real_T(m_cpu_x, &e_gpu_x);
          k = e_cpu_xt->size[0] * e_cpu_xt->size[1];
          e_cpu_xt->size[0] = 1;
          e_cpu_xt->size[1] = l_cpu_x->size[1];
          emxEnsureCapacity_real_T(e_cpu_xt, k, &i_emlrtRTEI);
          ...
          if (b_dirtyOnGpu) {
            ...
            h_x_dirtyOnCpu = false;
            ec_cwtAvg_kernel95<<<grid, block>>>(d_gpu_x, nbytes, gpu_xt, e_gpu_x);
            g_x_dirtyOnGpu = true;
          ...
          if (!first_iteration) {
            ...
            if (first_iteration) {
              ...
              k = e_cpu_fx->size[0] * e_cpu_fx->size[1];
              e_cpu_fx->size[0] = 1;
              e_cpu_fx->size[1] = l_cpu_x->size[1];
              emxEnsureCapacity_real_T(e_cpu_fx, k, &m_emlrtRTEI);
              if (!e_fx_dirtyOnCpu) {
              ...
              if (b_dirtyOnGpu) {
                ...
                ec_cwtAvg_kernel102<<<grid, block>>>(dv2_idx_1, gpu_fx);
          ...
          if (b_guard1) {
            ...
            emxEnsureCapacity_real_T(d_cpu_a, k, &nb_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(d_cpu_a, &b_gpu_a);
            bcoef = m_cpu_x->size[1] - 1;
            b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
              1L), &grid, &block, 1024U, 65535U);
            if (b_dirtyOnGpu) {
              ec_cwtAvg_kernel96<<<grid, block>>>(e_gpu_x, bcoef, b_gpu_a);
            }

            k = o_cpu_y->size[0] * o_cpu_y->size[1];
            o_cpu_y->size[0] = 1;
            o_cpu_y->size[1] = d_cpu_a->size[1];
            emxEnsureCapacity_real_T(o_cpu_y, k, &k_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(o_cpu_y, &f_gpu_y);
            bcoef = d_cpu_a->size[1];
            b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
              &grid, &block, 1024U, 65535U);
            if (b_dirtyOnGpu) {
              ec_cwtAvg_kernel97<<<grid, block>>>(b_gpu_a, bcoef, f_gpu_y);
            }

            k = n_cpu_x->size[0] * n_cpu_x->size[1];
            n_cpu_x->size[0] = 1;
            n_cpu_x->size[1] = o_cpu_y->size[1];
            emxEnsureCapacity_real_T(n_cpu_x, k, &pb_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(n_cpu_x, &f_gpu_x);
            bcoef = o_cpu_y->size[1] - 1;
            b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
              1L), &grid, &block, 1024U, 65535U);
            if (b_dirtyOnGpu) {
              ec_cwtAvg_kernel98<<<grid, block>>>(f_gpu_y, bcoef, f_gpu_x);
            }

            k = o_cpu_x->size[0] * o_cpu_x->size[1];
            o_cpu_x->size[0] = 1;
            o_cpu_x->size[1] = n_cpu_x->size[1];
            emxEnsureCapacity_real_T(o_cpu_x, k, &qb_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(o_cpu_x, &g_gpu_x);
            bcoef = n_cpu_x->size[1] - 1;
            b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
              1L), &grid, &block, 1024U, 65535U);
            if (b_dirtyOnGpu) {
              ec_cwtAvg_kernel99<<<grid, block>>>(f_gpu_x, bcoef, g_gpu_x);
            }

            bcoef = n_cpu_x->size[1];
            k = q_cpu_y->size[0] * q_cpu_y->size[1];
            q_cpu_y->size[0] = 1;
            q_cpu_y->size[1] = o_cpu_x->size[1];
            emxEnsureCapacity_real_T(q_cpu_y, k, &t_emlrtRTEI);
            gpuEmxEnsureCapacity_real_T(q_cpu_y, &g_gpu_y);
            b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
              &grid, &block, 1024U, 65535U);
            if (b_dirtyOnGpu) {
              ec_cwtAvg_kernel100<<<grid, block>>>(g_gpu_x, bcoef, g_gpu_y);
              f_y_dirtyOnGpu = true;
            }
            ...
            if (q_cpu_y->size[1] == m_cpu_x->size[1]) {
              ...
              emxEnsureCapacity_real_T(e_cpu_fx, k, &ab_emlrtRTEI);
              if (!e_fx_dirtyOnCpu) {
                gpuEmxEnsureCapacity_real_T(e_cpu_fx, &gpu_fx);
              }

              bcoef = q_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef +
                1L), &grid, &block, 1024U, 65535U);
              if (b_dirtyOnGpu) {
                if (e_fx_dirtyOnCpu) {
                ...
                ec_cwtAvg_kernel101<<<grid, block>>>(gpu_xt, e_gpu_x, g_gpu_y,
                  bcoef, gpu_fx);
                e_fx_dirtyOnGpu = true;
                e_fx_dirtyOnCpu = false;
              }
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              for (j = 0; j < 15; j++) {
                ...
                maxScale += dv4[j] * e_cpu_fx->data[(nbytes + j) + 1];
                e_fx_dirtyOnGpu = false;
                r += dv5[j] * e_cpu_fx->data[(nbytes + j) + 1];
              }
            ...
            c_r = 2.0 * cpu_halfh / static_cast<real_T>(acoef);
            r = 0.0;
            nbytes = 0;
            for (k = 0; k < nsubs; k++) {
              maxScale = errsub[k];
            ...
            if ((!std::isinf(e)) && (!std::isnan(e)) && ((!std::isinf(c_r)) && (
                  !std::isnan(c_r))) && (nbytes != 0) && (!(c_r <= cpu_halfh)))
            {
              nsubs = nbytes << 1;
              if (nsubs > 650) {
                exitg1 = 1;
    ...
    for (j = 0; j < 2; j++) {
      cpu_xSize[j] = static_cast<uint32_T>(cpu_cfspos->size[j]);
      xSize_dirtyOnCpu = true;
    }
    ...
    emxEnsureCapacity_real_T(m_cpu_y, k, &t_emlrtRTEI);
    ...
    if (b_dirtyOnGpu) {
      ...
      cfspos_dirtyOnCpu = false;
      ec_cwtAvg_kernel103<<<grid, block>>>(gpu_cfspos, bcoef, c_gpu_y);
    }

    for (j = 0; j < 2; j++) {
      cpu_xSize[j] = static_cast<uint32_T>(m_cpu_y->size[j]);
      xSize_dirtyOnCpu = true;
    }

    k = cpu_abscfssq->size[0] * cpu_abscfssq->size[1];
    cpu_abscfssq->size[0] = static_cast<int32_T>(cpu_xSize[0]);
    cpu_abscfssq->size[1] = static_cast<int32_T>(cpu_xSize[1]);
    emxEnsureCapacity_real_T(cpu_abscfssq, k, &k_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_abscfssq, &gpu_abscfssq);
    bcoef = static_cast<int32_T>(cpu_xSize[0]) * static_cast<int32_T>(cpu_xSize
      [1]);
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef), &grid,
      &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel104<<<grid, block>>>(c_gpu_y, bcoef, gpu_abscfssq);
    }

    k = c_cpu_a->size[0] * c_cpu_a->size[1];
    c_cpu_a->size[0] = cpu_abscfssq->size[0];
    c_cpu_a->size[1] = cpu_abscfssq->size[1];
    emxEnsureCapacity_real_T(c_cpu_a, k, &kb_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(c_cpu_a, &gpu_a);
    bcoef = cpu_abscfssq->size[0] * cpu_abscfssq->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel105<<<grid, block>>>(gpu_abscfssq, bcoef, gpu_a);
    }

    nbytes = cpu_fb_Scales->size[1];
    ...
    if (cpu_fb_Scales->size[1] == 1) {
      k = cpu_abscfssq->size[0];
    } else if (cpu_abscfssq->size[0] == 1) {
      k = cpu_fb_Scales->size[1];
    ...
    eint = cpu_abscfssq->size[1];
    nbytes = cpu_abscfssq->size[0] * cpu_abscfssq->size[1];
    cpu_abscfssq->size[0] = k;
    cpu_abscfssq->size[1] = eint;
    emxEnsureCapacity_real_T(cpu_abscfssq, nbytes, &p_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_abscfssq, &gpu_abscfssq);
    if ((k != 0) && (eint != 0)) {
      ...
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((bcoef + 1L) *
        (nbytes + 1L)), &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel106<<<grid, block>>>(gpu_fb_Scales, gpu_a, acoef, bcoef,
          eint - 1, gpu_abscfssq, c_cpu_a->size[0U], cpu_fb_Scales->size[1U],
    ...
    emxEnsureCapacity_real_T(cpu_z, k, &lb_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_z, &gpu_z);
    bcoef = cpu_abscfssq->size[0] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel108<<<grid, block>>>(bcoef, gpu_z);
    }
    ...
    if (cpu_abscfssq->size[1] > 1) {
      if (n_cpu_y->size[1] == 1) {
        ...
        emxEnsureCapacity_real_T(cpu_c, k, &ob_emlrtRTEI);
        ...
        ec_cwtAvg_kernel113<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r, gpu_c);
        ec_cwtAvg_kernel114<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r, gpu_c,
          cpu_abscfssq->size[1U]);
      } else {
        k = cpu_c->size[0];
        cpu_c->size[0] = cpu_abscfssq->size[1];
        emxEnsureCapacity_real_T(cpu_c, k, &mb_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(cpu_c, &gpu_c);
        ec_cwtAvg_kernel109<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(d_gpu_y,
          gpu_c);
        nbytes = cpu_abscfssq->size[1];
        b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nbytes - 2L),
          &grid, &block, 1024U, 65535U);
        if (b_dirtyOnGpu) {
          ec_cwtAvg_kernel110<<<grid, block>>>(d_gpu_y, nbytes, gpu_c);
        }
    ...
    if (cpu_z->size[0] <= 1) {
      ...
      if (cpu_fb_Scales->size[1] == 1) {
        ...
        emxEnsureCapacity_real_T(b_cpu_c, k, &ob_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(b_cpu_c, &c_gpu_c);
        b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nbytes),
          &grid, &block, 1024U, 65535U);
        if (b_dirtyOnGpu) {
          ec_cwtAvg_kernel118<<<grid, block>>>(gpu_fb_Scales, nbytes, c_gpu_c);
        }
        ...
        ec_cwtAvg_kernel119<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r, c_gpu_c);
        ec_cwtAvg_kernel120<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r, c_gpu_c,
          cpu_z->size[0U]);
      } else {
        k = b_cpu_c->size[0];
        b_cpu_c->size[0] = cpu_z->size[0];
        emxEnsureCapacity_real_T(b_cpu_c, k, &mb_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(b_cpu_c, &c_gpu_c);
        ec_cwtAvg_kernel115<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>
          (gpu_fb_Scales, c_gpu_c);
        nbytes = cpu_z->size[0];
        b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nbytes - 2L),
          &grid, &block, 1024U, 65535U);
        if (b_dirtyOnGpu) {
          ec_cwtAvg_kernel116<<<grid, block>>>(gpu_fb_Scales, nbytes, c_gpu_c);
        }

        ec_cwtAvg_kernel117<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>
    ...
    if (!(toler == 0.0)) {
      ...
      if (b_dirtyOnGpu) {
        ...
        ec_cwtAvg_kernel121<<<grid, block>>>(a, k, gpu_cfspos);
        cfspos_dirtyOnGpu = true;
        cfspos_dirtyOnCpu = false;
      }
    }
    ...
    emxEnsureCapacity_real_T(p_cpu_y, k, &t_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(p_cpu_y, &e_gpu_y);
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef), &grid,
      &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      if (cfspos_dirtyOnCpu) {
      ...
      cfspos_dirtyOnCpu = false;
      ec_cwtAvg_kernel122<<<grid, block>>>(gpu_cfspos, bcoef, e_gpu_y);
    }

    for (j = 0; j < 2; j++) {
      cpu_xSize[j] = static_cast<uint32_T>(p_cpu_y->size[j]);
      xSize_dirtyOnCpu = true;
    }

    k = cpu_abswt2->size[0] * cpu_abswt2->size[1];
    cpu_abswt2->size[0] = static_cast<int32_T>(cpu_xSize[0]);
    cpu_abswt2->size[1] = static_cast<int32_T>(cpu_xSize[1]);
    emxEnsureCapacity_real_T(cpu_abswt2, k, &k_emlrtRTEI);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef), &grid,
      &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_cwtAvg_kernel123<<<grid, block>>>(e_gpu_y, bcoef, gpu_abswt2);
    }

    k = cpu_abswt2S->size[0] * cpu_abswt2S->size[1];
    nbytes = cpu_fb_Scales->size[1];
    ...
    emxEnsureCapacity_real_T(cpu_abswt2S, k, &p_emlrtRTEI);
    ...
    if ((bcoef != 0) && (cpu_abswt2->size[1] != 0)) {
      ...
      bcoef = cpu_abswt2S->size[0] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((bcoef + 1L) *
        (nbytes + 1L)), &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel124<<<grid, block>>>(gpu_fb_Scales, gpu_abswt2, acoef,
          bcoef, nbytes, gpu_abswt2S, cpu_abswt2->size[0U], cpu_fb_Scales->size
          [1U], cpu_abswt2S->size[0U]);
      }
    }

    if ((cpu_abswt2S->size[0] != 0) || (cpu_abswt2S->size[1] != 0)) {
      k = cpu_savgpTMP->size[0] * cpu_savgpTMP->size[1];
      cpu_savgpTMP->size[0] = 1;
      cpu_savgpTMP->size[1] = cpu_abswt2S->size[1];
      emxEnsureCapacity_real_T(cpu_savgpTMP, k, &rb_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_savgpTMP, &gpu_savgpTMP);
      bcoef = cpu_abswt2S->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
        &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_cwtAvg_kernel125<<<grid, block>>>(bcoef, gpu_savgpTMP);
      }
      ...
      if (cpu_abswt2S->size[0] > 1) {
        if (i34 == 1) {
          ...
          emxEnsureCapacity_real_T(c_cpu_c, k, &ob_emlrtRTEI);
          gpuEmxEnsureCapacity_real_T(c_cpu_c, &b_gpu_c);
          b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nbytes),
            &grid, &block, 1024U, 65535U);
          if (b_dirtyOnGpu) {
            ec_cwtAvg_kernel129<<<grid, block>>>(gpu_fb_Scales, nbytes, b_gpu_c);
          }
          ...
          fb_Scales_dirtyOnGpu = false;
          r = 0.5 * cpu_fb_Scales->data[0];
          ec_cwtAvg_kernel130<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r,
            b_gpu_c);
          ec_cwtAvg_kernel131<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r,
            b_gpu_c, cpu_abswt2S->size[0U]);
        } else {
          k = c_cpu_c->size[0];
          c_cpu_c->size[0] = cpu_abswt2S->size[0];
          emxEnsureCapacity_real_T(c_cpu_c, k, &mb_emlrtRTEI);
          gpuEmxEnsureCapacity_real_T(c_cpu_c, &b_gpu_c);
          ...
          b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(nbytes - 2L),
            &grid, &block, 1024U, 65535U);
          if (b_dirtyOnGpu) {
            ec_cwtAvg_kernel127<<<grid, block>>>(gpu_fb_Scales, nbytes, b_gpu_c);
          }

          ec_cwtAvg_kernel128<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>
