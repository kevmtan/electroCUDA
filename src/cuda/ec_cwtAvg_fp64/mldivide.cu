              ...
              emxArray_real_T *gpu_Y, boolean_T *Y_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_A, 2, &if_emlrtRTEI, true);
  emxInit_int32_T(&cpu_jpvt, 2, &if_emlrtRTEI, true);
  emxInit_real_T(&cpu_tau, 1, &if_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_A, 2, &if_emlrtRTEI, true);
  emxInit_ptrdiff_t(&jpvt_t, 1, &ef_emlrtRTEI, true);
  emxInit_int32_T(&cpu_IPIV, 1, &jf_emlrtRTEI, true);
  emxInit_real_T(&cpu_B, 1, &gf_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_Y, u0, &xe_emlrtRTEI);
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(b_cpu_A, u0, &af_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(cpu_IPIV, u0, &cf_emlrtRTEI);
    ...
    if (cpu_maxmn < 0) {
      *Y_outdatedOnGpu = false;
      u0 = cpu_Y->size[0];
      cpu_Y->size[0] = B->size[0];
      emxEnsureCapacity_real_T(cpu_Y, u0, &ff_emlrtRTEI);
      for (u0 = 0; u0 < B->size[0]; u0++) {
        cpu_Y->data[u0] = rtNaN;
        *Y_outdatedOnGpu = true;
      }
    ...
    emxEnsureCapacity_real_T(cpu_A, u0, &ye_emlrtRTEI);
    for (u0 = 0; u0 < A->size[0] * A->size[1]; u0++) {
    ...
    emxEnsureCapacity_int32_T(cpu_jpvt, u0, &bf_emlrtRTEI);
    u0 = cpu_A->size[0];
    ...
    emxEnsureCapacity_real_T(cpu_tau, u0, &df_emlrtRTEI);
    u0 = jpvt_t->size[0];
    jpvt_t->size[0] = cpu_A->size[1];
    emxEnsureCapacity_ptrdiff_t(jpvt_t, u0, &ef_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(cpu_B, u0, &gf_emlrtRTEI);
    for (u0 = 0; u0 < B->size[0]; u0++) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    if (cpu_maxmn < 0) {
      ...
      emxEnsureCapacity_real_T(cpu_B, u0, &hf_emlrtRTEI);
      A_outdatedOnCpu = true;
