...
static __global__ void mldivide_kernel13(const int32_T b, const int32_T na,
                                         emxArray_real_T A, int32_T A_dim0);

static __global__ void mldivide_kernel14(const emxArray_real_T B,
...
static __global__ __launch_bounds__(1024, 1) void mldivide_kernel13(
...
static __global__ __launch_bounds__(1024, 1) void mldivide_kernel14(
              ...
              emxArray_real_T *gpu_Y, boolean_T *Y_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_A, 2, &ef_emlrtRTEI, true);
  emxInit_int32_T(&cpu_jpvt, 2, &ef_emlrtRTEI, true);
  emxInit_real_T(&cpu_tau, 1, &ef_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_A, 2, &ef_emlrtRTEI, true);
  emxInit_ptrdiff_t(&jpvt_t, 1, &af_emlrtRTEI, true);
  emxInit_int32_T(&cpu_IPIV, 1, &ff_emlrtRTEI, true);
  emxInit_real_T(&cpu_B, 1, &cf_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_Y, u0, &te_emlrtRTEI);
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(b_cpu_A, u0, &ve_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(cpu_IPIV, u0, &xe_emlrtRTEI);
    ...
    if (cpu_maxmn < 0) {
      *Y_outdatedOnGpu = false;
      u0 = cpu_Y->size[0];
      cpu_Y->size[0] = B->size[0];
      emxEnsureCapacity_real_T(cpu_Y, u0, &bf_emlrtRTEI);
      for (u0 = 0; u0 < B->size[0]; u0++) {
        cpu_Y->data[u0] = rtNaN;
        *Y_outdatedOnGpu = true;
      }
    ...
    emxEnsureCapacity_real_T(cpu_A, u0, &ue_emlrtRTEI);
    for (u0 = 0; u0 < A->size[0] * A->size[1]; u0++) {
    ...
    emxEnsureCapacity_int32_T(cpu_jpvt, u0, &we_emlrtRTEI);
    u0 = cpu_A->size[0];
    ...
    emxEnsureCapacity_real_T(cpu_tau, u0, &ye_emlrtRTEI);
    u0 = jpvt_t->size[0];
    jpvt_t->size[0] = cpu_A->size[1];
    emxEnsureCapacity_ptrdiff_t(jpvt_t, u0, &af_emlrtRTEI);
    ...
    if ((int32_T)info_t != 0) {
      ...
      if (validLaunchParams) {
        mldivide_kernel13<<<grid, block>>>(cpu_maxmn - 1, na, b_gpu_A,
                                           cpu_A->size[0U]);
      }
      A_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_B, u0, &cf_emlrtRTEI);
    for (u0 = 0; u0 < B->size[0]; u0++) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    if (cpu_maxmn < 0) {
      ...
      emxEnsureCapacity_real_T(cpu_B, u0, &df_emlrtRTEI);
      A_outdatedOnCpu = true;
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      mldivide_kernel14<<<grid, block>>>(gpu_B, gpu_jpvt, na, *gpu_Y);
    }
    *Y_outdatedOnGpu = false;
    *Y_outdatedOnCpu = true;
