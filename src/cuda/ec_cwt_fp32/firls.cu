                               ...
                               const emxArray_real_T *in5)
{
  ...
  int32_T stride_2_0;
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  emxInit_real_T(&b_in1, 1, &ig_emlrtRTEI, true);
  i = b_in1->size[0];
  if (in5->size[0] == 1) {
    b = in3->size[0];
  } else {
  ...
  emxEnsureCapacity_real_T(b_in1, i, &ig_emlrtRTEI);
  stride_0_0 = (in1->size[0] != 1);
  stride_1_0 = (in3->size[0] != 1);
  ...
  i = in1->size[0];
  in1->size[0] = b_in1->size[0];
  emxEnsureCapacity_real_T(in1, i, &jg_emlrtRTEI);
  for (i = 0; i < b_in1->size[0]; i++) {
    in1->data[i] = b_in1->data[i];
  }
  emxFree_real_T(&b_in1);
...
void firls(real_T varargin_1, const real_T varargin_2[4], emxArray_real_T *h)
{
  ...
  emxInit_real_T(&m, 2, &sd_emlrtRTEI, true);
  emxInit_real_T(&k, 1, &td_emlrtRTEI, true);
  emxInit_real_T(&G, 2, &je_emlrtRTEI, true);
  emxInit_real_T(&sinc1A, 2, &ke_emlrtRTEI, true);
  emxInit_real_T(&sinc2A, 2, &le_emlrtRTEI, true);
  emxInit_real_T(&sinc3A, 2, &me_emlrtRTEI, true);
  emxInit_real_T(&sinc4A, 2, &ne_emlrtRTEI, true);
  emxInit_real_T(&b, 1, &ae_emlrtRTEI, true);
  emxInit_real_T(&cpu_a, 1, &oe_emlrtRTEI, true);
  emxInit_real_T(&b_dv, 1, &pe_emlrtRTEI, true);
  emxInit_real_T(&x, 1, &qe_emlrtRTEI, true);
  emxInit_real_T(&b_dv1, 1, &pe_emlrtRTEI, true);
  emxInit_real_T(&y, 1, &re_emlrtRTEI, true);
  emxInit_real_T(&b_y, 1, &se_emlrtRTEI, true);
  emxInit_real_T(&b0, 1, &ce_emlrtRTEI, true);
  if ((!(max_freq > 1.0)) && (!(min_freq < 0.0))) {
    ...
    if (!Nodd) {
      ...
      emxEnsureCapacity_real_T(m, b_i, &sd_emlrtRTEI);
    ...
    b_i = k->size[0];
    k->size[0] = m->size[1];
    emxEnsureCapacity_real_T(k, b_i, &td_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      G->size[0] = k->size[0];
      G->size[1] = k->size[0];
      emxEnsureCapacity_real_T(G, b_i, &ud_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      b_i = k->size[0];
      k->size[0] = nx - i;
      emxEnsureCapacity_real_T(k, b_i, &be_emlrtRTEI);
    } else {
      i1Start = 0;
    }
    b_i = b->size[0];
    b->size[0] = k->size[0];
    emxEnsureCapacity_real_T(b, b_i, &ae_emlrtRTEI);
    ...
    for (int32_T s{0}; s < 2; s++) {
      ...
      emxEnsureCapacity_real_T(b_dv, b_i, &ee_emlrtRTEI);
      for (b_i = 0; b_i < k->size[0]; b_i++) {
      ...
      emxEnsureCapacity_real_T(b_dv1, b_i, &ee_emlrtRTEI);
      ...
      b_i = y->size[0];
      y->size[0] = k->size[0];
      emxEnsureCapacity_real_T(y, b_i, &ee_emlrtRTEI);
      for (b_i = 0; b_i < k->size[0]; b_i++) {
      ...
      b_i = b_y->size[0];
      b_y->size[0] = k->size[0];
      emxEnsureCapacity_real_T(b_y, b_i, &ee_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      emxEnsureCapacity_real_T(b0, b_i, &ce_emlrtRTEI);
      b0->data[0] = b_b0;
      loop_ub = b->size[0];
      for (b_i = 0; b_i < loop_ub; b_i++) {
      ...
      b_i = b->size[0];
      b->size[0] = b0->size[0];
      emxEnsureCapacity_real_T(b, b_i, &ge_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      emxEnsureCapacity_real_T(cpu_a, b_i, &de_emlrtRTEI);
      for (b_i = 0; b_i < b->size[0]; b_i++) {
    ...
    if (Nodd) {
      ...
      emxEnsureCapacity_real_T(x, b_i, &fe_emlrtRTEI);
      ...
      emxEnsureCapacity_real_T(h, b_i, &ie_emlrtRTEI);
      loop_ub = x->size[0];
      for (b_i = 0; b_i < loop_ub; b_i++) {
