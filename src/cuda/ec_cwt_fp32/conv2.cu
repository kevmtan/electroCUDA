...
static __global__ void conv2NonSeparable_kernel45(const emxArray_real32_T c,
                                                  const int32_T b,
...
static __global__ void conv2NonSeparable_kernel54(const emxArray_real32_T a,
                                                  const emxArray_int32_T iv,
                                                  const int32_T b,
                                                  emxArray_real32_T expanded);

static __global__ void
conv2NonSeparable_kernel55(const emxArray_real32_T expanded,
                           const emxArray_int32_T rows,
                           const emxArray_real32_T b, const int32_T c,
                           emxArray_real32_T b_c, int32_T b_dim0);

static __global__ void conv2_kernel28(const emxArray_real32_T a,
                                      const int32_T b_a, emxArray_real32_T c_a,
                                      int32_T a_dim0);

static __global__ void conv2_kernel29(const int32_T a, emxArray_real32_T c);

static __global__ void conv2_kernel30(const real32_T b,
                                      const emxArray_real32_T a,
                                      emxArray_real32_T c);

static __global__ void conv2_kernel31(const emxArray_real32_T c,
...
static __global__ void conv2_kernel34(const emxArray_real32_T a,
                                      const emxArray_int32_T iv,
                                      const int32_T b,
                                      emxArray_real32_T expanded);

static __global__ void conv2_kernel35(const real32_T b,
                                      const emxArray_real32_T expanded,
                                      const int32_T c, emxArray_real32_T b_c);

static __global__ void conv2_kernel36(const int32_T b, emxArray_real32_T c);

static __global__ void conv2_kernel37(const int32_T b, emxArray_real32_T c);

static __global__ void conv2_kernel38(const emxArray_real32_T a,
...
static __global__ void
conv2_kernel41(const emxArray_real32_T b, const int32_T mc,
               const emxArray_int32_T iv1, const int32_T c,
               emxArray_real32_T expanded, int32_T expanded_dim0);

static __global__ void
conv2_kernel42(const emxArray_real32_T expanded, const emxArray_int32_T cols,
                    ...
                    emxArray_real32_T *gpu_c, boolean_T *c_outdatedOnGpu)
{
  ...
  k = cpu_c->size[0];
  cpu_c->size[0] = mc;
  emxEnsureCapacity_real32_T(cpu_c, k, &pf_emlrtRTEI);
  ...
  *c_outdatedOnCpu = true;
  emxInit_real32_T(&cpu_expanded, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_y, 2, &uf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_rows, 2, &rf_emlrtRTEI, true);
  if ((cpu_a->size[0] != 0) && (cpu_b->size[0] != 0)) {
    if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
      ...
      *c_outdatedOnGpu = true;
      ...
      emxEnsureCapacity_real32_T(cpu_expanded, k, &rf_emlrtRTEI);
      ...
      emxEnsureCapacity_int32_T(cpu_y, k, &sf_emlrtRTEI);
      cpu_y->data[0] = 1;
      mc = 1;
      for (k = 0; k <= n - 2; k++) {
        mc++;
      ...
      emxEnsureCapacity_int32_T(cpu_iv, k, &rf_emlrtRTEI);
      mc = cpu_y->size[1] - 1;
      mwGetLaunchParameters1D(computeNumIters(mc), &grid, &block, 2147483647U);
      ...
      *a_outdatedOnGpu = false;
      ...
      emxEnsureCapacity_int32_T(cpu_rows, k, &sf_emlrtRTEI);
      cpu_rows->data[0] = 0;
      mc = 0;
      for (k = 0; k <= n - 2; k++) {
        mc++;
      ...
      emxEnsureCapacity_real32_T(cpu_c, k, &rf_emlrtRTEI);
                  ...
                  emxArray_real32_T *gpu_c, boolean_T *c_outdatedOnGpu)
{
  ...
  emxInit_real32_T(&b_cpu_c, 1, &wf_emlrtRTEI, true);
  emxInit_real32_T(&cpu_expanded, 2, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_y, 2, &uf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&b_cpu_y, 2, &uf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv1, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_rows, 2, &rf_emlrtRTEI, true);
  if ((cpu_a->size[0] == 0) || (cpu_a->size[1] == 0) || (cpu_b->size[0] == 0)) {
    ...
    k = b_cpu_c->size[0];
    b_cpu_c->size[0] = 1;
    emxEnsureCapacity_real32_T(b_cpu_c, k, &vf_emlrtRTEI);
    alpha1 = 1.0F;
    beta1 = 0.0F;
    gpuEmxEnsureCapacity_real32_T(cpu_a, gpu_a, !*a_outdatedOnGpu);
    gpuEmxEnsureCapacity_real32_T(cpu_b, gpu_b, !*b_outdatedOnGpu);
    ...
    *b_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_int32_T(b_cpu_y, k, &sf_emlrtRTEI);
    b_cpu_y->data[0] = 1;
    mc = 1;
    for (k = 0; k <= nc - 2; k++) {
      mc++;
    ...
    emxEnsureCapacity_int32_T(cpu_iv1, k, &rf_emlrtRTEI);
    k = b_cpu_y->size[1] - 1;
    mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
...
//
namespace coder {
void b_conv2(const emxArray_real32_T *cpu_a, const emxArray_real32_T *cpu_b,
             emxArray_real32_T *cpu_c, boolean_T *c_outdatedOnCpu,
             emxArray_real32_T *gpu_c, boolean_T *c_outdatedOnGpu)
{
  ...
  if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
    ...
    i = cpu_c->size[0];
    cpu_c->size[0] = 1;
    emxEnsureCapacity_real32_T(cpu_c, i, &qf_emlrtRTEI);
    cpu_c->data[0] = cpu_a->data[0] * cpu_b->data[0];
    *c_outdatedOnCpu = false;
    *c_outdatedOnGpu = true;
  } else if (cpu_b->size[0] > cpu_a->size[0]) {
    b_conv2NonSeparable((emxArray_real32_T *)cpu_b, &b_outdatedOnCpu, &gpu_b,
                        &b_outdatedOnGpu, (emxArray_real32_T *)cpu_a,
    ...
    b_conv2NonSeparable((emxArray_real32_T *)cpu_a, &a_outdatedOnCpu, &gpu_a,
                        &a_outdatedOnGpu, (emxArray_real32_T *)cpu_b,
           ...
           boolean_T *c_outdatedOnGpu)
{
  ...
  a_outdatedOnGpu = true;
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  emxInit_real32_T(&b_cpu_c, 1, &tf_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_a, 1, &mf_emlrtRTEI, true);
  emxInit_real32_T(&cpu_expanded, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_y, 2, &uf_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_expanded, 2, &rf_emlrtRTEI, true);
  emxInit_int32_T(&b_cpu_y, 2, &uf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv1, 1, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_rows, 2, &rf_emlrtRTEI, true);
  emxInit_int32_T(&cpu_cols, 2, &rf_emlrtRTEI, true);
  if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
    if (cpu_a->size[1] < 1) {
      int32_T k;
      k = cpu_c->size[0] * cpu_c->size[1];
      cpu_c->size[0] = 1;
      cpu_c->size[1] = 1;
      emxEnsureCapacity_real32_T(cpu_c, k, &of_emlrtRTEI);
      cpu_c->data[0] = 0.0F;
      *c_outdatedOnCpu = false;
      *c_outdatedOnGpu = true;
    } else {
      ...
      emxEnsureCapacity_real32_T(b_cpu_a, k, &mf_emlrtRTEI);
      k = cpu_a->size[1] - 1;
      mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
      ...
      *b_outdatedOnCpu = false;
      ...
      emxEnsureCapacity_real32_T(b_cpu_c, k, &pf_emlrtRTEI);
      k = b_cpu_a->size[0] - 1;
      mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
      gpuEmxEnsureCapacity_real32_T(b_cpu_c, &b_gpu_c, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      ...
      if (b_cpu_a->size[0] == 1) {
        ...
        k = b_cpu_c->size[0];
        b_cpu_c->size[0] = b_cpu_a->size[0];
        emxEnsureCapacity_real32_T(b_cpu_c, k, &rf_emlrtRTEI);
        mwApplyLaunchParameters(
      ...
      emxEnsureCapacity_real32_T(cpu_c, k, &qf_emlrtRTEI);
      k = b_cpu_c->size[0] - 1;
      mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
      gpuEmxEnsureCapacity_real32_T(cpu_c, gpu_c, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
    ...
    cpu_c->size[0] = mc;
    cpu_c->size[1] = nc;
    emxEnsureCapacity_real32_T(cpu_c, k, &nf_emlrtRTEI);
    k = mc * nc - 1;
    mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
    gpuEmxEnsureCapacity_real32_T(cpu_c, gpu_c, true);
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    ...
    if ((cpu_a->size[0] == 0) || (cpu_a->size[1] == 0)) {
      ...
      *c_outdatedOnCpu = true;
      ...
      emxEnsureCapacity_real32_T(b_cpu_expanded, k, &rf_emlrtRTEI);
      ...
      *b_outdatedOnGpu = false;
      ...
      emxEnsureCapacity_int32_T(cpu_cols, k, &sf_emlrtRTEI);
      cpu_cols->data[0] = 0;
      mc = 0;
      for (k = 0; k <= nc - 2; k++) {
        mc++;
