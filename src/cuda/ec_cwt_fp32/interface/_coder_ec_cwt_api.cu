...
//
// _coder_ec_cwt_api.cu
//
// Code generation for function '_coder_ec_cwt_api'
//

// Include files
#include "_coder_ec_cwt_api.h"
#include "ec_cwt.h"
                ...
                const mxArray *plhs[2])
{
  ...
  emxInit_real32_T(&x, 2, &xf_emlrtRTEI, true);
  x->canFreeData = false;
  ...
  emxInit_cell_wrap_0(&y, 2, &xf_emlrtRTEI, true);
  emxInit_real_T(&freqs, 1, &xf_emlrtRTEI, true);
  ec_cwt(x, fs, *fLims, fVoices, *ds, y, freqs);
  emxFree_real32_T(&x);
...
// End of code generation (_coder_ec_cwt_api.cu)
