...
// ec_cwt_emxutil.cu
//
// Code generation for function 'ec_cwt_emxutil'
//
    ...
    const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_real32_T(&pStruct->x, 2, srcLocation, doPush);
}
...
// End of code generation (ec_cwt_emxutil.cu)
