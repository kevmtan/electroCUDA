...
static emlrtRTEInfo kb_emlrtRTEI{ 42,  // lineNo
  6,                                   // colNo
  "ec_cwt",                            // fName
  "/home/kt/Gdrive/Git/electroCUDA/src/cuda/ec_cwt.m"// pName
};
...
static emlrtRTEInfo ob_emlrtRTEI{ 1265,// lineNo
  30,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023b/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo rb_emlrtRTEI{ 923, // lineNo
  26,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023b/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo fc_emlrtRTEI{ 42,  // lineNo
  12,                                  // colNo
  "ec_cwt",                            // fName
  "/home/kt/Gdrive/Git/electroCUDA/src/cuda/ec_cwt.m"// pName
};
...
static __global__ void ec_cwt_kernel14(const emxArray_real_T y, const int32_T
  b_y, emxArray_real_T dv7);
static __global__ void ec_cwt_kernel15(const emxArray_real_T xt, const
  emxArray_real_T dv7, const emxArray_real_T dv4, const int32_T b_dv4,
  emxArray_real_T fx);
static __global__ void ec_cwt_kernel16(const int16_T dv3_idx_1, emxArray_real_T
  fx);
...
static __global__ void ec_cwt_kernel25(const emxArray_real_T xt, const
  ...
  emxArray_real_T fx);
static __global__ void ec_cwt_kernel26(const int16_T dv3_idx_1, emxArray_real_T
  fx);
...
static __global__ void ec_cwt_kernel47(const emxArray_real_T xt, const
  emxArray_real_T dv14, const emxArray_real_T dv12, const int32_T b_dv12,
  emxArray_real_T fx);
static __global__ void ec_cwt_kernel48(const int16_T dv3_idx_1, emxArray_real_T
  fx);
...
static __global__ void ec_cwt_kernel57(const emxArray_real_T xt, const
  emxArray_real_T dv17, const emxArray_real_T dv16, const int32_T b_dv16,
  emxArray_real_T fx);
static __global__ void ec_cwt_kernel58(const int16_T dv3_idx_1, emxArray_real_T
  fx);
...
static __global__ void ec_cwt_kernel81(const real_T ds2, const int32_T j,
  emxArray_real_T dv1);
static __global__ void ec_cwt_kernel82(const int32_T i, const emxArray_real_T x,
  const int32_T b_x, emxArray_real_T xv, int32_T x_dim0);
static __global__ void ec_cwt_kernel83(const int32_T i, const emxArray_real_T x,
  const int32_T fb_SignalPad, emxArray_real_T b_x, int32_T x_dim0);
static __global__ void ec_cwt_kernel84(const int32_T fb_SignalPad, const int32_T
  bcoef, emxArray_real_T x);
static __global__ void ec_cwt_kernel85(const emxArray_real_T x, const int32_T k,
  emxArray_real_T xv);
static __global__ void ec_cwt_kernel86(const uint32_T xSize[2], const int32_T
  nbytes, emxArray_creal_T xposdft);
static __global__ void ec_cwt_kernel87(const emxArray_real_T xv, const int32_T
  b_xv, emxArray_creal_T xposdft);
static __global__ void ec_cwt_kernel88(const emxArray_creal_T xposdft, const
  ...
  cfsposdft_dim0);
static __global__ void ec_cwt_kernel89(const real_T cfsposdft_re, const
...
static __global__ void ec_cwt_kernel9(const emxArray_real_T x, const int32_T
  bcoef, emxArray_real_T y);
static __global__ void ec_cwt_kernel90(uint32_T xSize[2], int32_T cfsposdft_dim1);
static __global__ void ec_cwt_kernel91(const int32_T xSize, emxArray_creal_T
  cfspos);
static __global__ void ec_cwt_kernel92(const emxArray_creal_T cfspos, const
  int32_T bcoef, emxArray_real_T y);
static __global__ void ec_cwt_kernel93(const emxArray_real_T y, const int32_T
  b_y, const int32_T c_y, emxArray_real_T xCh, int32_T xCh_dim0, int32_T y_dim0);
static __global__ void ec_cwt_kernel94(const emxArray_real_T xCh, const int32_T
  nbytes, const int32_T bcoef, const int32_T i, emxArray_real_T b_xCh, int32_T
  xCh_dim0, int32_T b_xCh_dim0);
static __global__ void ec_cwt_kernel95(const emxArray_real_T xCh, const int32_T
  b_xCh, emxArray_real_T c_xCh);
static __global__ void ec_cwt_kernel96(const emxArray_real_T xCh, const int32_T
  xx_dim0, const int32_T i, const int32_T xx, const int32_T b_xx,
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel12(const
  emxArray_real_T a, const int32_T bcoef, emxArray_real_T dv4)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel14(const
  emxArray_real_T y, const int32_T b_y, emxArray_real_T dv7)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv7.data[k] = exp(-2.0 * y.data[k]);
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel15(const
  emxArray_real_T xt, const emxArray_real_T dv7, const emxArray_real_T dv4,
  const int32_T b_dv4, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    fx.data[k] = dv4.data[k] * dv7.data[k] * xt.data[k];
  }
}
  ...
  b_x)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    xt.data[k] = 2.0 * tkd1mtk / ((1.0 - xtmp) * (1.0 - xtmp));
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel22(const
  emxArray_real_T x, const int32_T bcoef, emxArray_real_T dv11)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel44(const
  emxArray_real_T a, const int32_T bcoef, emxArray_real_T dv12)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel46(const
  emxArray_real_T y, const int32_T b_y, emxArray_real_T dv14)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel47(const
  ...
  const int32_T b_dv12, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    fx.data[k] = dv12.data[k] * dv14.data[k] * xt.data[k];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel54(const
  emxArray_real_T x, const int32_T bcoef, emxArray_real_T dv16)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel57(const
  ...
  const int32_T b_dv16, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    fx.data[k] = dv16.data[k] * dv17.data[k] * xt.data[k];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel81(const real_T
  ds2, const int32_T j, emxArray_real_T dv1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv1.data[k] = ds2 * static_cast<real_T>(k) + 1.0;
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel82(const int32_T
  i, const emxArray_real_T x, const int32_T b_x, emxArray_real_T xv, int32_T
  x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel83(const int32_T
  i, const emxArray_real_T x, const int32_T fb_SignalPad, emxArray_real_T b_x,
  int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel84(const int32_T
  fb_SignalPad, const int32_T bcoef, emxArray_real_T x)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel85(const
  emxArray_real_T x, const int32_T k, emxArray_real_T xv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel86(const uint32_T
  xSize[2], const int32_T nbytes, emxArray_creal_T xposdft)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  int32_T psidft_dim0, int32_T cfsposdft_dim0)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    b_cfsposdft.data[b_k + cfsposdft_dim0 * k].re = psidft.data[b_bcoef * b_k +
      psidft_dim0 * (j2 - 1)] * xposdft.data[k].re;
    b_cfsposdft.data[b_k + cfsposdft_dim0 * k].im = psidft.data[b_bcoef * b_k +
      psidft_dim0 * (j2 - 1)] * xposdft.data[k].im;
  }
}
...
static __global__ __launch_bounds__(32, 1) void ec_cwt_kernel90(uint32_T xSize[2],
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel94(const
  emxArray_real_T xCh, const int32_T nbytes, const int32_T bcoef, const int32_T
  i, emxArray_real_T b_xCh, int32_T xCh_dim0, int32_T b_xCh_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_cwt_kernel96(const
  emxArray_real_T xCh, const int32_T xx_dim0, const int32_T i, const int32_T xx,
  const int32_T b_xx, emxArray_real_T c_xx, int32_T b_xx_dim0, int32_T xx_dim1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
            ...
            *cpu_freqs)
{
  ...
  if (!first_iteration) {
    ...
    emxInit_char_T(&str, 2, &nb_emlrtRTEI, true);
    ...
    if (cpu_wname[0] == 'm') {
      ...
      if (std::isinf(c_r) || std::isnan(c_r)) {
        ...
        if (i <= 0) {
          ...
          emxInit_real_T(&cpu_xt, 2, &yb_emlrtRTEI, true);
          ...
          emxInit_real_T(&cpu_dv4, 2, &dc_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_y, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv7, 2, &dc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel16<<<grid, block>>>(dv3_idx_1, d_gpu_fx);
                }
            ...
            if (guard1) {
              ...
              if (cpu_y->size[1] == b_cpu_y->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel11<<<grid, block>>>(l_gpu_y, k_gpu_y, i, b_gpu_a);
                  a_outdatedOnGpu = false;
              ...
              j = cpu_dv4->size[0] * cpu_dv4->size[1];
              cpu_dv4->size[0] = 1;
              cpu_dv4->size[1] = cpu_a->size[1];
              emxEnsureCapacity_real_T(cpu_dv4, j, &i_emlrtRTEI);
              ...
              if (validLaunchParams) {
                ...
                a_outdatedOnGpu = false;
                ec_cwt_kernel12<<<grid, block>>>(b_gpu_a, bcoef, gpu_dv4);
                dv4_outdatedOnCpu = true;
              }
              ...
              cpu_dv7->size[0] = 1;
              cpu_dv7->size[1] = c_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv7, j, &u_emlrtRTEI);
              ...
              if (validLaunchParams) {
                ec_cwt_kernel14<<<grid, block>>>(m_gpu_y, i, gpu_dv7);
                dv7_outdatedOnCpu = true;
              }

              if (cpu_dv4->size[1] == cpu_dv7->size[1]) {
                j = cpu_fx->size[0] * cpu_fx->size[1];
                cpu_fx->size[0] = 1;
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel15<<<grid, block>>>(d_gpu_xt, gpu_dv7, gpu_dv4,
                    bcoef, d_gpu_fx);
                  fx_outdatedOnGpu = false;
                ...
                xt_outdatedOnCpu = false;
                binary_expand_op_2(cpu_fx, cpu_dv4, cpu_dv7, cpu_xt);
                fx_outdatedOnCpu = false;
        ...
        if (i <= 0) {
          ...
          emxInit_real_T(&b_cpu_xt, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv11, 2, &gc_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_fx, 2, &qb_emlrtRTEI, true);
          emxInit_real_T(&f_cpu_y, 2, &hc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv13, 2, &gc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel26<<<grid, block>>>(dv3_idx_1, c_gpu_fx);
                }
            ...
            if (guard1) {
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (bcoef), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ec_cwt_kernel22<<<grid, block>>>(i_gpu_x, bcoef, gpu_dv11);
              ...
              emxEnsureCapacity_real_T(cpu_dv13, j, &v_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv13, &gpu_dv13);
              i = f_cpu_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ec_cwt_kernel24<<<grid, block>>>(j_gpu_y, i, gpu_dv13);
              ...
              if (cpu_dv11->size[1] == cpu_dv13->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel25<<<grid, block>>>(c_gpu_xt, gpu_dv13, gpu_dv11,
                    i, c_gpu_fx);
                  b_fx_outdatedOnGpu = false;
                ...
                b_xt_outdatedOnCpu = false;
                binary_expand_op_2(b_cpu_fx, cpu_dv11, cpu_dv13, b_cpu_xt);
                b_fx_outdatedOnCpu = false;
    ...
    if (!(c_r - r >= 1.0 / fb_VoicesPerOctave)) {
      ...
      emxInit_char_T(&b_str, 2, &nb_emlrtRTEI, true);
  ...
  if (validLaunchParams) {
    ec_cwt_kernel30<<<grid, block>>>(6.2831853071795862 / static_cast<real_T>(N),
      gpu_omega_tmp1, bcoef, gpu_omega_tmp2);
  }
  ...
  if (!first_iteration) {
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel68<<<grid, block>>>(b_gpu_y, halfh, i, gpu_fb_Scales);
    ...
    if (cpu_wav[0] == 'm') {
      ...
      if (std::isinf(c_r) || std::isnan(c_r)) {
        ...
        if (i <= 0) {
          ...
          emxInit_real_T(&c_cpu_xt, 2, &yb_emlrtRTEI, true);
          ...
          emxInit_real_T(&cpu_dv12, 2, &dc_emlrtRTEI, true);
          emxInit_real_T(&k_cpu_y, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv14, 2, &dc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel48<<<grid, block>>>(dv3_idx_1, b_gpu_fx);
                }
            ...
            if (guard1) {
              ...
              if (i_cpu_y->size[1] == j_cpu_y->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel43<<<grid, block>>>(h_gpu_y, g_gpu_y, i, gpu_a);
                  b_a_outdatedOnGpu = false;
              ...
              emxEnsureCapacity_real_T(cpu_dv12, j, &i_emlrtRTEI);
              ...
              if (validLaunchParams) {
                ...
                b_a_outdatedOnGpu = false;
                ec_cwt_kernel44<<<grid, block>>>(gpu_a, bcoef, gpu_dv12);
              ...
              emxEnsureCapacity_real_T(cpu_dv14, j, &u_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv14, &gpu_dv14);
              i = k_cpu_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ec_cwt_kernel46<<<grid, block>>>(i_gpu_y, i, gpu_dv14);
              ...
              if (cpu_dv12->size[1] == cpu_dv14->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel47<<<grid, block>>>(b_gpu_xt, gpu_dv14, gpu_dv12,
                    i, b_gpu_fx);
                  c_fx_outdatedOnGpu = false;
                ...
                c_xt_outdatedOnCpu = false;
                binary_expand_op_2(c_cpu_fx, cpu_dv12, cpu_dv14, c_cpu_xt);
                c_fx_outdatedOnCpu = false;
        ...
        if (i <= 0) {
          ...
          emxInit_real_T(&d_cpu_xt, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv16, 2, &gc_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_fx, 2, &qb_emlrtRTEI, true);
          emxInit_real_T(&l_cpu_y, 2, &hc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv17, 2, &gc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel58<<<grid, block>>>(dv3_idx_1, gpu_fx);
                }
            ...
            if (guard1) {
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (bcoef), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ec_cwt_kernel54<<<grid, block>>>(e_gpu_x, bcoef, gpu_dv16);
              ...
              emxEnsureCapacity_real_T(cpu_dv17, j, &v_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv17, &gpu_dv17);
              i = l_cpu_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ec_cwt_kernel56<<<grid, block>>>(f_gpu_y, i, gpu_dv17);
              ...
              if (cpu_dv16->size[1] == cpu_dv17->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ec_cwt_kernel57<<<grid, block>>>(gpu_xt, gpu_dv17, gpu_dv16,
                    bcoef, gpu_fx);
                  d_fx_outdatedOnGpu = false;
                ...
                d_xt_outdatedOnCpu = false;
                binary_expand_op_2(d_cpu_fx, cpu_dv16, cpu_dv17, d_cpu_xt);
                d_fx_outdatedOnCpu = false;
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel62<<<grid, block>>>(e_gpu_y, halfh, i, gpu_fb_Scales);
      fb_Scales_outdatedOnCpu = true;
    }
  ...
  if (first_iteration) {
    ...
    if (cpu_fb_Scales->size[1] == 1) {
      ...
      if (validLaunchParams) {
        ec_cwt_kernel71<<<grid, block>>>(gpu_fb_Omega, gpu_fb_Scales, bcoef, k,
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel73<<<grid, block>>>(gpu_absomega, bcoef, gpu_powscales);
    ...
    if ((cpu_absomega->size[0] == cpu_powscales->size[0]) && (cpu_absomega->
      ...
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
        &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_cwt_kernel75<<<grid, block>>>(gpu_powscales, gpu_absomega, bcoef,
          gpu_x);
    ...
    if ((j_cpu_x->size[0] == cpu_somega->size[0]) && (j_cpu_x->size[1] ==
      ...
      if (validLaunchParams) {
        ...
        ec_cwt_kernel77<<<grid, block>>>(gpu_somega, gpu_x, bcoef, gpu_psidft);
      }
    } else {
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel78<<<grid, block>>>(gpu_fb_Scales, bcoef, gpu_f);
    }
  } else {
    j = cpu_psidft->size[0] * cpu_psidft->size[1];
    ...
    gpuEmxEnsureCapacity_real_T(cpu_psidft, &gpu_psidft);
    bcoef = cpu_fb_Scales->size[1] * cpu_fb_Omega->size[1] - 1;
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel69<<<grid, block>>>(bcoef, gpu_psidft);
    }
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel70<<<grid, block>>>(gpu_fb_Scales, bcoef, gpu_f);
    }
  }
  ...
  if (std::isnan(ds2)) {
    ...
    cpu_dv1->size[1] = static_cast<int32_T>((static_cast<real_T>(cpu_x->size[0])
      - 1.0) / ds2) + 1;
    emxEnsureCapacity_real_T(cpu_dv1, nsubs, &w_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_dv1, &gpu_dv1);
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
      (static_cast<int64_T>((static_cast<real_T>(j) - 1.0) / ds2) + 1L), &grid,
      &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel81<<<grid, block>>>(ds2, j, gpu_dv1);
    }
  }
  ...
  emxInit_real_T(&cpu_xCh, 2, &kb_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_xCh, 2, &lb_emlrtRTEI, true);
  ...
  for (int64_T ch{0L}; ch <= e; ch++) {
    ...
    emxEnsureCapacity_real_T(cpu_xv, j, &db_emlrtRTEI);
    if (!xv_outdatedOnGpu) {
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_real_T(k_cpu_x, j, &gb_emlrtRTEI);
      ...
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef),
        &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_cwt_kernel84<<<grid, block>>>(fb_SignalPad, bcoef, c_gpu_x);
      }
      ...
      cpu_xv->size[1] = ((cpu_x->size[0] + k_cpu_x->size[1]) + div_s32(nsubs -
        eint, b_eint)) + 1;
      emxEnsureCapacity_real_T(cpu_xv, j, &hb_emlrtRTEI);
      if (!xv_outdatedOnGpu) {
        gpuEmxEnsureCapacity_real_T(cpu_xv, &gpu_xv);
      }
      ...
      if (validLaunchParams) {
        ...
        ec_cwt_kernel85<<<grid, block>>>(c_gpu_x, k, gpu_xv);
        xv_outdatedOnGpu = false;
        xv_outdatedOnCpu = true;
      }
    ...
    if (cpu_xv->size[1] - (static_cast<int32_T>(static_cast<uint32_T>
      ...
      if (validLaunchParams) {
        ...
        xv_outdatedOnGpu = false;
        ec_cwt_kernel87<<<grid, block>>>(gpu_xv, bcoef, gpu_xposdft);
      }
      ...
      emxEnsureCapacity_creal_T(cpu_xposdft, j, &fb_emlrtRTEI);
      gpuEmxEnsureCapacity_creal_T(cpu_xposdft, &gpu_xposdft);
      fftType = CUFFT_D2Z;
      ...
      if (validLaunchParams) {
        ...
        xSize_outdatedOnGpu = false;
        ec_cwt_kernel86<<<grid, block>>>(*gpu_xSize, nbytes, gpu_xposdft);
      }
    }
    ...
    emxEnsureCapacity_creal_T(cpu_cfsposdft, nsubs, &n_emlrtRTEI);
    ...
    if ((csz_idx_0 != 0) && (j != 0)) {
      ...
      if (validLaunchParams) {
        ...
        psidft_outdatedOnGpu = false;
        ec_cwt_kernel88<<<grid, block>>>(gpu_xposdft, gpu_psidft, bcoef, i, j -
    ...
    if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
      ...
      ec_cwt_kernel90<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_xSize,
      ...
      if (validLaunchParams) {
        ...
        ec_cwt_kernel91<<<grid, block>>>(bcoef, gpu_cfspos);
        cfspos_outdatedOnGpu = false;
      ...
      if (validLaunchParams) {
        ...
        ec_cwt_kernel89<<<grid, block>>>(static_cast<real_T>(bcoef),
          gpu_cfsposdft, i, gpu_cfspos);
        cfspos_outdatedOnGpu = false;
        cfspos_outdatedOnCpu = true;
      }
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_creal_T(cpu_cfspos, j, &jb_emlrtRTEI);
      if (!cfspos_outdatedOnGpu) {
        gpuEmxEnsureCapacity_creal_T(cpu_cfspos, &gpu_cfspos);
      }
    }
    ...
    emxEnsureCapacity_real_T(m_cpu_y, j, &r_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      cfspos_outdatedOnGpu = false;
      ec_cwt_kernel92<<<grid, block>>>(gpu_cfspos, bcoef, c_gpu_y);
    }

    j = cpu_xCh->size[0] * cpu_xCh->size[1];
    cpu_xCh->size[0] = m_cpu_y->size[1];
    cpu_xCh->size[1] = m_cpu_y->size[0];
    emxEnsureCapacity_real_T(cpu_xCh, j, &kb_emlrtRTEI);
    ...
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>((bcoef + 1L)
      * (i + 1L)), &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ec_cwt_kernel93<<<grid, block>>>(c_gpu_y, bcoef, i, gpu_xCh, cpu_xCh->
    ...
    if (ds2 > 1.0) {
      ...
      emxEnsureCapacity_real_T(b_cpu_xCh, j, &lb_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(b_cpu_xCh, &b_gpu_xCh);
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>((bcoef /
        nbytes + 1L) * i), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_cwt_kernel94<<<grid, block>>>(gpu_xCh, nbytes, bcoef, i, b_gpu_xCh,
      ...
      emxEnsureCapacity_real_T(cpu_xCh, j, &mb_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_xCh, &gpu_xCh);
      bcoef = b_cpu_xCh->size[0] * b_cpu_xCh->size[1] - 1;
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(bcoef + 1L),
        &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_cwt_kernel95<<<grid, block>>>(b_gpu_xCh, bcoef, gpu_xCh);
      }
    ...
    if (validLaunchParams) {
      ...
      ec_cwt_kernel96<<<grid, block>>>(gpu_xCh, xx[0], static_cast<int32_T>(ch +
                ...
                plhs[2])
{
  ...
  emxInit_real_T(&x, 2, &ic_emlrtRTEI, true);
  x->canFreeData = false;
  ...
  emxInit_real_T(&xx, 3, &ic_emlrtRTEI, true);
  emxInit_real_T(&freqs, 1, &ic_emlrtRTEI, true);
