...
cwtfilterbank_wt_kernel11(const int32_T i, const int32_T b, emxArray_real_T x);
                      ...
                      emxArray_creal_T *varargout_1)
{
  ...
  emxInit_real_T(&cpu_xv, 2, &xc_emlrtRTEI, true);
  ...
  if (self->SignalPad > 0.0) {
    ...
    emxInit_real_T(&cpu_x, 2, &bd_emlrtRTEI, true);
    xv_outdatedOnGpu = false;
    bcoef = cpu_x->size[0] * cpu_x->size[1];
    cpu_x->size[0] = 1;
    cpu_x->size[1] = i;
    emxEnsureCapacity_real_T(cpu_x, bcoef, &bd_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(cpu_xv, bcoef, &cd_emlrtRTEI);
    acoef = cpu_x->size[1];
  ...
  emxInit_creal_T(&cpu_xposdft, 2, &yc_emlrtRTEI, true);
  if (cpu_xv->size[1] == 0) {
    xv_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_creal_T(cpu_xposdft, bcoef, &yc_emlrtRTEI);
    ...
    cpu_xposdft->size[0] = 1;
    cpu_xposdft->size[1] = cpu_xv->size[1];
    emxEnsureCapacity_creal_T(cpu_xposdft, bcoef, &ad_emlrtRTEI);
  ...
  emxInit_creal_T(&cpu_cfsposdft, 2, &fd_emlrtRTEI, true);
  x_outdatedOnCpu = false;
  ...
  emxEnsureCapacity_creal_T(cpu_cfsposdft, bcoef, &wc_emlrtRTEI);
  ...
  if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
    ...
    emxEnsureCapacity_creal_T(varargout_1, bcoef, &dd_emlrtRTEI);
  ...
  if (self->SignalPad > 0.0) {
    ...
    emxEnsureCapacity_creal_T(varargout_1, bcoef, &ed_emlrtRTEI);
  }
