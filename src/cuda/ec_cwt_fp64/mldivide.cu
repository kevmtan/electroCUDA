              ...
              emxArray_real_T *gpu_Y, boolean_T *Y_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_A, 2, &df_emlrtRTEI, true);
  emxInit_int32_T(&cpu_jpvt, 2, &df_emlrtRTEI, true);
  emxInit_real_T(&cpu_tau, 1, &df_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_A, 2, &df_emlrtRTEI, true);
  emxInit_ptrdiff_t(&jpvt_t, 1, &ye_emlrtRTEI, true);
  emxInit_int32_T(&cpu_IPIV, 1, &ef_emlrtRTEI, true);
  emxInit_real_T(&cpu_B, 1, &bf_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_Y, u0, &se_emlrtRTEI);
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(b_cpu_A, u0, &ue_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(cpu_IPIV, u0, &we_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(cpu_A, u0, &te_emlrtRTEI);
    for (u0 = 0; u0 < A->size[0] * A->size[1]; u0++) {
    ...
    emxEnsureCapacity_int32_T(cpu_jpvt, u0, &ve_emlrtRTEI);
    u0 = cpu_A->size[0];
    ...
    emxEnsureCapacity_real_T(cpu_tau, u0, &xe_emlrtRTEI);
    u0 = jpvt_t->size[0];
    jpvt_t->size[0] = cpu_A->size[1];
    emxEnsureCapacity_ptrdiff_t(jpvt_t, u0, &ye_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(cpu_B, u0, &bf_emlrtRTEI);
    for (u0 = 0; u0 < B->size[0]; u0++) {
