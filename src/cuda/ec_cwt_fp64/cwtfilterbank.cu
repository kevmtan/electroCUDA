                                           ...
                                           real_T varargin_10)
{
  ...
  b = std::trunc(N / 2.0);
  emxInit_real_T(&omega_tmp1, 2, &x_emlrtRTEI, true);
  if (std::isnan(b)) {
    i = omega_tmp1->size[0] * omega_tmp1->size[1];
    omega_tmp1->size[0] = 1;
    omega_tmp1->size[1] = 1;
    emxEnsureCapacity_real_T(omega_tmp1, i, &x_emlrtRTEI);
  ...
  emxInit_real_T(&omega_tmp2, 2, &y_emlrtRTEI, true);
  i = omega_tmp2->size[0] * omega_tmp2->size[1];
  omega_tmp2->size[0] = 1;
  omega_tmp2->size[1] = omega_tmp1->size[1];
  emxEnsureCapacity_real_T(omega_tmp2, i, &y_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(b_self->Omega, i, &ab_emlrtRTEI);
  ...
  if (!y) {
    ...
    wavelet::internal::cwt::wavCFandSD(c_x, b_self->Gamma, b_self->Beta, &fo,
                                       &cf);
    fo = cf / cutoff;
    emxInit_real_T(&b_y, 2, &rb_emlrtRTEI, true);
    b = nv * b_log2(cf / omegac / fo);
    if (std::isnan(b)) {
      i = b_y->size[0] * b_y->size[1];
      b_y->size[0] = 1;
      b_y->size[1] = 1;
      emxEnsureCapacity_real_T(b_y, i, &q_emlrtRTEI);
      b_y->data[0] = rtNaN;
    } else if (b < 0.0) {
      b_y->size[0] = 1;
      b_y->size[1] = 0;
    ...
    emxInit_real_T(&c_b, 2, &sb_emlrtRTEI, true);
    i = c_b->size[0] * c_b->size[1];
    c_b->size[0] = 1;
    c_b->size[1] = b_y->size[1];
    emxEnsureCapacity_real_T(c_b, i, &bb_emlrtRTEI);
    nx = b_y->size[1];
    for (i2 = 0; i2 < nx; i2++) {
    ...
    emxEnsureCapacity_real_T(b_self->Scales, i, &cb_emlrtRTEI);
    ...
    N = rt_powd_snf(2.0, 1.0 / nv);
    emxInit_real_T(&c_y, 2, &ub_emlrtRTEI, true);
    b = std::fmax(b_log2(b / fo), 1.0 / nv) * nv;
    if (std::isnan(b)) {
      i = c_y->size[0] * c_y->size[1];
      c_y->size[0] = 1;
      c_y->size[1] = 1;
      emxEnsureCapacity_real_T(c_y, i, &q_emlrtRTEI);
      c_y->data[0] = rtNaN;
    } else if (b < 0.0) {
      c_y->size[0] = 1;
      c_y->size[1] = 0;
    ...
    emxInit_real_T(&d_b, 2, &xb_emlrtRTEI, true);
    i = d_b->size[0] * d_b->size[1];
    d_b->size[0] = 1;
    d_b->size[1] = c_y->size[1];
    emxEnsureCapacity_real_T(d_b, i, &bb_emlrtRTEI);
    nx = c_y->size[1];
    for (i2 = 0; i2 < nx; i2++) {
    ...
    emxEnsureCapacity_real_T(b_self->Scales, i, &db_emlrtRTEI);
  ...
  emxInit_real_T(&psidft, 2, &bc_emlrtRTEI, true);
  emxInit_real_T(&f, 2, &cc_emlrtRTEI, true);
  if (y) {
    ga = b_self->Gamma;
    be = b_self->Beta;
    emxInit_real_T(&b_somega, 2, &vb_emlrtRTEI, true);
    if (b_self->Scales->size[1] == 1) {
      ...
      emxEnsureCapacity_real_T(b_somega, i, &gb_emlrtRTEI);
    ...
    emxEnsureCapacity_real_T(absomega, i, &d_emlrtRTEI);
    for (i2 = 0; i2 < nx; i2++) {
      absomega->data[i2] = std::abs(b_somega->data[i2]);
    }
    emxInit_real_T(&powscales, 2, &ib_emlrtRTEI, true);
    if (ga == 3.0) {
      i = powscales->size[0] * powscales->size[1];
      powscales->size[0] = absomega->size[0];
      powscales->size[1] = absomega->size[1];
      emxEnsureCapacity_real_T(powscales, i, &ib_emlrtRTEI);
      ...
      powscales->size[0] = absomega->size[0];
      powscales->size[1] = absomega->size[1];
      emxEnsureCapacity_real_T(powscales, i, &bb_emlrtRTEI);
    ...
    emxInit_real_T(&b_x, 2, &jb_emlrtRTEI, true);
    if ((absomega->size[0] == powscales->size[0]) &&
      ...
      emxEnsureCapacity_real_T(b_x, i, &jb_emlrtRTEI);
      for (i = 0; i < absomega->size[0] * absomega->size[1]; i++) {
    ...
    if ((b_x->size[0] == b_somega->size[0]) &&
      ...
      emxEnsureCapacity_real_T(psidft, i, &mb_emlrtRTEI);
    ...
    if (b_self->Scales->size[1] == 1) {
      ...
      emxEnsureCapacity_real_T(somega, i, &eb_emlrtRTEI);
      loop_ub = b_self->Omega->size[1];
      for (i = 0; i < loop_ub; i++) {
        nx = b_self->Scales->size[1];
        for (i2 = 0; i2 < nx; i2++) {
    ...
    emxInit_real_T(&d_y, 2, &ac_emlrtRTEI, true);
    i = d_y->size[0] * d_y->size[1];
    d_y->size[0] = w->size[0];
    d_y->size[1] = w->size[1];
    emxEnsureCapacity_real_T(d_y, i, &d_emlrtRTEI);
    for (i2 = 0; i2 < nx; i2++) {
    ...
    if ((expnt->size[0] == d_y->size[0]) && (expnt->size[1] == d_y->size[1])) {
      ...
      emxEnsureCapacity_real_T(psidft, i, &kb_emlrtRTEI);
    ...
    f->size[0] = 1;
    f->size[1] = b_self->Scales->size[1];
    emxEnsureCapacity_real_T(f, i, &lb_emlrtRTEI);
    for (i = 0; i < b_self->Scales->size[1]; i++) {
  ...
  emxEnsureCapacity_real_T(b_self->PsiDFT, i, &pb_emlrtRTEI);
  ...
  emxEnsureCapacity_real_T(b_self->WaveletCenterFrequencies, i, &qb_emlrtRTEI);
