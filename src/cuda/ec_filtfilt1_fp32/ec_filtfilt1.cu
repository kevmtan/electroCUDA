...
ec_filtfilt1_kernel1(const int32_T ch, const emxArray_real32_T x,
                     const int32_T b_x, emxArray_real32_T fv, int32_T x_dim0);

static __global__ void ec_filtfilt1_kernel10(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel11(const emxArray_real32_T b,
                                             const int32_T b_b,
                                             emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel12(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel13(const emxArray_real32_T yc3,
                                             const int32_T bcoef,
                                             const int32_T i5, const int32_T b,
                                             emxArray_real32_T b_yc3);

static __global__ void ec_filtfilt1_kernel14(const real32_T a,
                                             const emxArray_real32_T z,
                                             const int32_T b_z,
                                             emxArray_real32_T c_z);

static __global__ void ec_filtfilt1_kernel15(const emxArray_real32_T b,
                                             const int32_T b_b,
                                             emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel16(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel17(const emxArray_real32_T yc2,
                                             const int32_T bcoef,
                                             const int32_T i5, const int32_T b,
                                             emxArray_real32_T b_yc2);

static __global__ void ec_filtfilt1_kernel18(const emxArray_real32_T yc5,
                                             const int32_T bcoef,
                                             const int32_T i5, const int32_T b,
                                             emxArray_real32_T fv);

static __global__ void ec_filtfilt1_kernel19(const emxArray_real32_T fv,
                                             const int32_T ch, const int32_T b,
                                             emxArray_real32_T y,
                                             int32_T y_dim0);

static __global__ void ec_filtfilt1_kernel2(const emxArray_real32_T fv,
                                            const int32_T bcoef,
                                            const int32_T i3, const int32_T i2,
                                            const real32_T a, const int32_T i5,
                                            emxArray_real32_T xt);

static __global__ void ec_filtfilt1_kernel3(const emxArray_real32_T b,
                                            const int32_T b_b,
                                            emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel4(const emxArray_real32_T a,
                                            const int32_T b_a,
                                            emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel5(const real32_T a,
                                            const emxArray_real32_T z,
                                            const int32_T b_z,
                                            emxArray_real32_T c_z);

static __global__ void ec_filtfilt1_kernel6(const emxArray_real32_T b,
                                            const int32_T b_b,
                                            emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel7(const emxArray_real32_T a,
                                            const int32_T b_a,
                                            emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel8(const emxArray_real32_T fv,
                                            const int32_T bcoef,
                                            const int32_T i7, const int32_T i6,
                                            const real32_T a, const int32_T i5,
                                            emxArray_real32_T c);

static __global__ void ec_filtfilt1_kernel9(const emxArray_real32_T b,
                                            const int32_T b_b,
                                            emxArray_real32_T c_b);
                  ...
                  emxArray_real32_T *cpu_y)
{
  ...
  for (int32_T ch{0}; ch < b_i; ch++) {
    ...
    if (validLaunchParams) {
      ec_filtfilt1_kernel1<<<grid, block>>>(ch, gpu_x, i, gpu_fv,
                                            cpu_x->size[0U]);
    }
    ...
    for (int32_T ii{0}; ii < i1; ii++) {
      ...
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        ec_filtfilt1_kernel18<<<grid, block>>>(gpu_yc5, bcoef, i5, i, gpu_fv);
      }
      fv_outdatedOnGpu = false;
    }
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      ec_filtfilt1_kernel19<<<grid, block>>>(gpu_fv, ch, i5 - 1, gpu_y,
                                             cpu_y->size[0U]);
    }
    yc5_outdatedOnCpu = true;
  }
