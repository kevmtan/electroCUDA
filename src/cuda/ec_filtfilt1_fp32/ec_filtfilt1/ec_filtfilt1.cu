...
static __global__ void ec_filtfilt1_kernel10(const real32_T *a1,
                                             const int32_T na,
                                             emxArray_real32_T a);
...
static __global__ void ec_filtfilt1_kernel13(const emxArray_real32_T xt,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real32_T expanded);

static __global__ void ec_filtfilt1_kernel14(const emxArray_real32_T expanded,
...
static __global__ void ec_filtfilt1_kernel15(const emxArray_real32_T y,
                                             const int32_T x,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel16(const emxArray_real32_T y,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel17(const emxArray_real32_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real32_T zfIIR);

static __global__ void ec_filtfilt1_kernel18(const emxArray_real32_T convOut,
...
static __global__ void ec_filtfilt1_kernel22(const real32_T *a1,
                                             const int32_T na,
                                             emxArray_real32_T a);
...
static __global__ void ec_filtfilt1_kernel25(const emxArray_real32_T fv,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real32_T expanded);

static __global__ void ec_filtfilt1_kernel26(const emxArray_real32_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real32_T b,
                                             const int32_T OH,
                                             emxArray_real32_T convOut,
...
static __global__ void ec_filtfilt1_kernel27(const emxArray_real32_T zfIIR,
                                             const int32_T x,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel28(const emxArray_real32_T zfIIR,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel29(const emxArray_real32_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real32_T zfIIR);
...
static __global__ void ec_filtfilt1_kernel30(const emxArray_real32_T convOut,
                                             const emxArray_real32_T a,
                                             const int32_T x,
                                             emxArray_real32_T zfIIR,
                                             int32_T a_dim0, int32_T fv_dim0);

static __global__ void ec_filtfilt1_kernel31(const emxArray_real32_T convOut,
                                             const int32_T fv,
                                             emxArray_real32_T y);

static __global__ void ec_filtfilt1_kernel32(const emxArray_real32_T fv,
                                             real32_T *a, int32_T fv_dim0);

static __global__ void ec_filtfilt1_kernel33(const emxArray_real32_T fv,
                                             const int32_T bcoef,
                                             const int32_T KH, const int32_T n,
                                             const real32_T *a, const int32_T x,
                                             emxArray_real32_T xt);

static __global__ void ec_filtfilt1_kernel34(const emxArray_real32_T b,
                                             const int32_T b_b,
                                             emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel35(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel36(const real32_T *a1,
                                             const int32_T nb,
                                             emxArray_real32_T b);

static __global__ void ec_filtfilt1_kernel37(const real32_T *a1,
                                             const int32_T na,
                                             emxArray_real32_T a);

static __global__ void ec_filtfilt1_kernel38(emxArray_real32_T a);
...
static __global__ void ec_filtfilt1_kernel40(const emxArray_real32_T xt,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real32_T expanded);

static __global__ void ec_filtfilt1_kernel41(const emxArray_real32_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real32_T b,
                                             const int32_T OH,
                                             emxArray_real32_T convOut,
...
static __global__ void ec_filtfilt1_kernel42(const emxArray_real32_T zfIIR,
                                             const int32_T x,
                                             emxArray_real32_T convOut);
...
static __global__ void ec_filtfilt1_kernel44(const emxArray_real32_T convOut,
                                             const int32_T xt,
                                             emxArray_real32_T yc3);

static __global__ void ec_filtfilt1_kernel45(const emxArray_real32_T yc3,
                                             real32_T *a, int32_T yc3_dim0);

static __global__ void ec_filtfilt1_kernel46(const real32_T *a,
                                             const emxArray_real32_T z,
                                             const int32_T b_z,
                                             emxArray_real32_T y);

static __global__ void ec_filtfilt1_kernel47(const emxArray_real32_T b,
                                             const int32_T b_b,
                                             emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel48(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel49(const real32_T *a1,
                                             const int32_T nb,
                                             emxArray_real32_T b);
...
static __global__ void ec_filtfilt1_kernel50(const real32_T *a1,
                                             const int32_T na,
                                             emxArray_real32_T a);

static __global__ void ec_filtfilt1_kernel51(emxArray_real32_T a);
...
static __global__ void
ec_filtfilt1_kernel54(const emxArray_real32_T yc3, const int32_T i25,
                      const int32_T i23, const emxArray_int32_T iv3,
                      const int32_T k, emxArray_real32_T expanded);
...
static __global__ void ec_filtfilt1_kernel56(const emxArray_real32_T y,
                                             const int32_T x,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel57(const emxArray_real32_T y,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel58(const emxArray_real32_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real32_T zfIIR);

static __global__ void
ec_filtfilt1_kernel59(const emxArray_real32_T convOut, const int32_T i25,
                      const int32_T i23, const int32_T i26,
                      const emxArray_real32_T a, const int32_T x,
...
static __global__ void ec_filtfilt1_kernel60(const emxArray_real32_T b,
                                             const int32_T b_b,
                                             emxArray_real32_T c_b);

static __global__ void ec_filtfilt1_kernel61(const emxArray_real32_T a,
                                             const int32_T b_a,
                                             emxArray_real32_T c_a);

static __global__ void ec_filtfilt1_kernel62(const real32_T *a1,
                                             const int32_T nb,
                                             emxArray_real32_T b);

static __global__ void ec_filtfilt1_kernel63(const real32_T *a1,
                                             const int32_T na,
                                             emxArray_real32_T a);

static __global__ void ec_filtfilt1_kernel64(emxArray_real32_T a);
...
static __global__ void
ec_filtfilt1_kernel67(const emxArray_real32_T y, const int32_T i25,
                      const int32_T i23, const emxArray_int32_T iv4,
                      const int32_T k, emxArray_real32_T expanded);

static __global__ void ec_filtfilt1_kernel68(const emxArray_real32_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real32_T b,
                                             const int32_T OH,
                                             emxArray_real32_T convOut,
...
static __global__ void ec_filtfilt1_kernel69(const emxArray_real32_T zfIIR,
                                             const int32_T x,
                                             emxArray_real32_T convOut);
...
static __global__ void ec_filtfilt1_kernel70(const emxArray_real32_T zfIIR,
                                             emxArray_real32_T convOut);

static __global__ void ec_filtfilt1_kernel71(const emxArray_real32_T convOut,
                                             const int32_T i25,
                                             const int32_T i23,
                                             const int32_T i26,
                                             emxArray_real32_T yc5);

static __global__ void ec_filtfilt1_kernel72(const emxArray_real32_T yc5,
                                             const int32_T bcoef,
                                             const int32_T x, const int32_T n,
                                             emxArray_real32_T fv);

static __global__ void
ec_filtfilt1_kernel73(const emxArray_real32_T fv, const int32_T x,
                      const int32_T b_fv, emxArray_real32_T y, int32_T y_dim0);
...
static __global__ void
ec_filtfilt1_kernel9(const real32_T *a1, const int32_T nb, emxArray_real32_T b);
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel10(
    const real32_T *a1, const int32_T na, emxArray_real32_T a)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel12(
    const uint32_T window_idx_0, const int32_T OH, emxArray_real32_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel13(
    ...
    const int32_T b_y, emxArray_real32_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel14(
    ...
    const emxArray_real32_T b, const int32_T OH, emxArray_real32_T convOut,
    int32_T b_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel15(
    const emxArray_real32_T y, const int32_T x, emxArray_real32_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel16(
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel17(
    const emxArray_real32_T convOut, const int32_T x, const int32_T bcoef,
    emxArray_real32_T zfIIR)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel18(
    const emxArray_real32_T convOut, const emxArray_real32_T a, const int32_T x,
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel21(
    const real32_T *a1, const int32_T nb, emxArray_real32_T b)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel27(
    const emxArray_real32_T zfIIR, const int32_T x, emxArray_real32_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel33(
    ...
    const int32_T n, const real32_T *a, const int32_T x, emxArray_real32_T xt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel38(emxArray_real32_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel51(emxArray_real32_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel54(
    ...
    const emxArray_int32_T iv3, const int32_T k, emxArray_real32_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel57(
    const emxArray_real32_T y, emxArray_real32_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel59(
    ...
    const int32_T i26, const emxArray_real32_T a, const int32_T x,
    emxArray_real32_T zfIIR, int32_T a_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel64(emxArray_real32_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel67(
    ...
    const emxArray_int32_T iv4, const int32_T k, emxArray_real32_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel71(
    const emxArray_real32_T convOut, const int32_T i25, const int32_T i23,
    const int32_T i26, emxArray_real32_T yc5)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel72(
    ...
    const int32_T n, emxArray_real32_T fv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel73(
    const emxArray_real32_T fv, const int32_T x, const int32_T b_fv,
                  ...
                  emxArray_real32_T *cpu_y)
{
  ...
  for (int64_T ch{0L}; ch <= b; ch++) {
    ...
    for (int32_T ii{0}; ii < i; ii++) {
      ...
      gpuEmxEnsureCapacity_real32_T(b_cpu_a, &c_gpu_a);
      ...
      gpuEmxEnsureCapacity_real32_T(c_cpu_a, &d_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      if (cpu_fv->size[0] == 0) {
        ...
        if (validLaunchParams) {
          ...
          c_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel25<<<grid, block>>>(gpu_fv, offsetH, g_gpu_y,
      ...
      cudaMemcpy(b_gpu_a, &g_cpu_a, 4UL, cudaMemcpyHostToDevice);
      ...
      if (k != 0) {
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(b_x + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel33<<<grid, block>>>(gpu_fv, bcoef, KH, n, b_gpu_a,
                                                 k - 1, gpu_xt);
        }
      }
      ...
      gpuEmxEnsureCapacity_real32_T(d_cpu_a, &e_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      gpuEmxEnsureCapacity_real32_T(e_cpu_a, &f_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      if (div_s32(i26 - i23, i25) + 1 == 0) {
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel54<<<grid, block>>>(gpu_yc3, i25, i23, gpu_iv3, k,
                                                 b_gpu_expanded);
        }
        ...
        if (validLaunchParams) {
          ...
          d_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel59<<<grid, block>>>(b_gpu_convOut, i25, i23, i26,
      ...
      gpuEmxEnsureCapacity_real32_T(f_cpu_a, &g_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      if (div_s32(i26 - i23, i25) + 1 == 0) {
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(k + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel67<<<grid, block>>>(d_gpu_y, i25, i23, gpu_iv4, k,
                                                 gpu_expanded);
        }
        ...
        if (validLaunchParams) {
          ...
          e_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel71<<<grid, block>>>(gpu_convOut, i25, i23, i26,
                                                 gpu_yc5);
        }
      }
      ...
      validLaunchParams =
          mwGetLaunchParameters1D(static_cast<real_T>((n - b_x) / bcoef + 1L),
                                  &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_filtfilt1_kernel72<<<grid, block>>>(gpu_yc5, bcoef, b_x, n, gpu_fv);
      }
    }
