...
static __global__ void ec_filtfilt1_kernel11(const emxArray_real_T xt,
...
ec_filtfilt1_kernel12(const emxArray_real_T expanded,
                      const emxArray_int32_T rows, const emxArray_real_T b,
                      int32_T OH, emxArray_real_T convOut, int32_T b_dim0);

static __global__ void ec_filtfilt1_kernel13(const emxArray_real_T y, int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel14(const emxArray_real_T y,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel15(const emxArray_real_T convOut,
                                             const int32_T x, int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void ec_filtfilt1_kernel16(const emxArray_real_T convOut,
                                             const emxArray_real_T a, int32_T x,
                                             emxArray_real_T zfIIR,
                                             int32_T a_dim0, int32_T xt_dim0);

static __global__ void ec_filtfilt1_kernel17(const emxArray_real_T b,
                                             int32_T b_b, emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel18(const emxArray_real_T a,
                                             int32_T b_a, emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel19(const real_T *a1, int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel2(const int32_T x,
                                            const emxArray_real_T b_x,
                                            int32_T c_x, emxArray_real_T dv,
                                            int32_T x_dim0);

static __global__ void ec_filtfilt1_kernel20(const real_T *a1, int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel21(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel22(int32_T OH, uint32_T window_idx_0,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel23(const emxArray_real_T dv,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             int32_T b_y,
                                             emxArray_real_T expanded);
...
static __global__ void
ec_filtfilt1_kernel24(const emxArray_real_T expanded,
                      const emxArray_int32_T rows, const emxArray_real_T b,
                      int32_T OH, emxArray_real_T convOut, int32_T b_dim0);

static __global__ void ec_filtfilt1_kernel25(const emxArray_real_T zfIIR,
                                             int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel26(const emxArray_real_T convOut,
                                             const int32_T x, int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void ec_filtfilt1_kernel27(const emxArray_real_T convOut,
                                             const emxArray_real_T a, int32_T x,
                                             emxArray_real_T zfIIR,
                                             int32_T a_dim0, int32_T dv_dim0);

static __global__ void ec_filtfilt1_kernel28(const emxArray_real_T convOut,
                                             int32_T dv, emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel29(const emxArray_real_T dv,
                                             const int32_T bcoef,
                                             const int32_T KH, const int32_T n,
                                             const real_T a, int32_T x,
                                             emxArray_real_T xt);
...
static __global__ void ec_filtfilt1_kernel30(const emxArray_real_T b,
                                             int32_T b_b, emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel31(const emxArray_real_T a,
                                             int32_T b_a, emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel32(const real_T *a1, int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel33(const real_T *a1, int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel34(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel35(int32_T OH, uint32_T window_idx_0,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel36(const emxArray_real_T xt,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             int32_T b_y,
                                             emxArray_real_T expanded);
...
static __global__ void
ec_filtfilt1_kernel37(const emxArray_real_T expanded,
                      const emxArray_int32_T rows, const emxArray_real_T b,
                      int32_T OH, emxArray_real_T convOut, int32_T b_dim0);

static __global__ void ec_filtfilt1_kernel38(const emxArray_real_T zfIIR,
                                             int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel39(const emxArray_real_T convOut,
                                             int32_T xt, emxArray_real_T yc3);

static __global__ void ec_filtfilt1_kernel4(const real_T a,
                                            const emxArray_real_T z,
                                            int32_T b_z, emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel40(const real_T a,
                                             const emxArray_real_T z,
                                             int32_T b_z, emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel41(const emxArray_real_T b,
                                             int32_T b_b, emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel42(const emxArray_real_T a,
                                             int32_T b_a, emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel43(const real_T *a1, int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel44(const real_T *a1, int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel45(emxArray_real_T a);
...
static __global__ void
ec_filtfilt1_kernel48(const emxArray_real_T yc3, const int32_T i24,
                      const int32_T i23, const emxArray_int32_T iv3, int32_T k,
                      emxArray_real_T expanded);

static __global__ void
ec_filtfilt1_kernel49(const emxArray_real_T expanded,
                      const emxArray_int32_T rows, const emxArray_real_T b,
                      int32_T OH, emxArray_real_T convOut, int32_T b_dim0);

static __global__ void ec_filtfilt1_kernel5(const emxArray_real_T b,
                                            int32_T b_b, emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel50(const emxArray_real_T y, int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel51(const emxArray_real_T y,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel52(const emxArray_real_T convOut,
                                             const int32_T x, int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void
ec_filtfilt1_kernel53(const emxArray_real_T convOut, const int32_T i24,
                      const int32_T i23, const int32_T i26,
                      const emxArray_real_T a, int32_T x, emxArray_real_T zfIIR,
                      int32_T a_dim0);

static __global__ void ec_filtfilt1_kernel54(const emxArray_real_T b,
                                             int32_T b_b, emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel55(const emxArray_real_T a,
                                             int32_T b_a, emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel56(const real_T *a1, int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel57(const real_T *a1, int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel58(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel59(int32_T OH, uint32_T window_idx_0,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel6(const emxArray_real_T a,
                                            int32_T b_a, emxArray_real_T c_a);
...
static __global__ void
ec_filtfilt1_kernel61(const emxArray_real_T y, const int32_T i24,
...
static __global__ void ec_filtfilt1_kernel64(const emxArray_real_T convOut,
                                             ...
                                             int32_T i24, emxArray_real_T yc5);

static __global__ void ec_filtfilt1_kernel65(const emxArray_real_T yc5,
                                             const int32_T bcoef,
                                             const int32_T x, int32_T n,
                                             emxArray_real_T dv);

static __global__ void ec_filtfilt1_kernel66(const emxArray_real_T dv,
                                             const int32_T x, int32_T b_dv,
                                             emxArray_real_T y, int32_T y_dim0);

static __global__ void ec_filtfilt1_kernel7(const real_T *a1, int32_T nb,
                                            emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel8(const real_T *a1, int32_T na,
                                            emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel9(emxArray_real_T a);
...
static real_T emlrt_marshallIn(const mxArray *nf, const char_T *identifier);
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel10(
    int32_T OH, uint32_T window_idx_0, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel11(
    ...
    int32_T b_y, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel12(
    ...
    const emxArray_real_T b, int32_T OH, emxArray_real_T convOut,
    int32_T b_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel13(
    const emxArray_real_T y, int32_T x, emxArray_real_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel14(const emxArray_real_T y,
                                                        emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel15(
    const emxArray_real_T convOut, const int32_T x, int32_T bcoef,
    emxArray_real_T zfIIR)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel16(
    const emxArray_real_T convOut, const emxArray_real_T a, int32_T x,
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel17(
    const emxArray_real_T b, int32_T b_b, emxArray_real_T c_b)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel18(
    const emxArray_real_T a, int32_T b_a, emxArray_real_T c_a)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel19(
    const real_T *a1, int32_T nb, emxArray_real_T b)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel2(
    const int32_T x, const emxArray_real_T b_x, int32_T c_x, emxArray_real_T dv,
    int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel20(
    const real_T *a1, int32_T na, emxArray_real_T a)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel21(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel25(
    const emxArray_real_T zfIIR, int32_T x, emxArray_real_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel28(
    const emxArray_real_T convOut, int32_T dv, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel29(
    ...
    const int32_T n, const real_T a, int32_T x, emxArray_real_T xt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel3(
    ...
    const int32_T i1, const real_T a, int32_T x, emxArray_real_T xt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel34(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel39(
    const emxArray_real_T convOut, int32_T xt, emxArray_real_T yc3)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel4(
    const real_T a, const emxArray_real_T z, int32_T b_z, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel45(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel48(
    ...
    const emxArray_int32_T iv3, int32_T k, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel51(const emxArray_real_T y,
                                                        emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel53(
    ...
    const int32_T i26, const emxArray_real_T a, int32_T x,
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel58(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel61(
    ...
    const emxArray_int32_T iv4, int32_T k, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel64(
    const emxArray_real_T convOut, int32_T i26, int32_T i23, int32_T i24,
    emxArray_real_T yc5)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel65(
    const emxArray_real_T yc5, const int32_T bcoef, const int32_T x, int32_T n,
    emxArray_real_T dv)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel66(
    const emxArray_real_T dv, const int32_T x, int32_T b_dv, emxArray_real_T y,
    int32_T y_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel9(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  ...
  for (int64_T ch{0L}; ch <= b; ch++) {
    ...
    for (int32_T ii{0}; ii < i; ii++) {
      ...
      if (validLaunchParams) {
        ...
        b_dirtyOnCpu = false;
        if (c_b_dirtyOnCpu) {
          gpuEmxMemcpyCpuToGpu_real_T(&c_gpu_b, c_cpu_b);
        }
      ...
      gpuEmxEnsureCapacity_real_T(c_cpu_a, &c_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      if (c_cpu_a->size[0] > c_cpu_b->size[0]) {
        ...
        if (b_x - 1 >= 0) {
          if (b_b_dirtyOnGpu) {
            gpuEmxMemcpyGpuToCpu_real_T(c_cpu_b, &c_gpu_b);
          }
      ...
      if (cpu_dv->size[0] == 0) {
        ...
        if (validLaunchParams) {
          ...
          c_y_dirtyOnCpu = false;
          ec_filtfilt1_kernel23<<<grid, block>>>(gpu_dv, offsetH, g_gpu_y,
        ...
        if (cpu_zfIIR->size[0] != 0) {
          if (cpu_zfIIR->size[0] == 1) {
            ...
            if (zfIIR_dirtyOnGpu) {
              gpuEmxMemcpyGpuToCpu_real_T(cpu_zfIIR, &c_gpu_zfIIR);
            }
            zfIIR_dirtyOnGpu = false;
        ...
        for (KH = 0; KH <= b_x - 2; KH++) {
          ...
          for (offsetH = 0; offsetH <= bcoef - 2; offsetH++) {
            ...
            if (b_a_dirtyOnGpu) {
              gpuEmxMemcpyGpuToCpu_real_T(c_cpu_a, &c_gpu_a);
            }
            b_a_dirtyOnGpu = false;
      ...
      if (k != 0) {
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(b_x + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel29<<<grid, block>>>(gpu_dv, bcoef, KH, n, a, k - 1,
                                                 gpu_xt);
          xt_dirtyOnGpu = true;
        }
      }
      ...
      if (validLaunchParams) {
        ...
        b_dirtyOnCpu = false;
        if (d_b_dirtyOnCpu) {
          gpuEmxMemcpyCpuToGpu_real_T(&d_gpu_b, d_cpu_b);
        }
      ...
      gpuEmxEnsureCapacity_real_T(d_cpu_a, &d_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
      ...
      if (d_cpu_a->size[0] > d_cpu_b->size[0]) {
        ...
        if (b_x - 1 >= 0) {
          if (c_b_dirtyOnGpu) {
            gpuEmxMemcpyGpuToCpu_real_T(d_cpu_b, &d_gpu_b);
          }
        ...
        if (b_cpu_zfIIR->size[0] != 0) {
          if (b_cpu_zfIIR->size[0] == 1) {
            ...
            if (b_zfIIR_dirtyOnGpu) {
              gpuEmxMemcpyGpuToCpu_real_T(b_cpu_zfIIR, &b_gpu_zfIIR);
            }
            b_zfIIR_dirtyOnGpu = false;
      ...
      if (div_s32(i26 - i23, i24) + 1 == 0) {
        ...
        a = (static_cast<real_T>(div_s32(i26 - i23, i24) + 1) +
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel48<<<grid, block>>>(gpu_yc3, i24, i23, gpu_iv3, k,
                                                 b_gpu_expanded);
        }
        ...
        r = dim3(static_cast<uint32_T>(std::floor((a + (x - 1.0)) / x)), 1U,
                 1U);
        if (x >= -2.147483648E+9) {
        ...
        if (validLaunchParams) {
          ...
          d_convOut_dirtyOnCpu = false;
          ec_filtfilt1_kernel53<<<grid, block>>>(b_gpu_convOut, i24, i23, i26,
      ...
      if (div_s32(i26 - i23, i24) + 1 == 0) {
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(k + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel61<<<grid, block>>>(d_gpu_y, i24, i23, gpu_iv4, k,
                                                 gpu_expanded);
        }
        ...
        if (c_cpu_zfIIR->size[0] != 0) {
          if (c_cpu_zfIIR->size[0] == 1) {
            ...
            if (c_zfIIR_dirtyOnGpu) {
              gpuEmxMemcpyGpuToCpu_real_T(c_cpu_zfIIR, &gpu_zfIIR);
            }
            c_zfIIR_dirtyOnGpu = false;
        ...
        if (validLaunchParams) {
          ...
          e_convOut_dirtyOnCpu = false;
          ec_filtfilt1_kernel64<<<grid, block>>>(gpu_convOut, i26, i23, i24,
                                                 gpu_yc5);
        }
      }
      ...
      validLaunchParams =
          mwGetLaunchParameters1D(static_cast<real_T>((n - b_x) / bcoef + 1L),
                                  &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_filtfilt1_kernel65<<<grid, block>>>(gpu_yc5, bcoef, b_x, n, gpu_dv);
        dv_dirtyOnGpu = true;
      }
    }
