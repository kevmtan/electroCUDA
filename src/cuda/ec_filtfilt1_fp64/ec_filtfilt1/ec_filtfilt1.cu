...
static emlrtRTEInfo g_emlrtRTEI{
    ...
    "/usr/local/MATLAB/R2023b/toolbox/gpucoder/gpucoder/+gpucoder/+internal/"
...
static __global__ void ec_filtfilt1_kernel1(const emxArray_real_T a, real_T *a1,
                                            real_T *b_a1, real_T *c_a1,
                                            real_T *d_a1, real_T *e_a1);

static __global__ void ec_filtfilt1_kernel10(const real_T *a1, const int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel11(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel12(const uint32_T window_idx_0,
                                             const int32_T OH,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel13(const emxArray_real_T xt,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel14(const emxArray_real_T expanded,
...
static __global__ void ec_filtfilt1_kernel15(const emxArray_real_T y,
                                             const int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel16(const emxArray_real_T y,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel17(const emxArray_real_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void ec_filtfilt1_kernel18(const emxArray_real_T convOut,
                                             const emxArray_real_T a,
                                             const int32_T x,
                                             emxArray_real_T zfIIR,
                                             int32_T a_dim0, int32_T xt_dim0);

static __global__ void ec_filtfilt1_kernel19(const emxArray_real_T b,
                                             const int32_T b_b,
                                             emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel2(const int32_T x,
                                            const emxArray_real_T b_x,
                                            const int32_T c_x,
                                            emxArray_real_T dv, int32_T x_dim0);

static __global__ void ec_filtfilt1_kernel20(const emxArray_real_T a,
                                             const int32_T b_a,
                                             emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel21(const real_T *a1, const int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel22(const real_T *a1, const int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel23(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel24(const uint32_T window_idx_0,
                                             const int32_T OH,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel25(const emxArray_real_T dv,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel26(const emxArray_real_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real_T b,
                                             const int32_T OH,
                                             emxArray_real_T convOut,
...
static __global__ void ec_filtfilt1_kernel27(const emxArray_real_T zfIIR,
                                             const int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel28(const emxArray_real_T zfIIR,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel29(const emxArray_real_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void ec_filtfilt1_kernel3(const emxArray_real_T dv,
                                            real_T *a);

static __global__ void ec_filtfilt1_kernel30(const emxArray_real_T convOut,
                                             const emxArray_real_T a,
                                             const int32_T x,
                                             emxArray_real_T zfIIR,
                                             int32_T a_dim0, int32_T dv_dim0);

static __global__ void ec_filtfilt1_kernel31(const emxArray_real_T convOut,
                                             const int32_T dv,
                                             emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel32(const emxArray_real_T dv,
                                             real_T *a, int32_T dv_dim0);

static __global__ void ec_filtfilt1_kernel33(const emxArray_real_T dv,
                                             const int32_T bcoef,
                                             const int32_T KH, const int32_T n,
                                             const real_T *a, const int32_T x,
                                             emxArray_real_T xt);

static __global__ void ec_filtfilt1_kernel34(const emxArray_real_T b,
                                             const int32_T b_b,
                                             emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel35(const emxArray_real_T a,
                                             const int32_T b_a,
                                             emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel36(const real_T *a1, const int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel37(const real_T *a1, const int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel38(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel39(const uint32_T window_idx_0,
                                             const int32_T OH,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel4(const emxArray_real_T dv,
                                            const int32_T bcoef,
                                            const int32_T i2, const int32_T i1,
                                            const real_T *a, const int32_T x,
                                            emxArray_real_T xt);

static __global__ void ec_filtfilt1_kernel40(const emxArray_real_T xt,
                                             const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel41(const emxArray_real_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real_T b,
                                             const int32_T OH,
                                             emxArray_real_T convOut,
...
static __global__ void ec_filtfilt1_kernel42(const emxArray_real_T zfIIR,
                                             const int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel43(const emxArray_real_T zfIIR,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel44(const emxArray_real_T convOut,
                                             const int32_T xt,
                                             emxArray_real_T yc3);

static __global__ void ec_filtfilt1_kernel45(const emxArray_real_T yc3,
                                             real_T *a, int32_T yc3_dim0);

static __global__ void ec_filtfilt1_kernel46(const real_T *a,
                                             const emxArray_real_T z,
                                             const int32_T b_z,
                                             emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel47(const emxArray_real_T b,
                                             const int32_T b_b,
                                             emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel48(const emxArray_real_T a,
                                             const int32_T b_a,
                                             emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel49(const real_T *a1, const int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel5(const emxArray_real_T xt,
                                            real_T *a);

static __global__ void ec_filtfilt1_kernel50(const real_T *a1, const int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel51(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel52(const uint32_T window_idx_0,
                                             const int32_T OH,
                                             emxArray_real_T expanded);
...
ec_filtfilt1_kernel54(const emxArray_real_T yc3, const int32_T i24,
                      const int32_T i23, const emxArray_int32_T iv3,
                      const int32_T k, emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel55(const emxArray_real_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real_T b,
                                             const int32_T OH,
                                             emxArray_real_T convOut,
...
static __global__ void ec_filtfilt1_kernel56(const emxArray_real_T y,
                                             const int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel57(const emxArray_real_T y,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel58(const emxArray_real_T convOut,
                                             const int32_T x,
                                             const int32_T bcoef,
                                             emxArray_real_T zfIIR);

static __global__ void
ec_filtfilt1_kernel59(const emxArray_real_T convOut, const int32_T i24,
                      const int32_T i23, const int32_T i26,
                      const emxArray_real_T a, const int32_T x,
                      emxArray_real_T zfIIR, int32_T a_dim0);

static __global__ void ec_filtfilt1_kernel6(const real_T *a,
                                            const emxArray_real_T z,
                                            const int32_T b_z,
                                            emxArray_real_T y);

static __global__ void ec_filtfilt1_kernel60(const emxArray_real_T b,
                                             const int32_T b_b,
                                             emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel61(const emxArray_real_T a,
                                             const int32_T b_a,
                                             emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel62(const real_T *a1, const int32_T nb,
                                             emxArray_real_T b);

static __global__ void ec_filtfilt1_kernel63(const real_T *a1, const int32_T na,
                                             emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel64(emxArray_real_T a);

static __global__ void ec_filtfilt1_kernel65(const uint32_T window_idx_0,
                                             const int32_T OH,
                                             emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel66(const int32_T offsetH,
                                             const emxArray_int32_T y,
                                             const int32_T b_y,
                                             emxArray_int32_T iv4);

static __global__ void
ec_filtfilt1_kernel67(const emxArray_real_T y, const int32_T i24,
                      const int32_T i23, const emxArray_int32_T iv4,
                      const int32_T k, emxArray_real_T expanded);

static __global__ void ec_filtfilt1_kernel68(const emxArray_real_T expanded,
                                             const emxArray_int32_T rows,
                                             const emxArray_real_T b,
                                             const int32_T OH,
                                             emxArray_real_T convOut,
...
static __global__ void ec_filtfilt1_kernel69(const emxArray_real_T zfIIR,
                                             const int32_T x,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel7(const emxArray_real_T b,
                                            const int32_T b_b,
                                            emxArray_real_T c_b);

static __global__ void ec_filtfilt1_kernel70(const emxArray_real_T zfIIR,
                                             emxArray_real_T convOut);

static __global__ void ec_filtfilt1_kernel71(const emxArray_real_T convOut,
                                             const int32_T i24,
                                             const int32_T i23,
                                             const int32_T i26,
                                             emxArray_real_T yc5);

static __global__ void ec_filtfilt1_kernel72(const emxArray_real_T yc5,
                                             const int32_T bcoef,
                                             const int32_T x, const int32_T n,
                                             emxArray_real_T dv);

static __global__ void ec_filtfilt1_kernel73(const emxArray_real_T dv,
                                             const int32_T x,
                                             const int32_T b_dv,
                                             emxArray_real_T y, int32_T y_dim0);

static __global__ void ec_filtfilt1_kernel8(const emxArray_real_T a,
                                            const int32_T b_a,
                                            emxArray_real_T c_a);

static __global__ void ec_filtfilt1_kernel9(const real_T *a1, const int32_T nb,
                                            emxArray_real_T b);
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel1(
    const emxArray_real_T a, real_T *a1, real_T *b_a1, real_T *c_a1,
    real_T *d_a1, real_T *e_a1)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel10(
    const real_T *a1, const int32_T na, emxArray_real_T a)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel11(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel12(
    const uint32_T window_idx_0, const int32_T OH, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel13(
    const emxArray_real_T xt, const int32_T offsetH, const emxArray_int32_T y,
    const int32_T b_y, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel14(
    ...
    const emxArray_real_T b, const int32_T OH, emxArray_real_T convOut,
    int32_T b_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel15(
    const emxArray_real_T y, const int32_T x, emxArray_real_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel16(const emxArray_real_T y,
                                                        emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel17(
    const emxArray_real_T convOut, const int32_T x, const int32_T bcoef,
    emxArray_real_T zfIIR)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel18(
    const emxArray_real_T convOut, const emxArray_real_T a, const int32_T x,
    emxArray_real_T zfIIR, int32_T a_dim0, int32_T xt_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel2(
    const int32_T x, const emxArray_real_T b_x, const int32_T c_x,
    emxArray_real_T dv, int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv.data[k] = b_x.data[k + x_dim0 * (x - 1)];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel21(
    const real_T *a1, const int32_T nb, emxArray_real_T b)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel23(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel25(
    const emxArray_real_T dv, const int32_T offsetH, const emxArray_int32_T y,
    const int32_T b_y, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel27(
    const emxArray_real_T zfIIR, const int32_T x, emxArray_real_T convOut)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel28(
    const emxArray_real_T zfIIR, emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel3(const emxArray_real_T dv,
                                                       real_T *a)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel30(
    const emxArray_real_T convOut, const emxArray_real_T a, const int32_T x,
    emxArray_real_T zfIIR, int32_T a_dim0, int32_T dv_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    for (int32_T j{0}; j <= k - 2; j++) {
      zfIIR.data[orow + 1] +=
          convOut.data[(dv_dim0 + orow) - j] * a.data[j + 1];
    }
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel31(
    const emxArray_real_T convOut, const int32_T dv, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>(dv);
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel32(
    const emxArray_real_T dv, real_T *a, int32_T dv_dim0)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  tmpIdx = static_cast<int32_T>(threadId);
  if (tmpIdx < 1) {
    *a = 2.0 * dv.data[dv_dim0 - 1];
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel33(
    const emxArray_real_T dv, const int32_T bcoef, const int32_T KH,
    const int32_T n, const real_T *a, const int32_T x, emxArray_real_T xt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    xt.data[k] = *a - dv.data[(n + KH * (bcoef * k)) - 1];
  }
}
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel38(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel4(
    const emxArray_real_T dv, const int32_T bcoef, const int32_T i2,
    const int32_T i1, const real_T *a, const int32_T x, emxArray_real_T xt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    xt.data[k] = *a - dv.data[(i1 + i2 * (bcoef * k)) - 1];
  }
}
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel43(
    const emxArray_real_T zfIIR, emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel44(
    const emxArray_real_T convOut, const int32_T xt, emxArray_real_T yc3)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel45(
    const emxArray_real_T yc3, real_T *a, int32_T yc3_dim0)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel5(const emxArray_real_T xt,
                                                       real_T *a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  ...
  tmpIdx = static_cast<int32_T>(threadId);
  if (tmpIdx < 1) {
    // 'ec_filtfilt1:140' [~,zo] = filter(b(:,ii),a(:,ii),xt,z(:,ii)*xt(1,:),1);
    *a = xt.data[0];
  }
}
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel51(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel54(
    const emxArray_real_T yc3, const int32_T i24, const int32_T i23,
    const emxArray_int32_T iv3, const int32_T k, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    expanded.data[iv3.data[b_k]] = yc3.data[(i23 + i24 * b_k) - 1];
  }
}
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel57(const emxArray_real_T y,
                                                        emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel59(
    const emxArray_real_T convOut, const int32_T i24, const int32_T i23,
    const int32_T i26, const emxArray_real_T a, const int32_T x,
    emxArray_real_T zfIIR, int32_T a_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    for (int32_T j{0}; j <= k - 2; j++) {
      zfIIR.data[orow + 1] +=
          convOut.data[((div_s32_device(i26 - i23, i24) + orow) - j) + 1] *
          a.data[j + 1];
    }
  }
}
...
static __global__
    __launch_bounds__(32, 1) void ec_filtfilt1_kernel64(emxArray_real_T a)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel67(
    const emxArray_real_T y, const int32_T i24, const int32_T i23,
    const emxArray_int32_T iv4, const int32_T k, emxArray_real_T expanded)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T b_k;
    b_k = static_cast<int32_T>(idx);
    expanded.data[iv4.data[b_k]] = y.data[(i23 + i24 * b_k) - 1];
  }
}
...
static __global__ __launch_bounds__(32, 1) void ec_filtfilt1_kernel70(
    const emxArray_real_T zfIIR, emxArray_real_T convOut)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel71(
    const emxArray_real_T convOut, const int32_T i24, const int32_T i23,
    const int32_T i26, emxArray_real_T yc5)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>((i26 - i23) / i24);
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
...
static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel72(
    const emxArray_real_T yc5, const int32_T bcoef, const int32_T x,
    const int32_T n, emxArray_real_T dv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv.data[k] = yc5.data[x + bcoef * k];
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_filtfilt1_kernel73(
    const emxArray_real_T dv, const int32_T x, const int32_T b_dv,
    emxArray_real_T y, int32_T y_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
                                        ...
                                        emxArray_real_T *gpu)
{
  ...
  if (gpu->data == 0) {
    newData = 0UL;
    mwCudaMalloc(&newData,
                 static_cast<uint32_T>(cpu->allocatedSize) * sizeof(real_T));
    gpu->numDimensions = cpu->numDimensions;
    gpu->size = static_cast<int32_T *>(emlrtCallocMex(
        static_cast<uint32_T>(gpu->numDimensions), sizeof(int32_T)));
    for (int32_T i{0}; i < cpu->numDimensions; i++) {
                                        ...
                                        const emxArray_real_T *cpu)
{
  ...
  if (gpu->allocatedSize < actualSize) {
    ...
    gpu->canFreeData = true;
    mwCudaMalloc(&gpu->data,
                 static_cast<uint32_T>(gpu->allocatedSize) * sizeof(real_T));
  }
  cudaMemcpy(gpu->data, cpu->data,
                  ...
                  real_T nf, real_T L, emxArray_real_T *cpu_y)
{
  ...
  boolean_T b_convOut_outdatedOnCpu;
  boolean_T b_convOut_outdatedOnGpu;
  boolean_T b_outdatedOnGpu;
  boolean_T b_rows_outdatedOnGpu;
  boolean_T b_y_outdatedOnGpu;
  boolean_T c_a_outdatedOnCpu;
  boolean_T c_convOut_outdatedOnCpu;
  boolean_T c_convOut_outdatedOnGpu;
  boolean_T c_rows_outdatedOnGpu;
  boolean_T c_y_outdatedOnGpu;
  boolean_T convOut_outdatedOnCpu;
  boolean_T convOut_outdatedOnGpu;
  boolean_T d_a_outdatedOnCpu;
  boolean_T d_convOut_outdatedOnCpu;
  boolean_T d_convOut_outdatedOnGpu;
  boolean_T d_rows_outdatedOnGpu;
  boolean_T d_y_outdatedOnGpu;
  boolean_T e_a_outdatedOnCpu;
  boolean_T e_convOut_outdatedOnCpu;
  boolean_T e_convOut_outdatedOnGpu;
  boolean_T e_rows_outdatedOnGpu;
  boolean_T e_y_outdatedOnGpu;
  boolean_T f_y_outdatedOnGpu;
  ...
  e_convOut_outdatedOnCpu = false;
  e_convOut_outdatedOnGpu = false;
  e_rows_outdatedOnGpu = false;
  f_y_outdatedOnGpu = false;
  d_convOut_outdatedOnCpu = false;
  d_convOut_outdatedOnGpu = false;
  d_rows_outdatedOnGpu = false;
  e_a_outdatedOnCpu = false;
  e_y_outdatedOnGpu = false;
  c_convOut_outdatedOnCpu = false;
  c_convOut_outdatedOnGpu = false;
  c_rows_outdatedOnGpu = false;
  d_a_outdatedOnCpu = false;
  d_y_outdatedOnGpu = false;
  b_convOut_outdatedOnCpu = false;
  b_convOut_outdatedOnGpu = false;
  c_a_outdatedOnCpu = false;
  b_rows_outdatedOnGpu = false;
  c_y_outdatedOnGpu = false;
  ...
  emxEnsureCapacity_real_T(cpu_y, bcoef, &emlrtRTEI);
  //  Loop across chans
  ...
  emxInit_real_T(&cpu_xt, 1, &l_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_y, 1, &m_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_b, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_a, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_b, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_a, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&cpu_expanded, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&c_cpu_y, 2, &g_emlrtRTEI, true);
  emxInit_int32_T(&cpu_rows, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_y, 1, &n_emlrtRTEI, true);
  emxInit_real_T(&cpu_convOut, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_expanded, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&e_cpu_y, 2, &g_emlrtRTEI, true);
  emxInit_int32_T(&b_cpu_rows, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&cpu_zfIIR, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_b, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_a, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_convOut, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&cpu_yc3, 1, &i_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_zfIIR, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_expanded, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&f_cpu_y, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&g_cpu_y, 1, &o_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_b, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_a, 1, &e_emlrtRTEI, true);
  emxInit_int32_T(&c_cpu_rows, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_convOut, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_expanded, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&h_cpu_y, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&f_cpu_b, 1, &e_emlrtRTEI, true);
  emxInit_real_T(&f_cpu_a, 1, &e_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv3, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&d_cpu_rows, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&cpu_yc5, 1, &j_emlrtRTEI, true);
  emxInit_real_T(&d_cpu_convOut, 1, &f_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_expanded, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&i_cpu_y, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&c_cpu_zfIIR, 1, &f_emlrtRTEI, true);
  emxInit_int32_T(&cpu_iv4, 1, &g_emlrtRTEI, true);
  emxInit_int32_T(&e_cpu_rows, 2, &g_emlrtRTEI, true);
  emxInit_real_T(&e_cpu_convOut, 1, &f_emlrtRTEI, true);
  ...
  for (int64_T ch{0L}; ch <= b; ch++) {
    ...
    emxEnsureCapacity_real_T(cpu_dv, k, &b_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_dv, &gpu_dv);
    b_x = cpu_x->size[0] - 1;
    ...
    for (int32_T ii{0}; ii < i; ii++) {
      ...
      if (b_a_outdatedOnGpu) {
        cudaMemcpy(b_gpu_a, &g_cpu_a, 8UL, cudaMemcpyHostToDevice);
      }
      ec_filtfilt1_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(gpu_dv,
                                                                    b_gpu_a);
      b_a_outdatedOnGpu = false;
      k = cpu_xt->size[0];
      cpu_xt->size[0] = csz_idx_0;
      emxEnsureCapacity_real_T(cpu_xt, k, &c_emlrtRTEI);
      ...
      if (csz_idx_0 != 0) {
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel4<<<grid, block>>>(
              gpu_dv, static_cast<int32_T>(div_s32(i3 - i1, i2) + 1 != 1), i2,
      ...
      emxEnsureCapacity_real_T(b_cpu_y, k, &d_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        ec_filtfilt1_kernel6<<<grid, block>>>(b_gpu_a, gpu_z, bcoef, gpu_y);
      }
      k = b_cpu_b->size[0];
      b_cpu_b->size[0] = cpu_b->size[0];
      emxEnsureCapacity_real_T(b_cpu_b, k, &e_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        ec_filtfilt1_kernel7<<<grid, block>>>(gpu_b, bcoef, b_gpu_b);
      }
      k = b_cpu_a->size[0];
      b_cpu_a->size[0] = cpu_a->size[0];
      emxEnsureCapacity_real_T(b_cpu_a, k, &e_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        a_outdatedOnGpu = false;
        ec_filtfilt1_kernel8<<<grid, block>>>(gpu_a, bcoef, c_gpu_a);
      ...
      if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel9<<<grid, block>>>(e_gpu_a1, nb, b_gpu_b);
        }
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(na - 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel10<<<grid, block>>>(e_gpu_a1, na, c_gpu_a);
        }
        ec_filtfilt1_kernel11<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(c_gpu_a);
        a_outdatedOnCpu = true;
      }
      if (b_cpu_a->size[0] > b_cpu_b->size[0]) {
        ...
        emxEnsureCapacity_real_T(b_cpu_b, bcoef, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(b_cpu_b, &b_gpu_b);
        if (b_x - 1 >= 0) {
          cudaMemset(&b_gpu_b.data[k], 0,
                     static_cast<uint32_T>(b_x) * sizeof(real_T));
        }
      }
      ...
      if (cpu_xt->size[0] == 0) {
        ...
        emxEnsureCapacity_real_T(cpu_zfIIR, k, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(cpu_zfIIR, &c_gpu_zfIIR);
      } else {
        ...
        emxEnsureCapacity_real_T(cpu_expanded, k, &g_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(cpu_expanded, &e_gpu_expanded);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel12<<<grid, block>>>(
              window_idx_0, static_cast<int32_T>(u), e_gpu_expanded);
        }
        n = cpu_xt->size[0];
        ...
        if (validLaunchParams) {
          ...
          b_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel13<<<grid, block>>>(gpu_xt, offsetH, h_gpu_y,
        ...
        emxEnsureCapacity_real_T(cpu_convOut, k, &g_emlrtRTEI);
        if (!convOut_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real_T(cpu_convOut, &e_gpu_convOut);
        }
        r = dim3(
        ...
        if (validLaunchParams) {
          ...
          rows_outdatedOnGpu = false;
          if (convOut_outdatedOnGpu) {
            gpuEmxMemcpyCpuToGpu_real_T(&e_gpu_convOut, cpu_convOut);
          }
          ec_filtfilt1_kernel14<<<grid, block>>>(
        ...
        if (b_cpu_y->size[0] != 0) {
          if (b_cpu_y->size[0] == 1) {
            ...
            ec_filtfilt1_kernel16<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
                gpu_y, e_gpu_convOut);
            convOut_outdatedOnGpu = false;
            convOut_outdatedOnCpu = true;
          } else {
            ...
            if (validLaunchParams) {
              ...
              ec_filtfilt1_kernel15<<<grid, block>>>(gpu_y, b_x, e_gpu_convOut);
              convOut_outdatedOnGpu = false;
              convOut_outdatedOnCpu = true;
            }
          }
        ...
        for (KH = 0; KH <= b_x - 2; KH++) {
          ...
          for (offsetH = 0; offsetH <= bcoef - 2; offsetH++) {
            if (convOut_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(cpu_convOut, &e_gpu_convOut);
            }
            if (a_outdatedOnCpu) {
        ...
        if (validLaunchParams) {
          ...
          convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel17<<<grid, block>>>(e_gpu_convOut, b_x, bcoef,
                                                 c_gpu_zfIIR);
        }
        b_x = b_cpu_a->size[0];
        validLaunchParams = mwGetLaunchParameters1D(
        ...
        if (validLaunchParams) {
          ...
          convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel18<<<grid, block>>>(e_gpu_convOut, c_gpu_a, b_x,
      ...
      emxEnsureCapacity_real_T(c_cpu_b, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(c_cpu_b, &c_gpu_b);
      bcoef = cpu_b->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ...
        b_outdatedOnGpu = false;
        ec_filtfilt1_kernel19<<<grid, block>>>(gpu_b, bcoef, c_gpu_b);
      }
      k = c_cpu_a->size[0];
      c_cpu_a->size[0] = cpu_a->size[0];
      emxEnsureCapacity_real_T(c_cpu_a, k, &e_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        a_outdatedOnGpu = false;
        ec_filtfilt1_kernel20<<<grid, block>>>(gpu_a, bcoef, d_gpu_a);
      ...
      if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel21<<<grid, block>>>(d_gpu_a1, b_nb, c_gpu_b);
        }
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(b_na - 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel22<<<grid, block>>>(d_gpu_a1, b_na, d_gpu_a);
        }
        ec_filtfilt1_kernel23<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(d_gpu_a);
        b_a_outdatedOnCpu = true;
      }
      if (c_cpu_a->size[0] > c_cpu_b->size[0]) {
        ...
        emxEnsureCapacity_real_T(c_cpu_b, bcoef, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(c_cpu_b, &c_gpu_b);
        if (b_x - 1 >= 0) {
      ...
      if (cpu_dv->size[0] == 0) {
        ...
        emxEnsureCapacity_real_T(b_cpu_expanded, k, &g_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(b_cpu_expanded, &d_gpu_expanded);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(
                (static_cast<int32_T>(u) + static_cast<int32_T>(window_idx_0)) -
                1L),
        ...
        if (validLaunchParams) {
          ...
          c_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel25<<<grid, block>>>(gpu_dv, offsetH, g_gpu_y,
        ...
        emxEnsureCapacity_real_T(b_cpu_convOut, k, &g_emlrtRTEI);
        if (!b_convOut_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real_T(b_cpu_convOut, &d_gpu_convOut);
        }
        r = dim3(
            static_cast<uint32_T>(std::floor(
                (static_cast<real_T>(OH) + (static_cast<real_T>(b_x) - 1.0)) /
        ...
        if (validLaunchParams) {
          ...
          b_rows_outdatedOnGpu = false;
          if (b_convOut_outdatedOnGpu) {
            gpuEmxMemcpyCpuToGpu_real_T(&d_gpu_convOut, b_cpu_convOut);
          }
          ec_filtfilt1_kernel26<<<grid, block>>>(
              d_gpu_expanded, d_gpu_rows, c_gpu_b, static_cast<int32_T>(u),
              d_gpu_convOut, c_cpu_b->size[0U]);
          b_convOut_outdatedOnGpu = false;
          b_convOut_outdatedOnCpu = true;
        }
        if (cpu_zfIIR->size[0] != 0) {
          if (cpu_zfIIR->size[0] == 1) {
            ...
            ec_filtfilt1_kernel28<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            ...
            if (validLaunchParams) {
              ...
              ec_filtfilt1_kernel27<<<grid, block>>>(c_gpu_zfIIR, b_x,
                                                     d_gpu_convOut);
              b_convOut_outdatedOnGpu = false;
              b_convOut_outdatedOnCpu = true;
            }
        ...
        b_x = cpu_dv->size[0] + c_cpu_a->size[0];
        for (KH = 0; KH <= b_x - 2; KH++) {
          bcoef = static_cast<int32_T>(
              std::fmin(static_cast<real_T>(KH) + 1.0,
                        static_cast<real_T>(c_cpu_a->size[0])));
          for (offsetH = 0; offsetH <= bcoef - 2; offsetH++) {
            if (b_convOut_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(b_cpu_convOut, &d_gpu_convOut);
            }
        ...
        if (static_cast<uint32_T>(cpu_dv->size[0]) + 1U >
        ...
        if (validLaunchParams) {
          ...
          b_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel29<<<grid, block>>>(d_gpu_convOut, b_x, bcoef,
                                                 b_gpu_zfIIR);
        }
        b_x = c_cpu_a->size[0];
        validLaunchParams = mwGetLaunchParameters1D(
        ...
        if (validLaunchParams) {
          ...
          b_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel30<<<grid, block>>>(d_gpu_convOut, d_gpu_a, b_x,
        ...
        gpuEmxEnsureCapacity_real_T(b_cpu_zfIIR, &b_gpu_zfIIR);
        k = d_cpu_y->size[0];
        d_cpu_y->size[0] = cpu_dv->size[0];
        emxEnsureCapacity_real_T(d_cpu_y, k, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(d_cpu_y, &d_gpu_y);
        bcoef = cpu_dv->size[0] - 1;
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          if (b_convOut_outdatedOnGpu) {
          ...
          b_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel31<<<grid, block>>>(d_gpu_convOut, bcoef, d_gpu_y);
        }
      }
      // 'ec_filtfilt1:142' xt = bsxfun(@minus,
      // 2*x(end,:),x(end-1:-1:end-nf(1,1),:));
      g_cpu_a = static_cast<real_T>(cpu_dv->size[0]) - nf;
      if (g_cpu_a > static_cast<real_T>(cpu_dv->size[0]) - 1.0) {
        n = 1;
        KH = 1;
        b_x = 0;
      } else {
      ...
      cudaMemcpy(b_gpu_a, &g_cpu_a, 8UL, cudaMemcpyHostToDevice);
      ec_filtfilt1_kernel32<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
          gpu_dv, b_gpu_a, cpu_dv->size[0U]);
      k = div_s32(b_x - n, KH) + 1;
      bcoef = cpu_xt->size[0];
      cpu_xt->size[0] = k;
      emxEnsureCapacity_real_T(cpu_xt, bcoef, &c_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_xt, &gpu_xt);
      if (k != 0) {
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(b_x + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel33<<<grid, block>>>(gpu_dv, bcoef, KH, n, b_gpu_a,
                                                 k - 1, gpu_xt);
        }
      }
      ...
      emxEnsureCapacity_real_T(d_cpu_b, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(d_cpu_b, &d_gpu_b);
      bcoef = cpu_b->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ...
        b_outdatedOnGpu = false;
        ec_filtfilt1_kernel34<<<grid, block>>>(gpu_b, bcoef, d_gpu_b);
      }
      k = d_cpu_a->size[0];
      d_cpu_a->size[0] = cpu_a->size[0];
      emxEnsureCapacity_real_T(d_cpu_a, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(d_cpu_a, &e_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ...
        a_outdatedOnGpu = false;
        ec_filtfilt1_kernel35<<<grid, block>>>(gpu_a, bcoef, e_gpu_a);
      ...
      if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel36<<<grid, block>>>(c_gpu_a1, c_nb, d_gpu_b);
        }
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(c_na - 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel37<<<grid, block>>>(c_gpu_a1, c_na, e_gpu_a);
        }
        ec_filtfilt1_kernel38<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(e_gpu_a);
        c_a_outdatedOnCpu = true;
      }
      if (d_cpu_a->size[0] > d_cpu_b->size[0]) {
        ...
        emxEnsureCapacity_real_T(d_cpu_b, bcoef, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(d_cpu_b, &d_gpu_b);
        if (b_x - 1 >= 0) {
      ...
      if (cpu_xt->size[0] == 0) {
        ...
        emxEnsureCapacity_real_T(c_cpu_expanded, k, &g_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(c_cpu_expanded, &c_gpu_expanded);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(
                (static_cast<int32_T>(u) + static_cast<int32_T>(window_idx_0)) -
                1L),
            &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel39<<<grid, block>>>(
              window_idx_0, static_cast<int32_T>(u), c_gpu_expanded);
        }
        n = cpu_xt->size[0];
        ...
        if (validLaunchParams) {
          ...
          d_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel40<<<grid, block>>>(gpu_xt, offsetH, f_gpu_y,
        ...
        emxEnsureCapacity_real_T(c_cpu_convOut, k, &g_emlrtRTEI);
        if (!c_convOut_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real_T(c_cpu_convOut, &c_gpu_convOut);
        }
        r = dim3(
            static_cast<uint32_T>(std::floor(
                (static_cast<real_T>(OH) + (static_cast<real_T>(b_x) - 1.0)) /
        ...
        if (validLaunchParams) {
          ...
          c_rows_outdatedOnGpu = false;
          if (c_convOut_outdatedOnGpu) {
            gpuEmxMemcpyCpuToGpu_real_T(&c_gpu_convOut, c_cpu_convOut);
          }
          ec_filtfilt1_kernel41<<<grid, block>>>(
              c_gpu_expanded, c_gpu_rows, d_gpu_b, static_cast<int32_T>(u),
              c_gpu_convOut, d_cpu_b->size[0U]);
          c_convOut_outdatedOnGpu = false;
          c_convOut_outdatedOnCpu = true;
        }
        if (b_cpu_zfIIR->size[0] != 0) {
          if (b_cpu_zfIIR->size[0] == 1) {
            ...
            ec_filtfilt1_kernel43<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            ...
            if (validLaunchParams) {
              ...
              ec_filtfilt1_kernel42<<<grid, block>>>(b_gpu_zfIIR, b_x,
                                                     c_gpu_convOut);
              c_convOut_outdatedOnGpu = false;
              c_convOut_outdatedOnCpu = true;
            }
        ...
        for (KH = 0; KH <= b_x - 2; KH++) {
          ...
          for (offsetH = 0; offsetH <= bcoef - 2; offsetH++) {
            if (c_convOut_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(c_cpu_convOut, &c_gpu_convOut);
            }
            if (c_a_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(d_cpu_a, &e_gpu_a);
            }
            c_a_outdatedOnCpu = false;
        ...
        emxEnsureCapacity_real_T(cpu_yc3, k, &i_emlrtRTEI);
        ...
        if (validLaunchParams) {
          ...
          c_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel44<<<grid, block>>>(c_gpu_convOut, bcoef, gpu_yc3);
        }
      }
      // 'ec_filtfilt1:145' [~,zo] =
      ...
      ec_filtfilt1_kernel45<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
          gpu_yc3, b_gpu_a, cpu_yc3->size[0U]);
      k = g_cpu_y->size[0];
      g_cpu_y->size[0] = cpu_z->size[0];
      emxEnsureCapacity_real_T(g_cpu_y, k, &d_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        z_outdatedOnGpu = false;
        ec_filtfilt1_kernel46<<<grid, block>>>(b_gpu_a, gpu_z, bcoef, b_gpu_y);
      }
      k = e_cpu_b->size[0];
      e_cpu_b->size[0] = cpu_b->size[0];
      emxEnsureCapacity_real_T(e_cpu_b, k, &e_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        b_outdatedOnGpu = false;
        ec_filtfilt1_kernel47<<<grid, block>>>(gpu_b, bcoef, e_gpu_b);
      }
      k = e_cpu_a->size[0];
      e_cpu_a->size[0] = cpu_a->size[0];
      emxEnsureCapacity_real_T(e_cpu_a, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(e_cpu_a, &f_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ...
        a_outdatedOnGpu = false;
        ec_filtfilt1_kernel48<<<grid, block>>>(gpu_a, bcoef, f_gpu_a);
      ...
      if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel49<<<grid, block>>>(b_gpu_a1, d_nb, e_gpu_b);
        }
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(d_na - 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel50<<<grid, block>>>(b_gpu_a1, d_na, f_gpu_a);
        }
        ec_filtfilt1_kernel51<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(f_gpu_a);
        d_a_outdatedOnCpu = true;
      }
      if (e_cpu_a->size[0] > e_cpu_b->size[0]) {
        ...
        emxEnsureCapacity_real_T(e_cpu_b, bcoef, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(e_cpu_b, &e_gpu_b);
        if (b_x - 1 >= 0) {
      ...
      if (div_s32(i26 - i23, i24) + 1 == 0) {
        k = c_cpu_zfIIR->size[0];
        c_cpu_zfIIR->size[0] = e_cpu_b->size[0] - 1;
        emxEnsureCapacity_real_T(c_cpu_zfIIR, k, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(c_cpu_zfIIR, &gpu_zfIIR);
      } else {
        window_idx_0 = static_cast<uint32_T>(e_cpu_b->size[0]);
        g_cpu_a = (static_cast<real_T>(div_s32(i26 - i23, i24) + 1) +
                   static_cast<real_T>(e_cpu_b->size[0])) -
                  1.0;
        b_a_outdatedOnGpu = true;
        x = std::fmin(32.0, g_cpu_a);
        if (g_cpu_a < 2.147483648E+9) {
          if (g_cpu_a >= -2.147483648E+9) {
            b_x = static_cast<int32_T>(g_cpu_a);
          } else {
            b_x = MIN_int32_T;
        ...
        emxEnsureCapacity_real_T(d_cpu_expanded, k, &g_emlrtRTEI);
        ...
        validLaunchParams = mwGetLaunchParameters1D(
            ...
            &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel52<<<grid, block>>>(window_idx_0, b_x,
                                                 b_gpu_expanded);
        }
        n = div_s32(i26 - i23, i24);
        k = h_cpu_y->size[0] * h_cpu_y->size[1];
        h_cpu_y->size[0] = 1;
        h_cpu_y->size[1] = div_s32(i26 - i23, i24) + 1;
        emxEnsureCapacity_int32_T(h_cpu_y, k, &h_emlrtRTEI);
        if (!e_y_outdatedOnGpu) {
          gpuEmxEnsureCapacity_int32_T(h_cpu_y, &e_gpu_y);
        }
        h_cpu_y->data[0] = 1;
        e_y_outdatedOnGpu = true;
        bcoef = 1;
        for (k = 0; k < n; k++) {
          bcoef++;
        ...
        if (validLaunchParams) {
          ...
          e_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel53<<<grid, block>>>(offsetH, e_gpu_y, bcoef,
                                                 gpu_iv3);
        }
        k = div_s32(i26 - i23, i24);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(k + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel54<<<grid, block>>>(gpu_yc3, i24, i23, gpu_iv3, k,
                                                 b_gpu_expanded);
        }
        ...
        emxEnsureCapacity_real_T(d_cpu_convOut, k, &g_emlrtRTEI);
        if (!d_convOut_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real_T(d_cpu_convOut, &b_gpu_convOut);
        }
        r = dim3(static_cast<uint32_T>(std::floor((g_cpu_a + (x - 1.0)) / x)),
                 1U, 1U);
        if (x >= -2.147483648E+9) {
        ...
        if (validLaunchParams) {
          ...
          ec_filtfilt1_kernel55<<<grid, block>>>(b_gpu_expanded, b_gpu_rows,
                                                 e_gpu_b, b_x, b_gpu_convOut,
                                                 e_cpu_b->size[0U]);
          d_convOut_outdatedOnGpu = false;
          d_convOut_outdatedOnCpu = true;
        }
        if (g_cpu_y->size[0] != 0) {
          if (g_cpu_y->size[0] == 1) {
            if (d_convOut_outdatedOnGpu) {
            ...
            ec_filtfilt1_kernel57<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            ...
            if (validLaunchParams) {
              ...
              ec_filtfilt1_kernel56<<<grid, block>>>(b_gpu_y, b_x,
                                                     b_gpu_convOut);
              d_convOut_outdatedOnGpu = false;
              d_convOut_outdatedOnCpu = true;
            }
        ...
        if (static_cast<real_T>(div_s32(i26 - i23, i24) + 1) + 1.0 >
            d_cpu_convOut->size[0]) {
          b_x = 0;
          bcoef = 0;
        } else {
          b_x = div_s32(i26 - i23, i24) + 1;
        ...
        if (validLaunchParams) {
          ...
          d_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel58<<<grid, block>>>(b_gpu_convOut, b_x, bcoef,
                                                 gpu_zfIIR);
        }
        b_x = e_cpu_a->size[0];
        validLaunchParams = mwGetLaunchParameters1D(
        ...
        if (validLaunchParams) {
          ...
          d_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel59<<<grid, block>>>(b_gpu_convOut, i24, i23, i26,
                                                 f_gpu_a, b_x, gpu_zfIIR,
                                                 e_cpu_a->size[0U]);
        }
        k = c_cpu_zfIIR->size[0];
      ...
      emxEnsureCapacity_real_T(f_cpu_b, k, &e_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        b_outdatedOnGpu = false;
        ec_filtfilt1_kernel60<<<grid, block>>>(gpu_b, bcoef, f_gpu_b);
      }
      k = f_cpu_a->size[0];
      f_cpu_a->size[0] = cpu_a->size[0];
      emxEnsureCapacity_real_T(f_cpu_a, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(f_cpu_a, &g_gpu_a);
      bcoef = cpu_a->size[0] - 1;
      validLaunchParams = mwGetLaunchParameters1D(
          static_cast<real_T>(bcoef + 1L), &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ...
        a_outdatedOnGpu = false;
        ec_filtfilt1_kernel61<<<grid, block>>>(gpu_a, bcoef, g_gpu_a);
        e_a_outdatedOnCpu = true;
      }
      if ((!std::isinf(cpu_a->data[0])) && (!std::isnan(cpu_a->data[0])) &&
          (!(cpu_a->data[0] == 0.0)) && (cpu_a->data[0] != 1.0)) {
        validLaunchParams = mwGetLaunchParameters1D(
        ...
        if (validLaunchParams) {
          ec_filtfilt1_kernel62<<<grid, block>>>(gpu_a1, e_nb, f_gpu_b);
        }
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(e_na - 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel63<<<grid, block>>>(gpu_a1, e_na, g_gpu_a);
        }
        ec_filtfilt1_kernel64<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(g_gpu_a);
        e_a_outdatedOnCpu = true;
      }
      if (f_cpu_a->size[0] > f_cpu_b->size[0]) {
        ...
        emxEnsureCapacity_real_T(f_cpu_b, bcoef, &f_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(f_cpu_b, &f_gpu_b);
        if (b_x - 1 >= 0) {
      ...
      if (div_s32(i26 - i23, i24) + 1 == 0) {
        ...
        emxEnsureCapacity_real_T(e_cpu_expanded, k, &g_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(e_cpu_expanded, &gpu_expanded);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>((b_x + static_cast<int32_T>(window_idx_0)) -
                                1L),
            &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel65<<<grid, block>>>(window_idx_0, b_x,
                                                 gpu_expanded);
        }
        n = div_s32(i26 - i23, i24);
        k = i_cpu_y->size[0] * i_cpu_y->size[1];
        i_cpu_y->size[0] = 1;
        i_cpu_y->size[1] = div_s32(i26 - i23, i24) + 1;
        emxEnsureCapacity_int32_T(i_cpu_y, k, &h_emlrtRTEI);
        if (!f_y_outdatedOnGpu) {
          gpuEmxEnsureCapacity_int32_T(i_cpu_y, &c_gpu_y);
        }
        i_cpu_y->data[0] = 1;
        f_y_outdatedOnGpu = true;
        bcoef = 1;
        for (k = 0; k < n; k++) {
          bcoef++;
        ...
        if (validLaunchParams) {
          ...
          f_y_outdatedOnGpu = false;
          ec_filtfilt1_kernel66<<<grid, block>>>(offsetH, c_gpu_y, bcoef,
                                                 gpu_iv4);
        }
        k = div_s32(i26 - i23, i24);
        validLaunchParams = mwGetLaunchParameters1D(
            static_cast<real_T>(k + 1L), &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          ec_filtfilt1_kernel67<<<grid, block>>>(d_gpu_y, i24, i23, gpu_iv4, k,
                                                 gpu_expanded);
        }
        ...
        if (!e_rows_outdatedOnGpu) {
          gpuEmxEnsureCapacity_int32_T(e_cpu_rows, &gpu_rows);
        }
        e_cpu_rows->data[0] = 0;
        e_rows_outdatedOnGpu = true;
        bcoef = 0;
        for (k = 0; k <= KH - 2; k++) {
          bcoef++;
        ...
        emxEnsureCapacity_real_T(e_cpu_convOut, k, &g_emlrtRTEI);
        if (!e_convOut_outdatedOnGpu) {
          gpuEmxEnsureCapacity_real_T(e_cpu_convOut, &gpu_convOut);
        }
        r = dim3(static_cast<uint32_T>(std::floor((g_cpu_a + (x - 1.0)) / x)),
                 1U, 1U);
        if (x >= -2.147483648E+9) {
        ...
        if (validLaunchParams) {
          ...
          e_rows_outdatedOnGpu = false;
          if (e_convOut_outdatedOnGpu) {
            gpuEmxMemcpyCpuToGpu_real_T(&gpu_convOut, e_cpu_convOut);
          }
          ec_filtfilt1_kernel68<<<grid, block>>>(gpu_expanded, gpu_rows,
                                                 f_gpu_b, b_x, gpu_convOut,
                                                 f_cpu_b->size[0U]);
          e_convOut_outdatedOnGpu = false;
          e_convOut_outdatedOnCpu = true;
        }
        if (c_cpu_zfIIR->size[0] != 0) {
          if (c_cpu_zfIIR->size[0] == 1) {
            ...
            ec_filtfilt1_kernel70<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            ...
            if (validLaunchParams) {
              ...
              ec_filtfilt1_kernel69<<<grid, block>>>(gpu_zfIIR, b_x,
                                                     gpu_convOut);
              e_convOut_outdatedOnGpu = false;
              e_convOut_outdatedOnCpu = true;
            }
        ...
        b_x = div_s32(i26 - i23, i24) + f_cpu_a->size[0];
        for (KH = 0; KH < b_x; KH++) {
          n = static_cast<int32_T>(
              std::fmin(static_cast<real_T>(KH) + 1.0,
                        static_cast<real_T>(f_cpu_a->size[0])));
          for (offsetH = 0; offsetH <= n - 2; offsetH++) {
            if (e_convOut_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(e_cpu_convOut, &gpu_convOut);
            }
            if (e_a_outdatedOnCpu) {
              gpuEmxMemcpyGpuToCpu_real_T(f_cpu_a, &g_gpu_a);
            }
            e_a_outdatedOnCpu = false;
        ...
        k = cpu_yc5->size[0];
        cpu_yc5->size[0] = div_s32(i26 - i23, i24) + 1;
        emxEnsureCapacity_real_T(cpu_yc5, k, &j_emlrtRTEI);
        gpuEmxEnsureCapacity_real_T(cpu_yc5, &gpu_yc5);
        validLaunchParams =
            mwGetLaunchParameters1D(static_cast<real_T>((i26 - i23) / i24 + 1L),
                                    &grid, &block, 1024U, 65535U);
        if (validLaunchParams) {
          if (e_convOut_outdatedOnGpu) {
            gpuEmxMemcpyCpuToGpu_real_T(&gpu_convOut, e_cpu_convOut);
          ...
          e_convOut_outdatedOnGpu = false;
          ec_filtfilt1_kernel71<<<grid, block>>>(gpu_convOut, i24, i23, i26,
                                                 gpu_yc5);
        }
      }
      ...
      k = cpu_dv->size[0];
      cpu_dv->size[0] = div_s32(n - b_x, bcoef) + 1;
      emxEnsureCapacity_real_T(cpu_dv, k, &e_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_dv, &gpu_dv);
      validLaunchParams =
          mwGetLaunchParameters1D(static_cast<real_T>((n - b_x) / bcoef + 1L),
                                  &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ec_filtfilt1_kernel72<<<grid, block>>>(gpu_yc5, bcoef, b_x, n, gpu_dv);
      }
    }
    ...
    if (validLaunchParams) {
      if (y_outdatedOnGpu) {
        gpuEmxMemcpyCpuToGpu_real_T(&i_gpu_y, cpu_y);
      }
      ec_filtfilt1_kernel73<<<grid, block>>>(
          gpu_dv, static_cast<int32_T>(static_cast<uint16_T>(ch + 1L)), bcoef,
  ...
  if (y_outdatedOnCpu) {
    gpuEmxMemcpyGpuToCpu_real_T(cpu_y, &i_gpu_y);
  }
