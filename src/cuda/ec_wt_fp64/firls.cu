                               ...
                               const emxArray_real_T *in5)
{
  ...
  emxInit_real_T(&b_in1, 1, &qh_emlrtRTEI, true);
  i = b_in1->size[0];
  if (in3->size[0] == 1) {
  ...
  emxEnsureCapacity_real_T(b_in1, i, &qh_emlrtRTEI);
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(in1, i, &rh_emlrtRTEI);
                               ...
                               const emxArray_real_T *in5)
{
  ...
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_in1, 1, &sh_emlrtRTEI, true);
  i = b_in1->size[0];
  if (in5->size[0] == 1) {
    b = in3->size[0];
  } else {
  ...
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(b_in1, i, &sh_emlrtRTEI);
  stride_0_0 = (in1->size[0] != 1);
  stride_1_0 = (in3->size[0] != 1);
  ...
  in1->size[0] = b_in1->size[0];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(in1, i, &th_emlrtRTEI);
...
void firls(real_T varargin_1, const real_T varargin_2[4], emxArray_real_T *h)
{
  ...
  profileLoopEnd();
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&m, 2, &df_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&k, 1, &ef_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&G, 2, &tf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc1A, 2, &uf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc2A, 2, &vf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc3A, 2, &wf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&sinc4A, 2, &xf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b, 1, &kf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_a, 1, &yf_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_dv, 1, &ag_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&x, 1, &bg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_dv1, 1, &ag_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&y, 1, &cg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_y, 1, &dg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b0, 1, &mf_emlrtRTEI, true);
  if ((!(max_freq > 1.0)) && (!(min_freq < 0.0))) {
    ...
    if (!Nodd) {
      ...
      m->size[1] = static_cast<int32_T>(L) + 1;
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(m, b_i, &cf_emlrtRTEI);
    ...
    k->size[0] = m->size[1];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(k, b_i, &ef_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      G->size[1] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(G, b_i, &ff_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      k->size[0] = nx - i;
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(k, b_i, &lf_emlrtRTEI);
    } else {
      i1Start = 0;
    }
    b_i = b->size[0];
    b->size[0] = k->size[0];
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b, b_i, &kf_emlrtRTEI);
    ...
    for (int32_T s{0}; s < 2; s++) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_dv, b_i, &of_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_dv1, b_i, &of_emlrtRTEI);
      ...
      y->size[0] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(y, b_i, &of_emlrtRTEI);
      ...
      b_y->size[0] = k->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b_y, b_i, &of_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b0, b_i, &mf_emlrtRTEI);
      b0->data[0] = b_b0;
      loop_ub = b->size[0];
      ...
      b->size[0] = b0->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(b, b_i, &qf_emlrtRTEI);
    ...
    if (a_outdatedOnGpu) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(cpu_a, b_i, &nf_emlrtRTEI);
    ...
    if (Nodd) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(h, b_i, &rf_emlrtRTEI);
      nvtxMarkA("#div_s32#" MW_AT_LINE);
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(x, b_i, &pf_emlrtRTEI);
