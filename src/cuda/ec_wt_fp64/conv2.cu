...
namespace coder {
static void
conv2NonSeparable(emxArray_real_T *cpu_a, boolean_T *a_outdatedOnCpu,
                  emxArray_real_T *gpu_a, boolean_T *a_outdatedOnGpu,
                  emxArray_creal_T *cpu_b, emxArray_creal_T *gpu_b,
...
static __global__ void conv2NonSeparable_kernel69(const int32_T b,
                                                  emxArray_creal_T c);

static __global__ void conv2NonSeparable_kernel70(const int32_T b,
                                                  emxArray_creal_T c);

static __global__ void conv2NonSeparable_kernel71(const real_T d,
                                                  creal_T a_data[1]);

static __global__ void conv2NonSeparable_kernel72(const emxArray_creal_T b,
                                                  const creal_T a_data[1],
                                                  emxArray_creal_T c);

static __global__ void conv2NonSeparable_kernel73(const int32_T OH,
                                                  emxArray_real_T expanded);

static __global__ void conv2NonSeparable_kernel74(const int32_T offsetH,
                                                  const emxArray_int32_T y,
                                                  const int32_T b_y,
                                                  emxArray_int32_T iv);

static __global__ void
conv2NonSeparable_kernel75(const emxArray_real_T a, const int32_T mc,
                           const emxArray_int32_T iv, const int32_T b,
                           emxArray_real_T expanded, int32_T expanded_dim0);

static __global__ void conv2NonSeparable_kernel76(
    const emxArray_real_T expanded, const emxArray_int32_T cols,
    const emxArray_int32_T rows, const emxArray_creal_T b, const int32_T c,
    const int32_T d, emxArray_creal_T b_c, int32_T b_dim0, int32_T b_dim1,
    int32_T expanded_dim0, int32_T c_dim0);

static __global__ void conv2_kernel48(const emxArray_creal_T a,
                                      const int32_T b_a, emxArray_creal_T c_a,
                                      int32_T a_dim0);

static __global__ void conv2_kernel49(const int32_T a, emxArray_creal_T c);

static __global__ void conv2_kernel50(const emxArray_creal_T a,
                                      const real_T cv_im,
                                      real_T *blockDims_idx_1, real_T *cv_re);

static __global__ void conv2_kernel51(const real_T *cv_re,
                                      const real_T *blockDims_idx_1,
                                      emxArray_creal_T c);

static __global__ void conv2_kernel52(const emxArray_creal_T c,
                                      const int32_T b_c, emxArray_creal_T c_c,
                                      int32_T c_dim0);

static __global__ void conv2_kernel53(const int32_T a,
                                      emxArray_creal_T expanded);

static __global__ void conv2_kernel54(const emxArray_int32_T y,
                                      const int32_T b_y, emxArray_int32_T iv);

static __global__ void conv2_kernel55(const emxArray_creal_T a,
                                      const emxArray_int32_T iv,
                                      const int32_T b,
                                      emxArray_creal_T expanded);

static __global__ void conv2_kernel56(const emxArray_creal_T expanded,
                                      const real_T cv_im, const int32_T b,
                                      emxArray_creal_T c);

static __global__ void conv2_kernel57(const int32_T b, emxArray_creal_T c);

static __global__ void conv2_kernel58(const int32_T b, emxArray_creal_T c);

static __global__ void conv2_kernel59(const real_T cv_re, creal_T b_data[1]);

static __global__ void conv2_kernel60(const emxArray_creal_T a,
                                      const creal_T b_data[1],
                                      emxArray_creal_T b_a);

static __global__ void conv2_kernel61(const emxArray_creal_T a,
                                      const int32_T iv1, emxArray_creal_T c);

static __global__ void conv2_kernel62(const int32_T OH,
                                      emxArray_creal_T expanded);

static __global__ void conv2_kernel63(const int32_T offsetH,
                                      const emxArray_int32_T y,
                                      const int32_T b_y, emxArray_int32_T iv1);

static __global__ void conv2_kernel64(const emxArray_int32_T y,
                                      const int32_T b_y, emxArray_int32_T iv2);

static __global__ void
conv2_kernel65(const emxArray_creal_T a, const int32_T iv1_dim0,
...
static __global__ void
conv2_kernel66(const int32_T offsetH, const emxArray_creal_T expanded,
               const int32_T k, const emxArray_int32_T rows,
               const int32_T b_rows, emxArray_creal_T newIm,
               int32_T expanded_dim0);

static __global__ void conv2_kernel67(const real_T cv_re, const int32_T offsetH,
                                      const int32_T k, emxArray_creal_T c,
                                      int32_T c_dim0);

static __global__ void conv2_kernel68(const real_T cv_im, const int32_T offsetH,
                                      const int32_T k, emxArray_creal_T c,
                                      int32_T c_dim0);

static __global__ void conv2_kernel77(const int32_T b, emxArray_creal_T c);

static __global__ void conv2_kernel78(const int32_T OH,
                                      emxArray_real_T expanded);

static __global__ void conv2_kernel79(const int32_T offsetH,
                                      const emxArray_int32_T y,
                                      const int32_T b_y, emxArray_int32_T iv1);

static __global__ void conv2_kernel80(const emxArray_real_T b,
                                      const emxArray_int32_T iv1,
                                      const int32_T c,
                                      emxArray_real_T expanded);

static __global__ void conv2_kernel81(const emxArray_real_T expanded,
                                      const emxArray_int32_T rows,
                                      const emxArray_creal_T a, const int32_T b,
                                      emxArray_creal_T c, int32_T a_dim0);

static __global__ void conv2_kernel82(const int32_T b, emxArray_creal_T c);

static __global__ void conv2_kernel83(const int32_T OH,
                                      emxArray_creal_T expanded);

static __global__ void conv2_kernel84(const int32_T offsetH,
                                      const emxArray_int32_T y,
                                      const int32_T b_y, emxArray_int32_T iv);

static __global__ void conv2_kernel85(const emxArray_creal_T a,
                                      const emxArray_int32_T iv,
                                      const int32_T b,
                                      emxArray_creal_T expanded);

static __global__ void conv2_kernel86(const emxArray_creal_T expanded,
                                      const int32_T offsetH,
                                      const emxArray_int32_T rows,
                                      const int32_T b_rows,
                                      emxArray_creal_T newIm);

static __global__ void conv2_kernel87(const real_T cv_im, const real_T cv_re,
                                      const int32_T offsetH,
                                      emxArray_creal_T c);
                  ...
                  boolean_T *c_outdatedOnGpu)
{
  ...
  emxEnsureCapacity_creal_T(cpu_c, k, &ah_emlrtRTEI);
  k = mc * nc - 1;
  ...
  if (validLaunchParams) {
    ...
    conv2NonSeparable_kernel69<<<grid, block>>>(k, *gpu_c);
  }
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_expanded, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_rows, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_cols, 2, &ch_emlrtRTEI, true);
  if ((cpu_a->size[0] == 0) ||
    ...
    if (validLaunchParams) {
      ...
      conv2NonSeparable_kernel70<<<grid, block>>>(k, *gpu_c);
    }
    ...
    *a_outdatedOnCpu = false;
    d = cpu_a->data[0];
    nvtxMarkA("#conv2NonSeparable_kernel71#" MW_AT_LINE);
    conv2NonSeparable_kernel71<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
        d, *gpu_a_data);
    k = cpu_c->size[0] * cpu_c->size[1];
    cpu_c->size[0] = 1;
    cpu_c->size[1] = 1;
    ...
    emxEnsureCapacity_creal_T(cpu_c, k, &ah_emlrtRTEI);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal_T(cpu_b, gpu_b, !*b_outdatedOnGpu);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal_T(cpu_c, gpu_c, true);
    if (*b_outdatedOnGpu) {
      nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal_T#" MW_AT_LINE);
      gpuEmxMemcpyCpuToGpu_creal_T(gpu_b, cpu_b);
    }
    *b_outdatedOnGpu = false;
    nvtxMarkA("#conv2NonSeparable_kernel72#" MW_AT_LINE);
    conv2NonSeparable_kernel72<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
    ...
    emxEnsureCapacity_real_T(cpu_expanded, k, &ch_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      conv2NonSeparable_kernel73<<<grid, block>>>(k, gpu_expanded);
    }
    nc = cpu_a->size[0];
    ...
    emxEnsureCapacity_int32_T(cpu_y, k, &eh_emlrtRTEI);
    cpu_y->data[0] = 1;
    mc = 1;
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(cpu_iv, k, &ch_emlrtRTEI);
    k = cpu_y->size[1] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
    ...
    if (validLaunchParams) {
      ...
      conv2NonSeparable_kernel74<<<grid, block>>>(offsetH, gpu_y, k, gpu_iv);
    }
    ...
    *a_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      conv2NonSeparable_kernel75<<<grid, block>>>(
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(cpu_rows, k, &eh_emlrtRTEI);
    cpu_rows->data[0] = 0;
    mc = 0;
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(cpu_cols, k, &eh_emlrtRTEI);
    cpu_cols->data[0] = 0;
    mc = 0;
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_c, k, &ch_emlrtRTEI);
    ...
    *b_outdatedOnGpu = false;
    ...
    if (validLaunchParams) {
      ...
      conv2NonSeparable_kernel76<<<grid, block>>>(
...
static __global__
    __launch_bounds__(32, 1) void conv2NonSeparable_kernel71(const real_T d,
                                                             creal_T a_data[1])
{
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(32, 1) void conv2NonSeparable_kernel72(
    const emxArray_creal_T b, const creal_T a_data[1], emxArray_creal_T c)
{
  int32_T k;
  k = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (k < 1) {
    creal_T b_b;
    b_b.re = a_data[0].re * b.data[0].re - 0.0 * b.data[0].im;
    b_b.im = a_data[0].re * b.data[0].im + 0.0 * b.data[0].re;
    c.data[0] = b_b;
  }
}
...
static __global__ __launch_bounds__(1024, 1) void conv2NonSeparable_kernel75(
    const emxArray_real_T a, const int32_T mc, const emxArray_int32_T iv,
    const int32_T b, emxArray_real_T expanded, int32_T expanded_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void conv2NonSeparable_kernel76(
    const emxArray_real_T expanded, const emxArray_int32_T cols,
    const emxArray_int32_T rows, const emxArray_creal_T b, const int32_T c,
    const int32_T d, emxArray_creal_T b_c, int32_T b_dim0, int32_T b_dim1,
    int32_T expanded_dim0, int32_T c_dim0)
...
static __global__ __launch_bounds__(1024,
                                    1) void conv2_kernel49(const int32_T a,
                                                           emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(32, 1) void conv2_kernel50(
    const emxArray_creal_T a, const real_T cv_im, real_T *blockDims_idx_1,
    real_T *cv_re)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    ...
    *blockDims_idx_1 = cv_im * a.data[0].im;
  }
}

static __global__ __launch_bounds__(32, 1) void conv2_kernel51(
    const real_T *cv_re, const real_T *blockDims_idx_1, emxArray_creal_T c)
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
  if (tmpIdx < 1) {
    c.data[0].im = *blockDims_idx_1;
    c.data[0].re = *cv_re;
  }
}
...
static __global__
    __launch_bounds__(1024, 1) void conv2_kernel53(const int32_T a,
                                                   emxArray_creal_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel54(
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel56(
    const emxArray_creal_T expanded, const real_T cv_im, const int32_T b,
    emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024,
                                    1) void conv2_kernel57(const int32_T b,
                                                           emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024,
                                    1) void conv2_kernel58(const int32_T b,
                                                           emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(32,
                                    1) void conv2_kernel59(const real_T cv_re,
                                                           creal_T b_data[1])
{
  int32_T tmpIdx;
  tmpIdx = static_cast<int32_T>(mwGetGlobalThreadIndex());
...
static __global__ __launch_bounds__(32, 1) void conv2_kernel60(
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel61(
    const emxArray_creal_T a, const int32_T iv1, emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__
    __launch_bounds__(1024, 1) void conv2_kernel62(const int32_T OH,
                                                   emxArray_creal_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel63(
    const int32_T offsetH, const emxArray_int32_T y, const int32_T b_y,
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel64(
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel65(
    const emxArray_creal_T a, const int32_T iv1_dim0,
    const emxArray_int32_T iv2, const emxArray_int32_T iv1, const int32_T b_iv1,
    const int32_T c_iv1, emxArray_creal_T expanded, int32_T expanded_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel66(
...
static __global__ __launch_bounds__(32, 1) void conv2_kernel67(
...
static __global__ __launch_bounds__(32, 1) void conv2_kernel68(
...
static __global__ __launch_bounds__(1024,
                                    1) void conv2_kernel77(const int32_T b,
                                                           emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(1024, 1) void conv2_kernel78(const int32_T OH,
                                                   emxArray_real_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel79(
    const int32_T offsetH, const emxArray_int32_T y, const int32_T b_y,
    emxArray_int32_T iv1)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel80(
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel81(
...
static __global__ __launch_bounds__(1024,
                                    1) void conv2_kernel82(const int32_T b,
                                                           emxArray_creal_T c)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__
    __launch_bounds__(1024, 1) void conv2_kernel83(const int32_T OH,
                                                   emxArray_creal_T expanded)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void conv2_kernel86(
...
static __global__ __launch_bounds__(32, 1) void conv2_kernel87(
             ...
             emxArray_creal_T *gpu_c, boolean_T *c_outdatedOnGpu)
{
  ...
  emxInit_creal_T(&cpu_expanded, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_cpu_expanded, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&b_cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv1, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_rows, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&b_cpu_rows, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_newIm, 1, &ch_emlrtRTEI, true);
  if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
    int32_T k;
    k = cpu_c->size[0];
    cpu_c->size[0] = 1;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_c, k, &dh_emlrtRTEI);
    ...
    *c_outdatedOnGpu = true;
    ...
    cpu_c->size[0] = mc;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_c, k, &hh_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#conv2_kernel77#" MW_AT_LINE);
      conv2_kernel77<<<grid, block>>>(mc - 1, *gpu_c);
    }
    *c_outdatedOnGpu = false;
    *c_outdatedOnCpu = true;
    if (cpu_a->size[0] != 0) {
      if ((cpu_b->size[0] == 1) && (cpu_a->size[0] == 1)) {
        ...
        *c_outdatedOnGpu = true;
        ...
        nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
        emxEnsureCapacity_real_T(b_cpu_expanded, k, &ch_emlrtRTEI);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#conv2_kernel78#" MW_AT_LINE);
          conv2_kernel78<<<grid, block>>>(k, gpu_expanded);
        }
        n = cpu_b->size[0];
        ...
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(b_cpu_y, k, &eh_emlrtRTEI);
        b_cpu_y->data[0] = 1;
        mc = 1;
        ...
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(cpu_iv1, k, &ch_emlrtRTEI);
        k = b_cpu_y->size[1] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(k), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
        ...
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#conv2_kernel79#" MW_AT_LINE);
          conv2_kernel79<<<grid, block>>>(offsetH, gpu_y, k, gpu_iv1);
        }
        mc = cpu_iv1->size[0];
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(mc - 1), &grid, &block,
                                2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_real_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_real_T(cpu_b, &gpu_b, false);
        nvtxMarkA("#gpuEmxMemcpyCpuToGpu_real_T#" MW_AT_LINE);
        gpuEmxMemcpyCpuToGpu_real_T(&gpu_b, cpu_b);
        validLaunchParams = mwValidateLaunchParameters(grid, block);
        if (validLaunchParams) {
          nvtxMarkA("#conv2_kernel80#" MW_AT_LINE);
          conv2_kernel80<<<grid, block>>>(gpu_b, gpu_iv1, mc - 1, gpu_expanded);
        }
        n = cpu_a->size[0];
        ...
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(b_cpu_rows, k, &eh_emlrtRTEI);
        b_cpu_rows->data[0] = 0;
        mc = 0;
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel81<<<grid, block>>>(gpu_expanded, gpu_rows, gpu_a,
    ...
    cpu_c->size[0] = mc;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_c, k, &yg_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(mc - 1), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      conv2_kernel82<<<grid, block>>>(mc - 1, *gpu_c);
    }
    *c_outdatedOnGpu = false;
    *c_outdatedOnCpu = true;
    if ((cpu_a->size[0] != 0) && (cpu_b->size[0] != 0)) {
      if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
        ...
        *c_outdatedOnGpu = true;
        ...
        cpu_expanded->size[0] = mc - 1;
        nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
        emxEnsureCapacity_creal_T(cpu_expanded, k, &ch_emlrtRTEI);
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel83<<<grid, block>>>(k, b_gpu_expanded);
        }
        n = cpu_a->size[0];
        k = cpu_y->size[0] * cpu_y->size[1];
        cpu_y->size[0] = 1;
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel84<<<grid, block>>>(offsetH, b_gpu_y, k, gpu_iv);
        }
        mc = cpu_iv->size[0];
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(mc - 1), &grid, &block,
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel85<<<grid, block>>>(gpu_a, gpu_iv, mc - 1,
                                          b_gpu_expanded);
        }
        n = cpu_b->size[0];
        k = cpu_rows->size[0] * cpu_rows->size[1];
        ...
        for (offsetH = 0; offsetH < b_OH; offsetH++) {
          ...
          nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
          emxEnsureCapacity_creal_T(cpu_newIm, k, &ch_emlrtRTEI);
          k = cpu_rows->size[1] - 1;
          nvtxMarkA("#computeNumIters#" MW_AT_LINE);
          ...
          if (validLaunchParams) {
            ...
            conv2_kernel86<<<grid, block>>>(b_gpu_expanded, offsetH, b_gpu_rows,
                                            k, gpu_newIm);
          }
          ...
          conv2_kernel87<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
           ...
           boolean_T *c_outdatedOnGpu)
{
  ...
  real_T *gpu_blockDims_idx_1;
  real_T *gpu_cv_re;
  boolean_T a_outdatedOnGpu;
  nvtxRangePushA("#fcn#conv2#" MW_AT_LOCATION);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaMalloc#" MW_AT_LINE);
  checkCudaError(mwCudaMalloc(&gpu_blockDims_idx_1, 8UL), __FILE__, __LINE__);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaMalloc#" MW_AT_LINE);
  checkCudaError(mwCudaMalloc(&gpu_cv_re, 8UL), __FILE__, __LINE__);
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaMalloc#" MW_AT_LINE);
  checkCudaError(mwCudaMalloc(&gpu_b_data, 16UL), __FILE__, __LINE__);
  nvtxMarkA("#gpuEmxReset_creal_T#" MW_AT_LINE);
  gpuEmxReset_creal_T(&c_gpu_a);
  nvtxMarkA("#gpuEmxReset_creal_T#" MW_AT_LINE);
  gpuEmxReset_creal_T(&gpu_newIm);
  nvtxMarkA("#gpuEmxReset_int32_T#" MW_AT_LINE);
  gpuEmxReset_int32_T(&gpu_rows);
  ...
  emlrtHeapReferenceStackEnterFcnR2012b(emlrtRootTLSGlobal);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&b_cpu_c, 1, &fh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&b_cpu_a, 1, &wg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_expanded, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&b_cpu_expanded, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&b_cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv, 1, &ch_emlrtRTEI, true);
  ...
  emxInit_int32_T(&cpu_iv1, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&c_cpu_y, 2, &gh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_iv2, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_rows, 2, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_newIm, 1, &ch_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&c_cpu_a, 1, &bh_emlrtRTEI, true);
  if ((cpu_a->size[0] == 1) && (cpu_b->size[0] == 1)) {
    if (cpu_a->size[1] < 1) {
      int32_T i;
      ...
      cpu_c->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(cpu_c, i, &xg_emlrtRTEI);
      cpu_c->data[0].im = 0.0;
      cpu_c->data[0].re = 0.0;
      *c_outdatedOnCpu = false;
      *c_outdatedOnGpu = true;
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(b_cpu_a, i, &wg_emlrtRTEI);
      i = cpu_a->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel48<<<grid, block>>>(gpu_a, i, b_gpu_a, cpu_a->size[0U]);
      }
      if (*b_outdatedOnCpu) {
        nvtxMarkA("#gpuEmxMemcpyGpuToCpu_real_T#" MW_AT_LINE);
      ...
      *b_outdatedOnCpu = false;
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(b_cpu_c, i, &ah_emlrtRTEI);
      i = b_cpu_a->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel49<<<grid, block>>>(i, b_gpu_c);
      }
      if (b_cpu_a->size[0] == 1) {
        cv_im = cpu_b->data[0];
        i = b_cpu_c->size[0];
        ...
        conv2_kernel50<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            b_gpu_a, cv_im, gpu_blockDims_idx_1, gpu_cv_re);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
        gpuEmxEnsureCapacity_creal_T(b_cpu_c, &b_gpu_c, true);
        nvtxMarkA("#conv2_kernel51#" MW_AT_LINE);
        conv2_kernel51<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            gpu_cv_re, gpu_blockDims_idx_1, b_gpu_c);
      } else {
        int32_T b_OH;
        int32_T mc;
        int32_T nc;
        ...
        cpu_expanded->size[0] = mc - 1;
        nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
        emxEnsureCapacity_creal_T(cpu_expanded, i, &ch_emlrtRTEI);
        i = b_cpu_a->size[0] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel53<<<grid, block>>>(i, gpu_expanded);
        }
        nc = b_cpu_a->size[0];
        ...
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(cpu_y, i, &eh_emlrtRTEI);
        cpu_y->data[0] = 1;
        mc = 1;
        ...
        cpu_iv->size[0] = cpu_y->size[1];
        nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
        emxEnsureCapacity_int32_T(cpu_iv, i, &ch_emlrtRTEI);
        i = cpu_y->size[1] - 1;
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
        nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel54<<<grid, block>>>(gpu_y, i, gpu_iv);
        }
        mc = cpu_iv->size[0];
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwGetLaunchParameters1D(computeNumIters(mc - 1), &grid, &block,
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel55<<<grid, block>>>(b_gpu_a, gpu_iv, mc - 1,
                                          gpu_expanded);
        }
        i = b_cpu_c->size[0];
        b_cpu_c->size[0] = b_cpu_a->size[0];
        nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
        emxEnsureCapacity_creal_T(b_cpu_c, i, &ch_emlrtRTEI);
        nvtxMarkA("#computeNumIters#" MW_AT_LINE);
        mwApplyLaunchParameters(
        ...
        if (validLaunchParams) {
          ...
          conv2_kernel56<<<grid, block>>>(gpu_expanded, cv_im, b_OH - 1,
                                          b_gpu_c);
        }
      }
      i = cpu_c->size[0] * cpu_c->size[1];
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(cpu_c, i, &dh_emlrtRTEI);
      i = b_cpu_c->size[0] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel52<<<grid, block>>>(b_gpu_c, i, *gpu_c, cpu_c->size[0U]);
      }
      *c_outdatedOnGpu = false;
      *c_outdatedOnCpu = true;
    }
    ...
    conv2NonSeparable(cpu_b, b_outdatedOnCpu, gpu_b, b_outdatedOnGpu,
                      (emxArray_creal_T *)cpu_a, &gpu_a, &a_outdatedOnGpu,
    ...
    cpu_c->size[1] = nc;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_c, i, &yg_emlrtRTEI);
    i = mc * nc - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      conv2_kernel57<<<grid, block>>>(i, *gpu_c);
    }
    *c_outdatedOnGpu = false;
    *c_outdatedOnCpu = true;
    if ((cpu_a->size[0] == 0) || (cpu_a->size[1] == 0) ||
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel58<<<grid, block>>>(i, *gpu_c);
      }
      ...
      *b_outdatedOnCpu = false;
      ...
      conv2_kernel59<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(cpu_cv_re,
                                                              *gpu_b_data);
      i = c_cpu_a->size[0];
      c_cpu_a->size[0] = 1;
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(c_cpu_a, i, &bh_emlrtRTEI);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal_T(cpu_a, &gpu_a, false);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal_T(c_cpu_a, &c_gpu_a, true);
      nvtxMarkA("#gpuEmxMemcpyCpuToGpu_creal_T#" MW_AT_LINE);
      gpuEmxMemcpyCpuToGpu_creal_T(&gpu_a, cpu_a);
      nvtxMarkA("#conv2_kernel60#" MW_AT_LINE);
      conv2_kernel60<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel61<<<grid, block>>>(c_gpu_a, i, *gpu_c);
      }
    } else {
      int32_T iv1[2];
      int32_T OW;
      ...
      b_cpu_expanded->size[0] = mc - 1;
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(b_cpu_expanded, i, &ch_emlrtRTEI);
      ...
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
      gpuEmxEnsureCapacity_creal_T(b_cpu_expanded, &b_gpu_expanded, true);
      validLaunchParams = mwValidateLaunchParameters(grid, block);
      if (validLaunchParams) {
        nvtxMarkA("#conv2_kernel62#" MW_AT_LINE);
        conv2_kernel62<<<grid, block>>>(i, b_gpu_expanded);
      }
      nc = cpu_a->size[0];
      ...
      nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
      emxEnsureCapacity_int32_T(b_cpu_y, i, &eh_emlrtRTEI);
      b_cpu_y->data[0] = 1;
      mc = 1;
      ...
      cpu_iv1->size[0] = b_cpu_y->size[1];
      nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
      emxEnsureCapacity_int32_T(cpu_iv1, i, &ch_emlrtRTEI);
      i = b_cpu_y->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel63<<<grid, block>>>(offsetH, b_gpu_y, i, gpu_iv1);
      }
      nc = cpu_a->size[1];
      ...
      nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
      emxEnsureCapacity_int32_T(c_cpu_y, i, &eh_emlrtRTEI);
      c_cpu_y->data[0] = 1;
      mc = 1;
      ...
      nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
      emxEnsureCapacity_int32_T(cpu_iv2, i, &ch_emlrtRTEI);
      i = c_cpu_y->size[1] - 1;
      nvtxMarkA("#computeNumIters#" MW_AT_LINE);
      mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
      nvtxMarkA("#gpuEmxEnsureCapacity_int32_T#" MW_AT_LINE);
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel64<<<grid, block>>>(c_gpu_y, i, gpu_iv2);
      }
      ...
      if (validLaunchParams) {
        ...
        conv2_kernel65<<<grid, block>>>(gpu_a, iv1[0], gpu_iv2, gpu_iv1,
      ...
      cpu_rows->size[1] = cpu_b->size[0];
      nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
      emxEnsureCapacity_int32_T(cpu_rows, i, &eh_emlrtRTEI);
      cpu_rows->data[0] = 0;
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(cpu_c, i, &ch_emlrtRTEI);
      c_needsGpuEnsureCapacity = true;
      mc = cpu_b->size[0];
      ...
      for (offsetH = 0; offsetH < OW; offsetH++) {
        ...
        for (int32_T k{0}; k < b_OH; k++) {
          ...
          cpu_newIm->size[0] = cpu_rows->size[1];
          nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
          emxEnsureCapacity_creal_T(cpu_newIm, i, &ch_emlrtRTEI);
          i = cpu_rows->size[1] - 1;
          nvtxMarkA("#computeNumIters#" MW_AT_LINE);
          ...
          if (validLaunchParams) {
            ...
            conv2_kernel66<<<grid, block>>>(offsetH, b_gpu_expanded, k,
          ...
          conv2_kernel67<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
              cpu_cv_re, offsetH, k, *gpu_c, cpu_c->size[0U]);
          c_needsGpuEnsureCapacity = false;
          nvtxMarkA("#conv2_kernel68#" MW_AT_LINE);
          conv2_kernel68<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
  ...
  nvtxMarkA("#checkCudaError#" MW_AT_LINE);
  nvtxMarkA("#mwCudaFree#" MW_AT_LINE);
  checkCudaError(mwCudaFree(gpu_blockDims_idx_1), __FILE__, __LINE__);
  nvtxRangePop();
}
