...
static __global__ void upfirdn_kernel35(const emxArray_creal_T x,
                                        const int32_T b_x,
                                        emxArray_creal_T xCol);

static __global__ void upfirdn_kernel36(const int32_T nx, const int32_T b,
                                        int32_T lshift[2]);

static __global__ void upfirdn_kernel37(const int32_T nx, const int32_T n,
                                        const int32_T dim, int32_T origSiz[2]);

static __global__ void upfirdn_kernel38(const emxArray_creal_T w,
                                        const int32_T nElements_dim0,
                                        const int32_T nx, const int32_T b,
                                        const int32_T c, emxArray_creal_T b_w,
                                        int32_T w_dim0);

static __global__ void upfirdn_kernel39(const emxArray_creal_T w,
                                        const int32_T nElements,
                                        emxArray_creal_T y_out);

static __global__ void upfirdn_kernel40(const emxArray_creal_T w,
                                        const int32_T nElements_dim0,
                                        const int32_T nx, const int32_T b,
                                        const int32_T c, emxArray_creal_T b_w,
                                        int32_T w_dim0);

static __global__ void upfirdn_kernel41(const emxArray_creal_T w,
                                        const int32_T nElements_dim0,
                                        const int32_T b, const int32_T c,
                                        emxArray_creal_T y_out,
                                        int32_T y_out_dim0);

static __global__ void upfirdn_kernel42(const emxArray_creal_T y_out,
                                        const int32_T b,
                                        emxArray_creal_T b_y_out,
                                        int32_T y_out_dim0);

static __global__ void upfirdn_kernel43(const emxArray_creal_T y_out,
                                        const int32_T b_y_out,
                                        emxArray_creal_T c_y_out);

static __global__ void upfirdn_kernel47(const emxArray_creal_T x,
                                        const int32_T b_x,
                                        emxArray_creal_T xCol);
...
static __global__ __launch_bounds__(1024,
                                    1) void upfirdn_kernel36(const int32_T nx,
                                                             const int32_T b,
                                                             int32_T lshift[2])
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(32, 1) void upfirdn_kernel37(
...
static __global__ __launch_bounds__(1024, 1) void upfirdn_kernel40(
    const emxArray_creal_T w, const int32_T nElements_dim0, const int32_T nx,
    const int32_T b, const int32_T c, emxArray_creal_T b_w, int32_T w_dim0)
{
  uint64_T gStride;
...
static __global__ __launch_bounds__(1024, 1) void upfirdn_kernel41(
...
//
namespace coder {
void upfirdn(emxArray_creal_T *cpu_x, emxArray_creal_T *gpu_x,
             ...
             emxArray_creal_T *gpu_y_out, boolean_T *y_out_outdatedOnGpu)
{
  ...
  if (xIsRow) {
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel35<<<grid, block>>>(*gpu_x, i, gpu_xCol);
    }
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_xCol, i, &qg_emlrtRTEI);
    i = cpu_x->size[0] * cpu_x->size[1] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    mwGetLaunchParameters1D(computeNumIters(i), &grid, &block, 2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel47<<<grid, block>>>(*gpu_x, i, gpu_xCol);
    }
    result_outdatedOnCpu = true;
  }
  ...
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_w, 2, &ne_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&A, 1, &ne_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_B, 1, &sg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_result, 1, &ne_emlrtRTEI, true);
  b_yCol = *yCol;
  ...
  upfirdn_kernel37<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(nx, n, dim,
                                                            *gpu_origSiz);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&b_cpu_w, 2, &tg_emlrtRTEI, true);
  i = b_cpu_w->size[0] * b_cpu_w->size[1];
  nvtxMarkA("#div_s32#" MW_AT_LINE);
  b_cpu_w->size[0] = div_s32(n, nx) + 1;
  b_cpu_w->size[1] = nElements;
  nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
  emxEnsureCapacity_creal_T(b_cpu_w, i, &tg_emlrtRTEI);
  i = n / nx;
  nvtxMarkA("#computeNumIters#" MW_AT_LINE);
  ...
  nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
  emxEnsureCapacity_creal_T(cpu_y_out, i, &ne_emlrtRTEI);
  ...
  if (validLaunchParams) {
    ...
    upfirdn_kernel39<<<grid, block>>>(b_gpu_w, nElements, *gpu_y_out);
  }
  nvtxMarkA("#emxFree_creal_T#" MW_AT_LINE);
  ...
  if (!(cpu_origSiz[0] < Ly)) {
    ...
    nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
    emxInit_creal_T(&c_cpu_w, 2, &tg_emlrtRTEI, true);
    nElements = c_cpu_w->size[0] * c_cpu_w->size[1];
    nvtxMarkA("#div_s32#" MW_AT_LINE);
    c_cpu_w->size[0] = div_s32(n, nx) + 1;
    c_cpu_w->size[1] = cpu_lshift[1];
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(c_cpu_w, nElements, &tg_emlrtRTEI);
    i = n / nx;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel40<<<grid, block>>>(gpu_w, cpu_lshift[0], nx, i,
    ...
    cpu_y_out->size[1] = cpu_origSiz[1];
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_y_out, nElements, &oe_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel41<<<grid, block>>>(c_gpu_w, cpu_origSiz[0], b_i - 1,
  ...
  if (xIsRow) {
    nElements = cpu_y_out->size[0] * cpu_y_out->size[1];
    nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
    emxInit_creal_T(&b_cpu_y_out, 2, &ug_emlrtRTEI, true);
    i = b_cpu_y_out->size[0] * b_cpu_y_out->size[1];
    b_cpu_y_out->size[0] = 1;
    b_cpu_y_out->size[1] = nElements;
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(b_cpu_y_out, i, &ug_emlrtRTEI);
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel42<<<grid, block>>>(*gpu_y_out, nElements - 1, b_gpu_y_out,
                                        b_cpu_y_out->size[0U]);
    }
    i = cpu_y_out->size[0] * cpu_y_out->size[1];
    cpu_y_out->size[0] = 1;
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_y_out, i, &vg_emlrtRTEI);
    ...
    if (validLaunchParams) {
      ...
      upfirdn_kernel43<<<grid, block>>>(b_gpu_y_out, i, *gpu_y_out);
    }
    nvtxMarkA("#emxFree_creal_T#" MW_AT_LINE);
