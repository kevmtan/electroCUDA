...
void uniformResampleAlongFirstDim(
    ...
    real_T opts_q, const emxArray_real_T *cpu_opts_filterWithPadding,
    real_T opts_filterDelay)
{
  ...
  emxInit_creal_T(&cpu_yOut, 2, &nh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&y, 2, &oh_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_yRow, 2, &ph_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_y, 2, &qe_emlrtRTEI, true);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&yRow, 1, &lh_emlrtRTEI, true);
  if ((!(opts_p == 1.0)) || (!(opts_q == 1.0))) {
    if ((cpu_xIn->size[0] == 1) || (cpu_xIn->size[1] == 1)) {
      ...
      if ((cpu_xIn->size[0] == 1) && (cpu_xIn->size[1] == 1)) {
        ...
        emxEnsureCapacity_creal_T(cpu_yRow, b_i, &kh_emlrtRTEI);
      } else {
        nvtxMarkA("#upfirdn#" MW_AT_LINE);
        upfirdn(cpu_xIn, gpu_xIn, xIn_outdatedOnGpu,
                (emxArray_real_T *)cpu_opts_filterWithPadding,
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(yRow, b_i, &lh_emlrtRTEI);
      ...
      cpu_xIn->size[1] = 1;
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(cpu_xIn, b_i, &mh_emlrtRTEI);
      ...
      nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
      emxEnsureCapacity_creal_T(cpu_xIn, b_i, &jh_emlrtRTEI);
