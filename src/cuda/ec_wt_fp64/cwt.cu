...
cwt_kernel19(const real_T fs, const emxArray_real_T omega,
             ...
             const int32_T c, emxArray_real_T b_cf, emxArray_real_T b_psidft,
             int32_T psidft_dim0);

static __global__ void cwt_kernel20(const emxArray_real_T x, const int32_T M,
                                    const int32_T Npad, const int32_T b,
                                    emxArray_real_T xv);

static __global__ void cwt_kernel21(const emxArray_creal_T xdft,
...
static __global__ void cwt_kernel23(const emxArray_creal_T cfstmp,
                                    const int32_T Npad, const int32_T M,
                                    const int32_T Ns, emxArray_creal_T cfs,
                                    int32_T cfs_dim0, int32_T cfstmp_dim0);

static __global__ void cwt_kernel24(const emxArray_creal_T cfstmp,
                                    const int32_T b, const int32_T Ns,
                                    emxArray_creal_T cfs, int32_T cfs_dim0,
                                    int32_T cfstmp_dim0);

static __global__ void cwt_kernel25(const real_T cfsdft_re,
                                    const emxArray_creal_T cfsdft,
                                    const int32_T b_cfsdft,
                                    emxArray_creal_T cfstmp);

static __global__ void cwt_kernel26(const emxArray_real_T xv,
                                    const int32_T b_xv, emxArray_creal_T xdft);

static __global__ void cwt_kernel27(const int32_T b, emxArray_creal_T xdft,
                                    uint32_T xSize_dim1);

static __global__ void cwt_kernel28(const emxArray_real_T x, const int32_T b,
                                    emxArray_real_T xv);
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel19(
    ...
    const int32_T M, const int32_T b, const int32_T c, emxArray_real_T b_cf,
    emxArray_real_T b_psidft, int32_T psidft_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
  ...
  for (uint64_T idx{gThreadId}; idx <= loopEnd; idx += gStride) {
    ...
    if (jj + 1 > M) {
      ...
      b_psidft.data[kk + psidft_dim0 * jj] =
          0.0050536085896138571 * exp(20.0 * log(ar * ai) - pow(ar * ai, 3.0));
    }
    if (jj + 1 == 1) {
      b_cf.data[kk] =
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel20(
    const emxArray_real_T x, const int32_T M, const int32_T Npad,
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel21(
    const emxArray_creal_T xdft, const int32_T b, const int32_T c,
    emxArray_real_T b_psidft, emxArray_creal_T cfsdft, int32_T cfsdft_dim0,
    int32_T psidft_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel23(
    const emxArray_creal_T cfstmp, const int32_T Npad, const int32_T M,
    const int32_T Ns, emxArray_creal_T cfs, int32_T cfs_dim0,
    int32_T cfstmp_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel24(
    const emxArray_creal_T cfstmp, const int32_T b, const int32_T Ns,
    emxArray_creal_T cfs, int32_T cfs_dim0, int32_T cfstmp_dim0)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel25(
    const real_T cfsdft_re, const emxArray_creal_T cfsdft,
    const int32_T b_cfsdft, emxArray_creal_T cfstmp)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024, 1) void cwt_kernel26(
    const emxArray_real_T xv, const int32_T b_xv, emxArray_creal_T xdft)
{
  uint64_T gStride;
  uint64_T gThreadId;
  uint64_T loopEnd;
...
static __global__ __launch_bounds__(1024,
                                    1) void cwt_kernel27(const int32_T b,
...
//
namespace coder {
void cwt(emxArray_real_T *cpu_x, emxArray_real_T *gpu_x,
         boolean_T *x_outdatedOnGpu, real_T fs, const real_T varargin_2[2],
         real_T varargin_4, emxArray_creal_T *cpu_cfs,
         boolean_T *cfs_outdatedOnCpu, emxArray_creal_T *gpu_cfs,
         boolean_T *cfs_outdatedOnGpu)
{
  ...
  emxArray_creal_T *cpu_cfstmp;
  emxArray_creal_T *cpu_xdft;
  ...
  if (!psidft_not_empty) {
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cf, i, &ab_emlrtRTEI);
    ...
    mwGetLaunchParameters1D(computeNumIters(Ns - 1, Nomega - 1), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_real_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_real_T(cf, &gpu_cf, false);
    nvtxMarkA("#gpuEmxEnsureCapacity_real_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_real_T(psidft, &gpu_psidft, false);
  ...
  Ns = psidft->size[0] - 1;
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_xv, 2, &t_emlrtRTEI, true);
  i = cpu_xv->size[0] * cpu_xv->size[1];
  cpu_xv->size[0] = 1;
  cpu_xv->size[1] = psidft->size[1];
  nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
  emxEnsureCapacity_real_T(cpu_xv, i, &t_emlrtRTEI);
  ...
  emxEnsureCapacity_creal_T(cpu_cfs, i, &t_emlrtRTEI);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_cfstmp, 2, &t_emlrtRTEI, true);
  N = psidft->size[1];
  if (Npad > 0) {
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
  ...
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&cpu_xdft, 2, &u_emlrtRTEI, true);
  if (cpu_xv->size[1] == 0) {
    cpu_xdft->size[0] = 1;
    cpu_xdft->size[1] = 0;
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_xdft, i, &u_emlrtRTEI);
    ...
    gpuEmxEnsureCapacity_creal_T(cpu_xdft, &gpu_xdft, true);
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_xdft, i, &w_emlrtRTEI);
  ...
  if ((cpu_cfsdft->size[0] == 0) || (cpu_cfsdft->size[1] == 0)) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_cfstmp, i, &t_emlrtRTEI);
    Nomega =
    ...
    mwGetLaunchParameters1D(computeNumIters(Nomega), &grid, &block,
                            2147483647U);
    nvtxMarkA("#gpuEmxEnsureCapacity_creal_T#" MW_AT_LINE);
    gpuEmxEnsureCapacity_creal_T(cpu_cfstmp, &gpu_cfstmp, true);
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
    ...
    nvtxMarkA("#emxEnsureCapacity_creal_T#" MW_AT_LINE);
    emxEnsureCapacity_creal_T(cpu_cfstmp, i, &t_emlrtRTEI);
    Nomega = cpu_cfsdft->size[1];
    i = cpu_cfsdft->size[0] * cpu_cfsdft->size[1] - 1;
    nvtxMarkA("#computeNumIters#" MW_AT_LINE);
    ...
    if (validLaunchParams) {
      ...
      cwt_kernel25<<<grid, block>>>(static_cast<real_T>(Nomega), gpu_cfsdft, i,
                                    gpu_cfstmp);
    }
  }
  nvtxMarkA("#emxFree_creal_T#" MW_AT_LINE);
...
void cwt_emx_init()
{
  ...
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&psidft, 2, &emlrtRTEI, false);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cf, 1, &b_emlrtRTEI, false);
  nvtxRangePop();
}
