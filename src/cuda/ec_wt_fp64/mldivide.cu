...
static __global__ void mldivide_kernel33(const int32_T b, const int32_T na,
                                         emxArray_real_T A, int32_T A_dim0);

static __global__ void mldivide_kernel34(const emxArray_real_T B,
...
static __global__ __launch_bounds__(1024, 1) void mldivide_kernel33(
...
static __global__ __launch_bounds__(1024, 1) void mldivide_kernel34(
              ...
              emxArray_real_T *gpu_Y, boolean_T *Y_outdatedOnGpu)
{
  ...
  emxInit_real_T(&cpu_A, 2, &og_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_jpvt, 2, &og_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_tau, 1, &og_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&b_cpu_A, 2, &og_emlrtRTEI, true);
  nvtxMarkA("#emxInit_ptrdiff_t#" MW_AT_LINE);
  emxInit_ptrdiff_t(&jpvt_t, 1, &kg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_int32_T#" MW_AT_LINE);
  emxInit_int32_T(&cpu_IPIV, 1, &pg_emlrtRTEI, true);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&cpu_B, 1, &mg_emlrtRTEI, true);
  if ((A->size[0] == 0) || (A->size[1] == 0) || (B->size[0] == 0)) {
    ...
    *Y_outdatedOnGpu = false;
    ...
    emxEnsureCapacity_real_T(cpu_Y, u0, &eg_emlrtRTEI);
    ...
    *Y_outdatedOnGpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(b_cpu_A, u0, &gg_emlrtRTEI);
    ...
    emxEnsureCapacity_int32_T(cpu_IPIV, u0, &ig_emlrtRTEI);
    ...
    if (cpu_maxmn < 0) {
      *Y_outdatedOnGpu = false;
      ...
      cpu_Y->size[0] = B->size[0];
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(cpu_Y, u0, &lg_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_A, u0, &fg_emlrtRTEI);
    ...
    nvtxMarkA("#emxEnsureCapacity_int32_T#" MW_AT_LINE);
    emxEnsureCapacity_int32_T(cpu_jpvt, u0, &hg_emlrtRTEI);
    u0 = cpu_A->size[0];
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_tau, u0, &jg_emlrtRTEI);
    u0 = jpvt_t->size[0];
    jpvt_t->size[0] = cpu_A->size[1];
    nvtxMarkA("#emxEnsureCapacity_ptrdiff_t#" MW_AT_LINE);
    emxEnsureCapacity_ptrdiff_t(jpvt_t, u0, &kg_emlrtRTEI);
    ...
    if ((int32_T)info_t != 0) {
      ...
      if (validLaunchParams) {
        nvtxMarkA("#mldivide_kernel33#" MW_AT_LINE);
        mldivide_kernel33<<<grid, block>>>(cpu_maxmn - 1, na, b_gpu_A,
                                           cpu_A->size[0U]);
      }
      A_outdatedOnGpu = false;
    ...
    nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
    emxEnsureCapacity_real_T(cpu_B, u0, &mg_emlrtRTEI);
    ...
    *Y_outdatedOnGpu = false;
    ...
    if (cpu_maxmn < 0) {
      ...
      nvtxMarkA("#emxEnsureCapacity_real_T#" MW_AT_LINE);
      emxEnsureCapacity_real_T(cpu_B, u0, &ng_emlrtRTEI);
      A_outdatedOnCpu = true;
    ...
    validLaunchParams = mwValidateLaunchParameters(grid, block);
    if (validLaunchParams) {
      nvtxMarkA("#mldivide_kernel34#" MW_AT_LINE);
      mldivide_kernel34<<<grid, block>>>(gpu_B, gpu_jpvt, na, *gpu_Y);
    }
    *Y_outdatedOnGpu = false;
    *Y_outdatedOnCpu = true;
