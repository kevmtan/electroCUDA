    ...
    coder::b_signal::internal::resample::ResampleParser *pStruct)
{
  ...
  emxFree_real_T(&pStruct->filter);
  nvtxMarkA("#emxFree_real_T#" MW_AT_LINE);
  emxFree_real_T(&pStruct->filterWithPadding);
  nvtxMarkA("#emxFree_creal_T#" MW_AT_LINE);
  emxFree_creal_T(&pStruct->x);
  nvtxRangePop();
}
    ...
    const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  ...
  emxInit_real_T(&pStruct->filter, 1, srcLocation, doPush);
  nvtxMarkA("#emxInit_real_T#" MW_AT_LINE);
  emxInit_real_T(&pStruct->filterWithPadding, 1, srcLocation, doPush);
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&pStruct->x, 2, srcLocation, doPush);
  nvtxRangePop();
}
                               ...
                               boolean_T doPush)
{
  ...
  nvtxMarkA("#emxInit_creal_T#" MW_AT_LINE);
  emxInit_creal_T(&pStruct->f1, 2, srcLocation, doPush);
  nvtxRangePop();
}
