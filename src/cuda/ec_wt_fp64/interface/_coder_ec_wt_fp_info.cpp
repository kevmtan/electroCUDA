...
//
// _coder_ec_wt_fp_info.cpp
//
// Code generation for function 'ec_wt_fp'
//

// Include files
#include "_coder_ec_wt_fp_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", emlrtMxCreateString("ec_wt_fp"));
  ...
  emlrtSetField(xEntryPoints, 0, "TimeStamp",
                emlrtMxCreateDoubleScalar(739333.42712962965));
...
// End of code generation (_coder_ec_wt_fp_info.cpp)
