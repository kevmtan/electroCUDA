function [F, word_map, RDM] = ec_imgSim2_test(imgDir,imgFns, method, create_heatmap, doGPU)
...
parfor ii = 1:n_imgs
    ...
    if method==3
        F{ii} = hier_model_KT2(Ic_all{ii},filter,n_filters,filter_size,filter_overlap,g_filter_Jar,box_filter);
    end
end
