function Fc = hier_model_KT2(Ic,filter,n_filters,filter_size,filter_overlap,g_filter_Jar,box_filter)
...
I = imresize(Ic, [400 400]);
I = I/255;
I_filtered = cell(n_filters,1);
I_g = I_filtered;
