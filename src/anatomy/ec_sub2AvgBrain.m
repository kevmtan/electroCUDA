function [elecNames,hemisphere,isSubdural,avgCoord,subCoord,avgVids,subVids]=ec_sub2AvgBrain(subj,cfg)
...
if universalYes(rmDepths)
    ...
    [avgCoordsDepths, elecNamesDepths]=depths2AvgBrain_lfn(subj,fsDir);
end
...
%% 
function [avgCoords, elecNames, isLeft] = depths2AvgBrain_lfn(subj,fsDir)
