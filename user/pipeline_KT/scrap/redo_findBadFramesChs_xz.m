...
chBad.cov = isoutlier(chCovZ,"median","ThresholdFactor",10);
chBad.covP = chCovZ;

% Calculate bad chans
chBad.bad = chBad.empty | chBad.nan | chBad.ai | sum([chBad.ref,...
    chBad.mad,chBad.diff,chBad.flat,chBad.sns*2,...
    chBad.cov,chBad.dev*2,chBad.grad,...
    chBad.hurstL,chBad.hurstH,chBad.detrend],2)>=4;
