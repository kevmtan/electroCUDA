...
% Load/save
op.figDir = "figBin_4-20hz_vd1vd2";
op.statFn = "statBin_4-20hz_vd1vd2";
...
% PP cond difference
op.d = op.c;
op.d.col = [cdcol.purple; cdcol.greenish_blue];
%op.d.col = [cdcol.violet; cdcol.greenish_blue];
op.d.col = ec_dim2cell(op.d.col,1);

% PP RT/RC/valence
op.r = op.c;
op.r.col = [cdcol.ruby_red; cdcol.orange; cdcol.olive];
op.r.col = ec_dim2cell(op.r.col,1);


%% Run
op.analDir = "/01/lbcn/anal/classifySpecROI/zf_bands_MathAb_LDA_nestedGammaDelta";
