...
o.floatAnal = "single"; % Analysis at floating-point precision ["double"|"single"|"half"]
...
o.p.chConcat = ""; % Concactenate channels by ["roi"|"all"|""], default="" (none)
...
o.p.pre.runNorm = ""; % Normalize run ["robust"|"zscore"|""]; skip=""
...
o.p.pre.badFrameVars = ""; % Bad frame removal vars (n.xBad) to use ["hfo"|"mad"|"diff"|"sns"|...]
