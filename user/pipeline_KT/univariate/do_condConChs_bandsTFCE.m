...
o.p.epoch.baselinePre = [-0.175 0]; %[-0.125 -0.025]; %[-0.15 -0.05]; %-0.2; % Pre-stimulus baseline (secs from stim onset): inf=ITI; [-.2]; [-0.2 1]
...
o.grpVars = "tr";   % group variables for 1-sample grouped/nested stats
o.grpVars2 = [];  % group variables for 2-sample grouped/nested stats
...
%% Run
[logs,chNfoA] = ec_condConChs_perm(o);
