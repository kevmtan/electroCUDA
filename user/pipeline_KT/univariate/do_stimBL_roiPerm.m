...
o.parallel2 = "none"; % Permute parallelization: ["none"|"gpu"|"cpu"] (cpu not worth it)
...
o.analName = "xs_perm"; % directory name within o.analDir
...
o.ciMode = "approx";
o.nPerm = 5e5; % number of permutations
o.nBlocks = 0;
o.nBlocks2 = 0;
