...
static emlrtRTEInfo j_emlrtRTEI{ 26,   // lineNo
  1,                                   // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static emlrtRTEInfo q_emlrtRTEI{ 946,  // lineNo
  13,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo v_emlrtRTEI{ 498,  // lineNo
  5,                                   // colNo
  "quadgk",                            // fName
  "/usr/local/MATLAB/R2023a/toolbox/eml/lib/matlab/funfun/quadgk.m"// pName
};
...
static emlrtRTEInfo y_emlrtRTEI{ 36,   // lineNo
  21,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static emlrtRTEInfo cb_emlrtRTEI{ 135, // lineNo
  1,                                   // colNo
  "wt",                                // fName
...
static emlrtRTEInfo hb_emlrtRTEI{ 161, // lineNo
  1,                                   // colNo
  "wt",                                // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/wt.m"// pName
};

static emlrtRTEInfo ib_emlrtRTEI{ 180, // lineNo
  5,                                   // colNo
  "wt",                                // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/wt.m"// pName
};
...
static emlrtRTEInfo kb_emlrtRTEI{ 43,  // lineNo
  16,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};

static emlrtRTEInfo lb_emlrtRTEI{ 43,  // lineNo
  10,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};

static emlrtRTEInfo mb_emlrtRTEI{ 1256,// lineNo
  30,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};

static emlrtRTEInfo nb_emlrtRTEI{ 1256,// lineNo
  25,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo pb_emlrtRTEI{ 924, // lineNo
  26,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo vb_emlrtRTEI{ 446, // lineNo
  1,                                   // colNo
  "quadgk",                            // fName
  "/usr/local/MATLAB/R2023a/toolbox/eml/lib/matlab/funfun/quadgk.m"// pName
};
...
static emlrtRTEInfo xb_emlrtRTEI{ 63,  // lineNo
  20,                                  // colNo
  "morseproperties",                   // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/+wavelet/+internal/+cwt/morseproperties.m"// pName
};

static emlrtRTEInfo yb_emlrtRTEI{ 63,  // lineNo
  34,                                  // colNo
  "morseproperties",                   // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/+wavelet/+internal/+cwt/morseproperties.m"// pName
};
...
static emlrtRTEInfo dc_emlrtRTEI{ 64,  // lineNo
  12,                                  // colNo
  "morseproperties",                   // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/+wavelet/+internal/+cwt/morseproperties.m"// pName
};
...
static emlrtRTEInfo fc_emlrtRTEI{ 41,  // lineNo
  12,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static __global__ void ecc_cwt_kernel1(const real_T fLims[2], boolean_T b[2]);
static __global__ void ecc_cwt_kernel10(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel11(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel12(const emxArray_real_T y, const
  emxArray_real_T b_y, int32_T c_y, emxArray_real_T a);
static __global__ void ecc_cwt_kernel13(const emxArray_real_T a, int32_T ix,
  emxArray_real_T dv9);
static __global__ void ecc_cwt_kernel14(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel15(const emxArray_real_T y, int32_T b_y,
  emxArray_real_T dv13);
static __global__ void ecc_cwt_kernel16(int32_T ix, emxArray_real_T dv13);
static __global__ void ecc_cwt_kernel17(const emxArray_real_T xt, const
  emxArray_real_T dv13, const emxArray_real_T dv9, int32_T b_dv9,
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel18(int16_T dv5_idx_1, emxArray_real_T fx);
static __global__ void ecc_cwt_kernel19(real_T interval[650]);
static __global__ void ecc_cwt_kernel2(const real_T fLims[2], real_T freqrange[2]);
static __global__ void ecc_cwt_kernel20(real_T interval[650]);
static __global__ void ecc_cwt_kernel21(const int32_T ix, real_T interval[650]);
static __global__ void ecc_cwt_kernel22(const real_T interval[650], int32_T
  nsubs, real_T subs[1298]);
static __global__ void ecc_cwt_kernel23(const emxArray_real_T x, int32_T ix,
  emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel24(const emxArray_real_T x, int32_T ix,
  emxArray_real_T dv16);
static __global__ void ecc_cwt_kernel25(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel26(const emxArray_real_T y, int32_T b_y,
  emxArray_real_T dv19);
static __global__ void ecc_cwt_kernel27(int32_T ix, emxArray_real_T dv19);
static __global__ void ecc_cwt_kernel28(const emxArray_real_T xt, const
  emxArray_real_T dv19, const emxArray_real_T dv16, int32_T b_dv16,
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel29(int16_T dv5_idx_1, emxArray_real_T fx);
static __global__ void ecc_cwt_kernel3(const real_T fs, real_T NyquistRange[2]);
static __global__ void ecc_cwt_kernel30(const real_T r, real_T freqrange[2],
  real_T fLims[2]);
static __global__ void ecc_cwt_kernel31(const real_T fs, real_T freqrange[2],
  real_T fLims[2]);
static __global__ void ecc_cwt_kernel32(int32_T lidx, emxArray_real_T omega);
static __global__ void ecc_cwt_kernel33(const uint32_T N, int32_T j,
  emxArray_real_T omega);
static __global__ void ecc_cwt_kernel34(emxArray_real_T r);
static __global__ void ecc_cwt_kernel35(const emxArray_real_T omega, int32_T
  eint, emxArray_real_T r);
static __global__ void ecc_cwt_kernel36(const int32_T lidx, const int32_T nsubs,
  const emxArray_real_T omega, int32_T eint, emxArray_real_T r, int32_T
  omega_dim1);
static __global__ void ecc_cwt_kernel37(const emxArray_real_T r, int32_T b_r,
  emxArray_real_T omega);
static __global__ void ecc_cwt_kernel38(const real_T fLims[2], boolean_T b[2]);
static __global__ void ecc_cwt_kernel39(const char_T cv[128], char_T wav[5],
  char_T b_dim0, char_T b_dim1, char_T b_dim2, char_T b_dim3, char_T b_dim4);
static __global__ void ecc_cwt_kernel4(const char_T cv[128], char_T wav[5],
  char_T b_dim0, char_T b_dim1, char_T b_dim2, char_T b_dim3, char_T b_dim4);
static __global__ void ecc_cwt_kernel40(real_T interval[650]);
static __global__ void ecc_cwt_kernel41(real_T interval[650]);
static __global__ void ecc_cwt_kernel42(const int32_T ix, real_T interval[650]);
static __global__ void ecc_cwt_kernel43(const real_T interval[650], int32_T
  nsubs, real_T subs[1298]);
static __global__ void ecc_cwt_kernel44(const emxArray_real_T x, int32_T lidx,
  emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel45(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel46(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel47(const emxArray_real_T y, const
  emxArray_real_T b_y, int32_T c_y, emxArray_real_T a);
static __global__ void ecc_cwt_kernel48(const emxArray_real_T a, int32_T ix,
  emxArray_real_T dv22);
static __global__ void ecc_cwt_kernel49(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel5(real_T interval[650]);
static __global__ void ecc_cwt_kernel50(const emxArray_real_T y, int32_T b_y,
  emxArray_real_T dv26);
static __global__ void ecc_cwt_kernel51(int32_T ix, emxArray_real_T dv26);
static __global__ void ecc_cwt_kernel52(const emxArray_real_T xt, const
  emxArray_real_T dv26, const emxArray_real_T dv22, int32_T b_dv22,
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel53(int16_T dv5_idx_1, emxArray_real_T fx);
static __global__ void ecc_cwt_kernel54(real_T interval[650]);
static __global__ void ecc_cwt_kernel55(real_T interval[650]);
static __global__ void ecc_cwt_kernel56(const int32_T ix, real_T interval[650]);
static __global__ void ecc_cwt_kernel57(const real_T interval[650], int32_T
  nsubs, real_T subs[1298]);
static __global__ void ecc_cwt_kernel58(const emxArray_real_T x, int32_T lidx,
  emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel59(const emxArray_real_T x, int32_T ix,
  emxArray_real_T dv28);
static __global__ void ecc_cwt_kernel6(real_T interval[650]);
static __global__ void ecc_cwt_kernel60(const emxArray_real_T x, int32_T ix,
  emxArray_real_T y);
static __global__ void ecc_cwt_kernel61(const emxArray_real_T y, int32_T b_y,
  emxArray_real_T dv30);
static __global__ void ecc_cwt_kernel62(int32_T ix, emxArray_real_T dv30);
static __global__ void ecc_cwt_kernel63(const emxArray_real_T xt, const
  emxArray_real_T dv30, const emxArray_real_T dv28, int32_T b_dv28,
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel64(int16_T dv5_idx_1, emxArray_real_T fx);
static __global__ void ecc_cwt_kernel65(real_T r, emxArray_real_T y);
static __global__ void ecc_cwt_kernel66(const emxArray_real_T y, const real_T r,
  int32_T ix, emxArray_real_T b_y);
static __global__ void ecc_cwt_kernel67(const emxArray_real_T y, const real_T
  halfh, int32_T b_y, emxArray_real_T fb_Scales);
static __global__ void ecc_cwt_kernel68(const real_T fs, const real_T fLims[2],
  real_T NyquistRange[2]);
static __global__ void ecc_cwt_kernel69(real_T r, emxArray_real_T y);
static __global__ void ecc_cwt_kernel7(const int32_T ix, real_T interval[650]);
static __global__ void ecc_cwt_kernel70(const emxArray_real_T y, const real_T
  tol, int32_T ix, emxArray_real_T b_y);
static __global__ void ecc_cwt_kernel71(const emxArray_real_T y, const real_T
  halfh, int32_T b_y, emxArray_real_T fb_Scales);
static __global__ void ecc_cwt_kernel72(int32_T fb_Scales, emxArray_real_T
  psidft);
static __global__ void ecc_cwt_kernel73(const emxArray_real_T fb_Scales, int32_T
  b_fb_Scales, emxArray_real_T f);
static __global__ void ecc_cwt_kernel74(const emxArray_real_T omega, const
  emxArray_real_T fb_Scales, const int32_T b_fb_Scales, int32_T eint,
  emxArray_real_T somega, int32_T somega_dim0);
static __global__ void ecc_cwt_kernel75(const emxArray_real_T somega, int32_T ix,
  emxArray_real_T absomega);
static __global__ void ecc_cwt_kernel76(const emxArray_real_T absomega, int32_T
  b_absomega, emxArray_real_T powscales);
static __global__ void ecc_cwt_kernel77(int32_T ix, emxArray_real_T absomega);
static __global__ void ecc_cwt_kernel78(const emxArray_real_T powscales, const
  emxArray_real_T absomega, int32_T b_absomega, emxArray_real_T x);
static __global__ void ecc_cwt_kernel79(int32_T ix, emxArray_real_T x);
static __global__ void ecc_cwt_kernel8(const real_T interval[650], int32_T nsubs,
  real_T subs[1298]);
static __global__ void ecc_cwt_kernel80(const emxArray_real_T somega, const
  emxArray_real_T x, int32_T b_x, emxArray_real_T psidft);
static __global__ void ecc_cwt_kernel81(const emxArray_real_T fb_Scales, int32_T
  b_fb_Scales, emxArray_real_T f);
static __global__ void ecc_cwt_kernel82(const real_T fs, int32_T j,
  emxArray_real_T f);
static __global__ void ecc_cwt_kernel83(const emxArray_real_T f, int32_T b_f,
  emxArray_real_T freqs);
static __global__ void ecc_cwt_kernel84(const real_T ds2, int32_T j,
  emxArray_real_T dv1);
static __global__ void ecc_cwt_kernel85(const int32_T eint, const
  emxArray_real_T x, int32_T b_x, emxArray_real_T xv, int32_T x_dim0);
static __global__ void ecc_cwt_kernel86(const int32_T eint, const
  emxArray_real_T x, int32_T fb_SignalPad, emxArray_real_T b_x, int32_T x_dim0);
static __global__ void ecc_cwt_kernel87(const emxArray_real_T x, int32_T eint,
  emxArray_real_T xv);
static __global__ void ecc_cwt_kernel88(const emxArray_real_T xv, int32_T b_xv,
  emxArray_creal_T xposdft);
static __global__ void ecc_cwt_kernel89(const emxArray_creal_T xposdft, const
  emxArray_real_T psidft, const int32_T bcoef, const int32_T lidx, const int32_T
  cfsposdft, int32_T ix, emxArray_creal_T b_cfsposdft, int32_T psidft_dim0,
  int32_T cfsposdft_dim0);
static __global__ void ecc_cwt_kernel9(const emxArray_real_T x, int32_T lidx,
  emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel90(const real_T cfsposdft_re, const
  emxArray_creal_T cfsposdft, int32_T b_cfsposdft, emxArray_creal_T cfspos);
static __global__ void ecc_cwt_kernel91(uint32_T xSize[2], int32_T
  cfsposdft_dim1);
static __global__ void ecc_cwt_kernel92(int32_T xSize, emxArray_creal_T cfspos);
static __global__ void ecc_cwt_kernel93(const emxArray_creal_T cfspos, int32_T
  ix, emxArray_real_T y);
static __global__ void ecc_cwt_kernel94(const emxArray_real_T y, const int32_T
  b_y, int32_T c_y, emxArray_real_T xCh, int32_T xCh_dim0, int32_T y_dim0);
static __global__ void ecc_cwt_kernel95(const emxArray_real_T xCh, const int32_T
  lidx, const int32_T ix, int32_T bcoef, emxArray_real_T b_xCh, int32_T xCh_dim0,
  int32_T b_xCh_dim0);
static __global__ void ecc_cwt_kernel96(const emxArray_real_T xCh, int32_T b_xCh,
  emxArray_real_T c_xCh);
static __global__ void ecc_cwt_kernel97(const emxArray_real_T xCh, const int32_T
  xx_dim0, const int32_T eint, const int32_T xx, int32_T b_xx, emxArray_real_T
  c_xx, int32_T b_xx_dim0, int32_T xx_dim1);
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel1(const real_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel10(const
  emxArray_real_T x, int32_T ix, emxArray_real_T y)
{
  ...
  loopEnd = static_cast<uint64_T>(ix) - 1UL;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel13(const
  emxArray_real_T a, int32_T ix, emxArray_real_T dv9)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  emxArray_real_T y, int32_T b_y, emxArray_real_T dv13)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    dv13.data[varargin_3] = -2.0 * y.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel16(int32_T ix,
  emxArray_real_T dv13)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv13.data[k] = exp(dv13.data[k]);
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel17(const
  emxArray_real_T xt, const emxArray_real_T dv13, const emxArray_real_T dv9,
  int32_T b_dv9, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv9.data[varargin_3] * dv13.data[varargin_3] *
      xt.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel18(int16_T
  dv5_idx_1, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>(dv5_idx_1) - 1UL;
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel19(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel2(const real_T
...
static __global__ __launch_bounds__(512, 1) void ecc_cwt_kernel20(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T k;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel21(const int32_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel22(const real_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel23(const
  emxArray_real_T x, int32_T ix, emxArray_real_T xt, emxArray_real_T b_x)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel24(const
  emxArray_real_T x, int32_T ix, emxArray_real_T dv16)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel26(const
  emxArray_real_T y, int32_T b_y, emxArray_real_T dv19)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    dv19.data[varargin_3] = -2.0 * y.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel27(int32_T ix,
  emxArray_real_T dv19)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv19.data[k] = exp(dv19.data[k]);
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel28(const
  emxArray_real_T xt, const emxArray_real_T dv19, const emxArray_real_T dv16,
  int32_T b_dv16, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv16.data[varargin_3] * dv19.data[varargin_3] *
      xt.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel29(int16_T
  dv5_idx_1, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel3(const real_T fs,
  real_T NyquistRange[2])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel30(const real_T r,
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel31(const real_T fs,
  real_T freqrange[2], real_T fLims[2])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel32(int32_T lidx,
  emxArray_real_T omega)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>(lidx) - 1UL;
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel33(const
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel34(emxArray_real_T
  r)
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel35(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel36(const int32_T
  lidx, const int32_T nsubs, const emxArray_real_T omega, int32_T eint,
  emxArray_real_T r, int32_T omega_dim1)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    r.data[(varargin_3 + omega_dim1) + 1] = -omega.data[nsubs + lidx *
      varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel37(const
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel38(const real_T
  fLims[2], boolean_T b[2])
{
  uint64_T threadId;
  int32_T varargin_3;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel39(const char_T
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel4(const char_T cv
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel40(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(512, 1) void ecc_cwt_kernel41(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T k;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel42(const int32_T
  ix, real_T interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel43(const real_T
  interval[650], int32_T nsubs, real_T subs[1298])
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel45(const
  emxArray_real_T x, int32_T ix, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel47(const
  emxArray_real_T y, const emxArray_real_T b_y, int32_T c_y, emxArray_real_T a)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel48(const
  emxArray_real_T a, int32_T ix, emxArray_real_T dv22)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel49(const
  emxArray_real_T x, int32_T ix, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel5(real_T interval
  [650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel50(const
  emxArray_real_T y, int32_T b_y, emxArray_real_T dv26)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    dv26.data[varargin_3] = -2.0 * y.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel51(int32_T ix,
  emxArray_real_T dv26)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv26.data[k] = exp(dv26.data[k]);
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel52(const
  emxArray_real_T xt, const emxArray_real_T dv26, const emxArray_real_T dv22,
  int32_T b_dv22, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv22.data[varargin_3] * dv26.data[varargin_3] *
      xt.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel53(int16_T
  dv5_idx_1, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel54(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(512, 1) void ecc_cwt_kernel55(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T k;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel56(const int32_T
  ix, real_T interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel57(const real_T
  interval[650], int32_T nsubs, real_T subs[1298])
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel58(const
  emxArray_real_T x, int32_T lidx, emxArray_real_T xt, emxArray_real_T b_x)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel59(const
  emxArray_real_T x, int32_T ix, emxArray_real_T dv28)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv28.data[k] = pow(x.data[k], 40.0);
  }
}

static __global__ __launch_bounds__(512, 1) void ecc_cwt_kernel6(real_T
  interval[650])
{
  uint64_T threadId;
  int32_T k;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel61(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel62(int32_T ix,
  emxArray_real_T dv30)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel63(const
  emxArray_real_T xt, const emxArray_real_T dv30, const emxArray_real_T dv28,
  int32_T b_dv28, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>(b_dv28);
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv28.data[varargin_3] * dv30.data[varargin_3] *
      xt.data[varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel64(int16_T
  dv5_idx_1, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel65(real_T r,
  emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel66(const
  emxArray_real_T y, const real_T r, int32_T ix, emxArray_real_T b_y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel67(const
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel68(const real_T fs,
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel69(real_T r,
  emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel7(const int32_T ix,
  real_T interval[650])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel70(const
  emxArray_real_T y, const real_T tol, int32_T ix, emxArray_real_T b_y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel72(int32_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel77(int32_T ix,
  emxArray_real_T absomega)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel78(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel79(int32_T ix,
  emxArray_real_T x)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel8(const real_T
  interval[650], int32_T nsubs, real_T subs[1298])
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel80(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel81(const
  emxArray_real_T fb_Scales, int32_T b_fb_Scales, emxArray_real_T f)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel82(const real_T
  fs, int32_T j, emxArray_real_T f)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel83(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel84(const real_T
  ds2, int32_T j, emxArray_real_T dv1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>((static_cast<real_T>(j) - 1.0) / ds2);
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel85(const int32_T
  eint, const emxArray_real_T x, int32_T b_x, emxArray_real_T xv, int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    xv.data[varargin_3] = x.data[varargin_3 + x_dim0 * eint];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel86(const int32_T
  eint, const emxArray_real_T x, int32_T fb_SignalPad, emxArray_real_T b_x,
  int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    b_x.data[varargin_3] = x.data[varargin_3 + x_dim0 * eint];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel89(const
  emxArray_creal_T xposdft, const emxArray_real_T psidft, const int32_T bcoef,
  const int32_T lidx, const int32_T cfsposdft, int32_T ix, emxArray_creal_T
  b_cfsposdft, int32_T psidft_dim0, int32_T cfsposdft_dim0)
{
  ...
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = (static_cast<uint64_T>(cfsposdft) + 1UL) * (static_cast<uint64_T>(ix)
    + 1UL) - 1UL;
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T b_bcoef;
    int32_T b_k;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel9(const
  emxArray_real_T x, int32_T lidx, emxArray_real_T xt, emxArray_real_T b_x)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel90(const real_T
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel91(uint32_T xSize
  [2], int32_T cfsposdft_dim1)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel92(int32_T xSize,
  emxArray_creal_T cfspos)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel93(const
  emxArray_creal_T cfspos, int32_T ix, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel95(const
  emxArray_real_T xCh, const int32_T lidx, const int32_T ix, int32_T bcoef,
  emxArray_real_T b_xCh, int32_T xCh_dim0, int32_T b_xCh_dim0)
{
  ...
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = (static_cast<uint64_T>(ix / lidx) + 1UL) * static_cast<uint64_T>
    (bcoef) - 1UL;
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T b_bcoef;
    int32_T varargin_3;
    b_bcoef = static_cast<int32_T>(idx % (static_cast<uint64_T>(ix / lidx) + 1UL));
    varargin_3 = static_cast<int32_T>((idx - static_cast<uint64_T>(b_bcoef)) / (
      static_cast<uint64_T>(ix / lidx) + 1UL));
    b_xCh.data[b_bcoef + xCh_dim0 * varargin_3] = xCh.data[lidx * b_bcoef +
      b_xCh_dim0 * varargin_3];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel96(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel97(const
  emxArray_real_T xCh, const int32_T xx_dim0, const int32_T eint, const int32_T
  xx, int32_T b_xx, emxArray_real_T c_xx, int32_T b_xx_dim0, int32_T xx_dim1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    c_xx.data[(bcoef + b_xx_dim0 * eint) + b_xx_dim0 * xx_dim1 * varargin_3] =
...
void ecc_cwt(const emxArray_real_T *cpu_x, real_T fs, real_T cpu_fLims[2],
             real_T fOctave, real_T ds2, emxArray_real_T *cpu_xx,
             emxArray_real_T *cpu_freqs)
{
  ...
  static const real_T dv7[15]{ 0.022935322010529221, 0.063092092629978544,
  ...
  static const real_T dv8[15]{ 0.022935322010529221, -0.066392873538891159,
  ...
  emxArray_real_T *cpu_dv28;
  emxArray_real_T *cpu_dv30;
  ...
  // 'ecc_cwt:19' if fOctave<1
  if (fOctave < 1.0) {
    // 'ecc_cwt:19' ;
    // 'ecc_cwt:19' fOctave=1;
    fOctave = 1.0;
  } else if (fOctave > 48.0) {
    // 'ecc_cwt:19' elseif fOctave>48
    // 'ecc_cwt:19' ;
    // 'ecc_cwt:19' fOctave=48;
    fOctave = 48.0;
  }

  // 'ecc_cwt:20' ds2 = floor(ds2);
  ds2 = std::floor(ds2);

  // 'ecc_cwt:21' fOctave = round(fOctave);
  // 'ecc_cwt:22' nFrames = height(x);
  // 'ecc_cwt:23' nChs = cast(width(x),like=x);
  //  Prep CWT
  // 'ecc_cwt:26' fb = cwtfilterbank(Wavelet="Morse",SignalLength=nFrames,...
  // 'ecc_cwt:27'     SamplingFrequency=fs,FrequencyLimits=fLims,VoicesPerOctave=fOctave);
  fb_CutOff = 50;
  ...
  do {
    exitg1 = 0;
    if (ix + 1 < 11) {
      if (cpu_cv[static_cast<int32_T>(Bndry[ix])] != cpu_cv[static_cast<int32_T>
          (cv1[ix])]) {
        exitg1 = 1;
      } else {
        ix++;
  ...
  if (first_iteration) {
    if (cpu_x->size[0] <= 100000) {
      ...
      r = std::frexp(static_cast<real_T>(cpu_x->size[0]), &lidx);
      if (r == 0.5) {
        r = static_cast<real_T>(lidx) - 1.0;
      } else {
        r = std::log(r) / 0.69314718055994529 + static_cast<real_T>(lidx);
      }
  ...
  ecc_cwt_kernel1<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_fLims, *gpu_b);
  b_dirtyOnGpu = true;
  first_iteration = true;
  k = 0;
  exitg2 = false;
  ...
  if (!first_iteration) {
    ...
    ecc_cwt_kernel2<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_fLims,
      *gpu_freqrange);
    ecc_cwt_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(fs,
      *gpu_NyquistRange);
    b_dirtyOnGpu = true;
    emxInit_char_T(&tmpStr, 2, &ob_emlrtRTEI, true);
    guard1 = false;
    if (cpu_fLims[1] <= 0.0) {
      guard1 = true;
    } else {
    ...
    ecc_cwt_kernel4<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*cpu_cv_gpu_clone, *
    ...
    switch (lidx) {
     case 0:
      ...
      if (std::isinf(b_r) || std::isnan(b_r)) {
        ecc_cwt_kernel5<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_interval);
        ecc_cwt_kernel6<<<dim3(2U, 1U, 1U), dim3(512U, 1U, 1U)>>>(*gpu_interval);
        intDsq = 0.0;
        ix = 1;
        ...
        lidx = 0;
        for (j = 0; j < ix; j++) {
          if (std::abs(cpu_interval[j + 1] - cpu_interval[lidx]) > 0.0) {
            lidx++;
            cpu_interval[lidx] = cpu_interval[j + 1];
            interval_dirtyOnCpu = true;
          } else {
            nsubs--;
          }
        ...
        if (nsubs + 1 < 2) {
          ...
          ecc_cwt_kernel7<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(ix,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (k <= 0) {
          ...
          if (b_dirtyOnGpu) {
            ...
            interval_dirtyOnCpu = false;
            ecc_cwt_kernel8<<<grid, block>>>(*gpu_interval, nsubs, *gpu_subs);
          ...
          emxInit_real_T(&c_cpu_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&cpu_xt, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&cpu_y, 2, &xb_emlrtRTEI, true);
          emxInit_real_T(&cpu_fx, 2, &ob_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_y, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&cpu_a, 2, &l_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv9, 2, &ac_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_y, 2, &bc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv13, 2, &ac_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              for (j = 0; j < 15; j++) {
                b_cpu_x->data[(ix + j) + 1] = NODES[j] * halfh + b_r;
                b_x_dirtyOnCpu = true;
              }
            ...
            if (b_dirtyOnGpu) {
              ...
              b_x_dirtyOnCpu = false;
              ecc_cwt_kernel9<<<grid, block>>>(j_gpu_x, lidx, d_gpu_xt, k_gpu_x);
              x_dirtyOnGpu = true;
              xt_dirtyOnGpu = true;
            }
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                dv5_idx_1 = static_cast<int16_T>(b_cpu_x->size[1]);
                ...
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>
                  (dv5_idx_1), &grid, &block, 1024U, 3584U);
                if (b_dirtyOnGpu) {
                  if (fx_dirtyOnCpu) {
                    gpuEmxMemcpyCpuToGpu_real_T(&d_gpu_fx, cpu_fx);
                  }

                  ecc_cwt_kernel18<<<grid, block>>>(dv5_idx_1, d_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              ix = c_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel10<<<grid, block>>>(k_gpu_x, ix, k_gpu_y);
                y_dirtyOnGpu = true;
              }
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel11<<<grid, block>>>(k_gpu_x, ix, l_gpu_y);
                b_y_dirtyOnGpu = true;
              }
              ...
              if (cpu_y->size[1] == b_cpu_y->size[1]) {
                ...
                emxEnsureCapacity_real_T(cpu_a, j, &l_emlrtRTEI);
                if (!a_dirtyOnCpu) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel12<<<grid, block>>>(l_gpu_y, k_gpu_y, k, b_gpu_a);
                  a_dirtyOnGpu = true;
                  a_dirtyOnCpu = false;
                }
              } else {
              ...
              cpu_dv9->size[0] = 1;
              cpu_dv9->size[1] = static_cast<int16_T>(cpu_a->size[1]);
              emxEnsureCapacity_real_T(cpu_dv9, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv9, &gpu_dv9);
              ix = static_cast<int16_T>(cpu_a->size[1]);
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                if (a_dirtyOnCpu) {
                ...
                a_dirtyOnCpu = false;
                ecc_cwt_kernel13<<<grid, block>>>(b_gpu_a, ix, gpu_dv9);
                dv9_dirtyOnGpu = true;
              }
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel14<<<grid, block>>>(k_gpu_x, ix, m_gpu_y);
              }

              j = cpu_dv13->size[0] * cpu_dv13->size[1];
              cpu_dv13->size[0] = 1;
              cpu_dv13->size[1] = c_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv13, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv13, &gpu_dv13);
              k = c_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel15<<<grid, block>>>(m_gpu_y, k, gpu_dv13);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel16<<<grid, block>>>(ix, gpu_dv13);
                dv13_dirtyOnGpu = true;
              }

              if (cpu_dv9->size[1] == cpu_dv13->size[1]) {
                j = cpu_fx->size[0] * cpu_fx->size[1];
                cpu_fx->size[0] = 1;
                cpu_fx->size[1] = cpu_dv9->size[1];
                emxEnsureCapacity_real_T(cpu_fx, j, &v_emlrtRTEI);
                if (!fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(cpu_fx, &d_gpu_fx);
                }
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel17<<<grid, block>>>(d_gpu_xt, gpu_dv13, gpu_dv9,
                    ix, d_gpu_fx);
                  fx_dirtyOnGpu = true;
                  fx_dirtyOnCpu = false;
                }
                ...
                xt_dirtyOnGpu = false;
                binary_expand_op(cpu_fx, cpu_dv9, cpu_dv13, cpu_xt);
                fx_dirtyOnCpu = true;
                fx_dirtyOnGpu = false;
              }
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                for (j = 0; j < 15; j++) {
                  ...
                  maxScale += dv7[j] * cpu_fx->data[(ix + j) + 1];
                  fx_dirtyOnGpu = false;
                  r += dv8[j] * cpu_fx->data[(ix + j) + 1];
                }
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                if (halfh <= b_r * ((cpu_subs[(k << 1) + 1] - cpu_subs[k << 1]) /
                  ...
                  r += halfh;
                  lidx++;
                  cpu_subs[(lidx - 1) << 1] = cpu_subs[k << 1];
                  cpu_subs[((lidx - 1) << 1) + 1] = cpu_subs[(k << 1) + 1];
              ...
              if ((!std::isinf(intDsq)) && (!std::isnan(intDsq)) && ((!std::
                ...
                if (nsubs > 650) {
                  ...
                  for (k = 0; k < lidx; k++) {
                    ...
                    cpu_subs[((((lidx - k) << 1) - 1) << 1) + 1] = cpu_subs
                      [(((lidx - k) - 1) << 1) + 1];
                    cpu_subs[(((lidx - k) << 1) - 1) << 1] = (cpu_subs[((lidx -
                      k) - 1) << 1] + cpu_subs[(((lidx - k) - 1) << 1) + 1]) /
                      2.0;
                    cpu_subs[((((lidx - k) << 1) - 2) << 1) + 1] = cpu_subs
                      [(((lidx - k) << 1) - 1) << 1];
                    cpu_subs[(((lidx - k) << 1) - 2) << 1] = cpu_subs[((lidx - k)
                      - 1) << 1];
                    subs_dirtyOnCpu = true;
                    subs_dirtyOnGpu = false;
                  }
        ...
        ecc_cwt_kernel19<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_interval);
        ecc_cwt_kernel20<<<dim3(2U, 1U, 1U), dim3(512U, 1U, 1U)>>>(*gpu_interval);
        interval_dirtyOnCpu = false;
        intFsq = 0.0;
        ix = 1;
        cudaMemcpy(cpu_interval, *gpu_interval, 5200UL, cudaMemcpyDeviceToHost);
        ...
        if (nsubs + 1 < 2) {
          ...
          ecc_cwt_kernel21<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(ix,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (k <= 0) {
          ...
          if (b_dirtyOnGpu) {
            ...
            ecc_cwt_kernel22<<<grid, block>>>(*gpu_interval, nsubs, *gpu_subs);
            subs_dirtyOnGpu = true;
            subs_dirtyOnCpu = false;
          }
          ...
          emxInit_real_T(&e_cpu_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_xt, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv16, 2, &dc_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_fx, 2, &ob_emlrtRTEI, true);
          emxInit_real_T(&f_cpu_y, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv19, 2, &dc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                d_cpu_x->data[(ix + j) + 1] = NODES[j] * halfh + b_r;
                c_x_dirtyOnCpu = true;
              }
            ...
            if (b_dirtyOnGpu) {
              ...
              c_x_dirtyOnCpu = false;
              ecc_cwt_kernel23<<<grid, block>>>(h_gpu_x, ix, c_gpu_xt, i_gpu_x);
              b_x_dirtyOnGpu = true;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                dv5_idx_1 = static_cast<int16_T>(d_cpu_x->size[1]);
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel29<<<grid, block>>>(dv5_idx_1, c_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              cpu_dv16->size[0] = 1;
              cpu_dv16->size[1] = e_cpu_x->size[1];
              emxEnsureCapacity_real_T(cpu_dv16, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv16, &gpu_dv16);
              ix = e_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel24<<<grid, block>>>(i_gpu_x, ix, gpu_dv16);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel25<<<grid, block>>>(i_gpu_x, ix, j_gpu_y);
              }

              j = cpu_dv19->size[0] * cpu_dv19->size[1];
              cpu_dv19->size[0] = 1;
              cpu_dv19->size[1] = f_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv19, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv19, &gpu_dv19);
              k = f_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel26<<<grid, block>>>(j_gpu_y, k, gpu_dv19);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel27<<<grid, block>>>(ix, gpu_dv19);
                dv19_dirtyOnGpu = true;
              }

              if (cpu_dv16->size[1] == cpu_dv19->size[1]) {
                j = b_cpu_fx->size[0] * b_cpu_fx->size[1];
                b_cpu_fx->size[0] = 1;
                b_cpu_fx->size[1] = cpu_dv16->size[1];
                emxEnsureCapacity_real_T(b_cpu_fx, j, &v_emlrtRTEI);
                if (!b_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(b_cpu_fx, &c_gpu_fx);
                }
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel28<<<grid, block>>>(c_gpu_xt, gpu_dv19, gpu_dv16,
                    k, c_gpu_fx);
                ...
                b_xt_dirtyOnGpu = false;
                binary_expand_op(b_cpu_fx, cpu_dv16, cpu_dv19, b_cpu_xt);
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                for (j = 0; j < 15; j++) {
                  ...
                  maxScale += dv7[j] * b_cpu_fx->data[(ix + j) + 1];
                  b_fx_dirtyOnGpu = false;
                  r += dv8[j] * b_cpu_fx->data[(ix + j) + 1];
                }
            ...
            if ((std::abs(b_m) <= toler) || (q_ok == 0.0)) {
              ...
              if ((std::abs(intDsq) < toler) || (std::abs(b_r) <= std::abs(q_ok)))
              {
                ...
                if (a == intFsq) {
                  ...
                  tol = b_r / err_ok;
                  c_r = q_ok / err_ok;
                  b_r = s * (2.0 * b_m * tol * (tol - c_r) - (omegac - a) * (c_r
                              - 1.0));
                ...
                if ((2.0 * b_r < 3.0 * b_m * tol - std::abs(toler * tol)) &&
                    (b_r < std::abs(0.5 * intDsq * tol))) {
                  intDsq = d;
                  d = b_r / tol;
                } else {
                  d = b_m;
    ...
    if (cpu_fLims[0] < r) {
      ecc_cwt_kernel30<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(r,
        *gpu_freqrange, *gpu_fLims);
      cudaMemcpy(cpu_fLims, *gpu_fLims, 16UL, cudaMemcpyDeviceToHost);
    }

    if (cpu_fLims[1] > fs / 2.0) {
      ecc_cwt_kernel31<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(fs,
        *gpu_freqrange, *gpu_fLims);
    }
    ...
    if (!(b_r - r >= 1.0 / fb_VoicesPerOctave)) {
      ...
      emlrt_marshallIn(length(emlrtAlias(c_tmpStr), &b_emlrtMCI),
                       "<output of length>");
      emxInit_char_T(&d_tmpStr, 2, &ob_emlrtRTEI, true);
  ...
  do {
    exitg1 = 0;
    if (ix + 1 < 6) {
      if (cpu_cv[static_cast<int32_T>(b[ix])] != cpu_cv[static_cast<int32_T>
          (cv2[ix])]) {
        exitg1 = 1;
      } else {
        ix++;
  ...
  emxInit_real_T(&cpu_omega, 2, &emlrtRTEI, true);
  if (lidx < 1) {
    cpu_omega->size[1] = 0;
  } else {
    j = cpu_omega->size[0] * cpu_omega->size[1];
    cpu_omega->size[0] = 1;
    cpu_omega->size[1] = lidx;
    emxEnsureCapacity_real_T(cpu_omega, j, &emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_omega, &gpu_omega);
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(lidx), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel32<<<grid, block>>>(lidx, gpu_omega);
  ...
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(j + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel33<<<grid, block>>>(N, j, gpu_omega);
    omega_dirtyOnGpu = true;
  }
  ...
  emxInit_real_T(&cpu_r, 2, &c_emlrtRTEI, true);
  j = cpu_r->size[0] * cpu_r->size[1];
  cpu_r->size[0] = 1;
  cpu_r->size[1] = (cpu_omega->size[1] + div_s32(ix - nsubs, lidx)) + 2;
  emxEnsureCapacity_real_T(cpu_r, j, &c_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(cpu_r, &gpu_r);
  ecc_cwt_kernel34<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(gpu_r);
  eint = cpu_omega->size[1];
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(eint), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel35<<<grid, block>>>(gpu_omega, eint, gpu_r);
  }

  eint = div_s32(ix - nsubs, lidx);
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(eint + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel36<<<grid, block>>>(lidx, nsubs, gpu_omega, eint, gpu_r,
      cpu_omega->size[1U]);
  }
  ...
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel37<<<grid, block>>>(gpu_r, ix, gpu_omega);
    omega_dirtyOnGpu = true;
  }

  emxFree_real_T(&cpu_r);
  ecc_cwt_kernel38<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_fLims, *gpu_b);
  b_dirtyOnGpu = true;
  first_iteration = true;
  k = 0;
  exitg2 = false;
  ...
  if (!first_iteration) {
    ecc_cwt_kernel68<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(fs, *gpu_fLims,
      *gpu_NyquistRange);
    r = 0.0;
    if (cpu_cv[77] == 'm') {
      lidx = 0;
    ...
    emxInit_real_T(&d_cpu_y, 2, &mb_emlrtRTEI, true);
    ...
    if (std::isnan(r)) {
      ...
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(static_cast<
        int64_T>(r) + 1L), &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel69<<<grid, block>>>(r, gpu_y);
      }
    }

    emxInit_real_T(&e_cpu_y, 2, &nb_emlrtRTEI, true);
    ...
    ix = d_cpu_y->size[1];
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      if (y_dirtyOnCpu) {
      ...
      ecc_cwt_kernel70<<<grid, block>>>(gpu_y, rt_powd_snf(2.0, 1.0 /
        fb_VoicesPerOctave), ix, b_gpu_y);
    }
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel71<<<grid, block>>>(b_gpu_y, halfh, k, gpu_fb_Scales);
      fb_Scales_dirtyOnGpu = true;
    }

    emxFree_real_T(&e_cpu_y);
  } else {
    ecc_cwt_kernel39<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*cpu_cv_gpu_clone,
      *gpu_wav, b[0], b[1], b[2], b[3], b[4]);
    omegac = 3.1415926535897931;
    a = 0.0;
    b_r = 0.0;
    ...
    switch (lidx) {
     case 0:
      ...
      if (std::isinf(b_r) || std::isnan(b_r)) {
        ...
        ecc_cwt_kernel40<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_interval);
        ecc_cwt_kernel41<<<dim3(2U, 1U, 1U), dim3(512U, 1U, 1U)>>>(*gpu_interval);
        interval_dirtyOnCpu = false;
        intDsq = 0.0;
        ix = 1;
        cudaMemcpy(cpu_interval, *gpu_interval, 5200UL, cudaMemcpyDeviceToHost);
        ...
        if (nsubs + 1 < 2) {
          ...
          ecc_cwt_kernel42<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(ix,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (k <= 0) {
          ...
          if (b_dirtyOnGpu) {
            ...
            ecc_cwt_kernel43<<<grid, block>>>(*gpu_interval, nsubs, *gpu_subs);
            subs_dirtyOnGpu = true;
            subs_dirtyOnCpu = false;
          }
          ...
          emxInit_real_T(&g_cpu_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_xt, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&i_cpu_y, 2, &xb_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_fx, 2, &ob_emlrtRTEI, true);
          emxInit_real_T(&j_cpu_y, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_a, 2, &l_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv22, 2, &ac_emlrtRTEI, true);
          emxInit_real_T(&k_cpu_y, 2, &bc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv26, 2, &ac_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                f_cpu_x->data[(ix + j) + 1] = NODES[j] * halfh + b_r;
                d_x_dirtyOnCpu = true;
              }
            ...
            if (b_dirtyOnGpu) {
              ...
              d_x_dirtyOnCpu = false;
              ecc_cwt_kernel44<<<grid, block>>>(f_gpu_x, lidx, b_gpu_xt, g_gpu_x);
              c_x_dirtyOnGpu = true;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                dv5_idx_1 = static_cast<int16_T>(f_cpu_x->size[1]);
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel53<<<grid, block>>>(dv5_idx_1, b_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel45<<<grid, block>>>(g_gpu_x, ix, g_gpu_y);
                c_y_dirtyOnGpu = true;
              }
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel46<<<grid, block>>>(g_gpu_x, ix, h_gpu_y);
                d_y_dirtyOnGpu = true;
              }
              ...
              if (i_cpu_y->size[1] == j_cpu_y->size[1]) {
                ...
                emxEnsureCapacity_real_T(b_cpu_a, j, &l_emlrtRTEI);
                if (!b_a_dirtyOnCpu) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel47<<<grid, block>>>(h_gpu_y, g_gpu_y, k, gpu_a);
                  b_a_dirtyOnGpu = true;
                  b_a_dirtyOnCpu = false;
                }
              } else {
              ...
              j = cpu_dv22->size[0] * cpu_dv22->size[1];
              cpu_dv22->size[0] = 1;
              cpu_dv22->size[1] = static_cast<int16_T>(b_cpu_a->size[1]);
              emxEnsureCapacity_real_T(cpu_dv22, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv22, &gpu_dv22);
              ix = static_cast<int16_T>(b_cpu_a->size[1]);
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                if (b_a_dirtyOnCpu) {
                ...
                b_a_dirtyOnCpu = false;
                ecc_cwt_kernel48<<<grid, block>>>(gpu_a, ix, gpu_dv22);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel49<<<grid, block>>>(g_gpu_x, ix, i_gpu_y);
              }

              j = cpu_dv26->size[0] * cpu_dv26->size[1];
              cpu_dv26->size[0] = 1;
              cpu_dv26->size[1] = k_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv26, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv26, &gpu_dv26);
              k = k_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel50<<<grid, block>>>(i_gpu_y, k, gpu_dv26);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel51<<<grid, block>>>(ix, gpu_dv26);
                dv26_dirtyOnGpu = true;
              }

              if (cpu_dv22->size[1] == cpu_dv26->size[1]) {
                j = c_cpu_fx->size[0] * c_cpu_fx->size[1];
                c_cpu_fx->size[0] = 1;
                c_cpu_fx->size[1] = cpu_dv22->size[1];
                emxEnsureCapacity_real_T(c_cpu_fx, j, &v_emlrtRTEI);
                if (!c_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(c_cpu_fx, &b_gpu_fx);
                }

                ix = cpu_dv22->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix +
                  1L), &grid, &block, 1024U, 3584U);
                if (b_dirtyOnGpu) {
                  if (c_fx_dirtyOnCpu) {
                  ...
                  ecc_cwt_kernel52<<<grid, block>>>(b_gpu_xt, gpu_dv26, gpu_dv22,
                    ix, b_gpu_fx);
                ...
                c_xt_dirtyOnGpu = false;
                binary_expand_op(c_cpu_fx, cpu_dv22, cpu_dv26, c_cpu_xt);
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                for (j = 0; j < 15; j++) {
                  ...
                  maxScale += dv7[j] * c_cpu_fx->data[(ix + j) + 1];
                  c_fx_dirtyOnGpu = false;
                  r += dv8[j] * c_cpu_fx->data[(ix + j) + 1];
                }
        ...
        ecc_cwt_kernel54<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_interval);
        ecc_cwt_kernel55<<<dim3(2U, 1U, 1U), dim3(512U, 1U, 1U)>>>(*gpu_interval);
        interval_dirtyOnCpu = false;
        intFsq = 0.0;
        ix = 1;
        cudaMemcpy(cpu_interval, *gpu_interval, 5200UL, cudaMemcpyDeviceToHost);
        ...
        if (nsubs + 1 < 2) {
          ...
          ecc_cwt_kernel56<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(ix,
            *gpu_interval);
          interval_dirtyOnCpu = false;
          nsubs = 1;
        }
        ...
        if (k <= 0) {
          ...
          if (b_dirtyOnGpu) {
            ...
            ecc_cwt_kernel57<<<grid, block>>>(*gpu_interval, nsubs, *gpu_subs);
            subs_dirtyOnGpu = true;
          }
          ...
          emxInit_real_T(&i_cpu_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_xt, 2, &vb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv28, 2, &dc_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_fx, 2, &ob_emlrtRTEI, true);
          emxInit_real_T(&l_cpu_y, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv30, 2, &dc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            for (k = 0; k < nsubs; k++) {
              ...
              halfh = (r - maxScale) / 2.0;
              for (j = 0; j < 15; j++) {
                h_cpu_x->data[(ix + j) + 1] = NODES[j] * halfh + b_r;
                e_x_dirtyOnCpu = true;
              }
            ...
            if (b_dirtyOnGpu) {
              ...
              e_x_dirtyOnCpu = false;
              ecc_cwt_kernel58<<<grid, block>>>(d_gpu_x, lidx, gpu_xt, e_gpu_x);
              d_x_dirtyOnGpu = true;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                dv5_idx_1 = static_cast<int16_T>(h_cpu_x->size[1]);
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel64<<<grid, block>>>(dv5_idx_1, gpu_fx);
                }
            ...
            if (b_guard1) {
              first_iteration = false;
              j = cpu_dv28->size[0] * cpu_dv28->size[1];
              cpu_dv28->size[0] = 1;
              cpu_dv28->size[1] = i_cpu_x->size[1];
              emxEnsureCapacity_real_T(cpu_dv28, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv28, &gpu_dv28);
              ix = i_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel59<<<grid, block>>>(e_gpu_x, ix, gpu_dv28);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel60<<<grid, block>>>(e_gpu_x, ix, f_gpu_y);
              }

              j = cpu_dv30->size[0] * cpu_dv30->size[1];
              cpu_dv30->size[0] = 1;
              cpu_dv30->size[1] = l_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv30, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv30, &gpu_dv30);
              k = l_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel61<<<grid, block>>>(f_gpu_y, k, gpu_dv30);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel62<<<grid, block>>>(ix, gpu_dv30);
                dv30_dirtyOnGpu = true;
              }

              if (cpu_dv28->size[1] == cpu_dv30->size[1]) {
                j = d_cpu_fx->size[0] * d_cpu_fx->size[1];
                d_cpu_fx->size[0] = 1;
                d_cpu_fx->size[1] = cpu_dv28->size[1];
                emxEnsureCapacity_real_T(d_cpu_fx, j, &v_emlrtRTEI);
                if (!d_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(d_cpu_fx, &gpu_fx);
                }

                ix = cpu_dv28->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix +
                  1L), &grid, &block, 1024U, 3584U);
                if (b_dirtyOnGpu) {
                  if (d_fx_dirtyOnCpu) {
                  ...
                  ecc_cwt_kernel63<<<grid, block>>>(gpu_xt, gpu_dv30, gpu_dv28,
                    ix, gpu_fx);
                ...
                if (dv28_dirtyOnGpu) {
                  gpuEmxMemcpyGpuToCpu_real_T(cpu_dv28, &gpu_dv28);
                }

                dv28_dirtyOnGpu = false;
                if (dv30_dirtyOnGpu) {
                  gpuEmxMemcpyGpuToCpu_real_T(cpu_dv30, &gpu_dv30);
                }
                ...
                d_xt_dirtyOnGpu = false;
                binary_expand_op(d_cpu_fx, cpu_dv28, cpu_dv30, d_cpu_xt);
              ...
              for (k = 0; k < nsubs; k++) {
                ...
                for (j = 0; j < 15; j++) {
                  ...
                  maxScale += dv7[j] * d_cpu_fx->data[(ix + j) + 1];
                  d_fx_dirtyOnGpu = false;
                  r += dv8[j] * d_cpu_fx->data[(ix + j) + 1];
                }
          ...
          emxFree_real_T(&cpu_dv30);
          emxFree_real_T(&l_cpu_y);
          emxFree_real_T(&d_cpu_fx);
          emxFree_real_T(&cpu_dv28);
    ...
    emxInit_real_T(&g_cpu_y, 2, &rb_emlrtRTEI, true);
    ...
    if (std::isnan(r)) {
      ...
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel65<<<grid, block>>>(r, d_gpu_y);
      }
    }

    emxInit_real_T(&h_cpu_y, 2, &ub_emlrtRTEI, true);
    ...
    if (b_dirtyOnGpu) {
      ...
      ecc_cwt_kernel66<<<grid, block>>>(d_gpu_y, rt_powd_snf(2.0, 1.0 /
        fb_VoicesPerOctave), ix, e_gpu_y);
    }
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel67<<<grid, block>>>(e_gpu_y, halfh, k, gpu_fb_Scales);
      fb_Scales_dirtyOnGpu = true;
    }
  ...
  emxInit_real_T(&cpu_psidft, 2, &ob_emlrtRTEI, true);
  emxInit_real_T(&cpu_f, 2, &pb_emlrtRTEI, true);
  if (first_iteration) {
    emxInit_real_T(&cpu_somega, 2, &qb_emlrtRTEI, true);
    if (cpu_fb_Scales->size[1] == 1) {
      ...
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel74<<<grid, block>>>(gpu_omega, gpu_fb_Scales, ix, eint,
          gpu_somega, cpu_somega->size[0U]);
        somega_dirtyOnGpu = true;
      }
    }

    ix = cpu_somega->size[0] * cpu_somega->size[1];
    for (k = 0; k < 2; k++) {
      cpu_xSize[k] = static_cast<uint32_T>(cpu_somega->size[k]);
      xSize_dirtyOnCpu = true;
    }

    emxInit_real_T(&cpu_absomega, 2, &sb_emlrtRTEI, true);
    ...
    if (b_dirtyOnGpu) {
      ...
      somega_dirtyOnCpu = false;
      ecc_cwt_kernel75<<<grid, block>>>(gpu_somega, ix, gpu_absomega);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel76<<<grid, block>>>(gpu_absomega, ix, gpu_powscales);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel77<<<grid, block>>>(ix, gpu_absomega);
      absomega_dirtyOnGpu = true;
    }
    ...
    if ((cpu_absomega->size[0] == cpu_powscales->size[0]) && (cpu_absomega->
      ...
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
        &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel78<<<grid, block>>>(gpu_powscales, gpu_absomega, ix, gpu_x);
        e_x_dirtyOnGpu = true;
      }
    } else {
    ...
    ix = j_cpu_x->size[0] * j_cpu_x->size[1];
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      if (f_x_dirtyOnCpu) {
      ...
      ecc_cwt_kernel79<<<grid, block>>>(ix, gpu_x);
      e_x_dirtyOnGpu = true;
      f_x_dirtyOnCpu = false;
    }
    ...
    if ((j_cpu_x->size[0] == cpu_somega->size[0]) && (j_cpu_x->size[1] ==
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel80<<<grid, block>>>(gpu_somega, gpu_x, ix, gpu_psidft);
      }
    } else {
      if (e_x_dirtyOnGpu) {
    ...
    emxEnsureCapacity_real_T(cpu_f, j, &bb_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_f, &gpu_f);
    ix = cpu_fb_Scales->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel81<<<grid, block>>>(gpu_fb_Scales, ix, gpu_f);
    }
  } else {
    j = cpu_psidft->size[0] * cpu_psidft->size[1];
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel72<<<grid, block>>>(ix, gpu_psidft);
    }
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel73<<<grid, block>>>(gpu_fb_Scales, ix, gpu_f);
    }
  }
  ...
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(j + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel82<<<grid, block>>>(fs, j, gpu_f);
  }

  // 'ecc_cwt:28' freqs = centerFrequencies(fb);
  j = cpu_freqs->size[0];
  ...
  if (b_dirtyOnGpu) {
    ...
    ecc_cwt_kernel83<<<grid, block>>>(gpu_f, ix, gpu_freqs);
    freqs_dirtyOnGpu = true;
  }

  // 'ecc_cwt:29' nFreqs = cast(numel(freqs),like=x);
  // 'ecc_cwt:30' nFrames = cast(numel(1:ds2:nFrames),like=x);
  emxInit_real_T(&cpu_dv1, 2, &wb_emlrtRTEI, true);
  if (std::isnan(ds2)) {
    j = cpu_dv1->size[0] * cpu_dv1->size[1];
    cpu_dv1->size[1] = 1;
    emxEnsureCapacity_real_T(cpu_dv1, j, &w_emlrtRTEI);
    ...
    j = cpu_x->size[0];
    k = cpu_dv1->size[0] * cpu_dv1->size[1];
    cpu_dv1->size[0] = 1;
    cpu_dv1->size[1] = static_cast<int32_T>((static_cast<real_T>(cpu_x->size[0])
      - 1.0) / ds2) + 1;
    emxEnsureCapacity_real_T(cpu_dv1, k, &w_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_dv1, &gpu_dv1);
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>
      (static_cast<int64_T>((static_cast<real_T>(j) - 1.0) / ds2) + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel84<<<grid, block>>>(ds2, j, gpu_dv1);
    }
  }

  //  Trigger CUDA kernel generation
  // 'ecc_cwt:33' coder.gpu.kernelfun;
  //  Preallocate
  ...
  emxEnsureCapacity_real_T(cpu_xx, j, &y_emlrtRTEI);

  //  Preallocate output
  //  xx = cell(1,nChs);
  //  CWT per channel
  // 'ecc_cwt:40' for ch = 1:nChs
  fb_CutOff = cpu_x->size[1];
  emxInit_creal_T(&cpu_cfspos, 2, &hb_emlrtRTEI, true);
  if (cpu_x->size[1] - 1 >= 0) {
    csz_idx_0 = cpu_psidft->size[0];
  }

  emxInit_real_T(&cpu_xv, 2, &cb_emlrtRTEI, true);
  emxInit_creal_T(&cpu_xposdft, 2, &db_emlrtRTEI, true);
  emxInit_real_T(&k_cpu_x, 2, &fb_emlrtRTEI, true);
  emxInit_creal_T(&cpu_cfsposdft, 2, &cc_emlrtRTEI, true);
  emxInit_real_T(&m_cpu_y, 2, &fc_emlrtRTEI, true);
  emxInit_real_T(&cpu_xCh, 2, &jb_emlrtRTEI, true);
  emxInit_real_T(&b_cpu_xCh, 2, &kb_emlrtRTEI, true);
  for (b_eint = 0; b_eint < fb_CutOff; b_eint++) {
    // 'ecc_cwt:41' xCh = abs(wt(fb,x(:,ch)))';
    j = cpu_xv->size[0] * cpu_xv->size[1];
    cpu_xv->size[0] = 1;
    cpu_xv->size[1] = cpu_x->size[0];
    emxEnsureCapacity_real_T(cpu_xv, j, &cb_emlrtRTEI);
    if (!xv_dirtyOnCpu) {
    ...
    if (b_dirtyOnGpu) {
      ...
      ecc_cwt_kernel85<<<grid, block>>>(b_eint, b_gpu_x, ix, gpu_xv, cpu_x->
        size[0U]);
      xv_dirtyOnGpu = true;
      xv_dirtyOnCpu = false;
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_real_T(k_cpu_x, j, &fb_emlrtRTEI);
      if (!g_x_dirtyOnCpu) {
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel86<<<grid, block>>>(b_eint, b_gpu_x, fb_SignalPad, c_gpu_x,
          cpu_x->size[0U]);
        f_x_dirtyOnGpu = true;
        g_x_dirtyOnCpu = false;
      }
      ...
      for (eint = 0; eint < lidx; eint++) {
        ...
        r = k_cpu_x->data[eint];
        k_cpu_x->data[eint] = k_cpu_x->data[ix];
        k_cpu_x->data[ix] = r;
        g_x_dirtyOnCpu = true;
        f_x_dirtyOnGpu = false;
      }
      ...
      j = cpu_xv->size[0] * cpu_xv->size[1];
      cpu_xv->size[0] = 1;
      cpu_xv->size[1] = ((cpu_x->size[0] + k_cpu_x->size[1]) + div_s32(bcoef - k,
        nsubs)) + 1;
      emxEnsureCapacity_real_T(cpu_xv, j, &gb_emlrtRTEI);
      if (!xv_dirtyOnCpu) {
        gpuEmxEnsureCapacity_real_T(cpu_xv, &gpu_xv);
      }
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel87<<<grid, block>>>(c_gpu_x, eint, gpu_xv);
        xv_dirtyOnGpu = true;
        xv_dirtyOnCpu = false;
      }
      ...
      eint = div_s32(bcoef - k, nsubs);
      for (j = 0; j <= eint; j++) {
        if (xv_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_real_T(cpu_xv, &gpu_xv);
        }

        cpu_xv->data[(j + cpu_x->size[0]) + k_cpu_x->size[1]] = cpu_x->data[(k +
          nsubs * j) + cpu_x->size[0] * b_eint];
        xv_dirtyOnCpu = true;
        xv_dirtyOnGpu = false;
      }
    }
    ...
    if (cpu_xv->size[1] - (static_cast<int32_T>(static_cast<uint32_T>
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel88<<<grid, block>>>(gpu_xv, ix, gpu_xposdft);
        xposdft_dirtyOnCpu = false;
      }
      ...
      emxEnsureCapacity_creal_T(cpu_xposdft, j, &eb_emlrtRTEI);
      if (!xposdft_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal_T(cpu_xposdft, &gpu_xposdft);
      }
      ...
      lidx = static_cast<int32_T>(static_cast<real_T>(static_cast<int32_T>
        (cpu_xSize[1]) + 1) / 2.0);
      for (nsubs = 0; nsubs <= lidx - 2; nsubs++) {
        if (b_dirtyOnGpu) {
    ...
    k = cpu_cfsposdft->size[0] * cpu_cfsposdft->size[1];
    ...
    emxEnsureCapacity_creal_T(cpu_cfsposdft, k, &o_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(cpu_cfsposdft, &gpu_cfsposdft);
    if ((csz_idx_0 != 0) && (j != 0)) {
      lidx = (cpu_xposdft->size[1] != 1);
      bcoef = (cpu_psidft->size[1] != 1);
      ix = j - 1;
      k = cpu_cfsposdft->size[0] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((k + 1L) * (ix
        + 1L)), &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        if (xposdft_dirtyOnCpu) {
          gpuEmxMemcpyCpuToGpu_creal_T(&gpu_xposdft, cpu_xposdft);
        ...
        psidft_dirtyOnCpu = false;
        ecc_cwt_kernel89<<<grid, block>>>(gpu_xposdft, gpu_psidft, bcoef, lidx,
          k, j - 1, gpu_cfsposdft, cpu_psidft->size[0U], cpu_cfsposdft->size[0U]);
      }
    }
    ...
    if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
      ...
      ecc_cwt_kernel91<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_xSize,
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel92<<<grid, block>>>(ix, gpu_cfspos);
      ...
      c_fftPlanHandle = acquireCUFFTPlan(1, &lidx, &lidx, cpu_cfsposdft->size[0],
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel90<<<grid, block>>>(static_cast<real_T>(ix), gpu_cfsposdft,
          k, gpu_cfspos);
        cfspos_dirtyOnGpu = true;
        cfspos_dirtyOnCpu = false;
      }
    ...
    if (fb_SignalPad > 0) {
      ...
      for (j = 0; j < eint; j++) {
        for (k = 0; k < bcoef; k++) {
          ...
          cpu_cfspos->data[k + bcoef * j] = cpu_cfspos->data[k +
            cpu_cfspos->size[0] * (lidx + j)];
      ...
      j = cpu_cfspos->size[0] * cpu_cfspos->size[1];
      cpu_cfspos->size[1] = ix - lidx;
      emxEnsureCapacity_creal_T(cpu_cfspos, j, &ib_emlrtRTEI);
      if (!cfspos_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal_T(cpu_cfspos, &gpu_cfspos);
      }
    }
    ...
    emxEnsureCapacity_real_T(m_cpu_y, j, &s_emlrtRTEI);
    ...
    if (b_dirtyOnGpu) {
      ...
      cfspos_dirtyOnCpu = false;
      ecc_cwt_kernel93<<<grid, block>>>(gpu_cfspos, ix, c_gpu_y);
    }

    j = cpu_xCh->size[0] * cpu_xCh->size[1];
    cpu_xCh->size[0] = m_cpu_y->size[1];
    cpu_xCh->size[1] = m_cpu_y->size[0];
    emxEnsureCapacity_real_T(cpu_xCh, j, &jb_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(cpu_xCh, &gpu_xCh);
    k = m_cpu_y->size[0] - 1;
    ix = m_cpu_y->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((ix + 1L) * (k +
      1L)), &grid, &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel94<<<grid, block>>>(c_gpu_y, ix, k, gpu_xCh, cpu_xCh->size
        [0U], m_cpu_y->size[0U]);
    }
    ...
    // 'ecc_cwt:42' if ds2>1
    if (ds2 > 1.0) {
      // 'ecc_cwt:43' xCh = xCh(1:ds2:end,:);
      if (cpu_xCh->size[0] < 1) {
        lidx = 1;
        ix = -1;
      } else {
        lidx = static_cast<int32_T>(ds2);
        ix = cpu_xCh->size[0] - 1;
      }

      bcoef = cpu_xCh->size[1];
      j = b_cpu_xCh->size[0] * b_cpu_xCh->size[1];
      b_cpu_xCh->size[0] = div_s32(ix, lidx) + 1;
      b_cpu_xCh->size[1] = cpu_xCh->size[1];
      emxEnsureCapacity_real_T(b_cpu_xCh, j, &kb_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(b_cpu_xCh, &b_gpu_xCh);
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((ix / lidx + 1L)
        * bcoef), &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel95<<<grid, block>>>(gpu_xCh, lidx, ix, bcoef, b_gpu_xCh,
      ...
      emxEnsureCapacity_real_T(cpu_xCh, j, &lb_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(cpu_xCh, &gpu_xCh);
      ix = b_cpu_xCh->size[0] * b_cpu_xCh->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
        &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel96<<<grid, block>>>(b_gpu_xCh, ix, gpu_xCh);
      }

      //  Downsample
    }

    // 'ecc_cwt:45' xx(:,ch,:) = xCh;
    xx[0] = cpu_xx->size[0];
    xx[2] = cpu_xx->size[2];
    ix = xx[2] - 1;
    k = xx[0] - 1;
    ...
    if (b_dirtyOnGpu) {
      ...
      ecc_cwt_kernel97<<<grid, block>>>(gpu_xCh, xx[0], b_eint, xx[0] - 1, xx[2]
        - 1, gpu_xx, cpu_xx->size[0U], cpu_xx->size[1U]);
      xx_dirtyOnGpu = true;
      xx_dirtyOnCpu = false;
    }
...
void ecc_cwt_api(const mxArray * const prhs[5], int32_T nlhs, const mxArray
                 *plhs[2])
{
  emxArray_real_T *freqs;
  emxArray_real_T *x;
  ...
  emxInit_real_T(&x, 2, &gc_emlrtRTEI, true);
  x->canFreeData = false;
  ...
  emxInit_real_T(&xx, 3, &gc_emlrtRTEI, true);
  emxInit_real_T(&freqs, 1, &gc_emlrtRTEI, true);
  ecc_cwt(x, fs, *fLims, fOctave, ds2, xx, freqs);
  emxFree_real_T(&x);
