...
static __global__ void ecc_cwt_kernel1(const emxArray_real_T x, int32_T b_x,
  emxArray_real_T c_x);
...
static __global__ void ecc_cwt_kernel107(int32_T nrefine, emxArray_real_T dv23);
...
static __global__ void ecc_cwt_kernel118(int32_T nrefine, emxArray_real_T dv29);
static __global__ void ecc_cwt_kernel119(const emxArray_real_T xt, const
  emxArray_real_T dv29, const emxArray_real_T dv25, int32_T b_dv25,
  emxArray_real_T fx);
...
static __global__ void ecc_cwt_kernel141(const emxArray_real_T x, int32_T b_x,
  emxArray_real_T xv);
static __global__ void ecc_cwt_kernel142(const emxArray_real_T x, int32_T
  fb_SignalPad, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel143(const emxArray_real_T x, int32_T eint,
  emxArray_real_T xv);
static __global__ void ecc_cwt_kernel144(const emxArray_real_T xv, int32_T b_xv,
  emxArray_creal_T xposdft);
static __global__ void ecc_cwt_kernel145(const emxArray_creal_T xposdft, const
...
static __global__ void ecc_cwt_kernel146(const int32_T cfsposdft_dim1, creal_T
  *cfsposdft);
static __global__ void ecc_cwt_kernel147(const creal_T *cfsposdft, const
  emxArray_creal_T b_cfsposdft, int32_T c_cfsposdft, emxArray_creal_T cfspos);
static __global__ void ecc_cwt_kernel148(const int32_T cfsposdft_dim1, uint32_T
  xSize[2]);
static __global__ void ecc_cwt_kernel149(int32_T xSize, emxArray_creal_T cfspos);
static __global__ void ecc_cwt_kernel15(const emxArray_real_T a, int32_T nrefine,
  emxArray_real_T dv8);
static __global__ void ecc_cwt_kernel150(const emxArray_creal_T cfspos, int32_T
  b_cfspos, emxArray_creal_T cfs);
static __global__ void ecc_cwt_kernel151(const emxArray_creal_T cfspos, const
  int32_T b_cfspos, const uint32_T N, uint32_T u, const int32_T cfs_dim0, const
  int32_T cfspos_dim0, emxArray_creal_T cfs);
static __global__ void ecc_cwt_kernel152(const emxArray_creal_T cfs, int32_T
  nrefine, emxArray_real_T dv20);
static __global__ void ecc_cwt_kernel153(const emxArray_real_T dv20, const
  ...
  xx_dim0, const int32_T xx_dim1, emxArray_real_T xx);
...
static __global__ void ecc_cwt_kernel19(const emxArray_real_T xt, const
  ...
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel2(const emxArray_real_T x, int32_T b_x,
  emxArray_real_T c_x);
...
static __global__ void ecc_cwt_kernel78(int32_T nrefine, emxArray_real_T dv26);
...
static __global__ void ecc_cwt_kernel89(int32_T nrefine, emxArray_real_T dv30);
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel115(const
  emxArray_real_T x, int32_T nrefine, emxArray_real_T dv25)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel119(const
  emxArray_real_T xt, const emxArray_real_T dv29, const emxArray_real_T dv25,
  int32_T b_dv25, emxArray_real_T fx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  threadStride = mwGetTotalThreadsLaunched();
  loopEnd = static_cast<uint64_T>(b_dv25);
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv25.data[varargin_3] * dv29.data[varargin_3] *
      xt.data[varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel140(const
  int32_T fb_CutOff, const emxArray_real_T x, const emxArray_uint32_T ii,
  int32_T b_ii, const int32_T x_dim0, emxArray_real_T b_x)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel146(const int32_T
  cfsposdft_dim1, creal_T *cfsposdft)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel147(const
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel148(const int32_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel149(int32_T
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel150(const
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel152(const
  emxArray_creal_T cfs, int32_T nrefine, emxArray_real_T dv20)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T k;
    k = static_cast<int32_T>(idx);
    dv20.data[k] = hypot(cfs.data[k].re, cfs.data[k].im);
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel153(const
  emxArray_real_T dv20, const int32_T iv10_dim0, const emxArray_int32_T iv11,
  const int32_T fb_CutOff, const emxArray_int32_T iv10, const int32_T b_iv10,
  int32_T c_iv10, const int32_T xx_dim0, const int32_T xx_dim1, emxArray_real_T
  xx)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    xx.data[(iv10.data[bcoef] + xx_dim0 * fb_CutOff) + xx_dim0 * xx_dim1 *
      iv11.data[varargin_3]] = dv20.data[bcoef + iv10_dim0 * varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel86(const
  emxArray_real_T x, int32_T nrefine, emxArray_real_T dv28)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
void ecc_cwt(const emxArray_real_T *x, real_T fs, real_T fLims[2], real_T
             fOctave, emxArray_real_T *xx, emxArray_real_T *freqs)
{
  ...
  emxInit_real_T(&b_x, 2, &pb_emlrtRTEI, true);
  if ((x->size[0] == 1) && (x->size[1] == 1)) {
    i = b_x->size[0] * b_x->size[1];
    b_x->size[0] = 1;
    b_x->size[1] = 1;
    emxEnsureCapacity_real_T(b_x, i, &emlrtRTEI);
     ...
     case 0:
      ...
      if (std::isinf(c_r) || std::isnan(c_r)) {
        ...
        if (k <= 0) {
          ...
          emxInit_real_T(&f_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&b_xt, 2, &xb_emlrtRTEI, true);
          emxInit_real_T(&j_y, 2, &bc_emlrtRTEI, true);
          emxInit_real_T(&b_fx, 2, &sb_emlrtRTEI, true);
          emxInit_real_T(&k_y, 2, &cc_emlrtRTEI, true);
        ...
        if (k <= 0) {
          ...
          emxInit_real_T(&j_x, 2, &tb_emlrtRTEI, true);
   ...
   case 0:
    ...
    if (std::isinf(toler) || std::isnan(toler)) {
      ...
      if (k > 0) {
        ...
        emxInit_real_T(&d_x, 2, &tb_emlrtRTEI, true);
        emxInit_real_T(&xt, 2, &xb_emlrtRTEI, true);
        emxInit_real_T(&f_y, 2, &bc_emlrtRTEI, true);
        emxInit_real_T(&fx, 2, &sb_emlrtRTEI, true);
        emxInit_real_T(&g_y, 2, &cc_emlrtRTEI, true);
      ...
      if (k > 0) {
        ...
        emxInit_real_T(&h_x, 2, &tb_emlrtRTEI, true);
  ...
  if (!first_iteration) {
     ...
     case 0:
      ...
      if (std::isinf(halfh) || std::isnan(halfh)) {
        ...
        if (k > 0) {
          ...
          emxInit_real_T(&l_x, 2, &tb_emlrtRTEI, true);
          ...
          emxInit_real_T(&dv23, 2, &sb_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (b_guard1) {
              ...
              if (validLaunchParams) {
                ...
                c_a_dirtyOnCpu = false;
                ecc_cwt_kernel104<<<grid, block>>>(c_gpu_a, nrefine, gpu_dv21);
              ...
              i = dv23->size[0] * dv23->size[1];
              dv23->size[0] = 1;
              dv23->size[1] = w_y->size[1];
              emxEnsureCapacity_real_T(dv23, i, &n_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(dv23, &gpu_dv23);
              k = w_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(k
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel106<<<grid, block>>>(s_gpu_y, k, gpu_dv23);
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel107<<<grid, block>>>(nrefine, gpu_dv23);
                dv23_dirtyOnGpu = true;
              }
              ...
              if (dv21->size[1] == dv23->size[1]) {
                ...
                if (validLaunchParams) {
                  ...
                  ecc_cwt_kernel108<<<grid, block>>>(e_gpu_xt, gpu_dv23,
                    gpu_dv21, i, e_gpu_fx);
                  e_fx_dirtyOnCpu = false;
        ...
        if (k > 0) {
          ...
          emxInit_real_T(&p_x, 2, &tb_emlrtRTEI, true);
          emxInit_real_T(&g_xt, 2, &xb_emlrtRTEI, true);
          emxInit_real_T(&dv25, 2, &sb_emlrtRTEI, true);
          emxInit_real_T(&g_fx, 2, &sb_emlrtRTEI, true);
          emxInit_real_T(&y_y, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&dv29, 2, &sb_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (b_guard1) {
              ...
              dv25->size[0] = 1;
              dv25->size[1] = p_x->size[1];
              emxEnsureCapacity_real_T(dv25, i, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(dv25, &gpu_dv25);
              nrefine = p_x->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel115<<<grid, block>>>(p_gpu_x, nrefine, gpu_dv25);
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(k
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel117<<<grid, block>>>(q_gpu_y, k, gpu_dv29);
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel118<<<grid, block>>>(nrefine, gpu_dv29);
                dv29_dirtyOnGpu = true;
              }

              if (dv25->size[1] == dv29->size[1]) {
                i = g_fx->size[0] * g_fx->size[1];
                g_fx->size[0] = 1;
                g_fx->size[1] = dv25->size[1];
                ...
                if (validLaunchParams) {
                  ...
                  ecc_cwt_kernel119<<<grid, block>>>(g_gpu_xt, gpu_dv29,
                    gpu_dv25, i, g_gpu_fx);
                  g_fx_dirtyOnCpu = false;
                ...
                g_xt_dirtyOnGpu = false;
                binary_expand_op(g_fx, dv25, dv29, g_xt);
                g_fx_dirtyOnGpu = false;
    ...
    emxInit_real_T(&n_y, 2, &qb_emlrtRTEI, true);
    r *= fOctave;
    if (std::isnan(r)) {
     ...
     case 0:
      ...
      if (std::isinf(c_r) || std::isnan(c_r)) {
        ...
        if (k <= 0) {
          ...
          emxInit_real_T(&n_x, 2, &tb_emlrtRTEI, true);
          ...
          emxInit_real_T(&dv26, 2, &sb_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (b_guard1) {
              ...
              emxEnsureCapacity_real_T(dv22, i, &i_emlrtRTEI);
              ...
              if (validLaunchParams) {
                ...
                d_a_dirtyOnCpu = false;
                ecc_cwt_kernel75<<<grid, block>>>(d_gpu_a, nrefine, gpu_dv22);
              ...
              i = dv26->size[0] * dv26->size[1];
              dv26->size[0] = 1;
              dv26->size[1] = x_y->size[1];
              emxEnsureCapacity_real_T(dv26, i, &n_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(dv26, &gpu_dv26);
              k = x_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(k
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel77<<<grid, block>>>(t_gpu_y, k, gpu_dv26);
                dv26_dirtyOnGpu = true;
              }

              nrefine = dv26->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel78<<<grid, block>>>(nrefine, gpu_dv26);
                dv26_dirtyOnGpu = true;
              }

              if (dv22->size[1] == dv26->size[1]) {
                i = f_fx->size[0] * f_fx->size[1];
                f_fx->size[0] = 1;
                ...
                if (validLaunchParams) {
                  ...
                  ecc_cwt_kernel79<<<grid, block>>>(f_gpu_xt, gpu_dv26, gpu_dv22,
                    i, f_gpu_fx);
                  f_fx_dirtyOnCpu = false;
                ...
                f_xt_dirtyOnGpu = false;
                binary_expand_op(f_fx, dv22, dv26, f_xt);
                f_fx_dirtyOnGpu = false;
        ...
        if (k <= 0) {
          ...
          emxInit_real_T(&r_x, 2, &tb_emlrtRTEI, true);
          ...
          do {
            ...
            if (b_guard1) {
              ...
              dv28->size[0] = 1;
              dv28->size[1] = r_x->size[1];
              emxEnsureCapacity_real_T(dv28, i, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(dv28, &gpu_dv28);
              nrefine = r_x->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel86<<<grid, block>>>(r_gpu_x, nrefine, gpu_dv28);
              ...
              i = dv30->size[0] * dv30->size[1];
              dv30->size[0] = 1;
              dv30->size[1] = ab_y->size[1];
              emxEnsureCapacity_real_T(dv30, i, &n_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(dv30, &gpu_dv30);
              k = ab_y->size[1] - 1;
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(k
                + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel88<<<grid, block>>>(r_gpu_y, k, gpu_dv30);
              ...
              validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>
                (nrefine + 1L), &grid, &block, 1024U, 65535U);
              if (validLaunchParams) {
                ecc_cwt_kernel89<<<grid, block>>>(nrefine, gpu_dv30);
                dv30_dirtyOnGpu = true;
              }

              if (dv28->size[1] == dv30->size[1]) {
                i = h_fx->size[0] * h_fx->size[1];
                h_fx->size[0] = 1;
                h_fx->size[1] = dv28->size[1];
                ...
                if (validLaunchParams) {
                  ...
                  ecc_cwt_kernel90<<<grid, block>>>(h_gpu_xt, gpu_dv30, gpu_dv28,
                    i, h_gpu_fx);
                  h_fx_dirtyOnCpu = false;
                ...
                h_xt_dirtyOnGpu = false;
                binary_expand_op(h_fx, dv28, dv30, h_xt);
                h_fx_dirtyOnGpu = false;
    ...
    emxInit_real_T(&q_y, 2, &wb_emlrtRTEI, true);
    ...
    emxInit_real_T(&r_y, 2, &ac_emlrtRTEI, true);
  ...
  xx->size[2] = f->size[1];
  emxFree_real_T(&f);
  emxEnsureCapacity_real_T(xx, i, &db_emlrtRTEI);

  //  Preallocate output
  //  Do CWT per channel
  // 'ecc_cwt:39' for ch = 1:width(x)
  b_eint = b_x->size[1];
  emxInit_creal_T(&cfs, 2, &nb_emlrtRTEI, true);
  if (b_x->size[1] - 1 >= 0) {
    csz_idx_0 = psidft->size[0];
  }

  emxInit_int32_T(&iv10, 1, &sb_emlrtRTEI, true);
  emxInit_int32_T(&iv11, 1, &sb_emlrtRTEI, true);
  emxInit_real_T(&t_x, 1, &gb_emlrtRTEI, true);
  emxInit_real_T(&xv, 2, &hb_emlrtRTEI, true);
  emxInit_creal_T(&xposdft, 2, &ib_emlrtRTEI, true);
  emxInit_real_T(&u_x, 2, &kb_emlrtRTEI, true);
  emxInit_creal_T(&cfsposdft, 2, &fc_emlrtRTEI, true);
  emxInit_creal_T(&cfspos, 2, &mb_emlrtRTEI, true);
  emxInit_real_T(&dv20, 2, &sb_emlrtRTEI, true);
  for (fb_CutOff = 0; fb_CutOff < b_eint; fb_CutOff++) {
    ...
    emxEnsureCapacity_real_T(t_x, i, &gb_emlrtRTEI);
    if (!k_x_dirtyOnCpu) {
    ...
    emxEnsureCapacity_real_T(xv, i, &hb_emlrtRTEI);
    if (!xv_dirtyOnCpu) {
    ...
    if (validLaunchParams) {
      ...
      ecc_cwt_kernel141<<<grid, block>>>(t_gpu_x, i, gpu_xv);
      xv_dirtyOnCpu = false;
      xv_dirtyOnGpu = true;
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_real_T(u_x, i, &kb_emlrtRTEI);
      if (!l_x_dirtyOnCpu) {
      ...
      if (validLaunchParams) {
        ...
        ecc_cwt_kernel142<<<grid, block>>>(t_gpu_x, fb_SignalPad, u_gpu_x);
        l_x_dirtyOnCpu = false;
        k_x_dirtyOnGpu = true;
      }
      ...
      xv->size[1] = ((t_x->size[0] + u_x->size[1]) + div_s32(nsubs - k, b_i)) +
        1;
      emxEnsureCapacity_real_T(xv, i, &lb_emlrtRTEI);
      if (!xv_dirtyOnCpu) {
        gpuEmxEnsureCapacity_real_T(xv, &gpu_xv);
      }
      ...
      if (validLaunchParams) {
        ...
        ecc_cwt_kernel143<<<grid, block>>>(u_gpu_x, eint, gpu_xv);
        xv_dirtyOnCpu = false;
        xv_dirtyOnGpu = true;
      }
    ...
    if (xv->size[1] - (static_cast<int32_T>(static_cast<uint32_T>(xv->size[1]) >>
      ...
      emxEnsureCapacity_creal_T(xposdft, i, &ib_emlrtRTEI);
      ...
      if (validLaunchParams) {
        ...
        ecc_cwt_kernel144<<<grid, block>>>(gpu_xv, i, gpu_xposdft);
        xposdft_dirtyOnCpu = false;
      }
      ...
      emxEnsureCapacity_creal_T(xposdft, i, &jb_emlrtRTEI);
      if (!xposdft_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal_T(xposdft, &gpu_xposdft);
      }
    ...
    emxEnsureCapacity_creal_T(cfsposdft, i, &q_emlrtRTEI);
    ...
    if ((cfsposdft->size[0] != 0) && (cfsposdft->size[1] != 0)) {
      ...
      if (validLaunchParams) {
        ...
        psidft_dirtyOnCpu = false;
        ecc_cwt_kernel145<<<grid, block>>>(gpu_xposdft, gpu_psidft, nsubs,
    ...
    if ((cfsposdft->size[0] == 0) || (cfsposdft->size[1] == 0)) {
      ...
      ecc_cwt_kernel148<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(i, *gpu_xSize);
      xSize_dirtyOnCpu = false;
      ...
      gpuEmxEnsureCapacity_creal_T(cfspos, &gpu_cfspos);
      i = cfsposdft->size[1];
      ecc_cwt_kernel146<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(i,
        b_gpu_cfsposdft);
      i = cfsposdft->size[0] * cfsposdft->size[1] - 1;
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i + 1L),
        &grid, &block, 1024U, 65535U);
      if (validLaunchParams) {
        ecc_cwt_kernel147<<<grid, block>>>(b_gpu_cfsposdft, gpu_cfsposdft, i,
          gpu_cfspos);
      }
    }
    ...
    emxEnsureCapacity_creal_T(cfs, i, &nb_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(cfs, &gpu_cfs);
    i = cfspos->size[0] * cfspos->size[1] - 1;
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(i + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ecc_cwt_kernel150<<<grid, block>>>(gpu_cfspos, i, gpu_cfs);
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_creal_T(cfs, i, &ob_emlrtRTEI);
      gpuEmxEnsureCapacity_creal_T(cfs, &gpu_cfs);
      i = cfspos->size[0] - 1;
      k = cfs->size[0];
      b_i = cfspos->size[0];
      validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>((i + 1L) *
        ...
        1024U, 65535U);
      if (validLaunchParams) {
        ecc_cwt_kernel151<<<grid, block>>>(gpu_cfspos, i, static_cast<uint32_T>
    ...
    dv20->size[0] = static_cast<int32_T>(xSize[0]);
    dv20->size[1] = static_cast<int32_T>(xSize[1]);
    emxEnsureCapacity_real_T(dv20, i, &u_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(dv20, &gpu_dv20);
    validLaunchParams = mwGetLaunchParameters1D(static_cast<real_T>(nrefine + 1L),
      &grid, &block, 1024U, 65535U);
    if (validLaunchParams) {
      ecc_cwt_kernel152<<<grid, block>>>(gpu_cfs, nrefine, gpu_dv20);
    }
    ...
    if (validLaunchParams) {
      ...
      ecc_cwt_kernel153<<<grid, block>>>(gpu_dv20, b_iv10[0], gpu_iv11,
        fb_CutOff, gpu_iv10, b_iv10[0] - 1, b_iv10[2] - 1, i, k, gpu_xx);
      xx_dirtyOnCpu = false;
      xx_dirtyOnGpu = true;
    }
  }
                 ...
                 *plhs[2])
{
  ...
  emxInit_real_T(&freqs, 2, &gc_emlrtRTEI, true);
