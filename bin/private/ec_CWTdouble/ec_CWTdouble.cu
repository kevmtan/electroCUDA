...
static emxArray_real_T *psidft;

static boolean_T psidft_not_empty;

static emxArray_real_T *cf;
...
static emlrtRTEInfo i_emlrtRTEI{
    ...
    5,                                                           // colNo
    "ec_CWTdouble",                                              // fName
    "/home/kt/Gdrive/Git/electroCUDA/bin/src_mex/ec_CWTdouble.m" // pName
};
...
static __global__ void ec_CWTdouble_kernel1(const real_T freqLims[2],
                                            boolean_T b[2]);

static __global__ void ec_CWTdouble_kernel10(const emxArray_real_T x,
                                             int32_T Norig, emxArray_real_T xv);

static __global__ void ec_CWTdouble_kernel11(const emxArray_real_T x,
                                             const int32_T Norig,
                                             const int32_T Npad, int32_T N,
                                             emxArray_real_T xv);

static __global__ void ec_CWTdouble_kernel12(const emxArray_real_T xv,
                                             int32_T b_xv,
                                             emxArray_creal_T xdft);

static __global__ void ec_CWTdouble_kernel13(const emxArray_creal_T xdft,
                                             const int32_T Nfilt, int32_T M,
                                             const int32_T cfsdft_dim0,
                                             const int32_T psidft_dim0,
                                             emxArray_real_T b_psidft,
                                             emxArray_creal_T cfsdft);

static __global__ void ec_CWTdouble_kernel14(const int32_T cfsdft_dim1,
                                             creal_T *cfsdft);

static __global__ void ec_CWTdouble_kernel15(const creal_T *cfsdft,
                                             const emxArray_creal_T b_cfsdft,
                                             int32_T c_cfsdft,
                                             emxArray_creal_T cfstmp);

static __global__ void ec_CWTdouble_kernel16(const int32_T cfsdft_dim1,
                                             uint32_T xSize[2]);

static __global__ void ec_CWTdouble_kernel17(int32_T xSize,
                                             emxArray_creal_T cfstmp);

static __global__ void ec_CWTdouble_kernel18(const emxArray_creal_T cfstmp,
...
ec_CWTdouble_kernel19(const emxArray_creal_T cfstmp, const int32_T Npad,
                      const int32_T Norig, int32_T Ns, const int32_T cfs_dim0,
                      const int32_T cfstmp_dim0, emxArray_creal_T cfs);

static __global__ void ec_CWTdouble_kernel2(const real_T maxscale,
                                            real_T freqLims[2]);

static __global__ void
ec_CWTdouble_kernel20(const real_T s0, const real_T maxscale,
                      const boolean_T IsOdd, const int32_T M,
                      const int32_T Norig, emxArray_real_T coi);

static __global__ void ec_CWTdouble_kernel21(int32_T b_cf, emxArray_real_T c_cf,
                                             emxArray_real_T freqs);

static __global__ void ec_CWTdouble_kernel22(const emxArray_creal_T cfs,
                                             int32_T N, emxArray_real_T y);

static __global__ void ec_CWTdouble_kernel23(const emxArray_real_T y,
                                             const int32_T b_y, int32_T c_y,
                                             const int32_T wt_dim0,
                                             const int32_T y_dim0,
                                             emxArray_real_T wt);

static __global__ void ec_CWTdouble_kernel24(const emxArray_real_T wt,
                                             int32_T M, emxArray_real_T y);

static __global__ void ec_CWTdouble_kernel25(const emxArray_real_T wt,
                                             const int32_T N, int32_T M,
                                             emxArray_real_T y);

static __global__ void ec_CWTdouble_kernel26(int32_T xSize, emxArray_real_T y);

static __global__ void ec_CWTdouble_kernel27(const int32_T N,
                                             const emxArray_real_T y,
                                             int32_T b_y, emxArray_real_T wt);

static __global__ void ec_CWTdouble_kernel28(const emxArray_real_T wt,
                                             int32_T b_wt,
                                             emxArray_real_T c_wt);

static __global__ void ec_CWTdouble_kernel3(const real_T fs,
                                            real_T freqLims[2]);

static __global__ void ec_CWTdouble_kernel4(const int32_T N,
                                            const real_T maxscale,
                                            const int32_T M,
                                            emxArray_real_T omega);

static __global__ void ec_CWTdouble_kernel5(const real_T freqLims[2],
                                            boolean_T b[2]);

static __global__ void ec_CWTdouble_kernel6(const real_T a0, int32_T Ns,
                                            emxArray_real_T scales);

static __global__ void ec_CWTdouble_kernel7(const real_T fs,
                                            real_T freqLims[2]);

static __global__ void ec_CWTdouble_kernel8(const real_T a0, const real_T s0,
                                            int32_T Ns, emxArray_real_T scales);

static __global__ void
ec_CWTdouble_kernel9(const real_T fs, const emxArray_real_T omega,
                     const emxArray_real_T scales, const int32_T M,
                     const int32_T N, int32_T Ns, const int32_T psidft_dim0,
                     emxArray_real_T b_cf, emxArray_real_T b_psidft);
...
static __global__
    __launch_bounds__(32, 1) void ec_CWTdouble_kernel1(const real_T freqLims[2],
                                                       boolean_T b[2])
{
  uint64_T threadId;
  int32_T jj;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel10(
    const emxArray_real_T x, int32_T Norig, emxArray_real_T xv)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel11(
    const emxArray_real_T x, const int32_T Norig, const int32_T Npad, int32_T N,
    emxArray_real_T xv)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel12(
    const emxArray_real_T xv, int32_T b_xv, emxArray_creal_T xdft)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel13(
    const emxArray_creal_T xdft, const int32_T Nfilt, int32_T M,
    const int32_T cfsdft_dim0, const int32_T psidft_dim0,
    emxArray_real_T b_psidft, emxArray_creal_T cfsdft)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(32, 1) void ec_CWTdouble_kernel14(
    const int32_T cfsdft_dim1, creal_T *cfsdft)
{
  uint64_T threadId;
  int32_T tmpIdx;
  threadId = static_cast<uint64_T>(mwGetGlobalThreadIndexInXDimension());
  ...
  if (tmpIdx < 1) {
    cfsdft->re = cfsdft_dim1;
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel15(
    const creal_T *cfsdft, const emxArray_creal_T b_cfsdft, int32_T c_cfsdft,
    emxArray_creal_T cfstmp)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    if (ai == 0.0) {
      ...
      cfstmp.data[jj].im = 0.0;
    } else if (ar == 0.0) {
      cfstmp.data[jj].re = 0.0;
...
static __global__ __launch_bounds__(32, 1) void ec_CWTdouble_kernel16(
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel17(
    int32_T xSize, emxArray_creal_T cfstmp)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel18(
    const emxArray_creal_T cfstmp, const int32_T Norig, int32_T Ns,
    const int32_T cfs_dim0, const int32_T cfstmp_dim0, emxArray_creal_T cfs)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel19(
    const emxArray_creal_T cfstmp, const int32_T Npad, const int32_T Norig,
...
static __global__
    __launch_bounds__(32, 1) void ec_CWTdouble_kernel2(const real_T maxscale,
                                                       real_T freqLims[2])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel20(
    const real_T s0, const real_T maxscale, const boolean_T IsOdd,
    const int32_T M, const int32_T Norig, emxArray_real_T coi)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    ai = 1.0 / (0.60690379849267206 * maxscale * static_cast<real_T>(b_index));
    coi.data[kk] = ai;
    if (ai > s0) {
      coi.data[kk] = s0;
    }
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel21(
    int32_T b_cf, emxArray_real_T c_cf, emxArray_real_T freqs)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel22(
    const emxArray_creal_T cfs, int32_T N, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    y.data[b_index] = hypot(cfs.data[b_index].re, cfs.data[b_index].im);
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel23(
    const emxArray_real_T y, const int32_T b_y, int32_T c_y,
    const int32_T wt_dim0, const int32_T y_dim0, emxArray_real_T wt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel24(
    const emxArray_real_T wt, int32_T M, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel25(
    const emxArray_real_T wt, const int32_T N, int32_T M, emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(1024, 1) void ec_CWTdouble_kernel26(int32_T xSize,
                                                          emxArray_real_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel27(
    const int32_T N, const emxArray_real_T y, int32_T b_y, emxArray_real_T wt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T jj;
    jj = static_cast<int32_T>(idx);
    wt.data[jj] = y.data[jj] / static_cast<real_T>(N);
  }
}

static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel28(
    const emxArray_real_T wt, int32_T b_wt, emxArray_real_T c_wt)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__
    __launch_bounds__(32, 1) void ec_CWTdouble_kernel3(const real_T fs,
                                                       real_T freqLims[2])
{
  uint64_T threadId;
  int32_T tmpIdx;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel4(
...
static __global__
    __launch_bounds__(32, 1) void ec_CWTdouble_kernel5(const real_T freqLims[2],
                                                       boolean_T b[2])
{
  uint64_T threadId;
  int32_T jj;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel6(
...
static __global__
    __launch_bounds__(32, 1) void ec_CWTdouble_kernel7(const real_T fs,
                                                       real_T freqLims[2])
{
  uint64_T threadId;
  int32_T jj;
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel8(
...
static __global__ __launch_bounds__(1024, 1) void ec_CWTdouble_kernel9(
    ...
    emxArray_real_T b_cf, emxArray_real_T b_psidft)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    ...
    if (jj + 1 > M) {
      b_psidft.data[kk + psidft_dim0 * jj] = 0.0;
    } else {
      real_T ai;
      real_T ar;
      ai = scales.data[kk];
      ar = omega.data[jj];
      b_psidft.data[kk + psidft_dim0 * jj] =
          0.0050536085896138571 * exp(20.0 * log(ai * ar) - pow(ai * ar, 3.0));
    }
    if (jj + 1 == 1) {
      b_cf.data[kk] =
  ...
  if (gpu->data == 0) {
    ...
    if (gpu->allocatedSize < actualSizeCpu) {
      ...
      cudaMemcpy(newData, gpu->data,
                 static_cast<uint32_T>(actualSizeGpu) * sizeof(creal_T),
                  ...
                  emxArray_real_T *freqs, emxArray_real_T *coi)
{
  ...
  emxArray_creal_T gpu_cfstmp;
  emxArray_creal_T gpu_xdft;
  emxArray_creal_T *cfs;
  emxArray_creal_T *cfsdft;
  emxArray_creal_T *cfstmp;
  emxArray_creal_T *xdft;
  emxArray_real_T b_gpu_wt;
  emxArray_real_T b_gpu_y;
  emxArray_real_T gpu_cf;
  ...
  if (!psidft_not_empty) {
    ...
    ec_CWTdouble_kernel1<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_freqLims,
                                                                  *gpu_b);
    b_dirtyOnGpu = true;
    IsOdd = true;
    k = 0;
    ...
    if (!IsOdd) {
      ...
      if (freqLims[0] < maxscale) {
        ec_CWTdouble_kernel2<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            maxscale, *gpu_freqLims);
        cudaMemcpy(freqLims, *gpu_freqLims, 16UL, cudaMemcpyDeviceToHost);
      }
      if (freqLims[1] > fs / 2.0) {
        ec_CWTdouble_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
            fs, *gpu_freqLims);
        cudaMemcpy(freqLims, *gpu_freqLims, 16UL, cudaMemcpyDeviceToHost);
      }
      if (freqLims[1] == 0.0) {
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(M + 1L), &grid,
                                           &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel4<<<grid, block>>>(
          N, 6.2831853071795862 / static_cast<real_T>(N), M, gpu_omega);
    }
    ec_CWTdouble_kernel5<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_freqLims,
                                                                  *gpu_b);
    b_dirtyOnGpu = true;
    IsOdd = true;
    k = 0;
    ...
    if (!IsOdd) {
      ec_CWTdouble_kernel7<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
          fs, *gpu_freqLims);
      cudaMemcpy(freqLims, *gpu_freqLims, 16UL, cudaMemcpyDeviceToHost);
      ...
      if (b_dirtyOnGpu) {
        ec_CWTdouble_kernel8<<<grid, block>>>(
      ...
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((Ns - 1) + 1L),
                                             &grid, &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_CWTdouble_kernel6<<<grid, block>>>(
    ...
    emxEnsureCapacity_real_T(psidft, k, &j_emlrtRTEI);
    k = cf->size[0];
    cf->size[0] = scales->size[1];
    emxEnsureCapacity_real_T(cf, k, &j_emlrtRTEI);
    ...
    if (b_dirtyOnGpu) {
      ...
      gpuEmxMemcpyCpuToGpu_real_T(&gpu_cf, cf);
      ec_CWTdouble_kernel9<<<grid, block>>>(fs, gpu_omega, gpu_scales, M, N, Ns,
                                            k, gpu_cf, gpu_psidft);
      gpuEmxMemcpyGpuToCpu_real_T(psidft, &gpu_psidft);
  ...
  Ns = psidft->size[0] - 1;
  emxInit_real_T(&xv, 2, &c_emlrtRTEI, true);
  k = xv->size[0] * xv->size[1];
  xv->size[0] = 1;
  xv->size[1] = psidft->size[1];
  emxEnsureCapacity_real_T(xv, k, &c_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(xv, &gpu_xv);
  emxInit_creal_T(&cfs, 2, &q_emlrtRTEI, true);
  k = cfs->size[0] * cfs->size[1];
  cfs->size[0] = psidft->size[0];
  cfs->size[1] = x->size[0];
  emxEnsureCapacity_creal_T(cfs, k, &c_emlrtRTEI);
  gpuEmxEnsureCapacity_creal_T(cfs, &gpu_cfs);
  emxInit_creal_T(&cfstmp, 2, &c_emlrtRTEI, true);
  N = xv->size[1] - 1;
  if (Npad > 0) {
    ...
    if (b_dirtyOnGpu) {
      ...
      ec_CWTdouble_kernel11<<<grid, block>>>(gpu_x, Norig, Npad, N, gpu_xv);
    }
  } else {
    ...
    if (b_dirtyOnGpu) {
      gpuEmxMemcpyCpuToGpu_real_T(&gpu_x, x);
      ec_CWTdouble_kernel10<<<grid, block>>>(gpu_x, Norig, gpu_xv);
    }
  }
  emxInit_creal_T(&xdft, 2, &d_emlrtRTEI, true);
  if (xv->size[1] == 0) {
    xdft->size[0] = 1;
    xdft->size[1] = 0;
  } else if (xv->size[1] -
    ...
    emxEnsureCapacity_creal_T(xdft, k, &d_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(xdft, &gpu_xdft);
    N = xv->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                           &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel12<<<grid, block>>>(gpu_xv, N, gpu_xdft);
    }
    N = xdft->size[1];
    fftPlanHandle = acquireCUFFTPlan(1, &N, &N, 1, 1, CUFFT_Z2Z, 1);
    cufftExecZ2Z(fftPlanHandle, (cufftDoubleComplex *)&gpu_xdft.data[0],
                 (cufftDoubleComplex *)&gpu_xdft.data[0], CUFFT_FORWARD);
  } else {
    N = xv->size[1];
    for (k = 0; k < 2; k++) {
    ...
    emxEnsureCapacity_creal_T(xdft, k, &f_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(xdft, &gpu_xdft);
    b_fftPlanHandle = acquireCUFFTPlan(1, &N, &N, 1, 1, CUFFT_D2Z, 1);
    cufftExecD2Z(b_fftPlanHandle, (cufftDoubleReal *)&gpu_xv.data[0],
                 (cufftDoubleComplex *)&gpu_xdft.data[0]);
    b_dirtyOnGpu = true;
    N = static_cast<int32_T>(
        static_cast<real_T>(static_cast<int32_T>(xSize[1]) + 1) / 2.0);
    for (Nfilt = 0; Nfilt <= N - 2; Nfilt++) {
      if (b_dirtyOnGpu) {
        gpuEmxMemcpyGpuToCpu_creal_T(xdft, &gpu_xdft);
      }
  ...
  M = psidft->size[0] - 1;
  Nfilt = psidft->size[1];
  emxInit_creal_T(&cfsdft, 2, &d_emlrtRTEI, true);
  k = cfsdft->size[0] * cfsdft->size[1];
  cfsdft->size[0] = psidft->size[0];
  cfsdft->size[1] = psidft->size[1];
  emxEnsureCapacity_creal_T(cfsdft, k, &d_emlrtRTEI);
  gpuEmxEnsureCapacity_creal_T(cfsdft, &gpu_cfsdft);
  N = cfsdft->size[0];
  k = psidft->size[0];
  b_dirtyOnGpu = mwGetLaunchParameters1D(
  ...
  if (b_dirtyOnGpu) {
    if (xdft_dirtyOnCpu) {
      gpuEmxMemcpyCpuToGpu_creal_T(&gpu_xdft, xdft);
    }
    gpuEmxMemcpyCpuToGpu_real_T(&gpu_psidft, psidft);
    ec_CWTdouble_kernel13<<<grid, block>>>(gpu_xdft, Nfilt, M, N, k, gpu_psidft,
                                           gpu_cfsdft);
    gpuEmxMemcpyGpuToCpu_real_T(psidft, &gpu_psidft);
  }
  ...
  if ((cfsdft->size[0] == 0) || (cfsdft->size[1] == 0)) {
    for (k = 0; k < 2; k++) {
      xSize[k] = static_cast<uint32_T>(cfsdft->size[k]);
      xSize_dirtyOnCpu = true;
    }
    N = cfsdft->size[1];
    if (xSize_dirtyOnCpu) {
    ...
    ec_CWTdouble_kernel16<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(N,
                                                                   *gpu_xSize);
    ...
    emxEnsureCapacity_creal_T(cfstmp, k, &c_emlrtRTEI);
    gpuEmxEnsureCapacity_creal_T(cfstmp, &gpu_cfstmp);
    N = static_cast<int32_T>(xSize[0]) * static_cast<int32_T>(xSize[1]) - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                           &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel17<<<grid, block>>>(N, gpu_cfstmp);
    }
  } else {
    cufftHandle c_fftPlanHandle;
    N = cfsdft->size[1];
    c_fftPlanHandle = acquireCUFFTPlan(1, &N, &N, cfsdft->size[0], 1, CUFFT_Z2Z,
                                       cfsdft->size[0]);
    cufftExecZ2Z(c_fftPlanHandle, (cufftDoubleComplex *)&gpu_cfsdft.data[0],
                 (cufftDoubleComplex *)&gpu_cfsdft.data[0], CUFFT_INVERSE);
    k = cfstmp->size[0] * cfstmp->size[1];
    ...
    gpuEmxEnsureCapacity_creal_T(cfstmp, &gpu_cfstmp);
    N = cfsdft->size[1];
    ec_CWTdouble_kernel14<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(
        N, b_gpu_cfsdft);
    N = cfsdft->size[0] * cfsdft->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                           &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel15<<<grid, block>>>(b_gpu_cfsdft, gpu_cfsdft, N,
                                             gpu_cfstmp);
    }
  }
  emxFree_creal_T(&cfsdft);
  if (Npad > 0) {
    N = cfs->size[0];
    M = cfstmp->size[0];
    b_dirtyOnGpu = mwGetLaunchParameters1D(
        ...
        1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel19<<<grid, block>>>(gpu_cfstmp, Npad, Norig, Ns, N, M,
                                             gpu_cfs);
    }
  } else {
    N = cfs->size[0];
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(
        ...
        1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel18<<<grid, block>>>(gpu_cfstmp, Norig, Ns, N, M,
                                             gpu_cfs);
    }
  }
  emxFree_creal_T(&cfstmp);
  if (cf->size[0] == 0) {
    s0 = rtNaN;
  } else {
    Npad = cf->size[0];
    ...
    for (Nfilt = 0; Nfilt <= Npad - 2; Nfilt++) {
      if (std::isnan(cf->data[Nfilt + 1])) {
        IsOdd = false;
      } else if (std::isnan(s0)) {
        IsOdd = true;
      } else {
        IsOdd = (s0 < cf->data[Nfilt + 1]);
      }
      if (IsOdd) {
        s0 = cf->data[Nfilt + 1];
      }
  ...
  k = coi->size[0];
  coi->size[0] = x->size[0];
  emxEnsureCapacity_real_T(coi, k, &c_emlrtRTEI);
  IsOdd = (x->size[0] -
  ...
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((Norig - 1) + 1L),
                                         &grid, &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    gpuEmxMemcpyCpuToGpu_real_T(&gpu_coi, coi);
    ec_CWTdouble_kernel20<<<grid, block>>>(s0, 1.0 / fs, IsOdd, M, Norig,
                                           gpu_coi);
    coi_dirtyOnGpu = true;
  }
  k = freqs->size[0];
  freqs->size[0] = cf->size[0];
  emxEnsureCapacity_real_T(freqs, k, &i_emlrtRTEI);
  N = cf->size[0] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                         &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ...
    gpuEmxMemcpyCpuToGpu_real_T(&gpu_cf, cf);
    ec_CWTdouble_kernel21<<<grid, block>>>(N, gpu_cf, gpu_freqs);
  ...
  emxInit_real_T(&d_y, 2, &t_emlrtRTEI, true);
  k = d_y->size[0] * d_y->size[1];
  d_y->size[0] = static_cast<int32_T>(xSize[0]);
  d_y->size[1] = static_cast<int32_T>(xSize[1]);
  emxEnsureCapacity_real_T(d_y, k, &k_emlrtRTEI);
  gpuEmxEnsureCapacity_real_T(d_y, &gpu_y);
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                         &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    ec_CWTdouble_kernel22<<<grid, block>>>(gpu_cfs, N, gpu_y);
  }
  emxFree_creal_T(&cfs);
  k = wt->size[0] * wt->size[1];
  wt->size[0] = d_y->size[1];
  wt->size[1] = d_y->size[0];
  emxEnsureCapacity_real_T(wt, k, &l_emlrtRTEI);
  Npad = d_y->size[0] - 1;
  N = d_y->size[1] - 1;
  M = wt->size[0];
  k = d_y->size[0];
  b_dirtyOnGpu =
      mwGetLaunchParameters1D(static_cast<real_T>((N + 1L) * (Npad + 1L)),
                              &grid, &block, 1024U, 65535U);
  if (b_dirtyOnGpu) {
    gpuEmxMemcpyCpuToGpu_real_T(&gpu_wt, wt);
    ec_CWTdouble_kernel23<<<grid, block>>>(gpu_y, N, Npad, M, k, gpu_wt);
    wt_dirtyOnCpu = false;
    wt_dirtyOnGpu = true;
  }
  emxFree_real_T(&d_y);
  if (doAvg) {
    ...
    if (wt->size[1] == 0) {
      for (k = 0; k < 2; k++) {
        xSize[k] = static_cast<uint32_T>(wt->size[k]);
      }
      k = e_y->size[0];
      e_y->size[0] = static_cast<int32_T>(xSize[0]);
      emxEnsureCapacity_real_T(e_y, k, &n_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(e_y, &b_gpu_y);
      b_dirtyOnGpu = mwGetLaunchParameters1D(
          static_cast<real_T>((static_cast<int32_T>(xSize[0]) - 1) + 1L), &grid,
          &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ec_CWTdouble_kernel26<<<grid, block>>>(
      ...
      emxEnsureCapacity_real_T(e_y, k, &m_emlrtRTEI);
      gpuEmxEnsureCapacity_real_T(e_y, &b_gpu_y);
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(M + 1L), &grid,
                                             &block, 1024U, 65535U);
      if (b_dirtyOnGpu) {
        ...
        wt_dirtyOnCpu = false;
        ec_CWTdouble_kernel24<<<grid, block>>>(gpu_wt, M, b_gpu_y);
      }
      for (k = 0; k <= Npad - 2; k++) {
        ...
        if (b_dirtyOnGpu) {
          ...
          wt_dirtyOnCpu = false;
          ec_CWTdouble_kernel25<<<grid, block>>>(gpu_wt, (k + 1) * (M + 1), M,
                                                 b_gpu_y);
        }
      }
    }
    N = wt->size[1];
    emxInit_real_T(&b_wt, 1, &q_emlrtRTEI, true);
    k = b_wt->size[0];
    b_wt->size[0] = e_y->size[0];
    emxEnsureCapacity_real_T(b_wt, k, &o_emlrtRTEI);
    gpuEmxEnsureCapacity_real_T(b_wt, &b_gpu_wt);
    Npad = e_y->size[0] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(Npad + 1L),
                                           &grid, &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ec_CWTdouble_kernel27<<<grid, block>>>(N, b_gpu_y, Npad, b_gpu_wt);
    }
    emxFree_real_T(&e_y);
    k = wt->size[0] * wt->size[1];
    wt->size[0] = b_wt->size[0];
    wt->size[1] = 1;
    emxEnsureCapacity_real_T(wt, k, &p_emlrtRTEI);
    if (!wt_dirtyOnCpu) {
      gpuEmxEnsureCapacity_real_T(wt, &gpu_wt);
    }
    N = b_wt->size[0] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(N + 1L), &grid,
                                           &block, 1024U, 65535U);
    if (b_dirtyOnGpu) {
      ...
      ec_CWTdouble_kernel28<<<grid, block>>>(b_gpu_wt, N, gpu_wt);
      wt_dirtyOnGpu = true;
    }
    emxFree_real_T(&b_wt);
  }
  ...
  if (wt_dirtyOnGpu) {
    gpuEmxMemcpyGpuToCpu_real_T(wt, &gpu_wt);
  }
  if (freqs_dirtyOnGpu) {
    gpuEmxMemcpyGpuToCpu_real_T(freqs, &gpu_freqs);
  }
  if (coi_dirtyOnGpu) {
    gpuEmxMemcpyGpuToCpu_real_T(coi, &gpu_coi);
  }
...
// End of code generation (ec_CWTdouble.cu)
