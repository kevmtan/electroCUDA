...
static emlrtRTEInfo kb_emlrtRTEI{ 41,  // lineNo
  6,                                   // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static emlrtRTEInfo mb_emlrtRTEI{ 43,  // lineNo
  10,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static emlrtRTEInfo qb_emlrtRTEI{ 924, // lineNo
  26,                                  // colNo
  "cwtfilterbank",                     // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/@cwtfilterbank/cwtfilterbank.m"// pName
};
...
static emlrtRTEInfo tb_emlrtRTEI{ 21,  // lineNo
  1,                                   // colNo
  "morsebpfilters",                    // fName
  "/usr/local/MATLAB/R2023a/toolbox/wavelet/wavelet/+wavelet/+internal/+cwt/morsebpfilters.m"// pName
};
...
static emlrtRTEInfo wb_emlrtRTEI{ 446, // lineNo
  1,                                   // colNo
  "quadgk",                            // fName
  "/usr/local/MATLAB/R2023a/toolbox/eml/lib/matlab/funfun/quadgk.m"// pName
};

static emlrtRTEInfo xb_emlrtRTEI{ 30,  // lineNo
  16,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static emlrtRTEInfo gc_emlrtRTEI{ 41,  // lineNo
  12,                                  // colNo
  "ecc_cwt",                           // fName
  "/home/kt/Gdrive/Git/electroCUDA/bin/mexSrc/ecc_cwt.m"// pName
};
...
static __global__ void ecc_cwt_kernel16(int32_T ix, emxArray_real_T dv11);
static __global__ void ecc_cwt_kernel17(const emxArray_real_T xt, const
  ...
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel18(int16_T dv3_idx_1, emxArray_real_T fx);
...
static __global__ void ecc_cwt_kernel27(int32_T ix, emxArray_real_T dv17);
static __global__ void ecc_cwt_kernel28(const emxArray_real_T xt, const
  ...
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel29(int16_T dv3_idx_1, emxArray_real_T fx);
...
static __global__ void ecc_cwt_kernel35(const emxArray_real_T omega, int32_T k,
  emxArray_real_T r);
static __global__ void ecc_cwt_kernel36(const int32_T lidx, const int32_T bcoef,
  const emxArray_real_T omega, int32_T k, emxArray_real_T r, int32_T omega_dim1);
...
static __global__ void ecc_cwt_kernel51(int32_T ix, emxArray_real_T dv24);
static __global__ void ecc_cwt_kernel52(const emxArray_real_T xt, const
  ...
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel53(int16_T dv3_idx_1, emxArray_real_T fx);
...
static __global__ void ecc_cwt_kernel62(int32_T ix, emxArray_real_T dv28);
static __global__ void ecc_cwt_kernel63(const emxArray_real_T xt, const
  emxArray_real_T dv28, const emxArray_real_T dv26, int32_T b_dv26,
  emxArray_real_T fx);
static __global__ void ecc_cwt_kernel64(int16_T dv3_idx_1, emxArray_real_T fx);
...
static __global__ void ecc_cwt_kernel74(const emxArray_real_T omega, const
  emxArray_real_T fb_Scales, const int32_T b_fb_Scales, int32_T k,
...
static __global__ void ecc_cwt_kernel84(const real32_T ds2, int32_T j,
  emxArray_real32_T fv);
static __global__ void ecc_cwt_kernel85(const emxArray_real_T psidft, int32_T
  b_psidft, emxArray_real32_T psihat);
static __global__ void ecc_cwt_kernel86(const int32_T bcoef, const
  emxArray_real32_T x, int32_T b_x, emxArray_real32_T xv, int32_T x_dim0);
static __global__ void ecc_cwt_kernel87(const int32_T bcoef, const
  emxArray_real32_T x, int32_T fb_SignalPad, emxArray_real32_T b_x, int32_T
  x_dim0);
static __global__ void ecc_cwt_kernel88(const emxArray_real32_T x, int32_T k,
  emxArray_real32_T xv);
static __global__ void ecc_cwt_kernel89(const emxArray_real32_T xv, int32_T b_xv,
  emxArray_creal32_T xposdft);
static __global__ void ecc_cwt_kernel9(const emxArray_real_T x, int32_T lidx,
  emxArray_real_T xt, emxArray_real_T b_x);
static __global__ void ecc_cwt_kernel90(const emxArray_creal32_T xposdft, const
  emxArray_real32_T psihat, const int32_T bcoef, const int32_T lidx, const
  int32_T cfsposdft, int32_T ix, emxArray_creal32_T b_cfsposdft, int32_T
  psihat_dim0, int32_T cfsposdft_dim0);
static __global__ void ecc_cwt_kernel91(const real32_T cfsposdft_re, const
  emxArray_creal32_T cfsposdft, int32_T b_cfsposdft, emxArray_creal32_T cfspos);
static __global__ void ecc_cwt_kernel92(uint32_T xSize[2], int32_T
  cfsposdft_dim1);
static __global__ void ecc_cwt_kernel93(int32_T xSize, emxArray_creal32_T cfspos);
static __global__ void ecc_cwt_kernel94(const emxArray_creal32_T cfspos, int32_T
  ix, emxArray_real32_T y);
static __global__ void ecc_cwt_kernel95(const emxArray_real32_T y, const int32_T
  b_y, int32_T c_y, emxArray_real32_T xCh, int32_T xCh_dim0, int32_T y_dim0);
static __global__ void ecc_cwt_kernel96(const emxArray_real32_T xCh, const
  int32_T lidx, const int32_T ix, int32_T bcoef, emxArray_real32_T b_xCh,
  int32_T xCh_dim0, int32_T b_xCh_dim0);
static __global__ void ecc_cwt_kernel97(const emxArray_real32_T xCh, int32_T
  b_xCh, emxArray_real32_T c_xCh);
static __global__ void ecc_cwt_kernel98(const emxArray_real32_T xCh, const
  int32_T xx_dim0, const int32_T bcoef, const int32_T xx, int32_T b_xx,
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel13(const
  emxArray_real_T a, int32_T ix, emxArray_real_T dv7)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  emxArray_real_T y, int32_T b_y, emxArray_real_T dv11)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    dv11.data[varargin_3] = -2.0 * y.data[varargin_3];
  }
}
  ...
  int32_T b_dv7, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv7.data[varargin_3] * dv11.data[varargin_3] *
      xt.data[varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel24(const
  emxArray_real_T x, int32_T ix, emxArray_real_T dv14)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
  ...
  int32_T b_dv14, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv14.data[varargin_3] * dv17.data[varargin_3] *
      xt.data[varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel35(const
  emxArray_real_T omega, int32_T k, emxArray_real_T r)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel36(const int32_T
  lidx, const int32_T bcoef, const emxArray_real_T omega, int32_T k,
  emxArray_real_T r, int32_T omega_dim1)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    r.data[(varargin_3 + omega_dim1) + 1] = -omega.data[bcoef + lidx *
      varargin_3];
  }
}
  ...
  int32_T b_dv20, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv20.data[varargin_3] * dv24.data[varargin_3] *
      xt.data[varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel63(const
  emxArray_real_T xt, const emxArray_real_T dv28, const emxArray_real_T dv26,
  int32_T b_dv26, emxArray_real_T fx)
{
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    fx.data[varargin_3] = dv26.data[varargin_3] * dv28.data[varargin_3] *
      xt.data[varargin_3];
  }
}
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel74(const
  ...
  b_fb_Scales, int32_T k, emxArray_real_T somega, int32_T somega_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel84(const
  real32_T ds2, int32_T j, emxArray_real32_T fv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel86(const int32_T
  bcoef, const emxArray_real32_T x, int32_T b_x, emxArray_real32_T xv, int32_T
  x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    xv.data[varargin_3] = x.data[varargin_3 + x_dim0 * (bcoef - 1)];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel87(const int32_T
  bcoef, const emxArray_real32_T x, int32_T fb_SignalPad, emxArray_real32_T b_x,
  int32_T x_dim0)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T varargin_3;
    varargin_3 = static_cast<int32_T>(idx);
    b_x.data[varargin_3] = x.data[varargin_3 + x_dim0 * (bcoef - 1)];
  }
}

static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel88(const
  emxArray_real32_T x, int32_T k, emxArray_real32_T xv)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel90(const
  ...
  bcoef, const int32_T lidx, const int32_T cfsposdft, int32_T ix,
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel91(const
...
static __global__ __launch_bounds__(32, 1) void ecc_cwt_kernel92(uint32_T xSize
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel93(int32_T xSize,
  emxArray_creal32_T cfspos)
{
  uint64_T loopEnd;
  uint64_T threadId;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel94(const
  emxArray_creal32_T cfspos, int32_T ix, emxArray_real32_T y)
{
  uint64_T loopEnd;
  uint64_T threadId;
  uint64_T threadStride;
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel96(const
  emxArray_real32_T xCh, const int32_T lidx, const int32_T ix, int32_T bcoef,
...
static __global__ __launch_bounds__(1024, 1) void ecc_cwt_kernel98(const
  emxArray_real32_T xCh, const int32_T xx_dim0, const int32_T bcoef, const
  int32_T xx, int32_T b_xx, emxArray_real32_T c_xx, int32_T b_xx_dim0, int32_T
  xx_dim1)
{
  uint64_T loopEnd;
  uint64_T threadId;
  ...
  for (uint64_T idx{threadId}; idx <= loopEnd; idx += threadStride) {
    int32_T b_bcoef;
    int32_T varargin_3;
    b_bcoef = static_cast<int32_T>(idx % (static_cast<uint64_T>(xx) + 1UL));
    varargin_3 = static_cast<int32_T>((idx - static_cast<uint64_T>(b_bcoef)) / (
      static_cast<uint64_T>(xx) + 1UL));
    c_xx.data[(b_bcoef + b_xx_dim0 * (bcoef - 1)) + b_xx_dim0 * xx_dim1 *
      varargin_3] = xCh.data[b_bcoef + xx_dim0 * varargin_3];
  }
}
             ...
             emxArray_real_T *cpu_freqs)
{
  ...
  if (!first_iteration) {
    ...
    ecc_cwt_kernel3<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(fs,
      *gpu_NyquistRange);
    b_dirtyOnGpu = true;
    emxInit_char_T(&tmpStr, 2, &pb_emlrtRTEI, true);
    guard1 = false;
    if (cpu_fLims[1] <= 0.0) {
      guard1 = true;
    } else {
    ...
    switch (lidx) {
     case 0:
      ...
      if (std::isinf(b_r) || std::isnan(b_r)) {
        ...
        lidx = 0;
        for (k = 0; k < ix; k++) {
          if (std::abs(cpu_interval[k + 1] - cpu_interval[lidx]) > 0.0) {
            lidx++;
            cpu_interval[lidx] = cpu_interval[k + 1];
            interval_dirtyOnCpu = true;
          } else {
            nsubs--;
          }
        ...
        if (bcoef <= 0) {
          ...
          emxInit_real_T(&c_cpu_x, 2, &ub_emlrtRTEI, true);
          emxInit_real_T(&cpu_xt, 2, &wb_emlrtRTEI, true);
          emxInit_real_T(&cpu_y, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&cpu_fx, 2, &pb_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_y, 2, &ac_emlrtRTEI, true);
          emxInit_real_T(&cpu_a, 2, &l_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv7, 2, &bc_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_y, 2, &cc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv11, 2, &bc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel18<<<grid, block>>>(dv3_idx_1, d_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              if (cpu_y->size[1] == b_cpu_y->size[1]) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel12<<<grid, block>>>(l_gpu_y, k_gpu_y, ix,
                    b_gpu_a);
                  a_dirtyOnGpu = true;
                  a_dirtyOnCpu = false;
                }
              ...
              emxEnsureCapacity_real_T(cpu_dv7, j, &i_emlrtRTEI);
              ...
              if (b_dirtyOnGpu) {
                ...
                a_dirtyOnCpu = false;
                ecc_cwt_kernel13<<<grid, block>>>(b_gpu_a, ix, gpu_dv7);
                dv7_dirtyOnGpu = true;
              }
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel16<<<grid, block>>>(ix, gpu_dv11);
                dv11_dirtyOnGpu = true;
              }
              ...
              if (cpu_dv7->size[1] == cpu_dv11->size[1]) {
                ...
                dv7 = cpu_dv7->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 +
                  1L), &grid, &block, 1024U, 3584U);
                if (b_dirtyOnGpu) {
                  if (fx_dirtyOnCpu) {
                    gpuEmxMemcpyCpuToGpu_real_T(&d_gpu_fx, cpu_fx);
                  ...
                  ecc_cwt_kernel17<<<grid, block>>>(d_gpu_xt, gpu_dv11, gpu_dv7,
                    dv7, d_gpu_fx);
                  fx_dirtyOnGpu = true;
                  fx_dirtyOnCpu = false;
                }
                ...
                xt_dirtyOnGpu = false;
                binary_expand_op(cpu_fx, cpu_dv7, cpu_dv11, cpu_xt);
                fx_dirtyOnCpu = true;
                fx_dirtyOnGpu = false;
              }
        ...
        if (bcoef <= 0) {
          ...
          emxInit_real_T(&e_cpu_x, 2, &ub_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_xt, 2, &wb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv14, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_fx, 2, &pb_emlrtRTEI, true);
          emxInit_real_T(&f_cpu_y, 2, &fc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv17, 2, &ec_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel29<<<grid, block>>>(dv3_idx_1, c_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              emxEnsureCapacity_real_T(cpu_dv14, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv14, &gpu_dv14);
              ix = e_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel24<<<grid, block>>>(i_gpu_x, ix, gpu_dv14);
              ...
              cpu_dv17->size[0] = 1;
              cpu_dv17->size[1] = f_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv17, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv17, &gpu_dv17);
              ix = f_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel26<<<grid, block>>>(j_gpu_y, ix, gpu_dv17);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel27<<<grid, block>>>(ix, gpu_dv17);
                dv17_dirtyOnGpu = true;
              }
              ...
              if (cpu_dv14->size[1] == cpu_dv17->size[1]) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel28<<<grid, block>>>(c_gpu_xt, gpu_dv17, gpu_dv14,
                    ix, c_gpu_fx);
                ...
                b_xt_dirtyOnGpu = false;
                binary_expand_op(b_cpu_fx, cpu_dv14, cpu_dv17, b_cpu_xt);
    ...
    if (!(b_r - r >= 1.0 / fb_VoicesPerOctave)) {
      ...
      emlrt_marshallIn(length(emlrtAlias(c_tmpStr), &b_emlrtMCI),
                       "<output of length>");
      emxInit_char_T(&d_tmpStr, 2, &pb_emlrtRTEI, true);
  ...
  cpu_r->size[0] = 1;
  cpu_r->size[1] = (cpu_omega->size[1] + div_s32(ix - bcoef, lidx)) + 2;
  ...
  k = cpu_omega->size[1];
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k), &grid, &block,
    1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel35<<<grid, block>>>(gpu_omega, k, gpu_r);
  }

  k = div_s32(ix - bcoef, lidx);
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel36<<<grid, block>>>(lidx, bcoef, gpu_omega, k, gpu_r,
      cpu_omega->size[1U]);
  }
  ...
  gpuEmxEnsureCapacity_real_T(cpu_omega, &gpu_omega);
  dv7 = cpu_r->size[1] - 1;
  b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
    &block, 1024U, 3584U);
  if (b_dirtyOnGpu) {
    ecc_cwt_kernel37<<<grid, block>>>(gpu_r, dv7, gpu_omega);
    omega_dirtyOnGpu = true;
  }
  ...
  if (!first_iteration) {
    ...
    emxInit_real_T(&d_cpu_y, 2, &nb_emlrtRTEI, true);
    ...
    emxInit_real_T(&e_cpu_y, 2, &ob_emlrtRTEI, true);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel71<<<grid, block>>>(b_gpu_y, halfh, ix, gpu_fb_Scales);
     ...
     case 0:
      ...
      if (std::isinf(b_r) || std::isnan(b_r)) {
        ...
        if (bcoef <= 0) {
          ...
          emxInit_real_T(&g_cpu_x, 2, &ub_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_xt, 2, &wb_emlrtRTEI, true);
          emxInit_real_T(&i_cpu_y, 2, &yb_emlrtRTEI, true);
          emxInit_real_T(&c_cpu_fx, 2, &pb_emlrtRTEI, true);
          emxInit_real_T(&j_cpu_y, 2, &ac_emlrtRTEI, true);
          emxInit_real_T(&b_cpu_a, 2, &l_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv20, 2, &bc_emlrtRTEI, true);
          emxInit_real_T(&k_cpu_y, 2, &cc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv24, 2, &bc_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel53<<<grid, block>>>(dv3_idx_1, b_gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              if (i_cpu_y->size[1] == j_cpu_y->size[1]) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel47<<<grid, block>>>(h_gpu_y, g_gpu_y, ix, gpu_a);
                  b_a_dirtyOnGpu = true;
                  b_a_dirtyOnCpu = false;
                }
              } else {
              ...
              j = cpu_dv20->size[0] * cpu_dv20->size[1];
              cpu_dv20->size[0] = 1;
              cpu_dv20->size[1] = static_cast<int16_T>(b_cpu_a->size[1]);
              emxEnsureCapacity_real_T(cpu_dv20, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv20, &gpu_dv20);
              ...
              if (b_dirtyOnGpu) {
                ...
                b_a_dirtyOnCpu = false;
                ecc_cwt_kernel48<<<grid, block>>>(gpu_a, ix, gpu_dv20);
              ...
              j = cpu_dv24->size[0] * cpu_dv24->size[1];
              cpu_dv24->size[0] = 1;
              cpu_dv24->size[1] = k_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv24, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv24, &gpu_dv24);
              ix = k_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel50<<<grid, block>>>(i_gpu_y, ix, gpu_dv24);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel51<<<grid, block>>>(ix, gpu_dv24);
                dv24_dirtyOnGpu = true;
              }

              if (cpu_dv20->size[1] == cpu_dv24->size[1]) {
                j = c_cpu_fx->size[0] * c_cpu_fx->size[1];
                c_cpu_fx->size[0] = 1;
                c_cpu_fx->size[1] = cpu_dv20->size[1];
                emxEnsureCapacity_real_T(c_cpu_fx, j, &v_emlrtRTEI);
                if (!c_fx_dirtyOnCpu) {
                  gpuEmxEnsureCapacity_real_T(c_cpu_fx, &b_gpu_fx);
                }

                dv7 = cpu_dv20->size[1] - 1;
                b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 +
                  1L), &grid, &block, 1024U, 3584U);
                if (b_dirtyOnGpu) {
                  if (c_fx_dirtyOnCpu) {
                  ...
                  ecc_cwt_kernel52<<<grid, block>>>(b_gpu_xt, gpu_dv24, gpu_dv20,
                    dv7, b_gpu_fx);
                ...
                c_xt_dirtyOnGpu = false;
                binary_expand_op(c_cpu_fx, cpu_dv20, cpu_dv24, c_cpu_xt);
        ...
        if (bcoef <= 0) {
          ...
          emxInit_real_T(&i_cpu_x, 2, &ub_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_xt, 2, &wb_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv26, 2, &ec_emlrtRTEI, true);
          emxInit_real_T(&d_cpu_fx, 2, &pb_emlrtRTEI, true);
          emxInit_real_T(&l_cpu_y, 2, &fc_emlrtRTEI, true);
          emxInit_real_T(&cpu_dv28, 2, &ec_emlrtRTEI, true);
          do {
            exitg1 = 0;
            ...
            if (!first_iteration) {
              ...
              if (first_iteration) {
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel64<<<grid, block>>>(dv3_idx_1, gpu_fx);
                }
            ...
            if (b_guard1) {
              ...
              emxEnsureCapacity_real_T(cpu_dv26, j, &i_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv26, &gpu_dv26);
              ix = i_cpu_x->size[1];
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel59<<<grid, block>>>(e_gpu_x, ix, gpu_dv26);
              ...
              cpu_dv28->size[0] = 1;
              cpu_dv28->size[1] = l_cpu_y->size[1];
              emxEnsureCapacity_real_T(cpu_dv28, j, &r_emlrtRTEI);
              gpuEmxEnsureCapacity_real_T(cpu_dv28, &gpu_dv28);
              ix = l_cpu_y->size[1] - 1;
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel61<<<grid, block>>>(f_gpu_y, ix, gpu_dv28);
              ...
              b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix),
                &grid, &block, 1024U, 3584U);
              if (b_dirtyOnGpu) {
                ecc_cwt_kernel62<<<grid, block>>>(ix, gpu_dv28);
                dv28_dirtyOnGpu = true;
              }

              if (cpu_dv26->size[1] == cpu_dv28->size[1]) {
                j = d_cpu_fx->size[0] * d_cpu_fx->size[1];
                d_cpu_fx->size[0] = 1;
                ...
                if (b_dirtyOnGpu) {
                  ...
                  ecc_cwt_kernel63<<<grid, block>>>(gpu_xt, gpu_dv28, gpu_dv26,
                    dv7, gpu_fx);
                ...
                d_xt_dirtyOnGpu = false;
                binary_expand_op(d_cpu_fx, cpu_dv26, cpu_dv28, d_cpu_xt);
    ...
    emxInit_real_T(&g_cpu_y, 2, &sb_emlrtRTEI, true);
    ...
    emxInit_real_T(&h_cpu_y, 2, &vb_emlrtRTEI, true);
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(ix + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel67<<<grid, block>>>(e_gpu_y, halfh, ix, gpu_fb_Scales);
      fb_Scales_dirtyOnGpu = true;
    }
  ...
  emxInit_real_T(&cpu_psidft, 2, &pb_emlrtRTEI, true);
  emxInit_real_T(&cpu_f, 2, &qb_emlrtRTEI, true);
  if (first_iteration) {
    emxInit_real_T(&cpu_somega, 2, &rb_emlrtRTEI, true);
    if (cpu_fb_Scales->size[1] == 1) {
      ...
      gpuEmxEnsureCapacity_real_T(cpu_somega, &gpu_somega);
      k = cpu_omega->size[1];
      dv7 = cpu_fb_Scales->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((dv7 + 1L) * k),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel74<<<grid, block>>>(gpu_omega, gpu_fb_Scales, dv7, k,
    ...
    for (dv7 = 0; dv7 < 2; dv7++) {
      cpu_xSize[dv7] = static_cast<uint32_T>(cpu_somega->size[dv7]);
      xSize_dirtyOnCpu = true;
    }

    emxInit_real_T(&cpu_absomega, 2, &tb_emlrtRTEI, true);
    ...
    dv7 = cpu_absomega->size[0] * cpu_absomega->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel76<<<grid, block>>>(gpu_absomega, dv7, gpu_powscales);
    ...
    if ((cpu_absomega->size[0] == cpu_powscales->size[0]) && (cpu_absomega->
      ...
      dv7 = cpu_absomega->size[0] * cpu_absomega->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel78<<<grid, block>>>(gpu_powscales, gpu_absomega, dv7,
          gpu_x);
        e_x_dirtyOnGpu = true;
      }
    } else {
    ...
    if ((j_cpu_x->size[0] == cpu_somega->size[0]) && (j_cpu_x->size[1] ==
      ...
      dv7 = j_cpu_x->size[0] * j_cpu_x->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        if (somega_dirtyOnCpu) {
        ...
        ecc_cwt_kernel80<<<grid, block>>>(gpu_somega, gpu_x, dv7, gpu_psidft);
      }
    } else {
      if (e_x_dirtyOnGpu) {
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel81<<<grid, block>>>(gpu_fb_Scales, dv7, gpu_f);
    }
  } else {
    j = cpu_psidft->size[0] * cpu_psidft->size[1];
    ...
    gpuEmxEnsureCapacity_real_T(cpu_psidft, &gpu_psidft);
    dv7 = cpu_fb_Scales->size[1] * cpu_omega->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel72<<<grid, block>>>(dv7, gpu_psidft);
    }
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel73<<<grid, block>>>(gpu_fb_Scales, dv7, gpu_f);
    }
  }
  ...
  if (std::isnan(ds2)) {
    ...
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>
      ...
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel84<<<grid, block>>>(ds2, j, gpu_fv);
    }
  }
  ...
  cpu_xx->size[0] = static_cast<int32_T>(static_cast<real32_T>(cpu_fv->size[1]));
  emxFree_real32_T(&cpu_fv);
  cpu_xx->size[1] = static_cast<int32_T>(static_cast<real32_T>(cpu_x->size[1]));
  cpu_xx->size[2] = static_cast<int32_T>(static_cast<real32_T>(cpu_f->size[1]));
  ...
  emxInit_real32_T(&cpu_xCh, 2, &kb_emlrtRTEI, true);
  emxInit_real32_T(&b_cpu_xCh, 2, &lb_emlrtRTEI, true);
  for (c_eint = 0; c_eint < fb_CutOff; c_eint++) {
    ...
    emxEnsureCapacity_real32_T(cpu_psihat, j, &cb_emlrtRTEI);
    gpuEmxEnsureCapacity_real32_T(cpu_psihat, &gpu_psihat);
    dv7 = cpu_psidft->size[0] * cpu_psidft->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L), &grid,
      &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ...
      psidft_dirtyOnCpu = false;
      ecc_cwt_kernel85<<<grid, block>>>(gpu_psidft, dv7, gpu_psihat);
    }

    j = cpu_xv->size[0] * cpu_xv->size[1];
    cpu_xv->size[0] = 1;
    cpu_xv->size[1] = cpu_x->size[0];
    emxEnsureCapacity_real32_T(cpu_xv, j, &db_emlrtRTEI);
    if (!xv_dirtyOnCpu) {
    ...
    if (b_dirtyOnGpu) {
      ...
      ecc_cwt_kernel86<<<grid, block>>>(static_cast<int32_T>
        (static_cast<real32_T>(c_eint) + 1.0F), b_gpu_x, dv7, gpu_xv,
        cpu_x->size[0U]);
      xv_dirtyOnGpu = true;
      xv_dirtyOnCpu = false;
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      emxEnsureCapacity_real32_T(k_cpu_x, j, &gb_emlrtRTEI);
      if (!g_x_dirtyOnCpu) {
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel87<<<grid, block>>>(static_cast<int32_T>
          (static_cast<real32_T>(c_eint) + 1.0F), b_gpu_x, fb_SignalPad, c_gpu_x,
          cpu_x->size[0U]);
        f_x_dirtyOnGpu = true;
        g_x_dirtyOnCpu = false;
      }
      ...
      for (bcoef = 0; bcoef < lidx; bcoef++) {
        ix = (fb_SignalPad - bcoef) - 1;
        if (f_x_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_real32_T(k_cpu_x, &c_gpu_x);
        }

        xtmp = k_cpu_x->data[bcoef];
        k_cpu_x->data[bcoef] = k_cpu_x->data[ix];
        k_cpu_x->data[ix] = xtmp;
        g_x_dirtyOnCpu = true;
        f_x_dirtyOnGpu = false;
      }
      ...
      cpu_xv->size[1] = ((cpu_x->size[0] + k_cpu_x->size[1]) + div_s32(nsubs -
        eint, b_eint)) + 1;
      emxEnsureCapacity_real32_T(cpu_xv, j, &hb_emlrtRTEI);
      if (!xv_dirtyOnCpu) {
        gpuEmxEnsureCapacity_real32_T(cpu_xv, &gpu_xv);
      }

      k = k_cpu_x->size[1];
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(k), &grid,
        &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        if (g_x_dirtyOnCpu) {
          gpuEmxMemcpyCpuToGpu_real32_T(&c_gpu_x, k_cpu_x);
        ...
        ecc_cwt_kernel88<<<grid, block>>>(c_gpu_x, k, gpu_xv);
        xv_dirtyOnGpu = true;
        xv_dirtyOnCpu = false;
      }
      ...
      for (j = 0; j <= k; j++) {
        ...
        cpu_xv->data[(j + cpu_x->size[0]) + k_cpu_x->size[1]] = cpu_x->data
          [(eint + b_eint * j) + cpu_x->size[0] * (static_cast<int32_T>(
    ...
    if (cpu_xv->size[1] - (static_cast<int32_T>(static_cast<uint32_T>
      ...
      emxEnsureCapacity_creal32_T(cpu_xposdft, j, &eb_emlrtRTEI);
      ...
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel89<<<grid, block>>>(gpu_xv, dv7, gpu_xposdft);
        xposdft_dirtyOnCpu = false;
      }
      ...
      lidx = cpu_xv->size[1];
      for (dv7 = 0; dv7 < 2; dv7++) {
        cpu_xSize[dv7] = static_cast<uint32_T>(cpu_xv->size[dv7]);
        xSize_dirtyOnCpu = true;
      }
      ...
      lidx = static_cast<int32_T>(static_cast<real_T>(static_cast<int32_T>
        (cpu_xSize[1]) + 1) / 2.0);
      for (bcoef = 0; bcoef <= lidx - 2; bcoef++) {
        if (b_dirtyOnGpu) {
          gpuEmxMemcpyGpuToCpu_creal32_T(cpu_xposdft, &gpu_xposdft);
        }

        cpu_xposdft->data[(static_cast<int32_T>(cpu_xSize[1]) - bcoef) - 1].re =
          cpu_xposdft->data[bcoef + 1].re;
        cpu_xposdft->data[(static_cast<int32_T>(cpu_xSize[1]) - bcoef) - 1].im =
          -cpu_xposdft->data[bcoef + 1].im;
        xposdft_dirtyOnCpu = true;
        b_dirtyOnGpu = false;
      }
    }

    lidx = cpu_psihat->size[1];
    ...
    if ((cpu_psihat->size[0] != 0) && (j != 0)) {
      ...
      ix = j - 1;
      dv7 = cpu_cfsposdft->size[0] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((dv7 + 1L) *
        (ix + 1L)), &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        if (xposdft_dirtyOnCpu) {
          gpuEmxMemcpyCpuToGpu_creal32_T(&gpu_xposdft, cpu_xposdft);
        }
        ...
        xposdft_dirtyOnCpu = false;
        ecc_cwt_kernel90<<<grid, block>>>(gpu_xposdft, gpu_psihat, bcoef, lidx,
          dv7, j - 1, gpu_cfsposdft, cpu_psihat->size[0U], cpu_cfsposdft->size
          [0U]);
      }
    }
    ...
    if ((cpu_cfsposdft->size[0] == 0) || (cpu_cfsposdft->size[1] == 0)) {
      for (dv7 = 0; dv7 < 2; dv7++) {
        cpu_xSize[dv7] = static_cast<uint32_T>(cpu_cfsposdft->size[dv7]);
        xSize_dirtyOnCpu = true;
      }
      ...
      ecc_cwt_kernel92<<<dim3(1U, 1U, 1U), dim3(32U, 1U, 1U)>>>(*gpu_xSize,
      ...
      emxEnsureCapacity_creal32_T(cpu_cfspos, j, &ib_emlrtRTEI);
      if (!cfspos_dirtyOnCpu) {
        gpuEmxEnsureCapacity_creal32_T(cpu_cfspos, &gpu_cfspos);
      }

      dv7 = static_cast<int32_T>(cpu_xSize[0]) * static_cast<int32_T>(cpu_xSize
        [1]) - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ...
        ecc_cwt_kernel93<<<grid, block>>>(dv7, gpu_cfspos);
      ...
      dv7 = cpu_cfsposdft->size[0] * cpu_cfsposdft->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        if (cfspos_dirtyOnCpu) {
        ...
        ecc_cwt_kernel91<<<grid, block>>>(xtmp, gpu_cfsposdft, dv7, gpu_cfspos);
        cfspos_dirtyOnGpu = true;
        cfspos_dirtyOnCpu = false;
      }
    }
    ...
    if (fb_SignalPad > 0) {
      ...
      for (j = 0; j < k; j++) {
        for (nsubs = 0; nsubs < bcoef; nsubs++) {
          ...
          cpu_cfspos->data[nsubs + bcoef * j] = cpu_cfspos->data[nsubs +
    ...
    for (dv7 = 0; dv7 < 2; dv7++) {
      cpu_xSize[dv7] = static_cast<uint32_T>(cpu_cfspos->size[dv7]);
      xSize_dirtyOnCpu = true;
    }
    ...
    if (b_dirtyOnGpu) {
      ...
      cfspos_dirtyOnCpu = false;
      ecc_cwt_kernel94<<<grid, block>>>(gpu_cfspos, ix, c_gpu_y);
    }

    j = cpu_xCh->size[0] * cpu_xCh->size[1];
    cpu_xCh->size[0] = m_cpu_y->size[1];
    cpu_xCh->size[1] = m_cpu_y->size[0];
    emxEnsureCapacity_real32_T(cpu_xCh, j, &kb_emlrtRTEI);
    gpuEmxEnsureCapacity_real32_T(cpu_xCh, &gpu_xCh);
    ix = m_cpu_y->size[0] - 1;
    dv7 = m_cpu_y->size[1] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((dv7 + 1L) * (ix
      + 1L)), &grid, &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      ecc_cwt_kernel95<<<grid, block>>>(c_gpu_y, dv7, ix, gpu_xCh, cpu_xCh->
    ...
    if (ds2 > 1.0F) {
      ...
      if (cpu_xCh->size[0] < 1.0F) {
        ...
        ix = static_cast<int32_T>(static_cast<real32_T>(cpu_xCh->size[0])) - 1;
      }
      ...
      emxEnsureCapacity_real32_T(b_cpu_xCh, j, &lb_emlrtRTEI);
      ...
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel96<<<grid, block>>>(gpu_xCh, lidx, ix, bcoef, b_gpu_xCh,
      ...
      emxEnsureCapacity_real32_T(cpu_xCh, j, &mb_emlrtRTEI);
      gpuEmxEnsureCapacity_real32_T(cpu_xCh, &gpu_xCh);
      dv7 = b_cpu_xCh->size[0] * b_cpu_xCh->size[1] - 1;
      b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>(dv7 + 1L),
        &grid, &block, 1024U, 3584U);
      if (b_dirtyOnGpu) {
        ecc_cwt_kernel97<<<grid, block>>>(b_gpu_xCh, dv7, gpu_xCh);
      }
    ...
    dv7 = xx[2] - 1;
    ix = xx[0] - 1;
    b_dirtyOnGpu = mwGetLaunchParameters1D(static_cast<real_T>((ix + 1L) * (dv7
      + 1L)), &grid, &block, 1024U, 3584U);
    if (b_dirtyOnGpu) {
      if (xx_dirtyOnCpu) {
      ...
      ecc_cwt_kernel98<<<grid, block>>>(gpu_xCh, xx[0], static_cast<int32_T>(
        static_cast<real32_T>(c_eint) + 1.0F), xx[0] - 1, xx[2] - 1, gpu_xx,
        cpu_xx->size[0U], cpu_xx->size[1U]);
      xx_dirtyOnGpu = true;
      xx_dirtyOnCpu = false;
    }
                 ...
                 *plhs[2])
{
  ...
  emxInit_real_T(&freqs, 1, &hc_emlrtRTEI, true);
