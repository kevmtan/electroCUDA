...
//
// _coder_ecc_cwt_mex.cu
//
// Code generation for function '_coder_ecc_cwt_mex'
//
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&ecc_cwt_atexit);
  // Module initialization.
  ecc_cwt_initialize();
  try {
    // Dispatch the entry-point.
    unsafe_ecc_cwt_mexFunction(nlhs, plhs, nrhs, prhs);
    // Module termination.
    ecc_cwt_terminate();
  } catch (...) {
...
// End of code generation (_coder_ecc_cwt_mex.cu)
